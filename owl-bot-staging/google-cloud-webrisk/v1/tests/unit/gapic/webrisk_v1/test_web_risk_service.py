...
def test__get_api_endpoint():
    ...
    assert WebRiskServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == WebRiskServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert WebRiskServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == WebRiskServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_submit_uri(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.submit_uri),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_compute_threat_list_diff_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_compute_threat_list_diff_with_metadata") as post_with_metadata, \
...
def test_search_uris_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_search_uris_with_metadata") as post_with_metadata, \
...
def test_search_hashes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_search_hashes_with_metadata") as post_with_metadata, \
...
def test_create_submission_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_create_submission_with_metadata") as post_with_metadata, \
...
def test_submit_uri_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_submit_uri") as post, \
        mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_submit_uri_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WebRiskServiceRestInterceptor, "pre_submit_uri") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

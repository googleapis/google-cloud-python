...
def test_compute_threat_list_diff_rest_unset_required_fields():
    transport = transports.WebRiskServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_submission_rest_required_fields(request_type=webrisk.CreateSubmissionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_submission._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_submit_uri_rest_required_fields(request_type=webrisk.SubmitUriRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).submit_uri._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = WebRiskServiceV1Beta1Client(credentials=cred)
...
def test_compute_threat_list_diff_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_compute_threat_list_diff_with_metadata") as post_with_metadata, \
...
def test_search_uris_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_uris_with_metadata") as post_with_metadata, \
...
def test_search_hashes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_hashes_with_metadata") as post_with_metadata, \

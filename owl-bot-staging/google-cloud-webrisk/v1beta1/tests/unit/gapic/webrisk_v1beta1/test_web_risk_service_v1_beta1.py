...
def test__read_environment_variables():
    assert WebRiskServiceV1Beta1Client._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert WebRiskServiceV1Beta1Client._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            WebRiskServiceV1Beta1Client._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert WebRiskServiceV1Beta1Client._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert WebRiskServiceV1Beta1Client._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert WebRiskServiceV1Beta1Client._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert WebRiskServiceV1Beta1Client._get_client_cert_source(None, False) is None
    assert WebRiskServiceV1Beta1Client._get_client_cert_source(mock_provided_cert_source, False) is None
    assert WebRiskServiceV1Beta1Client._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert WebRiskServiceV1Beta1Client._get_client_cert_source(None, True) is mock_default_cert_source
            assert WebRiskServiceV1Beta1Client._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(WebRiskServiceV1Beta1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WebRiskServiceV1Beta1Client))
@mock.patch.object(WebRiskServiceV1Beta1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WebRiskServiceV1Beta1AsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WebRiskServiceV1Beta1Client._DEFAULT_UNIVERSE
    default_endpoint = WebRiskServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = WebRiskServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert WebRiskServiceV1Beta1Client._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert WebRiskServiceV1Beta1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == WebRiskServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
    assert WebRiskServiceV1Beta1Client._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert WebRiskServiceV1Beta1Client._get_api_endpoint(None, None, default_universe, "always") == WebRiskServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
    assert WebRiskServiceV1Beta1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == WebRiskServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
    assert WebRiskServiceV1Beta1Client._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert WebRiskServiceV1Beta1Client._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        WebRiskServiceV1Beta1Client._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert WebRiskServiceV1Beta1Client._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert WebRiskServiceV1Beta1Client._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert WebRiskServiceV1Beta1Client._get_universe_domain(None, None) == WebRiskServiceV1Beta1Client._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (WebRiskServiceV1Beta1Client, transports.WebRiskServiceV1Beta1RestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_name", [
    ...
    (WebRiskServiceV1Beta1Client, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.WebRiskServiceV1Beta1RestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (WebRiskServiceV1Beta1Client, transports.WebRiskServiceV1Beta1RestTransport, "rest", "true"),
    (WebRiskServiceV1Beta1Client, transports.WebRiskServiceV1Beta1RestTransport, "rest", "false"),
])
@mock.patch.object(WebRiskServiceV1Beta1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WebRiskServiceV1Beta1Client))
@mock.patch.object(WebRiskServiceV1Beta1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WebRiskServiceV1Beta1AsyncClient))
...
@pytest.mark.parametrize("client_class", [
    WebRiskServiceV1Beta1Client, WebRiskServiceV1Beta1AsyncClient
])
...
@mock.patch.object(WebRiskServiceV1Beta1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WebRiskServiceV1Beta1Client))
@mock.patch.object(WebRiskServiceV1Beta1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WebRiskServiceV1Beta1AsyncClient))
def test_web_risk_service_v1_beta1_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (WebRiskServiceV1Beta1Client, transports.WebRiskServiceV1Beta1GrpcTransport, "grpc", grpc_helpers),
    (WebRiskServiceV1Beta1AsyncClient, transports.WebRiskServiceV1Beta1GrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (WebRiskServiceV1Beta1Client, transports.WebRiskServiceV1Beta1RestTransport, "rest", None),
])
...
def test_compute_threat_list_diff_rest_required_fields(request_type=webrisk.ComputeThreatListDiffRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).compute_threat_list_diff._get_unset_required_fields(jsonified_request)
...
def test_compute_threat_list_diff_rest_unset_required_fields():
    transport = transports.WebRiskServiceV1Beta1RestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_compute_threat_list_diff_rest_interceptors(null_interceptor):
    transport = transports.WebRiskServiceV1Beta1RestTransport(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        interceptor=None if null_interceptor else transports.WebRiskServiceV1Beta1RestInterceptor(),
        )
    client = WebRiskServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_compute_threat_list_diff") as post, \
         mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "pre_compute_threat_list_diff") as pre:
...
def test_search_uris_rest_required_fields(request_type=webrisk.SearchUrisRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_uris._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_uris_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_uris") as post, \
         mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "pre_search_uris") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_search_hashes_rest_required_fields(request_type=webrisk.SearchHashesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).search_hashes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_hashes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_hashes") as post, \
         mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "pre_search_hashes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_web_risk_service_v1_beta1_client_transport_session_collision(transport_name):
    ...
    client1 = WebRiskServiceV1Beta1Client(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = WebRiskServiceV1Beta1Client(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (WebRiskServiceV1Beta1Client, transports.WebRiskServiceV1Beta1GrpcTransport),
    (WebRiskServiceV1Beta1AsyncClient, transports.WebRiskServiceV1Beta1GrpcAsyncIOTransport),
])

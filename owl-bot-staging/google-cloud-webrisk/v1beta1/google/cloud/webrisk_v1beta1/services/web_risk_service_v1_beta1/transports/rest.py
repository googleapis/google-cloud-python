...
class WebRiskServiceV1Beta1RestTransport(_BaseWebRiskServiceV1Beta1RestTransport):
    ...
    class _ComputeThreatListDiff(_BaseWebRiskServiceV1Beta1RestTransport._BaseComputeThreatListDiff, WebRiskServiceV1Beta1RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebRiskServiceV1Beta1RestTransport._ComputeThreatListDiff._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchHashes(_BaseWebRiskServiceV1Beta1RestTransport._BaseSearchHashes, WebRiskServiceV1Beta1RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebRiskServiceV1Beta1RestTransport._SearchHashes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SearchUris(_BaseWebRiskServiceV1Beta1RestTransport._BaseSearchUris, WebRiskServiceV1Beta1RestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebRiskServiceV1Beta1RestTransport._SearchUris._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

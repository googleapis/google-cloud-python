...
from .base import AppConnectorsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class AppConnectorsServiceRestTransport(AppConnectorsServiceTransport):
    ...
    class _CreateAppConnector(AppConnectorsServiceRestStub):
        def __hash__(self):
    ...
    class _DeleteAppConnector(AppConnectorsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/appConnectors/*}',
            },
            ]
    ...
    class _GetAppConnector(AppConnectorsServiceRestStub):
        def __hash__(self):
    ...
    class _ListAppConnectors(AppConnectorsServiceRestStub):
        def __hash__(self):
    ...
    class _ReportStatus(AppConnectorsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{app_connector=projects/*/locations/*/appConnectors/*}:reportStatus',
                'body': '*',
            },
            ]
    ...
    class _UpdateAppConnector(AppConnectorsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{app_connector.name=projects/*/locations/*/appConnectors/*}',
                'body': 'app_connector',
            },
            ]
    ...
    class _GetLocation(AppConnectorsServiceRestStub):
        def __call__(self,
    ...
    class _ListLocations(AppConnectorsServiceRestStub):
        def __call__(self,
    ...
    class _GetIamPolicy(AppConnectorsServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _SetIamPolicy(AppConnectorsServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _TestIamPermissions(AppConnectorsServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _CancelOperation(AppConnectorsServiceRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(AppConnectorsServiceRestStub):
        def __call__(self,
    ...
    class _GetOperation(AppConnectorsServiceRestStub):
        def __call__(self,
    ...
    class _ListOperations(AppConnectorsServiceRestStub):
        def __call__(self,

...
class AppConnectorsServiceClient(metaclass=AppConnectorsServiceClientMeta):
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = AppConnectorsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            AppConnectorsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AppConnectorsServiceTransport]] = None,
    ...
    def list_app_connectors(self,
        ...
        # in a app_connectors_service.ListAppConnectorsRequest.
    ...
    def get_app_connector(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_connectors_service.GetAppConnectorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_app_connector(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_connectors_service.CreateAppConnectorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_app_connector(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_connectors_service.UpdateAppConnectorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_app_connector(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_connectors_service.DeleteAppConnectorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def report_status(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_connectors_service.ReportStatusRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

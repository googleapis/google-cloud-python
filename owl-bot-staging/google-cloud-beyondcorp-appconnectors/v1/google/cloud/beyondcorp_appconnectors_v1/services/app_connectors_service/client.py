...
from google.cloud.beyondcorp_appconnectors_v1.services.app_connectors_service import pagers
...
class AppConnectorsServiceClientMeta(type):
    """Metaclass for the AppConnectorsService client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[AppConnectorsServiceTransport]:
...
class AppConnectorsServiceClient(metaclass=AppConnectorsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AppConnectorsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AppConnectorsServiceTransport:
        ...
        Returns:
            AppConnectorsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def app_connector_path(project: str,location: str,app_connector: str,) -> str:
        """Returns a fully-qualified app_connector string."""
        return "projects/{project}/locations/{location}/appConnectors/{app_connector}".format(project=project, location=location, app_connector=app_connector, )

    @staticmethod
    def parse_app_connector_path(path: str) -> Dict[str,str]:
        """Parses a app_connector path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/appConnectors/(?P<app_connector>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AppConnectorsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AppConnectorsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AppConnectorsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AppConnectorsServiceTransport, Callable[..., AppConnectorsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AppConnectorsServiceClient._read_environment_variables()
        self._client_cert_source = AppConnectorsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AppConnectorsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AppConnectorsServiceTransport)
        if transport_provided:
            # transport is a AppConnectorsServiceTransport instance.
            ...
            self._transport = cast(AppConnectorsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            AppConnectorsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AppConnectorsServiceTransport], Callable[..., AppConnectorsServiceTransport]] = (
                AppConnectorsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AppConnectorsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.beyondcorp.appconnectors_v1.AppConnectorsServiceClient`.",
                    extra = {
    ...
    def list_app_connectors(self,
            request: Optional[Union[app_connectors_service.ListAppConnectorsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListAppConnectorsPager:
        ...
        Args:
            request (Union[google.cloud.beyondcorp_appconnectors_v1.types.ListAppConnectorsRequest, dict]):
        ...
        Returns:
            google.cloud.beyondcorp_appconnectors_v1.services.app_connectors_service.pagers.ListAppConnectorsPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_app_connectors]
        ...
        response = pagers.ListAppConnectorsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_app_connector(self,
            request: Optional[Union[app_connectors_service.GetAppConnectorRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.cloud.beyondcorp_appconnectors_v1.types.GetAppConnectorRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.beyondcorp_appconnectors_v1.types.AppConnector:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_app_connector]
    ...
    def create_app_connector(self,
            request: Optional[Union[app_connectors_service.CreateAppConnectorRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            app_connector: Optional[app_connectors_service.AppConnector] = None,
            app_connector_id: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        r"""Creates a new AppConnector in a given project and
        location.
        ...
        Args:
            request (Union[google.cloud.beyondcorp_appconnectors_v1.types.CreateAppConnectorRequest, dict]):
                The request object. Request message for
            ...
            app_connector (google.cloud.beyondcorp_appconnectors_v1.types.AppConnector):
                Required. A BeyondCorp AppConnector
                resource.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.beyondcorp_appconnectors_v1.types.AppConnector` A BeyondCorp connector resource that represents an application facing
                   component deployed proximal to and with direct access
                   to the application instances. It is used to establish
                   connectivity between the remote enterprise
                   environment and GCP. It initiates connections to the
                   applications and can proxy the data from users over
                   the connection.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, app_connector, app_connector_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, app_connectors_service.CreateAppConnectorRequest):
            ...
            if app_connector_id is not None:
                request.app_connector_id = app_connector_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_app_connector]
    ...
    def update_app_connector(self,
            request: Optional[Union[app_connectors_service.UpdateAppConnectorRequest, dict]] = None,
            *,
            app_connector: Optional[app_connectors_service.AppConnector] = None,
        ...
        Args:
            request (Union[google.cloud.beyondcorp_appconnectors_v1.types.UpdateAppConnectorRequest, dict]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [app_connector, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_app_connector]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("app_connector.name", request.app_connector.name),
            )),
        )
    ...
    def delete_app_connector(self,
            request: Optional[Union[app_connectors_service.DeleteAppConnectorRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.beyondcorp_appconnectors_v1.types.DeleteAppConnectorRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_app_connector]
    ...
    def report_status(self,
            request: Optional[Union[app_connectors_service.ReportStatusRequest, dict]] = None,
            *,
            app_connector: Optional[str] = None,
            resource_info: Optional[gcba_resource_info.ResourceInfo] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation.Operation:
        ...
        Args:
            request (Union[google.cloud.beyondcorp_appconnectors_v1.types.ReportStatusRequest, dict]):
            ...
            resource_info (google.cloud.beyondcorp_appconnectors_v1.types.ResourceInfo):
                Required. Resource info of the
                connector.

                This corresponds to the ``resource_info`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [app_connector, resource_info]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, app_connectors_service.ReportStatusRequest):
            ...
            if resource_info is not None:
                request.resource_info = resource_info

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.report_status]

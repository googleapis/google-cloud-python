...
def test__get_api_endpoint():
    ...
    assert AppConnectorsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AppConnectorsServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert AppConnectorsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AppConnectorsServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test_list_app_connectors_rest_required_fields(request_type=app_connectors_service.ListAppConnectorsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_app_connectors._get_unset_required_fields(jsonified_request)
...
def test_list_app_connectors_rest_unset_required_fields():
    transport = transports.AppConnectorsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_app_connector_rest_required_fields(request_type=app_connectors_service.GetAppConnectorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_app_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_app_connector_rest_required_fields(request_type=app_connectors_service.CreateAppConnectorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_app_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_app_connector_rest_required_fields(request_type=app_connectors_service.UpdateAppConnectorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_app_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_app_connector_rest_required_fields(request_type=app_connectors_service.DeleteAppConnectorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_app_connector._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_report_status_rest_required_fields(request_type=app_connectors_service.ReportStatusRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).report_status._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
class FileUploadsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_file_upload(self, request: fileuploads.GetFileUploadRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[fileuploads.GetFileUploadRequest, Sequence[Tuple[str, str]]]:

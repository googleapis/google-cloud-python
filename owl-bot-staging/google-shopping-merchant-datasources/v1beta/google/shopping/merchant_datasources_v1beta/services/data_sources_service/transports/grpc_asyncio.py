...
class DataSourcesServiceGrpcAsyncIOTransport(DataSourcesServiceTransport):
    ...
    def create_data_source(self) -> Callable[
        ...
        if 'create_data_source' not in self._stubs:
            self._stubs['create_data_source'] = self.grpc_channel.unary_unary(
    ...
    def update_data_source(self) -> Callable[
        ...
        if 'update_data_source' not in self._stubs:
            self._stubs['update_data_source'] = self.grpc_channel.unary_unary(
    ...
    def delete_data_source(self) -> Callable[
        ...
        if 'delete_data_source' not in self._stubs:
            self._stubs['delete_data_source'] = self.grpc_channel.unary_unary(
    ...
    def fetch_data_source(self) -> Callable[
        ...
        if 'fetch_data_source' not in self._stubs:
            self._stubs['fetch_data_source'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_data_source: gapic_v1.method_async.wrap_method(
            ...
            self.delete_data_source: gapic_v1.method_async.wrap_method(
                self.delete_data_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.fetch_data_source: gapic_v1.method_async.wrap_method(

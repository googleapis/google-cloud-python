...
class DataSourcesServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(DataSourcesServiceClient).get_transport_class, type(DataSourcesServiceClient))
    ...
    async def delete_data_source(self,
    ...
    async def fetch_data_source(self,

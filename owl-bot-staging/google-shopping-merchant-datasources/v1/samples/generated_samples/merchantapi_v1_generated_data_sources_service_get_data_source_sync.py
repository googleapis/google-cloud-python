...
# [START merchantapi_v1_generated_DataSourcesService_GetDataSource_sync]
...
def sample_get_data_source():
    ...
    request = merchant_datasources_v1.GetDataSourceRequest(
        name="name_value",
    )
...
# [END merchantapi_v1_generated_DataSourcesService_GetDataSource_sync]

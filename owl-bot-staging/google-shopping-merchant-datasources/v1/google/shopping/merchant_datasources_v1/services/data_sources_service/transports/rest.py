...
class DataSourcesServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_data_source(self, request: datasources.CreateDataSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.CreateDataSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_data_source_with_metadata(self, response: datasources.DataSource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.DataSource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_data_source
    ...
    def pre_delete_data_source(self, request: datasources.DeleteDataSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.DeleteDataSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_fetch_data_source(self, request: datasources.FetchDataSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.FetchDataSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_data_source(self, request: datasources.GetDataSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.GetDataSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_data_source_with_metadata(self, response: datasources.DataSource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.DataSource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_data_source
    ...
    def pre_list_data_sources(self, request: datasources.ListDataSourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.ListDataSourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_data_sources_with_metadata(self, response: datasources.ListDataSourcesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.ListDataSourcesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_data_sources
    ...
    def pre_update_data_source(self, request: datasources.UpdateDataSourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.UpdateDataSourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_data_source_with_metadata(self, response: datasources.DataSource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datasources.DataSource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_data_source
...
class DataSourcesServiceRestTransport(_BaseDataSourcesServiceRestTransport):
    ...
    class _CreateDataSource(_BaseDataSourcesServiceRestTransport._BaseCreateDataSource, DataSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataSourcesServiceRestTransport._CreateDataSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteDataSource(_BaseDataSourcesServiceRestTransport._BaseDeleteDataSource, DataSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataSourcesServiceRestTransport._DeleteDataSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _FetchDataSource(_BaseDataSourcesServiceRestTransport._BaseFetchDataSource, DataSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataSourcesServiceRestTransport._FetchDataSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetDataSource(_BaseDataSourcesServiceRestTransport._BaseGetDataSource, DataSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataSourcesServiceRestTransport._GetDataSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListDataSources(_BaseDataSourcesServiceRestTransport._BaseListDataSources, DataSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataSourcesServiceRestTransport._ListDataSources._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateDataSource(_BaseDataSourcesServiceRestTransport._BaseUpdateDataSource, DataSourcesServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = DataSourcesServiceRestTransport._UpdateDataSource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

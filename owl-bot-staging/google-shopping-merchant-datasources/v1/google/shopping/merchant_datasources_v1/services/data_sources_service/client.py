...
from google.shopping.merchant_datasources_v1.services.data_sources_service import pagers
from google.shopping.merchant_datasources_v1.types import datasources
from google.shopping.merchant_datasources_v1.types import datasourcetypes
from google.shopping.merchant_datasources_v1.types import fileinputs
from .transports.base import DataSourcesServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import DataSourcesServiceGrpcTransport
from .transports.grpc_asyncio import DataSourcesServiceGrpcAsyncIOTransport
from .transports.rest import DataSourcesServiceRestTransport


class DataSourcesServiceClientMeta(type):
    """Metaclass for the DataSourcesService client.
...
class DataSourcesServiceClient(metaclass=DataSourcesServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataSourcesServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DataSourcesServiceTransport:
        ...
        Returns:
            DataSourcesServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def data_source_path(account: str,datasource: str,) -> str:
        """Returns a fully-qualified data_source string."""
        return "accounts/{account}/dataSources/{datasource}".format(account=account, datasource=datasource, )

    @staticmethod
    def parse_data_source_path(path: str) -> Dict[str,str]:
        """Parses a data_source path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/dataSources/(?P<datasource>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DataSourcesServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataSourcesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DataSourcesServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DataSourcesServiceTransport, Callable[..., DataSourcesServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the data sources service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DataSourcesServiceClient._read_environment_variables()
        self._client_cert_source = DataSourcesServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DataSourcesServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DataSourcesServiceTransport)
        if transport_provided:
            # transport is a DataSourcesServiceTransport instance.
            ...
            self._transport = cast(DataSourcesServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DataSourcesServiceTransport], Callable[..., DataSourcesServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.datasources_v1.DataSourcesServiceClient`.",
                    extra = {
    ...
    def get_data_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1.types.GetDataSourceRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_datasources_v1.types.DataSource:
    ...
    def list_data_sources(self,
        ...
        .. code-block:: python
            ...
            def sample_list_data_sources():
                ...
                # Initialize request argument(s)
                request = merchant_datasources_v1.ListDataSourcesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1.types.ListDataSourcesRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_datasources_v1.services.data_sources_service.pagers.ListDataSourcesPager:
    ...
    def create_data_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1.types.CreateDataSourceRequest, dict]):
                The request object. Request message for the
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            data_source (google.shopping.merchant_datasources_v1.types.DataSource):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, data_source]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_data_source]
    ...
    def update_data_source(self,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1.types.UpdateDataSourceRequest, dict]):
                The request object. Request message for the
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                the request, it will only update the ``displayName``
    ...
    def delete_data_source(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_data_source():
                # Create a client
                client = merchant_datasources_v1.DataSourcesServiceClient()

                # Initialize request argument(s)
                request = merchant_datasources_v1.DeleteDataSourceRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1.types.DeleteDataSourceRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_data_source]
    ...
    def fetch_data_source(self,
        ...
        .. code-block:: python
            ...
            def sample_fetch_data_source():
                # Create a client
                client = merchant_datasources_v1.DataSourcesServiceClient()

                # Initialize request argument(s)
                request = merchant_datasources_v1.FetchDataSourceRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1.types.FetchDataSourceRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_data_source]
    ...
    def __enter__(self) -> "DataSourcesServiceClient":
        return self

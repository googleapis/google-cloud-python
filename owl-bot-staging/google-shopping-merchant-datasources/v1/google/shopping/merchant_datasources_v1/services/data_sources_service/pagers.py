...
class ListDataSourcesPager:
    ...
    :class:`google.shopping.merchant_datasources_v1.types.ListDataSourcesResponse` object, and
    ...
    All the usual :class:`google.shopping.merchant_datasources_v1.types.ListDataSourcesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.shopping.merchant_datasources_v1.types.ListDataSourcesRequest):
                The initial request object.
            response (google.shopping.merchant_datasources_v1.types.ListDataSourcesResponse):

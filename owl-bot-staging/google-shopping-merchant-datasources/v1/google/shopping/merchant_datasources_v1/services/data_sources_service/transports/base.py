...
class DataSourcesServiceTransport(abc.ABC):
    """Abstract transport class for DataSourcesService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_data_source: gapic_v1.method.wrap_method(
            ...
            self.delete_data_source: gapic_v1.method.wrap_method(
                self.delete_data_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.fetch_data_source: gapic_v1.method.wrap_method(

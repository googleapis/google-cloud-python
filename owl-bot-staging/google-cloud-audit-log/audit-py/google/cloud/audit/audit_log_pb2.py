...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_AUDITLOG'].fields_by_name['service_data']._serialized_options = b'\030\001'
  ...
  _globals['_ORGPOLICYVIOLATIONINFO'].fields_by_name['payload']._serialized_options = b'\340A\001'
  _globals['_ORGPOLICYVIOLATIONINFO'].fields_by_name['resource_type']._options = None
  _globals['_ORGPOLICYVIOLATIONINFO'].fields_by_name['resource_type']._serialized_options = b'\340A\001'
  _globals['_ORGPOLICYVIOLATIONINFO'].fields_by_name['resource_tags']._options = None
  _globals['_ORGPOLICYVIOLATIONINFO'].fields_by_name['resource_tags']._serialized_options = b'\340A\001'
  _globals['_ORGPOLICYVIOLATIONINFO'].fields_by_name['violation_info']._options = None
  _globals['_ORGPOLICYVIOLATIONINFO'].fields_by_name['violation_info']._serialized_options = b'\340A\001'
  _globals['_VIOLATIONINFO'].fields_by_name['constraint']._options = None
  _globals['_VIOLATIONINFO'].fields_by_name['constraint']._serialized_options = b'\340A\001'
  _globals['_VIOLATIONINFO'].fields_by_name['error_message']._options = None
  _globals['_VIOLATIONINFO'].fields_by_name['error_message']._serialized_options = b'\340A\001'
  _globals['_VIOLATIONINFO'].fields_by_name['checked_value']._options = None
  _globals['_VIOLATIONINFO'].fields_by_name['checked_value']._serialized_options = b'\340A\001'
  _globals['_VIOLATIONINFO'].fields_by_name['policy_type']._options = None
  _globals['_VIOLATIONINFO'].fields_by_name['policy_type']._serialized_options = b'\340A\001'

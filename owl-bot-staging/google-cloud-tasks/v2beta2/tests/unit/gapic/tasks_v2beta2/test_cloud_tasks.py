...
def test_lease_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudTasksRestInterceptor, "post_lease_tasks_with_metadata") as post_with_metadata, \
...
def test_renew_lease_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudTasksRestInterceptor, "post_renew_lease_with_metadata") as post_with_metadata, \
...
def test_cancel_lease_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudTasksRestInterceptor, "post_cancel_lease_with_metadata") as post_with_metadata, \

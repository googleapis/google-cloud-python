...
class CloudTasksGrpcAsyncIOTransport(CloudTasksTransport):
    ...
    @property
    def upload_queue_yaml(self) -> Callable[
    ...
    @property
    def lease_tasks(self) -> Callable[
            [cloudtasks.LeaseTasksRequest],
            Awaitable[cloudtasks.LeaseTasksResponse]]:
        ...
        if 'lease_tasks' not in self._stubs:
            self._stubs['lease_tasks'] = self._logged_channel.unary_unary(
    ...
    @property
    def acknowledge_task(self) -> Callable[
        ...
        if 'acknowledge_task' not in self._stubs:
            self._stubs['acknowledge_task'] = self._logged_channel.unary_unary(
    ...
    @property
    def cancel_lease(self) -> Callable[
        ...
        if 'cancel_lease' not in self._stubs:
            self._stubs['cancel_lease'] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.upload_queue_yaml: self._wrap_method(
            ...
            self.lease_tasks: self._wrap_method(
                self.lease_tasks,
                default_timeout=20.0,
                client_info=client_info,
            ),
            self.acknowledge_task: self._wrap_method(
                self.acknowledge_task,
                default_timeout=20.0,
                client_info=client_info,
            ),
            self.renew_lease: self._wrap_method(
                self.renew_lease,
                default_timeout=20.0,
                client_info=client_info,
            ),
            self.cancel_lease: self._wrap_method(
                self.cancel_lease,
                default_timeout=20.0,
                client_info=client_info,
            ),

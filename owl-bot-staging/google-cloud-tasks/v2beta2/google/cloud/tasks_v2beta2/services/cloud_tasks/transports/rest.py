...
class CloudTasksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_acknowledge_task(self, request: cloudtasks.AcknowledgeTaskRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudtasks.AcknowledgeTaskRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_cancel_lease(self, request: cloudtasks.CancelLeaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudtasks.CancelLeaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_cancel_lease_with_metadata(self, response: task.Task, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[task.Task, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for cancel_lease
    ...
    def pre_lease_tasks(self, request: cloudtasks.LeaseTasksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudtasks.LeaseTasksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_lease_tasks_with_metadata(self, response: cloudtasks.LeaseTasksResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudtasks.LeaseTasksResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for lease_tasks
    ...
    def pre_renew_lease(self, request: cloudtasks.RenewLeaseRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudtasks.RenewLeaseRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_renew_lease_with_metadata(self, response: task.Task, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[task.Task, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for renew_lease
...
class CloudTasksRestTransport(_BaseCloudTasksRestTransport):
    ...
    class _AcknowledgeTask(_BaseCloudTasksRestTransport._BaseAcknowledgeTask, CloudTasksRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseCloudTasksRestTransport._BaseAcknowledgeTask._get_http_options()

            request, metadata = self._interceptor.pre_acknowledge_task(request, metadata)
            transcoded_request = _BaseCloudTasksRestTransport._BaseAcknowledgeTask._get_transcoded_request(http_options, request)

            body = _BaseCloudTasksRestTransport._BaseAcknowledgeTask._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCloudTasksRestTransport._BaseAcknowledgeTask._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CloudTasksRestTransport._AcknowledgeTask._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelLease(_BaseCloudTasksRestTransport._BaseCancelLease, CloudTasksRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseCloudTasksRestTransport._BaseCancelLease._get_http_options()

            request, metadata = self._interceptor.pre_cancel_lease(request, metadata)
            transcoded_request = _BaseCloudTasksRestTransport._BaseCancelLease._get_transcoded_request(http_options, request)

            body = _BaseCloudTasksRestTransport._BaseCancelLease._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCloudTasksRestTransport._BaseCancelLease._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CloudTasksRestTransport._CancelLease._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_cancel_lease_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _LeaseTasks(_BaseCloudTasksRestTransport._BaseLeaseTasks, CloudTasksRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseCloudTasksRestTransport._BaseLeaseTasks._get_http_options()

            request, metadata = self._interceptor.pre_lease_tasks(request, metadata)
            transcoded_request = _BaseCloudTasksRestTransport._BaseLeaseTasks._get_transcoded_request(http_options, request)

            body = _BaseCloudTasksRestTransport._BaseLeaseTasks._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCloudTasksRestTransport._BaseLeaseTasks._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CloudTasksRestTransport._LeaseTasks._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_lease_tasks_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _RenewLease(_BaseCloudTasksRestTransport._BaseRenewLease, CloudTasksRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseCloudTasksRestTransport._BaseRenewLease._get_http_options()

            request, metadata = self._interceptor.pre_renew_lease(request, metadata)
            transcoded_request = _BaseCloudTasksRestTransport._BaseRenewLease._get_transcoded_request(http_options, request)

            body = _BaseCloudTasksRestTransport._BaseRenewLease._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseCloudTasksRestTransport._BaseRenewLease._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = CloudTasksRestTransport._RenewLease._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UploadQueueYaml(_BaseCloudTasksRestTransport._BaseUploadQueueYaml, CloudTasksRestStub):
        def __hash__(self):

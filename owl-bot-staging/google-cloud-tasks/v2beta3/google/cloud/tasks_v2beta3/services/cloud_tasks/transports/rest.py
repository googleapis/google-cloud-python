...
class CloudTasksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_buffer_task(self, request: cloudtasks.BufferTaskRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudtasks.BufferTaskRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_buffer_task(self, response: cloudtasks.BufferTaskResponse) -> cloudtasks.BufferTaskResponse:

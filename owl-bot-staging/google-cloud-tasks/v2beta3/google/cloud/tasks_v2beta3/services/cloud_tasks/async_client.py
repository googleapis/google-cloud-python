...
class CloudTasksAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudTasksTransport, Callable[..., CloudTasksTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.tasks_v2beta3.CloudTasksAsyncClient`.",
                extra = {
    ...
    async def list_queues(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.ListQueuesRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_queues]
    ...
    async def get_queue(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.GetQueueRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_queue]
    ...
    async def create_queue(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.CreateQueueRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_queue]
    ...
    async def update_queue(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.UpdateQueueRequest, dict]]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [queue, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_queue]
    ...
    async def delete_queue(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.DeleteQueueRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_queue]
    ...
    async def purge_queue(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.PurgeQueueRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.purge_queue]
    ...
    async def pause_queue(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.PauseQueueRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.pause_queue]
    ...
    async def resume_queue(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.ResumeQueueRequest, dict]]):
                The request object. Request message for
                [ResumeQueue][google.cloud.tasks.v2beta3.CloudTasks.ResumeQueue].
            name (:class:`str`):
                Required. The queue name. For example:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.resume_queue]
    ...
    async def create_task(self,
        ...
        Args:
            request (Optional[Union[google.cloud.tasks_v2beta3.types.CreateTaskRequest, dict]]):
                The request object. Request message for

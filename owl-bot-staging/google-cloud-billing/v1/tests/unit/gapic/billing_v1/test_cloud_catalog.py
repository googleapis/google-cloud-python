...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudCatalogRestInterceptor, "post_list_services_with_metadata") as post_with_metadata, \
...
def test_list_skus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.CloudCatalogRestInterceptor, "post_list_skus_with_metadata") as post_with_metadata, \

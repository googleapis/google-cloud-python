...
def test_update_billing_account_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'billingAccounts/sample1'}
    request_init["account"] = {'name': 'name_value', 'open_': True, 'display_name': 'display_name_value', 'master_billing_account': 'master_billing_account_value', 'parent': 'parent_value'}
...
def test_create_billing_account_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {}
    request_init["billing_account"] = {'name': 'name_value', 'open_': True, 'display_name': 'display_name_value', 'master_billing_account': 'master_billing_account_value', 'parent': 'parent_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

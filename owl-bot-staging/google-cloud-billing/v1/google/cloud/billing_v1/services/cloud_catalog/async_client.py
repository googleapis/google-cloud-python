...
class CloudCatalogAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = CloudCatalogClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = CloudCatalogClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, CloudCatalogTransport, Callable[..., CloudCatalogTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.billing_v1.CloudCatalogAsyncClient`.",
                extra = {

...
class _BaseCloudCatalogRestTransport(CloudCatalogTransport):
    """Base REST backend transport for CloudCatalog.
    ...
    class _BaseListSkus:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCloudCatalogRestTransport._BaseListSkus._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseCloudCatalogRestTransport',
)

...
from .rest_base import _BaseCloudCatalogRestTransport
...
class CloudCatalogRestInterceptor:
    """Interceptor for CloudCatalog.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CloudCatalogRestTransport.

    .. code-block:: python
        class MyCustomCloudCatalogInterceptor(CloudCatalogRestInterceptor):
        ...
        transport = CloudCatalogRestTransport(interceptor=MyCustomCloudCatalogInterceptor())
        client = CloudCatalogClient(transport=transport)


    """
    def pre_list_services(self, request: cloud_catalog.ListServicesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_catalog.ListServicesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for list_services

        Override in a subclass to manipulate the request or metadata
        before they are sent to the CloudCatalog server.
        """
        return request, metadata
    ...
    def post_list_services(self, response: cloud_catalog.ListServicesResponse) -> cloud_catalog.ListServicesResponse:
        ...
        after it is returned by the CloudCatalog server but before
    ...
    def post_list_services_with_metadata(self, response: cloud_catalog.ListServicesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_catalog.ListServicesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_services

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the CloudCatalog server but before it is returned to user code.
    ...
    def pre_list_skus(self, request: cloud_catalog.ListSkusRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_catalog.ListSkusRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_skus_with_metadata(self, response: cloud_catalog.ListSkusResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloud_catalog.ListSkusResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_skus
...
class CloudCatalogRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CloudCatalogRestInterceptor


class CloudCatalogRestTransport(_BaseCloudCatalogRestTransport):
    """REST backend synchronous transport for CloudCatalog.
    ...
    class _ListServices(_BaseCloudCatalogRestTransport._BaseListServices, CloudCatalogRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.billing_v1.CloudCatalogClient.ListServices",
                    extra = {
            ...
            # Send the request
            response = CloudCatalogRestTransport._ListServices._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = cloud_catalog.ListServicesResponse()
            pb_resp = cloud_catalog.ListServicesResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.billing_v1.CloudCatalogClient.list_services",
                    extra = {
                        "serviceName": "google.cloud.billing.v1.CloudCatalog",
                        "rpcName": "ListServices",
    ...
    class _ListSkus(_BaseCloudCatalogRestTransport._BaseListSkus, CloudCatalogRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.billing_v1.CloudCatalogClient.ListSkus",
                    extra = {
                        "serviceName": "google.cloud.billing.v1.CloudCatalog",
                        "rpcName": "ListSkus",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = CloudCatalogRestTransport._ListSkus._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            # Return the response
            resp = cloud_catalog.ListSkusResponse()
            pb_resp = cloud_catalog.ListSkusResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.billing_v1.CloudCatalogClient.list_skus",
                    extra = {
                        "serviceName": "google.cloud.billing.v1.CloudCatalog",
                        "rpcName": "ListSkus",
                        "metadata": http_response["headers"],

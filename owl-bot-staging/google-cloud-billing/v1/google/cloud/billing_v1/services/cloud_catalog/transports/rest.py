...
class CloudCatalogRestTransport(CloudCatalogTransport):
    """REST backend transport for CloudCatalog.
    ...
    class _ListServices(CloudCatalogRestStub):
        def __hash__(self):
    ...
    class _ListSkus(CloudCatalogRestStub):
        def __hash__(self):

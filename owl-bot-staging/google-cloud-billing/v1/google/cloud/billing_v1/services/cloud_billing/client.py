...
class CloudBillingClient(metaclass=CloudBillingClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "cloudbilling.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def billing_account_path(billing_account: str,) -> str:
        """Returns a fully-qualified billing_account string."""
        return "billingAccounts/{billing_account}".format(billing_account=billing_account, )

    @staticmethod
    def parse_billing_account_path(path: str) -> Dict[str,str]:
    ...
    @staticmethod
    def project_billing_info_path(project: str,) -> str:
        """Returns a fully-qualified project_billing_info string."""
        return "projects/{project}/billingInfo".format(project=project, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudBillingClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CloudBillingClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CloudBillingClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudBillingTransport, Callable[..., CloudBillingTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CloudBillingClient._read_environment_variables()
        self._client_cert_source = CloudBillingClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CloudBillingClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CloudBillingTransport)
        if transport_provided:
            ...
            self._transport = cast(CloudBillingTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CloudBillingTransport], Callable[..., CloudBillingTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.billing_v1.CloudBillingClient`.",
                    extra = {
    ...
    def move_billing_account(self,
        ...
        Args:
            request (Union[google.cloud.billing_v1.types.MoveBillingAccountRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.move_billing_account]

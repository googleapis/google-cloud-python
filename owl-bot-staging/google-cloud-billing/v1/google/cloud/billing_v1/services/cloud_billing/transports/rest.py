...
class CloudBillingRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_move_billing_account(self, request: cloud_billing.MoveBillingAccountRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_billing.MoveBillingAccountRequest, Sequence[Tuple[str, str]]]:

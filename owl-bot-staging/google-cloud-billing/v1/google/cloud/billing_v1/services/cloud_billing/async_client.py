...
class CloudBillingAsyncClient:
    ...
    parse_billing_account_path = staticmethod(CloudBillingClient.parse_billing_account_path)
    ...
    project_billing_info_path = staticmethod(CloudBillingClient.project_billing_info_path)
    parse_project_billing_info_path = staticmethod(CloudBillingClient.parse_project_billing_info_path)
    ...
    get_transport_class = CloudBillingClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, CloudBillingTransport, Callable[..., CloudBillingTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.billing_v1.CloudBillingAsyncClient`.",
                extra = {
    ...
    async def get_billing_account(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_billing_account]
    ...
    async def list_billing_accounts(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_billing_accounts]
    ...
    async def update_billing_account(self,
            request: Optional[Union[cloud_billing.UpdateBillingAccountRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_billing_account]
    ...
    async def create_billing_account(self,
            request: Optional[Union[cloud_billing.CreateBillingAccountRequest, dict]] = None,
            *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [billing_account, parent]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_billing_account]
    ...
    async def list_project_billing_info(self,
            request: Optional[Union[cloud_billing.ListProjectBillingInfoRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_project_billing_info]
    ...
    async def get_project_billing_info(self,
            request: Optional[Union[cloud_billing.GetProjectBillingInfoRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_project_billing_info]
    ...
    async def update_project_billing_info(self,
            request: Optional[Union[cloud_billing.UpdateProjectBillingInfoRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        *Note:* Incurred charges that have not yet been reported in the
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, project_billing_info]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_project_billing_info]
    ...
    async def move_billing_account(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.move_billing_account]

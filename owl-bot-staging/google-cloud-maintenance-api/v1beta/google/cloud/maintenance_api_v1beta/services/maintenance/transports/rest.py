...
class MaintenanceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_resource_maintenance(self, request: maintenance_service.GetResourceMaintenanceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maintenance_service.GetResourceMaintenanceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_resource_maintenance_with_metadata(self, response: maintenance_service.ResourceMaintenance, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maintenance_service.ResourceMaintenance, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_resource_maintenance
    ...
    def pre_list_resource_maintenances(self, request: maintenance_service.ListResourceMaintenancesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maintenance_service.ListResourceMaintenancesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_resource_maintenances(self, response: maintenance_service.ListResourceMaintenancesResponse) -> maintenance_service.ListResourceMaintenancesResponse:
    ...
    def post_list_resource_maintenances_with_metadata(self, response: maintenance_service.ListResourceMaintenancesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maintenance_service.ListResourceMaintenancesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_resource_maintenances
    ...
    def pre_summarize_maintenances(self, request: maintenance_service.SummarizeMaintenancesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maintenance_service.SummarizeMaintenancesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_summarize_maintenances(self, response: maintenance_service.SummarizeMaintenancesResponse) -> maintenance_service.SummarizeMaintenancesResponse:
    ...
    def post_summarize_maintenances_with_metadata(self, response: maintenance_service.SummarizeMaintenancesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[maintenance_service.SummarizeMaintenancesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for summarize_maintenances
...
class MaintenanceRestTransport(_BaseMaintenanceRestTransport):
    ...
    class _GetResourceMaintenance(_BaseMaintenanceRestTransport._BaseGetResourceMaintenance, MaintenanceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MaintenanceRestTransport._GetResourceMaintenance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListResourceMaintenances(_BaseMaintenanceRestTransport._BaseListResourceMaintenances, MaintenanceRestStub):
        ...
        maintenances method over HTTP.
            ...
            # Send the request
            response = MaintenanceRestTransport._ListResourceMaintenances._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SummarizeMaintenances(_BaseMaintenanceRestTransport._BaseSummarizeMaintenances, MaintenanceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MaintenanceRestTransport._SummarizeMaintenances._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetLocation(_BaseMaintenanceRestTransport._BaseGetLocation, MaintenanceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MaintenanceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseMaintenanceRestTransport._BaseListLocations, MaintenanceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MaintenanceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

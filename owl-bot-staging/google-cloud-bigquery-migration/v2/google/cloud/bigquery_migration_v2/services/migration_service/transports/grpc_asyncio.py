...
class MigrationServiceGrpcAsyncIOTransport(MigrationServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_migration_workflow: gapic_v1.method_async.wrap_method(
                self.create_migration_workflow,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_migration_workflow: gapic_v1.method_async.wrap_method(
            ...
            self.list_migration_workflows: gapic_v1.method_async.wrap_method(
            ...
            self.delete_migration_workflow: gapic_v1.method_async.wrap_method(
                self.delete_migration_workflow,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.start_migration_workflow: gapic_v1.method_async.wrap_method(
            ...
            self.get_migration_subtask: gapic_v1.method_async.wrap_method(
                self.get_migration_subtask,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_migration_subtasks: gapic_v1.method_async.wrap_method(

...
from google.cloud.bigquery_migration_v2.types import migration_service
...
class MigrationServiceGrpcTransport(MigrationServiceTransport):
    ...
    def create_migration_workflow(self) -> Callable[
        ...
        if 'create_migration_workflow' not in self._stubs:
            self._stubs['create_migration_workflow'] = self._logged_channel.unary_unary(
    ...
    def get_migration_workflow(self) -> Callable[
        ...
        if 'get_migration_workflow' not in self._stubs:
            self._stubs['get_migration_workflow'] = self._logged_channel.unary_unary(
    ...
    def list_migration_workflows(self) -> Callable[
        ...
        if 'list_migration_workflows' not in self._stubs:
            self._stubs['list_migration_workflows'] = self._logged_channel.unary_unary(
    ...
    def delete_migration_workflow(self) -> Callable[
        ...
        if 'delete_migration_workflow' not in self._stubs:
            self._stubs['delete_migration_workflow'] = self._logged_channel.unary_unary(
    ...
    def start_migration_workflow(self) -> Callable[
        ...
        if 'start_migration_workflow' not in self._stubs:
            self._stubs['start_migration_workflow'] = self._logged_channel.unary_unary(
    ...
    def get_migration_subtask(self) -> Callable[
        ...
        if 'get_migration_subtask' not in self._stubs:
            self._stubs['get_migration_subtask'] = self._logged_channel.unary_unary(
    ...
    def list_migration_subtasks(self) -> Callable[
        ...
        if 'list_migration_subtasks' not in self._stubs:
            self._stubs['list_migration_subtasks'] = self._logged_channel.unary_unary(

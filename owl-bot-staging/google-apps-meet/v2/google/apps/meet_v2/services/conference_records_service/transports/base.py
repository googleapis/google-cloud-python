...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
    ...
    @property
    def get_conference_record(self) -> Callable[
            [service.GetConferenceRecordRequest],
            Union[
                resource.ConferenceRecord,
                Awaitable[resource.ConferenceRecord]
            ]]:
        raise NotImplementedError()

    @property
    def list_conference_records(self) -> Callable[
    ...
    def get_participant(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[resource.Participant]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def get_participant_session(self) -> Callable[
    ...
    @property
    def list_participant_sessions(self) -> Callable[
    ...
    @property
    def get_recording(self) -> Callable[
            [service.GetRecordingRequest],
            Union[
                resource.Recording,
                Awaitable[resource.Recording]
            ]]:
        raise NotImplementedError()

    @property
    def list_recordings(self) -> Callable[
            [service.ListRecordingsRequest],
            Union[
                service.ListRecordingsResponse,
                Awaitable[service.ListRecordingsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_transcript(self) -> Callable[
            [service.GetTranscriptRequest],
            Union[
                resource.Transcript,
                Awaitable[resource.Transcript]
            ]]:
        raise NotImplementedError()

    @property
    def list_transcripts(self) -> Callable[
            [service.ListTranscriptsRequest],
            Union[
                service.ListTranscriptsResponse,
                Awaitable[service.ListTranscriptsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_transcript_entry(self) -> Callable[
            [service.GetTranscriptEntryRequest],
            Union[
                resource.TranscriptEntry,
                Awaitable[resource.TranscriptEntry]
            ]]:
        raise NotImplementedError()

    @property
    def list_transcript_entries(self) -> Callable[

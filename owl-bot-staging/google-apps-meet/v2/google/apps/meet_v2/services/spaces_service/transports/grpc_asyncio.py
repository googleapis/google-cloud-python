...
from .base import SpacesServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import SpacesServiceGrpcTransport


class SpacesServiceGrpcAsyncIOTransport(SpacesServiceTransport):
    """gRPC AsyncIO backend transport for SpacesService.
    ...
    def end_active_conference(self) -> Callable[
        ...
        if 'end_active_conference' not in self._stubs:
            self._stubs['end_active_conference'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.end_active_conference: gapic_v1.method_async.wrap_method(

...
initial=1.0,maximum=10.0,multiplier=1.3,                    predicate=retries.if_exception_type(
    ...
    @property
    def create_space(self) -> Callable[
            [service.CreateSpaceRequest],
            Union[
                resource.Space,
                Awaitable[resource.Space]
            ]]:
        raise NotImplementedError()

    @property
    def get_space(self) -> Callable[
    ...
    @property
    def update_space(self) -> Callable[
    ...
    @property
    def end_active_conference(self) -> Callable[

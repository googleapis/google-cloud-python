...
def test_get_space_rest_required_fields(request_type=service.GetSpaceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_space._get_unset_required_fields(jsonified_request)
...
def test_get_space_rest_unset_required_fields():
    transport = transports.SpacesServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_space_rest_required_fields(request_type=service.UpdateSpaceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_space._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_end_active_conference_rest_required_fields(request_type=service.EndActiveConferenceRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).end_active_conference._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

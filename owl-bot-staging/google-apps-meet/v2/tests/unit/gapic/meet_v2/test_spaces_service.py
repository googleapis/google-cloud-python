...
from google.apps.meet_v2.services.spaces_service import SpacesServiceAsyncClient
from google.apps.meet_v2.services.spaces_service import SpacesServiceClient
from google.apps.meet_v2.services.spaces_service import transports
from google.apps.meet_v2.types import resource
from google.apps.meet_v2.types import service
...
def test__get_default_mtls_endpoint():
    ...
    assert SpacesServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert SpacesServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert SpacesServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert SpacesServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert SpacesServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert SpacesServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SpacesServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SpacesServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SpacesServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SpacesServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SpacesServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SpacesServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SpacesServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SpacesServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SpacesServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpacesServiceClient))
@mock.patch.object(SpacesServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpacesServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SpacesServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SpacesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SpacesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SpacesServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SpacesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SpacesServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SpacesServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SpacesServiceClient._get_api_endpoint(None, None, default_universe, "always") == SpacesServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SpacesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SpacesServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SpacesServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SpacesServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SpacesServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SpacesServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SpacesServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SpacesServiceClient._get_universe_domain(None, None) == SpacesServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        SpacesServiceClient._get_universe_domain("", None)
...
def test_spaces_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (SpacesServiceAsyncClient, transports.SpacesServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (SpacesServiceClient, transports.SpacesServiceRestTransport, "rest"),
])
@mock.patch.object(SpacesServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpacesServiceClient))
@mock.patch.object(SpacesServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpacesServiceAsyncClient))
def test_spaces_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (SpacesServiceAsyncClient, transports.SpacesServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (SpacesServiceClient, transports.SpacesServiceGrpcTransport, "grpc", "false"),
    (SpacesServiceAsyncClient, transports.SpacesServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_spaces_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    SpacesServiceClient, SpacesServiceAsyncClient
])
@mock.patch.object(SpacesServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SpacesServiceClient))
@mock.patch.object(SpacesServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SpacesServiceAsyncClient))
...
def test_spaces_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (SpacesServiceClient, transports.SpacesServiceGrpcTransport, "grpc", grpc_helpers),
    (SpacesServiceAsyncClient, transports.SpacesServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SpacesServiceClient, transports.SpacesServiceRestTransport, "rest", None),
])
def test_spaces_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_spaces_service_client_client_options_from_dict():
    with mock.patch('google.apps.meet_v2.services.spaces_service.transports.SpacesServiceGrpcTransport.__init__') as grpc_transport:
...
def test_spaces_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_space(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_space),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_create_space_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_space in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_space] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_space_async(transport: str = 'grpc_asyncio', request_type=service.CreateSpaceRequest):
    client = SpacesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_space(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_space),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource.Space(
            name='name_value',
...
async def test_get_space_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_space in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_space] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_space_async(transport: str = 'grpc_asyncio', request_type=service.GetSpaceRequest):
    client = SpacesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_space(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_space),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource.Space(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_space_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpacesServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_space in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_space] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_space_async(transport: str = 'grpc_asyncio', request_type=service.UpdateSpaceRequest):
    client = SpacesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_end_active_conference(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.end_active_conference),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_end_active_conference_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.end_active_conference in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.end_active_conference] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_end_active_conference_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpacesServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.end_active_conference in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.end_active_conference] = mock_rpc
...
@pytest.mark.asyncio
async def test_end_active_conference_async(transport: str = 'grpc_asyncio', request_type=service.EndActiveConferenceRequest):
    client = SpacesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_space_rest_required_fields(request_type=service.GetSpaceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_space._get_unset_required_fields(jsonified_request)
...
def test_get_space_rest_unset_required_fields():
    transport = transports.SpacesServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_space_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=spaces/*}" % client.transport._host, args[1])
...
def test_update_space_rest_required_fields(request_type=service.UpdateSpaceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_space._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_space_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{space.name=spaces/*}" % client.transport._host, args[1])
...
def test_end_active_conference_rest_required_fields(request_type=service.EndActiveConferenceRequest):
    transport_class = transports.SpacesServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).end_active_conference._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_end_active_conference_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=spaces/*}:endActiveConference" % client.transport._host, args[1])
...
def test_create_space_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {}
    request_init["space"] = {'name': 'name_value', 'meeting_uri': 'meeting_uri_value', 'meeting_code': 'meeting_code_value', 'config': {'access_type': 1, 'entry_point_access': 1}, 'active_conference': {'conference_record': 'conference_record_value'}}
...
def test_create_space_rest_interceptors(null_interceptor):
    transport = transports.SpacesServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SpacesServiceRestInterceptor(),
        )
    client = SpacesServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "post_create_space") as post, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "post_create_space_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "pre_create_space") as pre:
        ...
        client.create_space(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_space_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "post_get_space") as post, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "post_get_space_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "pre_get_space") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_space(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_space_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'space': {'name': 'spaces/sample1'}}
    request_init["space"] = {'name': 'spaces/sample1', 'meeting_uri': 'meeting_uri_value', 'meeting_code': 'meeting_code_value', 'config': {'access_type': 1, 'entry_point_access': 1}, 'active_conference': {'conference_record': 'conference_record_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_space_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "post_update_space") as post, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "post_update_space_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "pre_update_space") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_space(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_end_active_conference_rest_bad_request(request_type=service.EndActiveConferenceRequest):
    client = SpacesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_end_active_conference_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SpacesServiceRestInterceptor, "pre_end_active_conference") as pre:
        pre.assert_not_called()
        pb_message = service.EndActiveConferenceRequest.pb(service.EndActiveConferenceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.end_active_conference(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_spaces_service_base_transport():
    ...
    with mock.patch('google.apps.meet_v2.services.spaces_service.transports.SpacesServiceTransport.__init__') as Transport:
...
def test_spaces_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.apps.meet_v2.services.spaces_service.transports.SpacesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_spaces_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.apps.meet_v2.services.spaces_service.transports.SpacesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SpacesServiceTransport()
        adc.assert_called_once()
...
def test_spaces_service_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/meetings.space.created',                'https://www.googleapis.com/auth/meetings.space.readonly',                'https://www.googleapis.com/auth/meetings.space.settings',),
            quota_project_id="octopus",
        )
...
@pytest.mark.parametrize("transport_class", [transports.SpacesServiceGrpcTransport, transports.SpacesServiceGrpcAsyncIOTransport])
def test_spaces_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_spaces_service_host_with_port(transport_name):
    client = SpacesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='meet.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.SpacesServiceGrpcTransport, transports.SpacesServiceGrpcAsyncIOTransport])
def test_spaces_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.SpacesServiceGrpcTransport, transports.SpacesServiceGrpcAsyncIOTransport])
def test_spaces_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_conference_record_path():
    ...
    expected = "conferenceRecords/{conference_record}".format(conference_record=conference_record, )
...
def test_space_path():
    space = "whelk"
    expected = "spaces/{space}".format(space=space, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.SpacesServiceTransport, '_prep_wrapped_messages') as prep:
        client = SpacesServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

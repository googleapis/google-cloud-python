...
from google.apps.meet_v2.services.conference_records_service import ConferenceRecordsServiceAsyncClient
from google.apps.meet_v2.services.conference_records_service import ConferenceRecordsServiceClient
from google.apps.meet_v2.services.conference_records_service import pagers
from google.apps.meet_v2.services.conference_records_service import transports
...
def test_conference_records_service_client_client_options_from_dict():
    with mock.patch('google.apps.meet_v2.services.conference_records_service.transports.ConferenceRecordsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_conference_records_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.apps.meet_v2.services.conference_records_service.transports.ConferenceRecordsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_conference_records_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.apps.meet_v2.services.conference_records_service.transports.ConferenceRecordsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConferenceRecordsServiceTransport()
        adc.assert_called_once()

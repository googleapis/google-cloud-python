...
def test_get_conference_record_rest_required_fields(request_type=service.GetConferenceRecordRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_conference_record._get_unset_required_fields(jsonified_request)
...
def test_get_conference_record_rest_unset_required_fields():
    transport = transports.ConferenceRecordsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_participant_rest_required_fields(request_type=service.GetParticipantRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_participant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_participants_rest_required_fields(request_type=service.ListParticipantsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_participants._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_participant_session_rest_required_fields(request_type=service.GetParticipantSessionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_participant_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_participant_sessions_rest_required_fields(request_type=service.ListParticipantSessionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_participant_sessions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_recording_rest_required_fields(request_type=service.GetRecordingRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_recording._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_recordings_rest_required_fields(request_type=service.ListRecordingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_recordings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_transcript_rest_required_fields(request_type=service.GetTranscriptRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_transcript._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_transcripts_rest_required_fields(request_type=service.ListTranscriptsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_transcripts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_transcript_entry_rest_required_fields(request_type=service.GetTranscriptEntryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_transcript_entry._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_transcript_entries_rest_required_fields(request_type=service.ListTranscriptEntriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_transcript_entries._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

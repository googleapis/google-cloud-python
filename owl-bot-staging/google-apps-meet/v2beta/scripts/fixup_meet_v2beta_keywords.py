...
class meetCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'list_transcript_entries': ('parent', 'page_size', 'page_token', ),
        'list_transcripts': ('parent', 'page_size', 'page_token', ),
...
def fix_files(
    ...
    *,
    transformer=meetCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the meet client library.

...
class SpacesServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_space(self, request: service.CreateSpaceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.CreateSpaceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_end_active_conference(self, request: service.EndActiveConferenceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.EndActiveConferenceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_space(self, request: service.GetSpaceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.GetSpaceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_space(self, request: service.UpdateSpaceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.UpdateSpaceRequest, Sequence[Tuple[str, str]]]:

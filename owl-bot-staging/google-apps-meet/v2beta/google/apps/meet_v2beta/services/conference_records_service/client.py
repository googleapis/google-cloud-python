...
class ConferenceRecordsServiceClient(metaclass=ConferenceRecordsServiceClientMeta):
    ...
    @staticmethod
    def conference_record_path(conference_record: str,) -> str:
        """Returns a fully-qualified conference_record string."""
        return "conferenceRecords/{conference_record}".format(conference_record=conference_record, )
    ...
    @staticmethod
    def participant_path(conference_record: str,participant: str,) -> str:
        """Returns a fully-qualified participant string."""
        return "conferenceRecords/{conference_record}/participants/{participant}".format(conference_record=conference_record, participant=participant, )

    @staticmethod
    def parse_participant_path(path: str) -> Dict[str,str]:
        """Parses a participant path into its component segments."""
        m = re.match(r"^conferenceRecords/(?P<conference_record>.+?)/participants/(?P<participant>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def participant_session_path(conference_record: str,participant: str,participant_session: str,) -> str:
        """Returns a fully-qualified participant_session string."""
        return "conferenceRecords/{conference_record}/participants/{participant}/participantSessions/{participant_session}".format(conference_record=conference_record, participant=participant, participant_session=participant_session, )

    @staticmethod
    def parse_participant_session_path(path: str) -> Dict[str,str]:
        """Parses a participant_session path into its component segments."""
        m = re.match(r"^conferenceRecords/(?P<conference_record>.+?)/participants/(?P<participant>.+?)/participantSessions/(?P<participant_session>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def recording_path(conference_record: str,recording: str,) -> str:
        """Returns a fully-qualified recording string."""
        return "conferenceRecords/{conference_record}/recordings/{recording}".format(conference_record=conference_record, recording=recording, )

    @staticmethod
    def parse_recording_path(path: str) -> Dict[str,str]:
        """Parses a recording path into its component segments."""
        m = re.match(r"^conferenceRecords/(?P<conference_record>.+?)/recordings/(?P<recording>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def space_path(space: str,) -> str:
        """Returns a fully-qualified space string."""
        return "spaces/{space}".format(space=space, )
    ...
    @staticmethod
    def transcript_path(conference_record: str,transcript: str,) -> str:
        """Returns a fully-qualified transcript string."""
        return "conferenceRecords/{conference_record}/transcripts/{transcript}".format(conference_record=conference_record, transcript=transcript, )

    @staticmethod
    def parse_transcript_path(path: str) -> Dict[str,str]:
        """Parses a transcript path into its component segments."""
        m = re.match(r"^conferenceRecords/(?P<conference_record>.+?)/transcripts/(?P<transcript>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def transcript_entry_path(conference_record: str,transcript: str,entry: str,) -> str:
        """Returns a fully-qualified transcript_entry string."""
        return "conferenceRecords/{conference_record}/transcripts/{transcript}/entries/{entry}".format(conference_record=conference_record, transcript=transcript, entry=entry, )

    @staticmethod
    def parse_transcript_entry_path(path: str) -> Dict[str,str]:
        """Parses a transcript_entry path into its component segments."""
        m = re.match(r"^conferenceRecords/(?P<conference_record>.+?)/transcripts/(?P<transcript>.+?)/entries/(?P<entry>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConferenceRecordsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConferenceRecordsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConferenceRecordsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ConferenceRecordsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConferenceRecordsServiceTransport, Callable[..., ConferenceRecordsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConferenceRecordsServiceClient._read_environment_variables()
        self._client_cert_source = ConferenceRecordsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConferenceRecordsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConferenceRecordsServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(ConferenceRecordsServiceTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConferenceRecordsServiceTransport], Callable[..., ConferenceRecordsServiceTransport]] = (
    ...
    def list_conference_records(self,
    ...
    def get_participant_session(self,
    ...
    def list_participant_sessions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_participant_sessions]
    ...
    def list_transcript_entries(self,

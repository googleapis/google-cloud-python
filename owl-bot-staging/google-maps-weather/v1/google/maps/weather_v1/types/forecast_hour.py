...
class ForecastHour(proto.Message):
    r"""Represents an hourly forecast record at a given location.
    ...
    Attributes:
        interval (google.type.interval_pb2.Interval):
            ...
            forecast data is valid for (the timestamps are
        ...
        display_date_time (google.type.datetime_pb2.DateTime):
            ...
            forecast is calculated for. This field may be
            used for display purposes on the client.
        ...
        feels_like_temperature (google.maps.weather_v1.types.Temperature):
            The measure of how the temperature will feel
            like at the requested location.
        ...
        wind_chill (google.maps.weather_v1.types.Temperature):
            The forecasted wind chill, air temperature
            exposed on the skin.
        wet_bulb_temperature (google.maps.weather_v1.types.Temperature):
            The forecasted wet bulb temperature, lowest
        ...
        precipitation (google.maps.weather_v1.types.Precipitation):
            The forecasted precipitation probability and
            amount of precipitation accumulated over the
            last hour.
        thunderstorm_probability (int):
            The forecasted thunderstorm probability
            (values from 0 to 100).
        ...
        cloud_cover (int):
            The forecasted percentage of the sky covered

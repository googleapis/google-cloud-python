...
class LanguageServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_analyze_entity_sentiment(self, request: language_service.AnalyzeEntitySentimentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeEntitySentimentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_analyze_entity_sentiment_with_metadata(self, response: language_service.AnalyzeEntitySentimentResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeEntitySentimentResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for analyze_entity_sentiment
    ...
    def pre_analyze_syntax(self, request: language_service.AnalyzeSyntaxRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeSyntaxRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_analyze_syntax_with_metadata(self, response: language_service.AnalyzeSyntaxResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeSyntaxResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for analyze_syntax
...
class LanguageServiceRestTransport(_BaseLanguageServiceRestTransport):
    ...
    class _AnalyzeEntitySentiment(_BaseLanguageServiceRestTransport._BaseAnalyzeEntitySentiment, LanguageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LanguageServiceRestTransport._AnalyzeEntitySentiment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _AnalyzeSyntax(_BaseLanguageServiceRestTransport._BaseAnalyzeSyntax, LanguageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LanguageServiceRestTransport._AnalyzeSyntax._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

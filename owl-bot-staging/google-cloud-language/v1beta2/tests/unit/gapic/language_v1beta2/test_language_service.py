...
def test_analyze_sentiment_rest_required_fields(request_type=language_service.AnalyzeSentimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).analyze_sentiment._get_unset_required_fields(jsonified_request)
...
def test_analyze_entities_rest_required_fields(request_type=language_service.AnalyzeEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).analyze_entities._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_entity_sentiment_rest_required_fields(request_type=language_service.AnalyzeEntitySentimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).analyze_entity_sentiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_syntax_rest_required_fields(request_type=language_service.AnalyzeSyntaxRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).analyze_syntax._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_classify_text_rest_required_fields(request_type=language_service.ClassifyTextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).classify_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_moderate_text_rest_required_fields(request_type=language_service.ModerateTextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).moderate_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_annotate_text_rest_required_fields(request_type=language_service.AnnotateTextRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).annotate_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

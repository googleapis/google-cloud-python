...
from google.cloud.language_v1beta2.services.language_service import LanguageServiceAsyncClient
from google.cloud.language_v1beta2.services.language_service import LanguageServiceClient
...
def test__get_api_endpoint():
    ...
    assert LanguageServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == LanguageServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert LanguageServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == LanguageServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    LanguageServiceClient, LanguageServiceAsyncClient
])
...
def test_analyze_entity_sentiment_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_analyze_entity_sentiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.analyze_entity_sentiment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.analyze_entity_sentiment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_analyze_entity_sentiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LanguageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.analyze_entity_sentiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.analyze_entity_sentiment] = mock_rpc

        request = {}
        await client.analyze_entity_sentiment(request)
...
def test_analyze_syntax_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_analyze_syntax_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.analyze_syntax in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.analyze_syntax] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_analyze_syntax_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LanguageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.analyze_syntax in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.analyze_syntax] = mock_rpc

        request = {}
        await client.analyze_syntax(request)
...
def test_moderate_text(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.moderate_text),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_analyze_entity_sentiment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LanguageServiceClient(
...
def test_analyze_syntax_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LanguageServiceClient(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_analyze_entity_sentiment_empty_call_grpc():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = language_service.AnalyzeEntitySentimentResponse()
        client.analyze_entity_sentiment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_analyze_syntax_empty_call_grpc():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = language_service.AnalyzeSyntaxResponse()
        client.analyze_syntax(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_analyze_entity_sentiment_empty_call_grpc_asyncio():
    client = LanguageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.analyze_entity_sentiment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_analyze_syntax_empty_call_grpc_asyncio():
    client = LanguageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.analyze_syntax(request=None)
...
def test_analyze_sentiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_sentiment") as post, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_sentiment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "pre_analyze_sentiment") as pre:
...
def test_analyze_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_entities") as post, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_entities_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "pre_analyze_entities") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_analyze_entity_sentiment_rest_bad_request(request_type=language_service.AnalyzeEntitySentimentRequest):
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_analyze_entity_sentiment_rest_call_success(request_type):
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_analyze_entity_sentiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_entity_sentiment") as post, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_entity_sentiment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "pre_analyze_entity_sentiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = language_service.AnalyzeEntitySentimentResponse.to_json(language_service.AnalyzeEntitySentimentResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = language_service.AnalyzeEntitySentimentResponse(), metadata
...
def test_analyze_syntax_rest_bad_request(request_type=language_service.AnalyzeSyntaxRequest):
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_analyze_syntax_rest_call_success(request_type):
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_analyze_syntax_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_syntax") as post, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_syntax_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "pre_analyze_syntax") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = language_service.AnalyzeSyntaxResponse.to_json(language_service.AnalyzeSyntaxResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = language_service.AnalyzeSyntaxResponse(), metadata
...
def test_classify_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_classify_text") as post, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_classify_text_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "pre_classify_text") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_moderate_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_moderate_text") as post, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_moderate_text_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "pre_moderate_text") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_annotate_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_annotate_text") as post, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "post_annotate_text_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.LanguageServiceRestInterceptor, "pre_annotate_text") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_analyze_entity_sentiment_empty_call_rest():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_analyze_syntax_empty_call_rest():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_language_service_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/cloud-language',                'https://www.googleapis.com/auth/cloud-platform',),
            quota_project_id="octopus",
        )

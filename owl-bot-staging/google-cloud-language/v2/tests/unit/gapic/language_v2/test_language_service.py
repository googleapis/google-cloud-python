...
from google.cloud.language_v2.services.language_service import LanguageServiceAsyncClient
from google.cloud.language_v2.services.language_service import LanguageServiceClient
from google.cloud.language_v2.services.language_service import transports
...
def test_language_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.language_v2.services.language_service.transports.LanguageServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_language_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.language_v2.services.language_service.transports.LanguageServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LanguageServiceTransport()
        adc.assert_called_once()

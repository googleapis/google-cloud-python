...
class LanguageServiceClient(metaclass=LanguageServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = LanguageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            LanguageServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, LanguageServiceTransport, Callable[..., LanguageServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LanguageServiceClient._read_environment_variables()
        self._client_cert_source = LanguageServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LanguageServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            LanguageServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LanguageServiceTransport], Callable[..., LanguageServiceTransport]] = (
    ...
    def analyze_sentiment(self,
        ...
        Args:
            request (Union[google.cloud.language_v2.types.AnalyzeSentimentRequest, dict]):
    ...
    def analyze_entities(self,
        ...
        Args:
            request (Union[google.cloud.language_v2.types.AnalyzeEntitiesRequest, dict]):
    ...
    def classify_text(self,
        ...
        Args:
            request (Union[google.cloud.language_v2.types.ClassifyTextRequest, dict]):
    ...
    def moderate_text(self,
        ...
        Args:
            request (Union[google.cloud.language_v2.types.ModerateTextRequest, dict]):
    ...
    def annotate_text(self,
        ...
        r"""A convenience method that provides all features in
        one call.
        ...
        Args:
            request (Union[google.cloud.language_v2.types.AnnotateTextRequest, dict]):
        ...
        Returns:
            google.cloud.language_v2.types.AnnotateTextResponse:

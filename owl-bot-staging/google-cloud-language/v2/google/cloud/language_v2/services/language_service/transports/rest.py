...
class LanguageServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_moderate_text(self, request: language_service.ModerateTextRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[language_service.ModerateTextRequest, Sequence[Tuple[str, str]]]:

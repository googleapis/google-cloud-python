...
class LanguageServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_analyze_entities(self, request: language_service.AnalyzeEntitiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeEntitiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_analyze_entities_with_metadata(self, response: language_service.AnalyzeEntitiesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeEntitiesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for analyze_entities
    ...
    def pre_analyze_sentiment(self, request: language_service.AnalyzeSentimentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeSentimentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_analyze_sentiment_with_metadata(self, response: language_service.AnalyzeSentimentResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnalyzeSentimentResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for analyze_sentiment
    ...
    def pre_annotate_text(self, request: language_service.AnnotateTextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnnotateTextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_annotate_text_with_metadata(self, response: language_service.AnnotateTextResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.AnnotateTextResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for annotate_text
    ...
    def pre_classify_text(self, request: language_service.ClassifyTextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.ClassifyTextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_classify_text_with_metadata(self, response: language_service.ClassifyTextResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.ClassifyTextResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for classify_text
    ...
    def pre_moderate_text(self, request: language_service.ModerateTextRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.ModerateTextRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_moderate_text_with_metadata(self, response: language_service.ModerateTextResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[language_service.ModerateTextResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for moderate_text
...
class LanguageServiceRestTransport(_BaseLanguageServiceRestTransport):
    ...
    class _AnalyzeEntities(_BaseLanguageServiceRestTransport._BaseAnalyzeEntities, LanguageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LanguageServiceRestTransport._AnalyzeEntities._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _AnalyzeSentiment(_BaseLanguageServiceRestTransport._BaseAnalyzeSentiment, LanguageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LanguageServiceRestTransport._AnalyzeSentiment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _AnnotateText(_BaseLanguageServiceRestTransport._BaseAnnotateText, LanguageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LanguageServiceRestTransport._AnnotateText._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ClassifyText(_BaseLanguageServiceRestTransport._BaseClassifyText, LanguageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LanguageServiceRestTransport._ClassifyText._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ModerateText(_BaseLanguageServiceRestTransport._BaseModerateText, LanguageServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = LanguageServiceRestTransport._ModerateText._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def moderate_text(self) -> Callable[

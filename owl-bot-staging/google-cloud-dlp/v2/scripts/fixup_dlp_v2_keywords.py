...
class dlpCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'cancel_dlp_job': ('name', ),
        'create_connection': ('parent', 'connection', ),
        'create_deidentify_template': ('parent', 'deidentify_template', 'template_id', 'location_id', ),
        'create_discovery_config': ('parent', 'discovery_config', 'config_id', ),
        ...
        'delete_discovery_config': ('name', ),
        'delete_dlp_job': ('name', ),
        'delete_file_store_data_profile': ('name', ),
        'delete_inspect_template': ('name', ),
        'delete_job_trigger': ('name', ),
        'delete_stored_info_type': ('name', ),
        'delete_table_data_profile': ('name', ),
        'finish_dlp_job': ('name', ),
        'get_column_data_profile': ('name', ),
        'get_connection': ('name', ),
        'get_deidentify_template': ('name', ),
        'get_discovery_config': ('name', ),
        'get_dlp_job': ('name', ),
        'get_file_store_data_profile': ('name', ),
        'get_inspect_template': ('name', ),
        'get_job_trigger': ('name', ),
        'get_project_data_profile': ('name', ),
        'get_stored_info_type': ('name', ),
        'get_table_data_profile': ('name', ),
        ...
        'list_column_data_profiles': ('parent', 'page_token', 'page_size', 'order_by', 'filter', ),
        'list_connections': ('parent', 'page_size', 'page_token', 'filter', ),
        'list_deidentify_templates': ('parent', 'page_token', 'page_size', 'order_by', 'location_id', ),
        'list_discovery_configs': ('parent', 'page_token', 'page_size', 'order_by', ),
        'list_dlp_jobs': ('parent', 'filter', 'page_size', 'page_token', 'type_', 'order_by', 'location_id', ),
        'list_file_store_data_profiles': ('parent', 'page_token', 'page_size', 'order_by', 'filter', ),
        ...
        'update_discovery_config': ('name', 'discovery_config', 'update_mask', ),

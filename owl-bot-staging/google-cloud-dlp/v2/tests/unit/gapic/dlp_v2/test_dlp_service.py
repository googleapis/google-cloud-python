...
def test_reidentify_content_rest_required_fields(request_type=dlp.ReidentifyContentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).reidentify_content._get_unset_required_fields(jsonified_request)
...
def test_reidentify_content_rest_unset_required_fields():
    transport = transports.DlpServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_create_inspect_template_rest_required_fields(request_type=dlp.CreateInspectTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_inspect_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_inspect_template_rest_required_fields(request_type=dlp.UpdateInspectTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_inspect_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_inspect_template_rest_required_fields(request_type=dlp.GetInspectTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_inspect_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_inspect_templates_rest_required_fields(request_type=dlp.ListInspectTemplatesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_inspect_templates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_inspect_template_rest_required_fields(request_type=dlp.DeleteInspectTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_inspect_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_deidentify_template_rest_required_fields(request_type=dlp.CreateDeidentifyTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_deidentify_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_deidentify_template_rest_required_fields(request_type=dlp.UpdateDeidentifyTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_deidentify_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_deidentify_template_rest_required_fields(request_type=dlp.GetDeidentifyTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_deidentify_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_deidentify_templates_rest_required_fields(request_type=dlp.ListDeidentifyTemplatesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_deidentify_templates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_deidentify_template_rest_required_fields(request_type=dlp.DeleteDeidentifyTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_deidentify_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_job_trigger_rest_required_fields(request_type=dlp.CreateJobTriggerRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_job_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_job_trigger_rest_required_fields(request_type=dlp.UpdateJobTriggerRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_job_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_hybrid_inspect_job_trigger_rest_required_fields(request_type=dlp.HybridInspectJobTriggerRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).hybrid_inspect_job_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_job_trigger_rest_required_fields(request_type=dlp.GetJobTriggerRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_job_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_job_triggers_rest_required_fields(request_type=dlp.ListJobTriggersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_job_triggers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_job_trigger_rest_required_fields(request_type=dlp.DeleteJobTriggerRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_job_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_activate_job_trigger_rest_required_fields(request_type=dlp.ActivateJobTriggerRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).activate_job_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_discovery_config_rest_required_fields(request_type=dlp.CreateDiscoveryConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_discovery_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_discovery_config_rest_required_fields(request_type=dlp.UpdateDiscoveryConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_discovery_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_discovery_config_rest_required_fields(request_type=dlp.GetDiscoveryConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_discovery_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_discovery_configs_rest_required_fields(request_type=dlp.ListDiscoveryConfigsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_discovery_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_discovery_config_rest_required_fields(request_type=dlp.DeleteDiscoveryConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_discovery_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_dlp_job_rest_required_fields(request_type=dlp.CreateDlpJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_dlp_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_dlp_jobs_rest_required_fields(request_type=dlp.ListDlpJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_dlp_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_dlp_job_rest_required_fields(request_type=dlp.GetDlpJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_dlp_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_dlp_job_rest_required_fields(request_type=dlp.DeleteDlpJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_dlp_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_dlp_job_rest_required_fields(request_type=dlp.CancelDlpJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).cancel_dlp_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_stored_info_type_rest_required_fields(request_type=dlp.CreateStoredInfoTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_stored_info_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_stored_info_type_rest_required_fields(request_type=dlp.UpdateStoredInfoTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_stored_info_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_stored_info_type_rest_required_fields(request_type=dlp.GetStoredInfoTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_stored_info_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_stored_info_types_rest_required_fields(request_type=dlp.ListStoredInfoTypesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_stored_info_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_stored_info_type_rest_required_fields(request_type=dlp.DeleteStoredInfoTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_stored_info_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_hybrid_inspect_dlp_job_rest_required_fields(request_type=dlp.HybridInspectDlpJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).hybrid_inspect_dlp_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_finish_dlp_job_rest_required_fields(request_type=dlp.FinishDlpJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).finish_dlp_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DlpServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DlpServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DlpServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DlpServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DlpServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DlpServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DlpServiceClient))
@mock.patch.object(DlpServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DlpServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DlpServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DlpServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DlpServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DlpServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DlpServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DlpServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DlpServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DlpServiceClient._get_api_endpoint(None, None, default_universe, "always") == DlpServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DlpServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DlpServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DlpServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DlpServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DlpServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DlpServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DlpServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DlpServiceClient._get_universe_domain(None, None) == DlpServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class", [
    DlpServiceClient, DlpServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (DlpServiceAsyncClient, transports.DlpServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_discovery_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_discovery_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_discovery_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_discovery_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = dlp.DiscoveryConfig(
            name='name_value',
...
def test_get_discovery_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_discovery_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = dlp.DiscoveryConfig(
            name='name_value',
...
def test_list_discovery_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dlp.DiscoveryConfig)
                   for i in results)
...
def test_delete_discovery_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_discovery_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_project_data_profiles_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_project_data_profiles_async(transport: str = 'grpc_asyncio', request_type=dlp.ListProjectDataProfilesRequest):
    client = DlpServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dlp.ListProjectDataProfilesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_project_data_profiles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dlp.ProjectDataProfile)
                   for i in results)
...
async def test_list_project_data_profiles_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_project_data_profiles(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_table_data_profiles_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_table_data_profiles_async(transport: str = 'grpc_asyncio', request_type=dlp.ListTableDataProfilesRequest):
    client = DlpServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dlp.ListTableDataProfilesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_table_data_profiles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dlp.TableDataProfile)
                   for i in results)
...
async def test_list_table_data_profiles_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_table_data_profiles(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_list_column_data_profiles_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_column_data_profiles_async(transport: str = 'grpc_asyncio', request_type=dlp.ListColumnDataProfilesRequest):
    client = DlpServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_column_data_profiles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dlp.ColumnDataProfile)
                   for i in results)
...
async def test_list_column_data_profiles_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_column_data_profiles(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_project_data_profile(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_project_data_profile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_project_data_profile_async(transport: str = 'grpc_asyncio', request_type=dlp.GetProjectDataProfileRequest):
    client = DlpServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_table_data_profile(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_table_data_profile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.resource_visibility == dlp.ResourceVisibility.RESOURCE_VISIBILITY_PUBLIC


def test_get_table_data_profile_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_table_data_profile_async(transport: str = 'grpc_asyncio', request_type=dlp.GetTableDataProfileRequest):
    client = DlpServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dlp.TableDataProfile(
            name='name_value',
            project_data_profile='project_data_profile_value',
            dataset_project_id='dataset_project_id_value',
            dataset_location='dataset_location_value',
...
def test_get_column_data_profile(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_column_data_profile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.estimated_null_percentage == dlp.NullPercentageLevel.NULL_PERCENTAGE_VERY_LOW
    assert response.estimated_uniqueness_score == dlp.UniquenessScoreLevel.UNIQUENESS_SCORE_LOW
    ...
    assert response.policy_state == dlp.ColumnDataProfile.ColumnPolicyState.COLUMN_POLICY_TAGGED


def test_get_column_data_profile_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_column_data_profile_async(transport: str = 'grpc_asyncio', request_type=dlp.GetColumnDataProfileRequest):
    client = DlpServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dlp.ColumnDataProfile(
            name='name_value',
            state=dlp.ColumnDataProfile.State.RUNNING,
            table_data_profile='table_data_profile_value',
            table_full_resource='table_full_resource_value',
...
def test_inspect_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_inspect_content") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_inspect_content") as pre:
...
def test_redact_image_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_redact_image") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_redact_image") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_deidentify_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_deidentify_content") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_deidentify_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_reidentify_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_reidentify_content") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_reidentify_content") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_info_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_info_types") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_info_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_inspect_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_create_inspect_template") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_create_inspect_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_inspect_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_update_inspect_template") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_update_inspect_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_inspect_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_inspect_template") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_inspect_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_inspect_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_inspect_templates") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_inspect_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_inspect_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_delete_inspect_template") as pre:
        pre.assert_not_called()
...
def test_create_deidentify_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_create_deidentify_template") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_create_deidentify_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_deidentify_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_update_deidentify_template") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_update_deidentify_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_deidentify_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_deidentify_template") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_deidentify_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_deidentify_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_deidentify_templates") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_deidentify_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_deidentify_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_delete_deidentify_template") as pre:
        pre.assert_not_called()
...
def test_create_job_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_create_job_trigger") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_create_job_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_job_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_update_job_trigger") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_update_job_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_hybrid_inspect_job_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_hybrid_inspect_job_trigger") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_hybrid_inspect_job_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_job_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_job_trigger") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_job_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_job_triggers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_job_triggers") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_job_triggers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_job_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_delete_job_trigger") as pre:
        pre.assert_not_called()
...
def test_activate_job_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_activate_job_trigger") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_activate_job_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_discovery_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_create_discovery_config") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_create_discovery_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_discovery_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_update_discovery_config") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_update_discovery_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_discovery_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_discovery_config") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_discovery_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_discovery_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_discovery_configs") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_discovery_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_discovery_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_delete_discovery_config") as pre:
        pre.assert_not_called()
...
def test_create_dlp_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_create_dlp_job") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_create_dlp_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_dlp_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_dlp_jobs") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_dlp_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_dlp_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_dlp_job") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_dlp_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_dlp_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_delete_dlp_job") as pre:
        pre.assert_not_called()
...
def test_cancel_dlp_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_cancel_dlp_job") as pre:
        pre.assert_not_called()
...
def test_create_stored_info_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_create_stored_info_type") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_create_stored_info_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_stored_info_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_update_stored_info_type") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_update_stored_info_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_stored_info_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_stored_info_type") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_stored_info_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_stored_info_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_stored_info_types") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_stored_info_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_stored_info_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_delete_stored_info_type") as pre:
        pre.assert_not_called()
...
def test_list_project_data_profiles_rest(request_type):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_project_data_profiles_rest_required_fields(request_type=dlp.ListProjectDataProfilesRequest):
    transport_class = transports.DlpServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_project_data_profiles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_project_data_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_project_data_profiles") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_project_data_profiles") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dlp.ListProjectDataProfilesRequest.pb(dlp.ListProjectDataProfilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dlp.ListProjectDataProfilesResponse.to_json(dlp.ListProjectDataProfilesResponse())
        ...
        client.list_project_data_profiles(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_project_data_profiles_rest_bad_request(transport: str = 'rest', request_type=dlp.ListProjectDataProfilesRequest):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_project_data_profiles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=organizations/*/locations/*}/projectDataProfiles" % client.transport._host, args[1])
...
def test_list_project_data_profiles_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dlp.ListProjectDataProfilesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_table_data_profiles_rest(request_type):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_table_data_profiles_rest_required_fields(request_type=dlp.ListTableDataProfilesRequest):
    transport_class = transports.DlpServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_table_data_profiles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_table_data_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_table_data_profiles") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_table_data_profiles") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dlp.ListTableDataProfilesRequest.pb(dlp.ListTableDataProfilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dlp.ListTableDataProfilesResponse.to_json(dlp.ListTableDataProfilesResponse())
        ...
        client.list_table_data_profiles(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_table_data_profiles_rest_bad_request(transport: str = 'rest', request_type=dlp.ListTableDataProfilesRequest):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_table_data_profiles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=organizations/*/locations/*}/tableDataProfiles" % client.transport._host, args[1])
...
def test_list_column_data_profiles_rest(request_type):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_column_data_profiles_rest_required_fields(request_type=dlp.ListColumnDataProfilesRequest):
    transport_class = transports.DlpServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_column_data_profiles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_column_data_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_list_column_data_profiles") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_list_column_data_profiles") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dlp.ListColumnDataProfilesRequest.pb(dlp.ListColumnDataProfilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dlp.ListColumnDataProfilesResponse.to_json(dlp.ListColumnDataProfilesResponse())
        ...
        client.list_column_data_profiles(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_column_data_profiles_rest_bad_request(transport: str = 'rest', request_type=dlp.ListColumnDataProfilesRequest):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_column_data_profiles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=organizations/*/locations/*}/columnDataProfiles" % client.transport._host, args[1])
...
def test_list_column_data_profiles_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dlp.ListColumnDataProfilesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_project_data_profile_rest(request_type):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'organizations/sample1/locations/sample2/projectDataProfiles/sample3'}
    request = request_type(**request_init)
...
def test_get_project_data_profile_rest_required_fields(request_type=dlp.GetProjectDataProfileRequest):
    transport_class = transports.DlpServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_project_data_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_project_data_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_project_data_profile") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_project_data_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dlp.GetProjectDataProfileRequest.pb(dlp.GetProjectDataProfileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dlp.ProjectDataProfile.to_json(dlp.ProjectDataProfile())
        ...
        client.get_project_data_profile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_project_data_profile_rest_bad_request(transport: str = 'rest', request_type=dlp.GetProjectDataProfileRequest):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_project_data_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'organizations/sample1/locations/sample2/projectDataProfiles/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=organizations/*/locations/*/projectDataProfiles/*}" % client.transport._host, args[1])
...
def test_get_table_data_profile_rest(request_type):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'organizations/sample1/locations/sample2/tableDataProfiles/sample3'}
    request = request_type(**request_init)
...
def test_get_table_data_profile_rest_required_fields(request_type=dlp.GetTableDataProfileRequest):
    transport_class = transports.DlpServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_table_data_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_table_data_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_table_data_profile") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_table_data_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dlp.TableDataProfile.to_json(dlp.TableDataProfile())
        ...
        client.get_table_data_profile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_table_data_profile_rest_bad_request(transport: str = 'rest', request_type=dlp.GetTableDataProfileRequest):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_table_data_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'organizations/sample1/locations/sample2/tableDataProfiles/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=organizations/*/locations/*/tableDataProfiles/*}" % client.transport._host, args[1])
...
def test_get_table_data_profile_rest_error():
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_get_column_data_profile_rest(request_type):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'organizations/sample1/locations/sample2/columnDataProfiles/sample3'}
    request = request_type(**request_init)
...
def test_get_column_data_profile_rest_required_fields(request_type=dlp.GetColumnDataProfileRequest):
    transport_class = transports.DlpServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_column_data_profile._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_column_data_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_get_column_data_profile") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_get_column_data_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dlp.GetColumnDataProfileRequest.pb(dlp.GetColumnDataProfileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dlp.ColumnDataProfile.to_json(dlp.ColumnDataProfile())
        ...
        client.get_column_data_profile(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_column_data_profile_rest_bad_request(transport: str = 'rest', request_type=dlp.GetColumnDataProfileRequest):
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_column_data_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'organizations/sample1/locations/sample2/columnDataProfiles/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=organizations/*/locations/*/columnDataProfiles/*}" % client.transport._host, args[1])
...
def test_get_column_data_profile_rest_error():
    client = DlpServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_hybrid_inspect_dlp_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "post_hybrid_inspect_dlp_job") as post, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_hybrid_inspect_dlp_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_finish_dlp_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DlpServiceRestInterceptor, "pre_finish_dlp_job") as pre:
        pre.assert_not_called()
...
def test_column_data_profile_path():
    ...
    expected = "organizations/{organization}/locations/{location}/columnDataProfiles/{column_data_profile}".format(organization=organization, location=location, column_data_profile=column_data_profile, )
    actual = DlpServiceClient.column_data_profile_path(organization, location, column_data_profile)
...
def test_project_data_profile_path():
    ...
    expected = "organizations/{organization}/locations/{location}/projectDataProfiles/{project_data_profile}".format(organization=organization, location=location, project_data_profile=project_data_profile, )
    actual = DlpServiceClient.project_data_profile_path(organization, location, project_data_profile)
    assert expected == actual
...
def test_table_data_profile_path():
    ...
    expected = "organizations/{organization}/locations/{location}/tableDataProfiles/{table_data_profile}".format(organization=organization, location=location, table_data_profile=table_data_profile, )
    actual = DlpServiceClient.table_data_profile_path(organization, location, table_data_profile)
    assert expected == actual

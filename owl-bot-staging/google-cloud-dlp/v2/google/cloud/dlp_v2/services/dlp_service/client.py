...
class DlpServiceClient(metaclass=DlpServiceClientMeta):
    ...
    @staticmethod
    def column_data_profile_path(organization: str,location: str,column_data_profile: str,) -> str:
        """Returns a fully-qualified column_data_profile string."""
        return "organizations/{organization}/locations/{location}/columnDataProfiles/{column_data_profile}".format(organization=organization, location=location, column_data_profile=column_data_profile, )
    ...
    @staticmethod
    def connection_path(organization: str,location: str,connection: str,) -> str:
        """Returns a fully-qualified connection string."""
        return "organizations/{organization}/locations/{location}/connections/{connection}".format(organization=organization, location=location, connection=connection, )

    @staticmethod
    def parse_connection_path(path: str) -> Dict[str,str]:
        """Parses a connection path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/connections/(?P<connection>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def discovery_config_path(project: str,location: str,discovery_config: str,) -> str:
        """Returns a fully-qualified discovery_config string."""
        return "projects/{project}/locations/{location}/discoveryConfigs/{discovery_config}".format(project=project, location=location, discovery_config=discovery_config, )
    ...
    @staticmethod
    def file_store_data_profile_path(organization: str,location: str,file_store_data_profile: str,) -> str:
        """Returns a fully-qualified file_store_data_profile string."""
        return "organizations/{organization}/locations/{location}/fileStoreDataProfiles/{file_store_data_profile}".format(organization=organization, location=location, file_store_data_profile=file_store_data_profile, )
    ...
    def parse_file_store_data_profile_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/fileStoreDataProfiles/(?P<file_store_data_profile>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def project_data_profile_path(organization: str,location: str,project_data_profile: str,) -> str:
        """Returns a fully-qualified project_data_profile string."""
        return "organizations/{organization}/locations/{location}/projectDataProfiles/{project_data_profile}".format(organization=organization, location=location, project_data_profile=project_data_profile, )
    ...
    @staticmethod
    def table_data_profile_path(organization: str,location: str,table_data_profile: str,) -> str:
        """Returns a fully-qualified table_data_profile string."""
        return "organizations/{organization}/locations/{location}/tableDataProfiles/{table_data_profile}".format(organization=organization, location=location, table_data_profile=table_data_profile, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            DlpServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_discovery_config(self,
    ...
    def list_discovery_configs(self,
    ...
    def delete_discovery_config(self,
    ...
    def list_project_data_profiles(self,
    ...
    def list_table_data_profiles(self,
    ...
    def list_column_data_profiles(self,
    ...
    def get_project_data_profile(self,
    ...
    def list_file_store_data_profiles(self,
    ...
    def get_file_store_data_profile(self,
    ...
    def delete_file_store_data_profile(self,
    ...
    def get_table_data_profile(self,
    ...
    def get_column_data_profile(self,
    ...
    def delete_table_data_profile(self,

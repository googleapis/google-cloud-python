...
from google.api.cloudquotas_v1beta.types import cloudquotas
from google.api.cloudquotas_v1beta.types import resources
...
class CloudQuotasRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_quota_preference(self, request: cloudquotas.CreateQuotaPreferenceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.CreateQuotaPreferenceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_quota_info(self, request: cloudquotas.GetQuotaInfoRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.GetQuotaInfoRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_quota_preference(self, request: cloudquotas.GetQuotaPreferenceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.GetQuotaPreferenceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_quota_infos(self, request: cloudquotas.ListQuotaInfosRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.ListQuotaInfosRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_quota_preferences(self, request: cloudquotas.ListQuotaPreferencesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.ListQuotaPreferencesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update_quota_preference(self, request: cloudquotas.UpdateQuotaPreferenceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.UpdateQuotaPreferenceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _CreateQuotaPreference(_BaseCloudQuotasRestTransport._BaseCreateQuotaPreference, CloudQuotasRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1beta.CloudQuotasClient.CreateQuotaPreference",
                    extra = {
            ...
            # Send the request
            response = CloudQuotasRestTransport._CreateQuotaPreference._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1beta.CloudQuotasClient.create_quota_preference",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
                        "rpcName": "CreateQuotaPreference",
    ...
    class _GetQuotaInfo(_BaseCloudQuotasRestTransport._BaseGetQuotaInfo, CloudQuotasRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1beta.CloudQuotasClient.GetQuotaInfo",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
            ...
            # Send the request
            response = CloudQuotasRestTransport._GetQuotaInfo._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1beta.CloudQuotasClient.get_quota_info",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
                        "rpcName": "GetQuotaInfo",
                        "metadata": http_response["headers"],
    ...
    class _GetQuotaPreference(_BaseCloudQuotasRestTransport._BaseGetQuotaPreference, CloudQuotasRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1beta.CloudQuotasClient.GetQuotaPreference",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
            ...
            # Send the request
            response = CloudQuotasRestTransport._GetQuotaPreference._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1beta.CloudQuotasClient.get_quota_preference",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
                        "rpcName": "GetQuotaPreference",
                        "metadata": http_response["headers"],
    ...
    class _ListQuotaInfos(_BaseCloudQuotasRestTransport._BaseListQuotaInfos, CloudQuotasRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1beta.CloudQuotasClient.ListQuotaInfos",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
            ...
            # Send the request
            response = CloudQuotasRestTransport._ListQuotaInfos._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1beta.CloudQuotasClient.list_quota_infos",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
                        "rpcName": "ListQuotaInfos",
                        "metadata": http_response["headers"],
    ...
    class _ListQuotaPreferences(_BaseCloudQuotasRestTransport._BaseListQuotaPreferences, CloudQuotasRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1beta.CloudQuotasClient.ListQuotaPreferences",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
            ...
            # Send the request
            response = CloudQuotasRestTransport._ListQuotaPreferences._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1beta.CloudQuotasClient.list_quota_preferences",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
                        "rpcName": "ListQuotaPreferences",
                        "metadata": http_response["headers"],
    ...
    class _UpdateQuotaPreference(_BaseCloudQuotasRestTransport._BaseUpdateQuotaPreference, CloudQuotasRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1beta.CloudQuotasClient.UpdateQuotaPreference",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
            ...
            # Send the request
            response = CloudQuotasRestTransport._UpdateQuotaPreference._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1beta.CloudQuotasClient.update_quota_preference",
                    extra = {
                        "serviceName": "google.api.cloudquotas.v1beta.CloudQuotas",
                        "rpcName": "UpdateQuotaPreference",
                        "metadata": http_response["headers"],

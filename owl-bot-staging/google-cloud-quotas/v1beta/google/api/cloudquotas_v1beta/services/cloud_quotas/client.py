...
class CloudQuotasClient(metaclass=CloudQuotasClientMeta):
    ...
    def list_quota_infos(self,
        ...
        Args:
            request (Union[google.api.cloudquotas_v1beta.types.ListQuotaInfosRequest, dict]):
        ...
        Returns:
            google.api.cloudquotas_v1beta.services.cloud_quotas.pagers.ListQuotaInfosPager:
    ...
    def get_quota_info(self,
        ...
        Args:
            request (Union[google.api.cloudquotas_v1beta.types.GetQuotaInfoRequest, dict]):
        ...
        Returns:
            google.api.cloudquotas_v1beta.types.QuotaInfo:
    ...
    def list_quota_preferences(self,
        ...
        Args:
            request (Union[google.api.cloudquotas_v1beta.types.ListQuotaPreferencesRequest, dict]):
                The request object. Message for requesting list of
                QuotaPreferences
            parent (str):
        ...
        Returns:
            google.api.cloudquotas_v1beta.services.cloud_quotas.pagers.ListQuotaPreferencesPager:
                Message for response to listing
                QuotaPreferences
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def get_quota_preference(self,
        ...
        Args:
            request (Union[google.api.cloudquotas_v1beta.types.GetQuotaPreferenceRequest, dict]):
        ...
        Returns:
            google.api.cloudquotas_v1beta.types.QuotaPreference:
    ...
    def create_quota_preference(self,
        ...
        Args:
            request (Union[google.api.cloudquotas_v1beta.types.CreateQuotaPreferenceRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            quota_preference (google.api.cloudquotas_v1beta.types.QuotaPreference):
    ...
    def update_quota_preference(self,
        ...
        Args:
            request (Union[google.api.cloudquotas_v1beta.types.UpdateQuotaPreferenceRequest, dict]):

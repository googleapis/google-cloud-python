...
class CloudQuotasAsyncClient:
    ...
    async def list_quota_infos(self,
        ...
        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.ListQuotaInfosRequest, dict]]):
        ...
        Returns:
            google.api.cloudquotas_v1beta.services.cloud_quotas.pagers.ListQuotaInfosAsyncPager:
    ...
    async def get_quota_info(self,
        ...
        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.GetQuotaInfoRequest, dict]]):
    ...
    async def list_quota_preferences(self,
        ...
        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.ListQuotaPreferencesRequest, dict]]):
                The request object. Message for requesting list of
                QuotaPreferences
            parent (:class:`str`):
        ...
        Returns:
            google.api.cloudquotas_v1beta.services.cloud_quotas.pagers.ListQuotaPreferencesAsyncPager:
                Message for response to listing
                QuotaPreferences
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def get_quota_preference(self,
        ...
        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.GetQuotaPreferenceRequest, dict]]):
    ...
    async def create_quota_preference(self,
        ...
        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.CreateQuotaPreferenceRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            quota_preference (:class:`google.api.cloudquotas_v1beta.types.QuotaPreference`):
    ...
    async def update_quota_preference(self,
        ...
        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.UpdateQuotaPreferenceRequest, dict]]):

...
from google.api.cloudquotas_v1beta import gapic_version as package_version
...
from google.api.cloudquotas_v1beta.types import quota_adjuster_settings
from google.api.cloudquotas_v1beta.types import quota_adjuster_settings as gac_quota_adjuster_settings
from google.protobuf import field_mask_pb2  # type: ignore
from google.protobuf import timestamp_pb2  # type: ignore
from .transports.base import QuotaAdjusterSettingsManagerTransport, DEFAULT_CLIENT_INFO
...
class QuotaAdjusterSettingsManagerAsyncClient:
    ...
    _client: QuotaAdjusterSettingsManagerClient
    ...
    def transport(self) -> QuotaAdjusterSettingsManagerTransport:
        ...
        Returns:
            QuotaAdjusterSettingsManagerTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = QuotaAdjusterSettingsManagerClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        """
        self._client = QuotaAdjusterSettingsManagerClient(
    ...
    async def update_quota_adjuster_settings(self,
        ...
        .. code-block:: python
            ...
            from google.api import cloudquotas_v1beta

            async def sample_update_quota_adjuster_settings():
                # Create a client
        ...
        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.UpdateQuotaAdjusterSettingsRequest, dict]]):
                The request object. Request for updating
                QuotaAdjusterSettings
            quota_adjuster_settings (:class:`google.api.cloudquotas_v1beta.types.QuotaAdjusterSettings`):
        ...
        Returns:
            google.api.cloudquotas_v1beta.types.QuotaAdjusterSettings:
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("quota_adjuster_settings.name", request.quota_adjuster_settings.name),
            )),
        )
    ...
    async def get_quota_adjuster_settings(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_quota_adjuster_settings():
                # Create a client
                client = cloudquotas_v1beta.QuotaAdjusterSettingsManagerAsyncClient()
                ...
                # Make the request
                response = await client.get_quota_adjuster_settings(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.api.cloudquotas_v1beta.types.GetQuotaAdjusterSettingsRequest, dict]]):
    ...
    async def __aenter__(self) -> "QuotaAdjusterSettingsManagerAsyncClient":
        return self

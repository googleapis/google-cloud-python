...
class QuotaInfo(proto.Message):
    ...
    Attributes:
        ...
        container_type (google.api.cloudquotas_v1beta.types.QuotaInfo.ContainerType):
        ...
        metric_unit (str):
            ...
            reported, e.g., "MByte".
        quota_increase_eligibility (google.api.cloudquotas_v1beta.types.QuotaIncreaseEligibility):
            Whether it is eligible to request a higher
            quota value for this quota.
        is_fixed (bool):
            Whether the quota value is fixed or
            adjustable
        dimensions_infos (MutableSequence[google.api.cloudquotas_v1beta.types.DimensionsInfo]):
...
class QuotaIncreaseEligibility(proto.Message):
    ...
    Attributes:
        is_eligible (bool):
            ...
            for the quota.
        ineligibility_reason (google.api.cloudquotas_v1beta.types.QuotaIncreaseEligibility.IneligibilityReason):
...
class QuotaPreference(proto.Message):
    ...
    Attributes:
        ...
        quota_config (google.api.cloudquotas_v1beta.types.QuotaConfig):
...
class QuotaConfig(proto.Message):
    ...
    Attributes:
        ...
        request_origin (google.api.cloudquotas_v1beta.types.QuotaConfig.Origin):
...
class DimensionsInfo(proto.Message):
    ...
    Attributes:
        dimensions (MutableMapping[str, str]):
            ...
            quota.
        details (google.api.cloudquotas_v1beta.types.QuotaDetails):
...
class QuotaDetails(proto.Message):
    ...
    Attributes:
        value (int):
            ...
            enforced.
        rollout_info (google.api.cloudquotas_v1beta.types.RolloutInfo):

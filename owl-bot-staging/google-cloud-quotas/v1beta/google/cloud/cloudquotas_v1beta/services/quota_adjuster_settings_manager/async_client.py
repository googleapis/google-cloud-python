...
class QuotaAdjusterSettingsManagerAsyncClient:
    ...
    async def update_quota_adjuster_settings(self,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudquotas_v1beta.types.UpdateQuotaAdjusterSettingsRequest, dict]]):
                The request object. Request for updating
                QuotaAdjusterSettings
            quota_adjuster_settings (:class:`google.cloud.cloudquotas_v1beta.types.QuotaAdjusterSettings`):
    ...
    async def get_quota_adjuster_settings(self,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudquotas_v1beta.types.GetQuotaAdjusterSettingsRequest, dict]]):

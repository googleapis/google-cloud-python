...
class QuotaAdjusterSettingsManagerTransport(abc.ABC):
    """Abstract transport class for QuotaAdjusterSettingsManager."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'cloudquotas.googleapis.com'
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.update_quota_adjuster_settings: gapic_v1.method.wrap_method(
                self.update_quota_adjuster_settings,
            ...
            self.get_quota_adjuster_settings: gapic_v1.method.wrap_method(
                self.get_quota_adjuster_settings,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,

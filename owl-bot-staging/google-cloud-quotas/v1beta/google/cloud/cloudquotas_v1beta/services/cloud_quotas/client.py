...
from google.cloud.cloudquotas_v1beta.services.cloud_quotas import pagers
from google.cloud.cloudquotas_v1beta.types import cloudquotas
...
from .transports.grpc import CloudQuotasGrpcTransport
from .transports.grpc_asyncio import CloudQuotasGrpcAsyncIOTransport
from .transports.rest import CloudQuotasRestTransport


class CloudQuotasClientMeta(type):
    """Metaclass for the CloudQuotas client.
...
class CloudQuotasClient(metaclass=CloudQuotasClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "cloudquotas.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CloudQuotasClient: The constructed client.
        """
    ...
    def transport(self) -> CloudQuotasTransport:
        ...
        Returns:
            CloudQuotasTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def quota_info_path(project: str,location: str,service: str,quota_info: str,) -> str:
        """Returns a fully-qualified quota_info string."""
        return "projects/{project}/locations/{location}/services/{service}/quotaInfos/{quota_info}".format(project=project, location=location, service=service, quota_info=quota_info, )

    @staticmethod
    def parse_quota_info_path(path: str) -> Dict[str,str]:
        """Parses a quota_info path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/services/(?P<service>.+?)/quotaInfos/(?P<quota_info>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def quota_preference_path(project: str,location: str,quota_preference: str,) -> str:
        """Returns a fully-qualified quota_preference string."""
        return "projects/{project}/locations/{location}/quotaPreferences/{quota_preference}".format(project=project, location=location, quota_preference=quota_preference, )

    @staticmethod
    def parse_quota_preference_path(path: str) -> Dict[str,str]:
        """Parses a quota_preference path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/quotaPreferences/(?P<quota_preference>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudQuotasClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CloudQuotasClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CloudQuotasClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudQuotasTransport, Callable[..., CloudQuotasTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CloudQuotasClient._read_environment_variables()
        self._client_cert_source = CloudQuotasClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CloudQuotasClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CloudQuotasTransport)
        if transport_provided:
            # transport is a CloudQuotasTransport instance.
            ...
            self._transport = cast(CloudQuotasTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CloudQuotasTransport], Callable[..., CloudQuotasTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.api.cloudquotas_v1beta.CloudQuotasClient`.",
                    extra = {
    ...
    def list_quota_infos(self,
        ...
        .. code-block:: python
            ...
            def sample_list_quota_infos():
                # Create a client
                client = cloudquotas_v1beta.CloudQuotasClient()

                # Initialize request argument(s)
                request = cloudquotas_v1beta.ListQuotaInfosRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.ListQuotaInfosRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_quota_infos]
        ...
        response = pagers.ListQuotaInfosPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_quota_info(self,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.GetQuotaInfoRequest, dict]):
        ...
        Returns:
            google.cloud.cloudquotas_v1beta.types.QuotaInfo:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_quota_info]
    ...
    def list_quota_preferences(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListQuotaPreferencesPager:
        ...
        .. code-block:: python
            ...
            def sample_list_quota_preferences():
                ...
                # Initialize request argument(s)
                request = cloudquotas_v1beta.ListQuotaPreferencesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.ListQuotaPreferencesRequest, dict]):
                The request object. Message for requesting list of
                QuotaPreferences
            parent (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_quota_preferences]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListQuotaPreferencesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_quota_preference(self,
        ...
        .. code-block:: python
            ...
            def sample_get_quota_preference():
                ...
                # Initialize request argument(s)
                request = cloudquotas_v1beta.GetQuotaPreferenceRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.GetQuotaPreferenceRequest, dict]):
        ...
        Returns:
            google.cloud.cloudquotas_v1beta.types.QuotaPreference:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_quota_preference]
    ...
    def create_quota_preference(self,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.CreateQuotaPreferenceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_quota_preference]
    ...
    def update_quota_preference(self,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.UpdateQuotaPreferenceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_quota_preference]
    ...
    def __enter__(self) -> "CloudQuotasClient":
        return self

...
class CloudQuotasGrpcAsyncIOTransport(CloudQuotasTransport):
    ...
    @property
    def list_quota_infos(self) -> Callable[
    ...
    @property
    def get_quota_info(self) -> Callable[
    ...
    @property
    def list_quota_preferences(self) -> Callable[
    ...
    @property
    def get_quota_preference(self) -> Callable[
    ...
    @property
    def create_quota_preference(self) -> Callable[
    ...
    @property
    def update_quota_preference(self) -> Callable[

...
class CloudQuotasRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_quota_preference_with_metadata(self, response: resources.QuotaPreference, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.QuotaPreference, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_quota_preference
    ...
    def post_get_quota_info_with_metadata(self, response: resources.QuotaInfo, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.QuotaInfo, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_quota_info
    ...
    def post_get_quota_preference_with_metadata(self, response: resources.QuotaPreference, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.QuotaPreference, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_quota_preference
    ...
    def post_list_quota_infos_with_metadata(self, response: cloudquotas.ListQuotaInfosResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.ListQuotaInfosResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_quota_infos
    ...
    def post_list_quota_preferences_with_metadata(self, response: cloudquotas.ListQuotaPreferencesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[cloudquotas.ListQuotaPreferencesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_quota_preferences
    ...
    def post_update_quota_preference_with_metadata(self, response: resources.QuotaPreference, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.QuotaPreference, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_quota_preference

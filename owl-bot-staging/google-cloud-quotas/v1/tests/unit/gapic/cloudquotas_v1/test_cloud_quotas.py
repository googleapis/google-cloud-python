...
from google.cloud.cloudquotas_v1.services.cloud_quotas import CloudQuotasAsyncClient
from google.cloud.cloudquotas_v1.services.cloud_quotas import CloudQuotasClient
from google.cloud.cloudquotas_v1.services.cloud_quotas import pagers
from google.cloud.cloudquotas_v1.services.cloud_quotas import transports
...
def test_cloud_quotas_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.cloudquotas_v1.services.cloud_quotas.transports.CloudQuotasTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_quotas_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.cloudquotas_v1.services.cloud_quotas.transports.CloudQuotasTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CloudQuotasTransport()
        adc.assert_called_once()

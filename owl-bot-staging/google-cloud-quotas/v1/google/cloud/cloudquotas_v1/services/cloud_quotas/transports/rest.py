...
class CloudQuotasRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_quota_preference(self, request: cloudquotas.CreateQuotaPreferenceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudquotas.CreateQuotaPreferenceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_quota_info(self, request: cloudquotas.GetQuotaInfoRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudquotas.GetQuotaInfoRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_quota_preference(self, request: cloudquotas.GetQuotaPreferenceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudquotas.GetQuotaPreferenceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_quota_infos(self, request: cloudquotas.ListQuotaInfosRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudquotas.ListQuotaInfosRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_quota_preferences(self, request: cloudquotas.ListQuotaPreferencesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudquotas.ListQuotaPreferencesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_quota_preference(self, request: cloudquotas.UpdateQuotaPreferenceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudquotas.UpdateQuotaPreferenceRequest, Sequence[Tuple[str, str]]]:

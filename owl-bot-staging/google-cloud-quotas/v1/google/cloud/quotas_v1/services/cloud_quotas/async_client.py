...
class CloudQuotasAsyncClient:
    ...
    get_transport_class = functools.partial(type(CloudQuotasClient).get_transport_class, type(CloudQuotasClient))
    ...
    async def list_quota_infos(self,
        ...
        Args:
            request (Optional[Union[google.cloud.quotas_v1.types.ListQuotaInfosRequest, dict]]):
        ...
        Returns:
            google.cloud.quotas_v1.services.cloud_quotas.pagers.ListQuotaInfosAsyncPager:
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_quota_info(self,
        ...
        Args:
            request (Optional[Union[google.cloud.quotas_v1.types.GetQuotaInfoRequest, dict]]):
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_quota_preferences(self,
        ...
        Args:
            request (Optional[Union[google.cloud.quotas_v1.types.ListQuotaPreferencesRequest, dict]]):
                The request object. Message for requesting list of
                QuotaPreferences
            parent (:class:`str`):
        ...
        Returns:
            google.cloud.quotas_v1.services.cloud_quotas.pagers.ListQuotaPreferencesAsyncPager:
                Message for response to listing
                QuotaPreferences
                Iterating over this object will yield
                results and resolve additional pages
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_quota_preference(self,
        ...
        Args:
            request (Optional[Union[google.cloud.quotas_v1.types.GetQuotaPreferenceRequest, dict]]):
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_quota_preference(self,
        ...
        Args:
            request (Optional[Union[google.cloud.quotas_v1.types.CreateQuotaPreferenceRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            quota_preference (:class:`google.cloud.quotas_v1.types.QuotaPreference`):
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_quota_preference(self,
        ...
        Args:
            request (Optional[Union[google.cloud.quotas_v1.types.UpdateQuotaPreferenceRequest, dict]]):

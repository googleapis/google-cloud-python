...
project = u"google-cloud-public-ca"
...
latex_documents = [
    (
        ...
        u"google-cloud-public-ca Documentation",
        author,
        "manual",
    )
]
...
man_pages = [
    (
        ...
        u"Google Cloud Security Publicca Documentation",
        [author],
        1,
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-public-ca",
        "GAPIC library for Google Cloud Security Publicca API",
        "APIs",
    )
]

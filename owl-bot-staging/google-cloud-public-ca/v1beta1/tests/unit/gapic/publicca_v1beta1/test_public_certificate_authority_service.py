...
def test_create_external_account_key_rest_required_fields(request_type=service.CreateExternalAccountKeyRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_external_account_key._get_unset_required_fields(jsonified_request)
...
def test_create_external_account_key_rest_unset_required_fields():
    transport = transports.PublicCertificateAuthorityServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)

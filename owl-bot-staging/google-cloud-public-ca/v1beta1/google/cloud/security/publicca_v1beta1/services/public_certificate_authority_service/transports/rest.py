...
class PublicCertificateAuthorityServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_external_account_key(self, request: service.CreateExternalAccountKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.CreateExternalAccountKeyRequest, Sequence[Tuple[str, str]]]:

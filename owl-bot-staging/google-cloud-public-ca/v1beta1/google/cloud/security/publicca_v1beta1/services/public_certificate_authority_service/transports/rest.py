...
from .base import PublicCertificateAuthorityServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class PublicCertificateAuthorityServiceRestTransport(PublicCertificateAuthorityServiceTransport):

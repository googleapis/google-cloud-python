...
from google.cloud.security.publicca_v1beta1.types import service


from .rest_base import _BasePublicCertificateAuthorityServiceRestTransport
...
class PublicCertificateAuthorityServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_external_account_key(self, request: service.CreateExternalAccountKeyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[service.CreateExternalAccountKeyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_external_account_key(self, response: resources.ExternalAccountKey) -> resources.ExternalAccountKey:
        ...
        it is returned to user code. This `post_create_external_account_key` interceptor runs
        before the `post_create_external_account_key_with_metadata` interceptor.
        """
        return response

    def post_create_external_account_key_with_metadata(self, response: resources.ExternalAccountKey, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[resources.ExternalAccountKey, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_external_account_key

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the PublicCertificateAuthorityService server but before it is returned to user code.

        We recommend only using this `post_create_external_account_key_with_metadata`
        interceptor in new development instead of the `post_create_external_account_key` interceptor.
        When both interceptors are used, this `post_create_external_account_key_with_metadata` interceptor runs after the
        `post_create_external_account_key` interceptor. The (possibly modified) response returned by
        `post_create_external_account_key` will be passed to
        `post_create_external_account_key_with_metadata`.
        """
...
class PublicCertificateAuthorityServiceRestTransport(_BasePublicCertificateAuthorityServiceRestTransport):
    ...
    def __init__(self, *,
        ...
        Args:
            host (Optional[str]):
                 The hostname to connect to (default: 'publicca.googleapis.com').
    ...
    class _CreateExternalAccountKey(_BasePublicCertificateAuthorityServiceRestTransport._BaseCreateExternalAccountKey, PublicCertificateAuthorityServiceRestStub):
        def __hash__(self):
        ...
        key method over HTTP.
            ...
            transcoded_request = _BasePublicCertificateAuthorityServiceRestTransport._BaseCreateExternalAccountKey._get_transcoded_request(http_options, request)
            ...
            query_params = _BasePublicCertificateAuthorityServiceRestTransport._BaseCreateExternalAccountKey._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.security.publicca_v1beta1.PublicCertificateAuthorityServiceClient.CreateExternalAccountKey",
                    extra = {
                        "serviceName": "google.cloud.security.publicca.v1beta1.PublicCertificateAuthorityService",
                        "rpcName": "CreateExternalAccountKey",
            ...
            # Send the request
            response = PublicCertificateAuthorityServiceRestTransport._CreateExternalAccountKey._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.security.publicca_v1beta1.PublicCertificateAuthorityServiceClient.create_external_account_key",
                    extra = {
                        "serviceName": "google.cloud.security.publicca.v1beta1.PublicCertificateAuthorityService",
                        "rpcName": "CreateExternalAccountKey",
    ...
    @property
    def create_external_account_key(self) -> Callable[

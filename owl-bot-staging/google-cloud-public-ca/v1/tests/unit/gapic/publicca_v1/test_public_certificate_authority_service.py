...
from google.cloud.security.publicca_v1.services.public_certificate_authority_service import PublicCertificateAuthorityServiceAsyncClient
from google.cloud.security.publicca_v1.services.public_certificate_authority_service import PublicCertificateAuthorityServiceClient
from google.cloud.security.publicca_v1.services.public_certificate_authority_service import transports
...
def test_public_certificate_authority_service_client_client_options_from_dict():
    with mock.patch('google.cloud.security.publicca_v1.services.public_certificate_authority_service.transports.PublicCertificateAuthorityServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_external_account_key_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
async def test_create_external_account_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_external_account_key] = mock_object
...
def test_public_certificate_authority_service_base_transport():
    ...
    with mock.patch('google.cloud.security.publicca_v1.services.public_certificate_authority_service.transports.PublicCertificateAuthorityServiceTransport.__init__') as Transport:
...
def test_public_certificate_authority_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.security.publicca_v1.services.public_certificate_authority_service.transports.PublicCertificateAuthorityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_public_certificate_authority_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.security.publicca_v1.services.public_certificate_authority_service.transports.PublicCertificateAuthorityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PublicCertificateAuthorityServiceTransport()
        adc.assert_called_once()

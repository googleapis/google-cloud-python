    ...
    class _CreateExternalAccountKey(_BasePublicCertificateAuthorityServiceRestTransport._BaseCreateExternalAccountKey, PublicCertificateAuthorityServiceRestStub):
        ...
        key method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.security.publicca_v1alpha1.PublicCertificateAuthorityServiceClient.CreateExternalAccountKey",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.security.publicca_v1alpha1.PublicCertificateAuthorityServiceClient.create_external_account_key",
                    extra = {
                        "serviceName": "google.cloud.security.publicca.v1alpha1.PublicCertificateAuthorityService",
                        "rpcName": "CreateExternalAccountKey",

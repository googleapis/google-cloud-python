...
class PublicCertificateAuthorityServiceGrpcAsyncIOTransport(PublicCertificateAuthorityServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_external_account_key: self._wrap_method(

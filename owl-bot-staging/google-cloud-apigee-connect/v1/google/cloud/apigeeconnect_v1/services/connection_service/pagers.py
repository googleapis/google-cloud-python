...
class ListConnectionsPager:
    ...
    :class:`google.cloud.apigeeconnect_v1.types.ListConnectionsResponse` object, and
    ...
    All the usual :class:`google.cloud.apigeeconnect_v1.types.ListConnectionsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.apigeeconnect_v1.types.ListConnectionsResponse):

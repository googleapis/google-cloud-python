...
class ConnectionServiceClient(metaclass=ConnectionServiceClientMeta):
    ...
    def endpoint_path(project: str,endpoint: str,) -> str:
        ...
        return "projects/{project}/endpoints/{endpoint}".format(project=project, endpoint=endpoint, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConnectionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConnectionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConnectionServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ConnectionServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConnectionServiceTransport, Callable[..., ConnectionServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConnectionServiceClient._read_environment_variables()
        self._client_cert_source = ConnectionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConnectionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConnectionServiceTransport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConnectionServiceTransport], Callable[..., ConnectionServiceTransport]] = (

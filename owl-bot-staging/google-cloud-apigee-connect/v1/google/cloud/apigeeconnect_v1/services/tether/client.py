...
class TetherClientMeta(type):
    """Metaclass for the Tether client.
...
class TetherClient(metaclass=TetherClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "apigeeconnect.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TetherClient: The constructed client.
        """
    ...
    def transport(self) -> TetherTransport:
        ...
        Returns:
            TetherTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = TetherClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TetherClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = TetherClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = TetherClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            TetherClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TetherTransport, Callable[..., TetherTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,TetherTransport,Callable[..., TetherTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the TetherTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TetherClient._read_environment_variables()
        self._client_cert_source = TetherClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TetherClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, TetherTransport)
        if transport_provided:
            # transport is a TetherTransport instance.
            ...
            self._transport = cast(TetherTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            TetherClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TetherTransport], Callable[..., TetherTransport]] = (
    ...
    def egress(self,
        ...
        Returns:
            Iterable[google.cloud.apigeeconnect_v1.types.EgressRequest]:

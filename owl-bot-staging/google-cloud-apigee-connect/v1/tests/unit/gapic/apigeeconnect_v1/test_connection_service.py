...
def test__get_api_endpoint():
    ...
    assert ConnectionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ConnectionServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert ConnectionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ConnectionServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    ConnectionServiceClient, ConnectionServiceAsyncClient
])
...
def test_transport_kind_grpc_asyncio():
    transport = ConnectionServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_connection_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        'apigeeconnect.googleapis.com:8000'
    )

...
class CloudDeployClient(metaclass=CloudDeployClientMeta):
    ...
    @staticmethod
    def automation_path(project: str,location: str,delivery_pipeline: str,automation: str,) -> str:
        """Returns a fully-qualified automation string."""
        return "projects/{project}/locations/{location}/deliveryPipelines/{delivery_pipeline}/automations/{automation}".format(project=project, location=location, delivery_pipeline=delivery_pipeline, automation=automation, )

    @staticmethod
    def parse_automation_path(path: str) -> Dict[str,str]:
        """Parses a automation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deliveryPipelines/(?P<delivery_pipeline>.+?)/automations/(?P<automation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def automation_run_path(project: str,location: str,delivery_pipeline: str,automation_run: str,) -> str:
        """Returns a fully-qualified automation_run string."""
        return "projects/{project}/locations/{location}/deliveryPipelines/{delivery_pipeline}/automationRuns/{automation_run}".format(project=project, location=location, delivery_pipeline=delivery_pipeline, automation_run=automation_run, )

    @staticmethod
    def parse_automation_run_path(path: str) -> Dict[str,str]:
        """Parses a automation_run path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deliveryPipelines/(?P<delivery_pipeline>.+?)/automationRuns/(?P<automation_run>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def custom_target_type_path(project: str,location: str,custom_target_type: str,) -> str:
        """Returns a fully-qualified custom_target_type string."""
        return "projects/{project}/locations/{location}/customTargetTypes/{custom_target_type}".format(project=project, location=location, custom_target_type=custom_target_type, )

    @staticmethod
    def parse_custom_target_type_path(path: str) -> Dict[str,str]:
        """Parses a custom_target_type path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/customTargetTypes/(?P<custom_target_type>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def deploy_policy_path(project: str,location: str,deploy_policy: str,) -> str:
        """Returns a fully-qualified deploy_policy string."""
        return "projects/{project}/locations/{location}/deployPolicies/{deploy_policy}".format(project=project, location=location, deploy_policy=deploy_policy, )

    @staticmethod
    def parse_deploy_policy_path(path: str) -> Dict[str,str]:
        """Parses a deploy_policy path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deployPolicies/(?P<deploy_policy>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudDeployClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            CloudDeployClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudDeployTransport, Callable[..., CloudDeployTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CloudDeployClient._read_environment_variables()
        self._client_cert_source = CloudDeployClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CloudDeployClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            CloudDeployClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CloudDeployTransport], Callable[..., CloudDeployTransport]] = (
    ...
    def list_custom_target_types(self,
    ...
    def get_custom_target_type(self,
    ...
    def create_custom_target_type(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_custom_target_type]
    ...
    def update_custom_target_type(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_custom_target_type]
    ...
    def delete_custom_target_type(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_custom_target_type]
    ...
    def cancel_automation_run(self,

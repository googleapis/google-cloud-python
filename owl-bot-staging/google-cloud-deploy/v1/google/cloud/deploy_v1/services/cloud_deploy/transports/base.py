...
class CloudDeployTransport(abc.ABC):
    ...
    @property
    def rollback_target(self) -> Callable[
    ...
    @property
    def list_custom_target_types(self) -> Callable[
    ...
    @property
    def get_custom_target_type(self) -> Callable[
    ...
    @property
    def create_custom_target_type(self) -> Callable[
    ...
    @property
    def update_custom_target_type(self) -> Callable[
    ...
    @property
    def delete_custom_target_type(self) -> Callable[
    ...
    @property
    def create_deploy_policy(self) -> Callable[
    ...
    @property
    def update_deploy_policy(self) -> Callable[
    ...
    @property
    def delete_deploy_policy(self) -> Callable[
    ...
    @property
    def list_deploy_policies(self) -> Callable[
    ...
    @property
    def get_deploy_policy(self) -> Callable[
            [cloud_deploy.GetDeployPolicyRequest],
            Union[
                cloud_deploy.DeployPolicy,
                Awaitable[cloud_deploy.DeployPolicy]
            ]]:
        raise NotImplementedError()
    ...
    def ignore_job(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[cloud_deploy.IgnoreJobResponse]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def create_automation(self) -> Callable[
    ...
    @property
    def update_automation(self) -> Callable[
    ...
    @property
    def delete_automation(self) -> Callable[
    ...
    @property
    def get_automation(self) -> Callable[
            [cloud_deploy.GetAutomationRequest],
            Union[
                cloud_deploy.Automation,
                Awaitable[cloud_deploy.Automation]
            ]]:
        raise NotImplementedError()

    @property
    def list_automations(self) -> Callable[
    ...
    @property
    def get_automation_run(self) -> Callable[
            [cloud_deploy.GetAutomationRunRequest],
            Union[
                cloud_deploy.AutomationRun,
                Awaitable[cloud_deploy.AutomationRun]
            ]]:
        raise NotImplementedError()

    @property
    def list_automation_runs(self) -> Callable[
    ...
    @property
    def cancel_automation_run(self) -> Callable[

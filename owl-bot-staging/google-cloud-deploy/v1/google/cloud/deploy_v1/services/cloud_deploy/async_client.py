...
class CloudDeployAsyncClient:
    ...
    get_transport_class = functools.partial(type(CloudDeployClient).get_transport_class, type(CloudDeployClient))
    ...
    async def list_delivery_pipelines(self,
    ...
    async def get_delivery_pipeline(self,
    ...
    async def create_delivery_pipeline(self,
    ...
    async def update_delivery_pipeline(self,
    ...
    async def delete_delivery_pipeline(self,
    ...
    async def rollback_target(self,
    ...
    async def list_custom_target_types(self,
    ...
    async def get_custom_target_type(self,
    ...
    async def create_custom_target_type(self,
    ...
    async def update_custom_target_type(self,
    ...
    async def delete_custom_target_type(self,
    ...
    async def abandon_release(self,
    ...
    async def create_deploy_policy(self,
    ...
    async def update_deploy_policy(self,
    ...
    async def delete_deploy_policy(self,
    ...
    async def list_deploy_policies(self,
    ...
    async def get_deploy_policy(self,
    ...
    async def approve_rollout(self,
    ...
    async def terminate_job_run(self,
    ...
    async def delete_automation(self,
    ...
    async def get_automation_run(self,
    ...
    async def list_automation_runs(self,
    ...
    async def cancel_automation_run(self,

...
class ContainerAnalysisAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ContainerAnalysisClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = ContainerAnalysisClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, ContainerAnalysisTransport, Callable[..., ContainerAnalysisTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the container analysis async client.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.devtools.containeranalysis_v1.ContainerAnalysisAsyncClient`.",
                extra = {
    ...
    async def get_vulnerability_occurrences_summary(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_vulnerability_occurrences_summary]
    ...
    async def export_sbom(self,
        ...
        .. code-block:: python
            ...
            async def sample_export_sbom():
                ...
                # Make the request
                response = await client.export_sbom(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.devtools.containeranalysis_v1.types.ExportSBOMRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_sbom]
    ...
    async def __aenter__(self) -> "ContainerAnalysisAsyncClient":
        return self

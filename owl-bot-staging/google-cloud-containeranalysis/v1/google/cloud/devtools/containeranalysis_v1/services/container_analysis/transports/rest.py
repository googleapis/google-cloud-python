...
class ContainerAnalysisRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_export_sbom(self, request: containeranalysis.ExportSBOMRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[containeranalysis.ExportSBOMRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_sbom_with_metadata(self, response: containeranalysis.ExportSBOMResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[containeranalysis.ExportSBOMResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_sbom
    ...
    def pre_get_vulnerability_occurrences_summary(self, request: containeranalysis.GetVulnerabilityOccurrencesSummaryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[containeranalysis.GetVulnerabilityOccurrencesSummaryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_vulnerability_occurrences_summary(self, response: containeranalysis.VulnerabilityOccurrencesSummary) -> containeranalysis.VulnerabilityOccurrencesSummary:
    ...
    def post_get_vulnerability_occurrences_summary_with_metadata(self, response: containeranalysis.VulnerabilityOccurrencesSummary, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[containeranalysis.VulnerabilityOccurrencesSummary, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_vulnerability_occurrences_summary
...
class ContainerAnalysisRestTransport(_BaseContainerAnalysisRestTransport):
    ...
    class _ExportSBOM(_BaseContainerAnalysisRestTransport._BaseExportSBOM, ContainerAnalysisRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ContainerAnalysisRestTransport._ExportSBOM._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetIamPolicy(_BaseContainerAnalysisRestTransport._BaseGetIamPolicy, ContainerAnalysisRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.devtools.containeranalysis_v1.ContainerAnalysisClient.GetIamPolicy",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
            ...
            # Send the request
            response = ContainerAnalysisRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.devtools.containeranalysis_v1.ContainerAnalysisClient.get_iam_policy",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
                        "rpcName": "GetIamPolicy",
                        "metadata": http_response["headers"],
    ...
    class _GetVulnerabilityOccurrencesSummary(_BaseContainerAnalysisRestTransport._BaseGetVulnerabilityOccurrencesSummary, ContainerAnalysisRestStub):
        ...
        occurrences summary method over HTTP.
            ...
            transcoded_request = _BaseContainerAnalysisRestTransport._BaseGetVulnerabilityOccurrencesSummary._get_transcoded_request(http_options, request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.devtools.containeranalysis_v1.ContainerAnalysisClient.GetVulnerabilityOccurrencesSummary",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
                        "rpcName": "GetVulnerabilityOccurrencesSummary",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = ContainerAnalysisRestTransport._GetVulnerabilityOccurrencesSummary._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.devtools.containeranalysis_v1.ContainerAnalysisClient.get_vulnerability_occurrences_summary",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
                        "rpcName": "GetVulnerabilityOccurrencesSummary",
                        "metadata": http_response["headers"],
    ...
    class _SetIamPolicy(_BaseContainerAnalysisRestTransport._BaseSetIamPolicy, ContainerAnalysisRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.devtools.containeranalysis_v1.ContainerAnalysisClient.SetIamPolicy",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
            ...
            # Send the request
            response = ContainerAnalysisRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.devtools.containeranalysis_v1.ContainerAnalysisClient.set_iam_policy",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
                        "rpcName": "SetIamPolicy",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseContainerAnalysisRestTransport._BaseTestIamPermissions, ContainerAnalysisRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.devtools.containeranalysis_v1.ContainerAnalysisClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
            ...
            # Send the request
            response = ContainerAnalysisRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.devtools.containeranalysis_v1.ContainerAnalysisClient.test_iam_permissions",
                    extra = {
                        "serviceName": "google.devtools.containeranalysis.v1.ContainerAnalysis",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

...
class ContainerAnalysisClient(metaclass=ContainerAnalysisClientMeta):
    ...
    def transport(self) -> ContainerAnalysisTransport:
        ...
        Returns:
            ContainerAnalysisTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = ContainerAnalysisClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = ContainerAnalysisClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ContainerAnalysisClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ContainerAnalysisClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ContainerAnalysisTransport, Callable[..., ContainerAnalysisTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,ContainerAnalysisTransport,Callable[..., ContainerAnalysisTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ContainerAnalysisTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ContainerAnalysisClient._read_environment_variables()
        self._client_cert_source = ContainerAnalysisClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ContainerAnalysisClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ContainerAnalysisTransport)
        if transport_provided:
            ...
            self._transport = cast(ContainerAnalysisTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ContainerAnalysisClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ContainerAnalysisTransport], Callable[..., ContainerAnalysisTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.devtools.containeranalysis_v1.ContainerAnalysisClient`.",
                    extra = {
    ...
    def get_vulnerability_occurrences_summary(self,
            request: Optional[Union[containeranalysis.GetVulnerabilityOccurrencesSummaryRequest, dict]] = None,
            *,
    ...
    def export_sbom(self,
            request: Optional[Union[containeranalysis.ExportSBOMRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> containeranalysis.ExportSBOMResponse:
        r"""Generates an SBOM for the given resource.
        ...
        .. code-block:: python
            ...
            def sample_export_sbom():
                # Create a client
                client = containeranalysis_v1.ContainerAnalysisClient()

                # Initialize request argument(s)
                request = containeranalysis_v1.ExportSBOMRequest(
                    name="name_value",
                )

                # Make the request
                response = client.export_sbom(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.devtools.containeranalysis_v1.types.ExportSBOMRequest, dict]):
        ...
        Returns:
            google.cloud.devtools.containeranalysis_v1.types.ExportSBOMResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, containeranalysis.ExportSBOMRequest):
            request = containeranalysis.ExportSBOMRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_sbom]

...
def test_set_iam_policy_rest_unset_required_fields():
    transport = transports.ContainerAnalysisRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_vulnerability_occurrences_summary_rest_required_fields(request_type=containeranalysis.GetVulnerabilityOccurrencesSummaryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_vulnerability_occurrences_summary._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

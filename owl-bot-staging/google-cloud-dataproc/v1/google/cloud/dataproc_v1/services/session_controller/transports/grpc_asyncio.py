...
class SessionControllerGrpcAsyncIOTransport(SessionControllerTransport):
    ...
    def list_sessions(self) -> Callable[
            ...
            Awaitable[sessions.ListSessionsResponse]]:
    ...
    @property
    def terminate_session(self) -> Callable[
        ...
        if 'terminate_session' not in self._stubs:
            self._stubs['terminate_session'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.terminate_session: gapic_v1.method_async.wrap_method(

...
from .base import SessionControllerTransport, DEFAULT_CLIENT_INFO
...
class _BaseSessionControllerRestTransport(SessionControllerTransport):
    ...
    class _BaseCreateSession:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionControllerRestTransport._BaseCreateSession._get_unset_required_fields(query_params))
    ...
    class _BaseDeleteSession:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionControllerRestTransport._BaseDeleteSession._get_unset_required_fields(query_params))
    ...
    class _BaseGetSession:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionControllerRestTransport._BaseGetSession._get_unset_required_fields(query_params))
    ...
    class _BaseListSessions:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionControllerRestTransport._BaseListSessions._get_unset_required_fields(query_params))
    ...
    class _BaseTerminateSession:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionControllerRestTransport._BaseTerminateSession._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseSessionControllerRestTransport',
)

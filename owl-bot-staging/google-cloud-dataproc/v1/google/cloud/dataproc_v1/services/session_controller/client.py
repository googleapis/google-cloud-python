...
class SessionControllerClient(metaclass=SessionControllerClientMeta):
    ...
    @staticmethod
    def session_path(project: str,location: str,session: str,) -> str:
    ...
    @staticmethod
    def session_template_path(project: str,location: str,template: str,) -> str:
        """Returns a fully-qualified session_template string."""
        return "projects/{project}/locations/{location}/sessionTemplates/{template}".format(project=project, location=location, template=template, )

    @staticmethod
    def parse_session_template_path(path: str) -> Dict[str,str]:
        """Parses a session_template path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sessionTemplates/(?P<template>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SessionControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _compare_universes(client_universe: str,
        ...
        if credentials:
            ...
            if client_universe != credentials_universe:
                default_universe = SessionControllerClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SessionControllerClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SessionControllerTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, SessionControllerTransport]): The
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SessionControllerClient._read_environment_variables()
        self._client_cert_source = SessionControllerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SessionControllerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = (self._api_endpoint or
            SessionControllerClient._get_api_endpoint(
    ...
    def create_session(self,
        ...
        # in a sessions.CreateSessionRequest.
    ...
    def get_session(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a sessions.GetSessionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_sessions(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a sessions.ListSessionsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def terminate_session(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a sessions.TerminateSessionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_session(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a sessions.DeleteSessionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

...
class SessionControllerClient(metaclass=SessionControllerClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SessionControllerTransport, Callable[..., SessionControllerTransport]]] = None,
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SessionControllerTransport], Callable[..., SessionControllerTransport]] = (

...
class ClusterControllerAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ClusterControllerTransport, Callable[..., ClusterControllerTransport]]] = "grpc_asyncio",
    ...
    async def stop_cluster(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_cluster]
    ...
    async def start_cluster(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.start_cluster]
    ...
    async def diagnose_cluster(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.diagnose_cluster]

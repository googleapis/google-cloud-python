...
from .base import ClusterControllerTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ClusterControllerRestTransport(ClusterControllerTransport):
    """REST backend transport for ClusterController.
    ...
    class _CreateCluster(ClusterControllerRestStub):
        def __hash__(self):
    ...
    class _DeleteCluster(ClusterControllerRestStub):
        def __hash__(self):
    ...
    class _DiagnoseCluster(ClusterControllerRestStub):
        def __hash__(self):
    ...
    class _GetCluster(ClusterControllerRestStub):
        def __hash__(self):
    ...
    class _ListClusters(ClusterControllerRestStub):
        def __hash__(self):
    ...
    class _StartCluster(ClusterControllerRestStub):
        def __hash__(self):
    ...
    class _StopCluster(ClusterControllerRestStub):
        def __hash__(self):
    ...
    class _UpdateCluster(ClusterControllerRestStub):
        def __hash__(self):
            ...
            },
{
    ...
    class _SetIamPolicy(ClusterControllerRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _TestIamPermissions(ClusterControllerRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _CancelOperation(ClusterControllerRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _DeleteOperation(ClusterControllerRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetOperation(ClusterControllerRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(ClusterControllerRestStub):
        def __call__(self,

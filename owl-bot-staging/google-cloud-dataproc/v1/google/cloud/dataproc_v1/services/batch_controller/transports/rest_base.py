...
class _BaseBatchControllerRestTransport(BatchControllerTransport):
    ...
    class _BaseCreateBatch:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseBatchControllerRestTransport._BaseCreateBatch._get_unset_required_fields(query_params))
    ...
    class _BaseDeleteBatch:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseBatchControllerRestTransport._BaseDeleteBatch._get_unset_required_fields(query_params))
    ...
    class _BaseGetBatch:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseBatchControllerRestTransport._BaseGetBatch._get_unset_required_fields(query_params))
    ...
    class _BaseListBatches:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseBatchControllerRestTransport._BaseListBatches._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseBatchControllerRestTransport',
)

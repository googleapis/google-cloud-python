...
class BatchControllerAsyncClient:
    ...
    common_billing_account_path = staticmethod(BatchControllerClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(BatchControllerClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(BatchControllerClient.common_folder_path)
    parse_common_folder_path = staticmethod(BatchControllerClient.parse_common_folder_path)
    common_organization_path = staticmethod(BatchControllerClient.common_organization_path)
    parse_common_organization_path = staticmethod(BatchControllerClient.parse_common_organization_path)
    common_project_path = staticmethod(BatchControllerClient.common_project_path)
    parse_common_project_path = staticmethod(BatchControllerClient.parse_common_project_path)
    common_location_path = staticmethod(BatchControllerClient.common_location_path)
    parse_common_location_path = staticmethod(BatchControllerClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(BatchControllerClient).get_transport_class, type(BatchControllerClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, BatchControllerTransport, Callable[..., BatchControllerTransport]]] = "grpc_asyncio",
    ...
    async def create_batch(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_batch]
    ...
    async def get_batch(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_batch]
    ...
    async def list_batches(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_batches]
    ...
    async def delete_batch(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_batch]

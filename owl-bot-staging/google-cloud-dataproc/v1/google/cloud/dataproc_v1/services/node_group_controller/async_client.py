...
class NodeGroupControllerAsyncClient:
    ...
    parse_node_group_path = staticmethod(NodeGroupControllerClient.parse_node_group_path)
    common_billing_account_path = staticmethod(NodeGroupControllerClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(NodeGroupControllerClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(NodeGroupControllerClient.common_folder_path)
    parse_common_folder_path = staticmethod(NodeGroupControllerClient.parse_common_folder_path)
    common_organization_path = staticmethod(NodeGroupControllerClient.common_organization_path)
    parse_common_organization_path = staticmethod(NodeGroupControllerClient.parse_common_organization_path)
    common_project_path = staticmethod(NodeGroupControllerClient.common_project_path)
    parse_common_project_path = staticmethod(NodeGroupControllerClient.parse_common_project_path)
    common_location_path = staticmethod(NodeGroupControllerClient.common_location_path)
    parse_common_location_path = staticmethod(NodeGroupControllerClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(NodeGroupControllerClient).get_transport_class, type(NodeGroupControllerClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, NodeGroupControllerTransport, Callable[..., NodeGroupControllerTransport]]] = "grpc_asyncio",
    ...
    async def create_node_group(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_node_group]
    ...
    async def resize_node_group(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.resize_node_group]
    ...
    async def get_node_group(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_node_group]

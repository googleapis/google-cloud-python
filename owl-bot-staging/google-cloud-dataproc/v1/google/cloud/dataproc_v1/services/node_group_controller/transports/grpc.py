...
from .base import NodeGroupControllerTransport, DEFAULT_CLIENT_INFO
...
class NodeGroupControllerGrpcTransport(NodeGroupControllerTransport):
    ...
    def create_node_group(self) -> Callable[
        ...
        if 'create_node_group' not in self._stubs:
            self._stubs['create_node_group'] = self.grpc_channel.unary_unary(
    ...
    def resize_node_group(self) -> Callable[
        ...
        if 'resize_node_group' not in self._stubs:
            self._stubs['resize_node_group'] = self.grpc_channel.unary_unary(
    ...
    def get_node_group(self) -> Callable[
        ...
        if 'get_node_group' not in self._stubs:
            self._stubs['get_node_group'] = self.grpc_channel.unary_unary(

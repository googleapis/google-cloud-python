...
class _BaseWorkflowTemplateServiceRestTransport(WorkflowTemplateServiceTransport):
    ...
    class _BaseInstantiateInlineWorkflowTemplate:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseWorkflowTemplateServiceRestTransport._BaseInstantiateInlineWorkflowTemplate._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseWorkflowTemplateServiceRestTransport',
)

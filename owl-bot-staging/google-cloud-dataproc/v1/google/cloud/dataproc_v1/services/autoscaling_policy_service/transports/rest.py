...
class AutoscalingPolicyServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_autoscaling_policy(self, request: autoscaling_policies.CreateAutoscalingPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[autoscaling_policies.CreateAutoscalingPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_autoscaling_policy(self, request: autoscaling_policies.DeleteAutoscalingPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[autoscaling_policies.DeleteAutoscalingPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_autoscaling_policy(self, request: autoscaling_policies.GetAutoscalingPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[autoscaling_policies.GetAutoscalingPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_autoscaling_policies(self, request: autoscaling_policies.ListAutoscalingPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[autoscaling_policies.ListAutoscalingPoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_autoscaling_policy(self, request: autoscaling_policies.UpdateAutoscalingPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[autoscaling_policies.UpdateAutoscalingPolicyRequest, Sequence[Tuple[str, str]]]:

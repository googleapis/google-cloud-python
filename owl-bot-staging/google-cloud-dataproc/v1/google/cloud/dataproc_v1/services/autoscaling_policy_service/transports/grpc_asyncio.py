...
class AutoscalingPolicyServiceGrpcAsyncIOTransport(AutoscalingPolicyServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_autoscaling_policy: gapic_v1.method_async.wrap_method(
                self.create_autoscaling_policy,
                default_timeout=600.0,
                client_info=client_info,
            ),
            self.update_autoscaling_policy: gapic_v1.method_async.wrap_method(
            ...
            self.get_autoscaling_policy: gapic_v1.method_async.wrap_method(
            ...
            self.list_autoscaling_policies: gapic_v1.method_async.wrap_method(
            ...
            self.delete_autoscaling_policy: gapic_v1.method_async.wrap_method(

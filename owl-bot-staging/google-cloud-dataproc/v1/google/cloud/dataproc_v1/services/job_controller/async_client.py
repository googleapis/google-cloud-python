...
class JobControllerAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, JobControllerTransport, Callable[..., JobControllerTransport]]] = "grpc_asyncio",
    ...
    async def submit_job(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.submit_job]
    ...
    async def submit_job_as_operation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.submit_job_as_operation]

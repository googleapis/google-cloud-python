...
class JobControllerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_cancel_job(self, request: jobs.CancelJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.CancelJobRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_job(self, request: jobs.DeleteJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.DeleteJobRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_submit_job(self, request: jobs.SubmitJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.SubmitJobRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_submit_job_as_operation(self, request: jobs.SubmitJobRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[jobs.SubmitJobRequest, Sequence[Tuple[str, str]]]:

...
class SessionTemplateControllerAsyncClient:
    ...
    get_transport_class = functools.partial(type(SessionTemplateControllerClient).get_transport_class, type(SessionTemplateControllerClient))
    ...
    async def create_session_template(self,
    ...
    async def update_session_template(self,
    ...
    async def get_session_template(self,
    ...
    async def list_session_templates(self,
    ...
    async def delete_session_template(self,

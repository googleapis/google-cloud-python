...
class ListSessionTemplatesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[session_templates.ListSessionTemplatesResponse]],
            request: session_templates.ListSessionTemplatesRequest,
            response: session_templates.ListSessionTemplatesResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[session_templates.ListSessionTemplatesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

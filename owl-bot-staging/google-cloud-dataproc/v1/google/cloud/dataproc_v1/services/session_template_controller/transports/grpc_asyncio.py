...
class SessionTemplateControllerGrpcAsyncIOTransport(SessionTemplateControllerTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_session_template: gapic_v1.method_async.wrap_method(
                self.create_session_template,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_session_template: gapic_v1.method_async.wrap_method(
                self.update_session_template,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_session_template: gapic_v1.method_async.wrap_method(
                self.get_session_template,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_session_templates: gapic_v1.method_async.wrap_method(
                self.list_session_templates,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_session_template: gapic_v1.method_async.wrap_method(

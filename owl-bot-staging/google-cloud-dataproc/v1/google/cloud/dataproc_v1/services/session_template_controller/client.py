...
from .transports.base import SessionTemplateControllerTransport, DEFAULT_CLIENT_INFO
...
class SessionTemplateControllerClient(metaclass=SessionTemplateControllerClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SessionTemplateControllerClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._client_cert_source = SessionTemplateControllerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
    ...
    def update_session_template(self,
    ...
    def list_session_templates(self,
    ...
    def delete_session_template(self,

...
def test_create_cluster_rest_unset_required_fields():
    transport = transports.ClusterControllerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_stop_cluster_rest_required_fields(request_type=clusters.StopClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).stop_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_cluster_rest_required_fields(request_type=clusters.StartClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).start_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_diagnose_cluster_rest_required_fields(request_type=clusters.DiagnoseClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).diagnose_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

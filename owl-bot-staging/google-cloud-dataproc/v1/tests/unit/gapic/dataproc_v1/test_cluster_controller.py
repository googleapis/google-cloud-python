...
from google.cloud.dataproc_v1.services.cluster_controller import ClusterControllerAsyncClient
...
def test__read_environment_variables():
    assert ClusterControllerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ClusterControllerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ClusterControllerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ClusterControllerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ClusterControllerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ClusterControllerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ClusterControllerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ClusterControllerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ClusterControllerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ClusterControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClusterControllerClient))
@mock.patch.object(ClusterControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClusterControllerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ClusterControllerClient._DEFAULT_UNIVERSE
    default_endpoint = ClusterControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ClusterControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ClusterControllerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ClusterControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ClusterControllerClient.DEFAULT_MTLS_ENDPOINT
    assert ClusterControllerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ClusterControllerClient._get_api_endpoint(None, None, default_universe, "always") == ClusterControllerClient.DEFAULT_MTLS_ENDPOINT
    assert ClusterControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ClusterControllerClient.DEFAULT_MTLS_ENDPOINT
    assert ClusterControllerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ClusterControllerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ClusterControllerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ClusterControllerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ClusterControllerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ClusterControllerClient._get_universe_domain(None, None) == ClusterControllerClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ClusterControllerAsyncClient, transports.ClusterControllerGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ClusterControllerClient, transports.ClusterControllerGrpcTransport, "grpc", "true"),
    (ClusterControllerAsyncClient, transports.ClusterControllerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ClusterControllerClient, transports.ClusterControllerGrpcTransport, "grpc", "false"),
    (ClusterControllerAsyncClient, transports.ClusterControllerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (ClusterControllerClient, transports.ClusterControllerRestTransport, "rest", "true"),
    (ClusterControllerClient, transports.ClusterControllerRestTransport, "rest", "false"),
])
@mock.patch.object(ClusterControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClusterControllerClient))
@mock.patch.object(ClusterControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClusterControllerAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ClusterControllerClient, transports.ClusterControllerGrpcTransport, "grpc", grpc_helpers),
    (ClusterControllerAsyncClient, transports.ClusterControllerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ClusterControllerClient, transports.ClusterControllerRestTransport, "rest", None),
])
...
def test_stop_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_stop_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ClusterControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.stop_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stop_cluster] = mock_rpc
...
def test_start_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.start_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_start_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ClusterControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_cluster] = mock_rpc
...
def test_list_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, clusters.Cluster)
                   for i in results)
...
def test_diagnose_cluster(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.diagnose_cluster),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_diagnose_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.diagnose_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_diagnose_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ClusterControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.diagnose_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.diagnose_cluster] = mock_rpc
...
def test_create_cluster_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = clusters.CreateClusterRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_cluster_empty_call_grpc():
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.stop_cluster(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = clusters.StopClusterRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_start_cluster_empty_call_grpc():
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.start_cluster(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = clusters.StartClusterRequest()
...
def test_delete_cluster_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = clusters.DeleteClusterRequest()
...
def test_get_cluster_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = clusters.GetClusterRequest()
...
def test_list_clusters_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = clusters.ListClustersRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_cluster_empty_call_grpc():
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.diagnose_cluster(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = clusters.DiagnoseClusterRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ClusterControllerAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_stop_cluster_empty_call_grpc_asyncio():
    client = ClusterControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.stop_cluster(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_start_cluster_empty_call_grpc_asyncio():
    client = ClusterControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.start_cluster(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_diagnose_cluster_empty_call_grpc_asyncio():
    client = ClusterControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.diagnose_cluster(request=None)
...
def test_transport_kind_rest():
    transport = ClusterControllerClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_cluster_rest_bad_request(request_type=clusters.CreateClusterRequest):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_cluster_rest_interceptors(null_interceptor):
    transport = transports.ClusterControllerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ClusterControllerRestInterceptor(),
        )
    client = ClusterControllerClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_create_cluster") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_create_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_create_cluster") as pre:
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_update_cluster") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_update_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_update_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_cluster_rest_call_success(request_type):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_stop_cluster") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_stop_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_stop_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_start_cluster_rest_call_success(request_type):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_start_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_start_cluster") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_start_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_start_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_delete_cluster") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_delete_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_delete_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_get_cluster") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_get_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_get_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = clusters.Cluster.to_json(clusters.Cluster())
        req.return_value.content = return_value
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_list_clusters") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_list_clusters_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_list_clusters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = clusters.ListClustersResponse.to_json(clusters.ListClustersResponse())
        req.return_value.content = return_value
...
def test_diagnose_cluster_rest_bad_request(request_type=clusters.DiagnoseClusterRequest):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_diagnose_cluster_rest_call_success(request_type):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_diagnose_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_diagnose_cluster") as post, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "post_diagnose_cluster_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ClusterControllerRestInterceptor, "pre_diagnose_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_cluster_empty_call_rest():
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_start_cluster_empty_call_rest():
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_cluster_empty_call_rest():
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_cluster_controller_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_crypto_key_path():
    ...
    actual = ClusterControllerClient.crypto_key_path(project, location, key_ring, crypto_key)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (ClusterControllerAsyncClient, transports.ClusterControllerGrpcAsyncIOTransport),
])

...
from google.cloud.dataproc_v1.services.batch_controller import BatchControllerAsyncClient
...
def test__read_environment_variables():
    assert BatchControllerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BatchControllerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert BatchControllerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert BatchControllerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert BatchControllerClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert BatchControllerClient._get_client_cert_source(None, False) is None
    assert BatchControllerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert BatchControllerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert BatchControllerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert BatchControllerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(BatchControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchControllerClient))
@mock.patch.object(BatchControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchControllerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BatchControllerClient._DEFAULT_UNIVERSE
    default_endpoint = BatchControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = BatchControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert BatchControllerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert BatchControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == BatchControllerClient.DEFAULT_MTLS_ENDPOINT
    assert BatchControllerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert BatchControllerClient._get_api_endpoint(None, None, default_universe, "always") == BatchControllerClient.DEFAULT_MTLS_ENDPOINT
    assert BatchControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == BatchControllerClient.DEFAULT_MTLS_ENDPOINT
    assert BatchControllerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert BatchControllerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        BatchControllerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert BatchControllerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert BatchControllerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert BatchControllerClient._get_universe_domain(None, None) == BatchControllerClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        BatchControllerClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = BatchControllerClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (BatchControllerClient, transports.BatchControllerGrpcTransport, "grpc", "true"),
    (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (BatchControllerClient, transports.BatchControllerGrpcTransport, "grpc", "false"),
    (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (BatchControllerClient, transports.BatchControllerRestTransport, "rest", "true"),
    (BatchControllerClient, transports.BatchControllerRestTransport, "rest", "false"),
])
@mock.patch.object(BatchControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchControllerClient))
@mock.patch.object(BatchControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchControllerAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    BatchControllerClient, BatchControllerAsyncClient
])
...
@mock.patch.object(BatchControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchControllerClient))
@mock.patch.object(BatchControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BatchControllerAsyncClient))
def test_batch_controller_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (BatchControllerClient, transports.BatchControllerGrpcTransport, "grpc", grpc_helpers),
    (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_batch(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_batch),
            '__call__') as call:
...
def test_create_batch_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_batch in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_batch] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_batch_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_batch in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_batch] = mock_rpc
...
def test_get_batch(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_batch),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_batch_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_batch in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_batch] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_batch_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_batch in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_batch] = mock_rpc
...
def test_list_batches(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_batches),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_batches_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_batches in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_batches] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_batches_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_batches in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_batches] = mock_rpc
...
def test_list_batches_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_batches(request={}, retry=retry, timeout=timeout)
...
def test_delete_batch(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_batch),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_batch_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_batch in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_batch] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_batch_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = BatchControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_batch in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_batch] = mock_rpc
...
def test_create_batch_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchControllerClient(
...
def test_get_batch_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchControllerClient(
...
def test_delete_batch_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = BatchControllerClient(
...
def test_create_batch_empty_call_grpc():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_batch(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_batch_empty_call_grpc():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_batches_empty_call_grpc():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = batches.ListBatchesResponse()
        client.list_batches(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_batch_empty_call_grpc():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_batch(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = BatchControllerAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_batch_empty_call_grpc_asyncio():
    client = BatchControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_batch(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_batch_empty_call_grpc_asyncio():
    client = BatchControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_batch(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_batches_empty_call_grpc_asyncio():
    client = BatchControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_batches(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_batch_empty_call_grpc_asyncio():
    client = BatchControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_batch(request=None)
...
def test_transport_kind_rest():
    transport = BatchControllerClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_batch_rest_bad_request(request_type=batches.CreateBatchRequest):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_batch_rest_call_success(request_type):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_batch_rest_interceptors(null_interceptor):
    transport = transports.BatchControllerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BatchControllerRestInterceptor(),
        )
    client = BatchControllerClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.BatchControllerRestInterceptor, "post_create_batch") as post, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "post_create_batch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "pre_create_batch") as pre:
...
def test_get_batch_rest_bad_request(request_type=batches.GetBatchRequest):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_batch_rest_call_success(request_type):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_batch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "post_get_batch") as post, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "post_get_batch_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "pre_get_batch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = batches.Batch.to_json(batches.Batch())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = batches.Batch(), metadata
...
def test_list_batches_rest_bad_request(request_type=batches.ListBatchesRequest):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_batches_rest_call_success(request_type):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_batches_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "post_list_batches") as post, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "post_list_batches_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "pre_list_batches") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = batches.ListBatchesResponse.to_json(batches.ListBatchesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = batches.ListBatchesResponse(), metadata
...
def test_delete_batch_rest_bad_request(request_type=batches.DeleteBatchRequest):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_batch_rest_call_success(request_type):
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_batch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.BatchControllerRestInterceptor, "pre_delete_batch") as pre:
        pre.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_batch_empty_call_rest():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_batch_empty_call_rest():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_batches_empty_call_rest():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_batch_empty_call_rest():
    client = BatchControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

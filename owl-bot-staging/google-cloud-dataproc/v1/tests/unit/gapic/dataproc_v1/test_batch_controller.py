...
def test_create_batch_rest_required_fields(request_type=batches.CreateBatchRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_batch._get_unset_required_fields(jsonified_request)
...
def test_create_batch_rest_unset_required_fields():
    transport = transports.BatchControllerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_batch_rest_required_fields(request_type=batches.GetBatchRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_batch._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_batches_rest_required_fields(request_type=batches.ListBatchesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_batches._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_batch_rest_required_fields(request_type=batches.DeleteBatchRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_batch._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

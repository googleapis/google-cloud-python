...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert JobControllerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert JobControllerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert JobControllerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert JobControllerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert JobControllerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert JobControllerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert JobControllerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(JobControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(JobControllerClient))
@mock.patch.object(JobControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(JobControllerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = JobControllerClient._DEFAULT_UNIVERSE
    default_endpoint = JobControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = JobControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert JobControllerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert JobControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == JobControllerClient.DEFAULT_MTLS_ENDPOINT
    assert JobControllerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert JobControllerClient._get_api_endpoint(None, None, default_universe, "always") == JobControllerClient.DEFAULT_MTLS_ENDPOINT
    assert JobControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == JobControllerClient.DEFAULT_MTLS_ENDPOINT
    assert JobControllerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert JobControllerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        JobControllerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert JobControllerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert JobControllerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert JobControllerClient._get_universe_domain(None, None) == JobControllerClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = JobControllerClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (JobControllerClient, transports.JobControllerGrpcTransport, "grpc", grpc_helpers),
    (JobControllerAsyncClient, transports.JobControllerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
async def test_submit_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.submit_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.submit_job] = mock_rpc
...
def test_submit_job_as_operation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.submit_job_as_operation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.submit_job_as_operation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_submit_job_as_operation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = JobControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.submit_job_as_operation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.submit_job_as_operation] = mock_rpc
...
def test_submit_job_empty_call_grpc():
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = jobs.Job()
        client.submit_job(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = jobs.SubmitJobRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_submit_job_as_operation_empty_call_grpc():
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.submit_job_as_operation(request=None)
...
def test_cancel_job_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = jobs.CancelJobRequest()
...
def test_delete_job_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = jobs.DeleteJobRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = JobControllerAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_submit_job_empty_call_grpc_asyncio():
    client = JobControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.submit_job(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_submit_job_as_operation_empty_call_grpc_asyncio():
    client = JobControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.submit_job_as_operation(request=None)
...
def test_transport_kind_rest():
    transport = JobControllerClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_submit_job_rest_bad_request(request_type=jobs.SubmitJobRequest):
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_submit_job_rest_call_success(request_type):
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_submit_job_rest_interceptors(null_interceptor):
    transport = transports.JobControllerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.JobControllerRestInterceptor(),
        )
    client = JobControllerClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_submit_job") as post, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_submit_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobControllerRestInterceptor, "pre_submit_job") as pre:
...
def test_submit_job_as_operation_rest_bad_request(request_type=jobs.SubmitJobRequest):
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_submit_job_as_operation_rest_call_success(request_type):
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_submit_job_as_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.JobControllerRestInterceptor, "post_submit_job_as_operation") as post, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_submit_job_as_operation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobControllerRestInterceptor, "pre_submit_job_as_operation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = jobs.SubmitJobRequest.pb(jobs.SubmitJobRequest())
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_get_job") as post, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_get_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobControllerRestInterceptor, "pre_get_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_list_jobs") as post, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_list_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobControllerRestInterceptor, "pre_list_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = jobs.ListJobsResponse.to_json(jobs.ListJobsResponse())
        req.return_value.content = return_value
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_update_job") as post, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_update_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobControllerRestInterceptor, "pre_update_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_cancel_job_rest_bad_request(request_type=jobs.CancelJobRequest):
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_cancel_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_cancel_job") as post, \
        mock.patch.object(transports.JobControllerRestInterceptor, "post_cancel_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.JobControllerRestInterceptor, "pre_cancel_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_job_rest_bad_request(request_type=jobs.DeleteJobRequest):
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.JobControllerRestInterceptor, "pre_delete_job") as pre:
        pre.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_submit_job_empty_call_rest():
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_submit_job_as_operation_empty_call_rest():
    client = JobControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

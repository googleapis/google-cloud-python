...
def test_submit_job_rest_required_fields(request_type=jobs.SubmitJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).submit_job._get_unset_required_fields(jsonified_request)
...
def test_submit_job_rest_unset_required_fields():
    transport = transports.JobControllerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_submit_job_as_operation_rest_required_fields(request_type=jobs.SubmitJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).submit_job_as_operation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_jobs_rest_required_fields(request_type=jobs.ListJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_job_rest_required_fields(request_type=jobs.UpdateJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_job_rest_required_fields(request_type=jobs.CancelJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).cancel_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_job_rest_required_fields(request_type=jobs.DeleteJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

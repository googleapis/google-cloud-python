...
def test_create_workflow_template_rest_required_fields(request_type=workflow_templates.CreateWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_workflow_template._get_unset_required_fields(jsonified_request)
...
def test_create_workflow_template_rest_unset_required_fields():
    transport = transports.WorkflowTemplateServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_workflow_template_rest_required_fields(request_type=workflow_templates.GetWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_workflow_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_instantiate_workflow_template_rest_required_fields(request_type=workflow_templates.InstantiateWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).instantiate_workflow_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_instantiate_inline_workflow_template_rest_required_fields(request_type=workflow_templates.InstantiateInlineWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).instantiate_inline_workflow_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_workflow_template_rest_required_fields(request_type=workflow_templates.UpdateWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_workflow_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_workflow_templates_rest_required_fields(request_type=workflow_templates.ListWorkflowTemplatesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_workflow_templates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_workflow_template_rest_required_fields(request_type=workflow_templates.DeleteWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_workflow_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

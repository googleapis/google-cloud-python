...
from google.cloud.dataproc_v1.services.workflow_template_service import WorkflowTemplateServiceAsyncClient
...
def test__read_environment_variables():
    assert WorkflowTemplateServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert WorkflowTemplateServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert WorkflowTemplateServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert WorkflowTemplateServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert WorkflowTemplateServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert WorkflowTemplateServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert WorkflowTemplateServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert WorkflowTemplateServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert WorkflowTemplateServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(WorkflowTemplateServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkflowTemplateServiceClient))
@mock.patch.object(WorkflowTemplateServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkflowTemplateServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WorkflowTemplateServiceClient._DEFAULT_UNIVERSE
    default_endpoint = WorkflowTemplateServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = WorkflowTemplateServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert WorkflowTemplateServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert WorkflowTemplateServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == WorkflowTemplateServiceClient.DEFAULT_MTLS_ENDPOINT
    assert WorkflowTemplateServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert WorkflowTemplateServiceClient._get_api_endpoint(None, None, default_universe, "always") == WorkflowTemplateServiceClient.DEFAULT_MTLS_ENDPOINT
    assert WorkflowTemplateServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == WorkflowTemplateServiceClient.DEFAULT_MTLS_ENDPOINT
    assert WorkflowTemplateServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert WorkflowTemplateServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        WorkflowTemplateServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert WorkflowTemplateServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert WorkflowTemplateServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert WorkflowTemplateServiceClient._get_universe_domain(None, None) == WorkflowTemplateServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = WorkflowTemplateServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceRestTransport, "rest"),
])
@mock.patch.object(WorkflowTemplateServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkflowTemplateServiceClient))
@mock.patch.object(WorkflowTemplateServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkflowTemplateServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceRestTransport, "rest", "true"),
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceRestTransport, "rest", "false"),
])
@mock.patch.object(WorkflowTemplateServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkflowTemplateServiceClient))
@mock.patch.object(WorkflowTemplateServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkflowTemplateServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceGrpcTransport, "grpc", grpc_helpers),
    (WorkflowTemplateServiceAsyncClient, transports.WorkflowTemplateServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceRestTransport, "rest", None),
])
...
def test_create_workflow_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_workflow_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_workflow_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_workflow_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_workflow_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_workflow_template] = mock_rpc
...
def test_get_workflow_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_workflow_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_workflow_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_workflow_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkflowTemplateServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_workflow_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_workflow_template] = mock_rpc
...
def test_instantiate_workflow_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.instantiate_workflow_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.instantiate_workflow_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_instantiate_workflow_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkflowTemplateServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.instantiate_workflow_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.instantiate_workflow_template] = mock_rpc
...
def test_instantiate_inline_workflow_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.instantiate_inline_workflow_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.instantiate_inline_workflow_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_instantiate_inline_workflow_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkflowTemplateServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.instantiate_inline_workflow_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.instantiate_inline_workflow_template] = mock_rpc
...
def test_update_workflow_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_workflow_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_workflow_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_workflow_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkflowTemplateServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_workflow_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_workflow_template] = mock_rpc
...
def test_list_workflow_templates_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_workflow_templates in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_workflow_templates] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_workflow_templates_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkflowTemplateServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_workflow_templates in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_workflow_templates] = mock_rpc
...
def test_delete_workflow_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_workflow_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_workflow_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_workflow_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = WorkflowTemplateServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_workflow_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_workflow_template] = mock_rpc
...
def test_create_workflow_template_empty_call_grpc():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workflow_templates.WorkflowTemplate()
        client.create_workflow_template(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_workflow_template_empty_call_grpc():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workflow_templates.WorkflowTemplate()
        client.get_workflow_template(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_instantiate_workflow_template_empty_call_grpc():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.instantiate_workflow_template(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_instantiate_inline_workflow_template_empty_call_grpc():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.instantiate_inline_workflow_template(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_workflow_template_empty_call_grpc():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workflow_templates.WorkflowTemplate()
        client.update_workflow_template(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_workflow_templates_empty_call_grpc():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = workflow_templates.ListWorkflowTemplatesResponse()
        client.list_workflow_templates(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_workflow_template_empty_call_grpc():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.delete_workflow_template(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = WorkflowTemplateServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_workflow_template_empty_call_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_workflow_template(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_workflow_template_empty_call_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_workflow_template(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_instantiate_workflow_template_empty_call_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.instantiate_workflow_template(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_instantiate_inline_workflow_template_empty_call_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.instantiate_inline_workflow_template(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_workflow_template_empty_call_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_workflow_template(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_workflow_templates_empty_call_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_workflow_templates(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_workflow_template_empty_call_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_workflow_template(request=None)
...
def test_transport_kind_rest():
    transport = WorkflowTemplateServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_workflow_template_rest_bad_request(request_type=workflow_templates.CreateWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_workflow_template_rest_call_success(request_type):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_workflow_template_rest_interceptors(null_interceptor):
    transport = transports.WorkflowTemplateServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.WorkflowTemplateServiceRestInterceptor(),
        )
    client = WorkflowTemplateServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_create_workflow_template") as post, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_create_workflow_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_create_workflow_template") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = workflow_templates.WorkflowTemplate.to_json(workflow_templates.WorkflowTemplate())
        ...
        post_with_metadata.return_value = workflow_templates.WorkflowTemplate(), metadata
...
def test_get_workflow_template_rest_bad_request(request_type=workflow_templates.GetWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_workflow_template_rest_call_success(request_type):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_get_workflow_template") as post, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_get_workflow_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_get_workflow_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_instantiate_workflow_template_rest_bad_request(request_type=workflow_templates.InstantiateWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_instantiate_workflow_template_rest_call_success(request_type):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_instantiate_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_workflow_template") as post, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_workflow_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_instantiate_workflow_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_instantiate_inline_workflow_template_rest_bad_request(request_type=workflow_templates.InstantiateInlineWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_instantiate_inline_workflow_template_rest_call_success(request_type):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_instantiate_inline_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_inline_workflow_template") as post, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_inline_workflow_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_instantiate_inline_workflow_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_workflow_template_rest_bad_request(request_type=workflow_templates.UpdateWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_workflow_template_rest_call_success(request_type):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'template': {'name': 'projects/sample1/locations/sample2/workflowTemplates/sample3'}}
    request_init["template"] = {'id': 'id_value', 'name': 'projects/sample1/locations/sample2/workflowTemplates/sample3', 'version': 774, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'placement': {'managed_cluster': {'cluster_name': 'cluster_name_value', 'config': {'cluster_tier': 1, 'config_bucket': 'config_bucket_value', 'temp_bucket': 'temp_bucket_value', 'gce_cluster_config': {'zone_uri': 'zone_uri_value', 'network_uri': 'network_uri_value', 'subnetwork_uri': 'subnetwork_uri_value', 'internal_ip_only': True, 'private_ipv6_google_access': 1, 'service_account': 'service_account_value', 'service_account_scopes': ['service_account_scopes_value1', 'service_account_scopes_value2'], 'tags': ['tags_value1', 'tags_value2'], 'metadata': {}, 'reservation_affinity': {'consume_reservation_type': 1, 'key': 'key_value', 'values': ['values_value1', 'values_value2']}, 'node_group_affinity': {'node_group_uri': 'node_group_uri_value'}, 'shielded_instance_config': {'enable_secure_boot': True, 'enable_vtpm': True, 'enable_integrity_monitoring': True}, 'confidential_instance_config': {'enable_confidential_compute': True}}, 'master_config': {'num_instances': 1399, 'instance_names': ['instance_names_value1', 'instance_names_value2'], 'instance_references': [{'instance_name': 'instance_name_value', 'instance_id': 'instance_id_value', 'public_key': 'public_key_value', 'public_ecies_key': 'public_ecies_key_value'}], 'image_uri': 'image_uri_value', 'machine_type_uri': 'machine_type_uri_value', 'disk_config': {'boot_disk_type': 'boot_disk_type_value', 'boot_disk_size_gb': 1792, 'num_local_ssds': 1494, 'local_ssd_interface': 'local_ssd_interface_value', 'boot_disk_provisioned_iops': 2793, 'boot_disk_provisioned_throughput': 3464}, 'is_preemptible': True, 'preemptibility': 1, 'managed_group_config': {'instance_template_name': 'instance_template_name_value', 'instance_group_manager_name': 'instance_group_manager_name_value', 'instance_group_manager_uri': 'instance_group_manager_uri_value'}, 'accelerators': [{'accelerator_type_uri': 'accelerator_type_uri_value', 'accelerator_count': 1805}], 'min_cpu_platform': 'min_cpu_platform_value', 'min_num_instances': 1818, 'instance_flexibility_policy': {'provisioning_model_mix': {'standard_capacity_base': 2296, 'standard_capacity_percent_above_base': 3764}, 'instance_selection_list': [{'machine_types': ['machine_types_value1', 'machine_types_value2'], 'rank': 428}], 'instance_selection_results': [{'machine_type': 'machine_type_value', 'vm_count': 875}]}, 'startup_config': {'required_registration_fraction': 0.3216}}, 'worker_config': {}, 'secondary_worker_config': {}, 'software_config': {'image_version': 'image_version_value', 'properties': {}, 'optional_components': [5]}, 'initialization_actions': [{'executable_file': 'executable_file_value', 'execution_timeout': {'seconds': 751, 'nanos': 543}}], 'encryption_config': {'gce_pd_kms_key_name': 'gce_pd_kms_key_name_value', 'kms_key': 'kms_key_value'}, 'autoscaling_config': {'policy_uri': 'policy_uri_value'}, 'security_config': {'kerberos_config': {'enable_kerberos': True, 'root_principal_password_uri': 'root_principal_password_uri_value', 'kms_key_uri': 'kms_key_uri_value', 'keystore_uri': 'keystore_uri_value', 'truststore_uri': 'truststore_uri_value', 'keystore_password_uri': 'keystore_password_uri_value', 'key_password_uri': 'key_password_uri_value', 'truststore_password_uri': 'truststore_password_uri_value', 'cross_realm_trust_realm': 'cross_realm_trust_realm_value', 'cross_realm_trust_kdc': 'cross_realm_trust_kdc_value', 'cross_realm_trust_admin_server': 'cross_realm_trust_admin_server_value', 'cross_realm_trust_shared_password_uri': 'cross_realm_trust_shared_password_uri_value', 'kdc_db_key_uri': 'kdc_db_key_uri_value', 'tgt_lifetime_hours': 1933, 'realm': 'realm_value'}, 'identity_config': {'user_service_account_mapping': {}}}, 'lifecycle_config': {'idle_delete_ttl': {}, 'auto_delete_time': {}, 'auto_delete_ttl': {}, 'idle_start_time': {}}, 'endpoint_config': {'http_ports': {}, 'enable_http_port_access': True}, 'metastore_config': {'dataproc_metastore_service': 'dataproc_metastore_service_value'}, 'dataproc_metric_config': {'metrics': [{'metric_source': 1, 'metric_overrides': ['metric_overrides_value1', 'metric_overrides_value2']}]}, 'auxiliary_node_groups': [{'node_group': {'name': 'name_value', 'roles': [1], 'node_group_config': {}, 'labels': {}}, 'node_group_id': 'node_group_id_value'}]}, 'labels': {}}, 'cluster_selector': {'zone': 'zone_value', 'cluster_labels': {}}}, 'jobs': [{'step_id': 'step_id_value', 'hadoop_job': {'main_jar_file_uri': 'main_jar_file_uri_value', 'main_class': 'main_class_value', 'args': ['args_value1', 'args_value2'], 'jar_file_uris': ['jar_file_uris_value1', 'jar_file_uris_value2'], 'file_uris': ['file_uris_value1', 'file_uris_value2'], 'archive_uris': ['archive_uris_value1', 'archive_uris_value2'], 'properties': {}, 'logging_config': {'driver_log_levels': {}}}, 'spark_job': {'main_jar_file_uri': 'main_jar_file_uri_value', 'main_class': 'main_class_value', 'args': ['args_value1', 'args_value2'], 'jar_file_uris': ['jar_file_uris_value1', 'jar_file_uris_value2'], 'file_uris': ['file_uris_value1', 'file_uris_value2'], 'archive_uris': ['archive_uris_value1', 'archive_uris_value2'], 'properties': {}, 'logging_config': {}}, 'pyspark_job': {'main_python_file_uri': 'main_python_file_uri_value', 'args': ['args_value1', 'args_value2'], 'python_file_uris': ['python_file_uris_value1', 'python_file_uris_value2'], 'jar_file_uris': ['jar_file_uris_value1', 'jar_file_uris_value2'], 'file_uris': ['file_uris_value1', 'file_uris_value2'], 'archive_uris': ['archive_uris_value1', 'archive_uris_value2'], 'properties': {}, 'logging_config': {}}, 'hive_job': {'query_file_uri': 'query_file_uri_value', 'query_list': {'queries': ['queries_value1', 'queries_value2']}, 'continue_on_failure': True, 'script_variables': {}, 'properties': {}, 'jar_file_uris': ['jar_file_uris_value1', 'jar_file_uris_value2']}, 'pig_job': {'query_file_uri': 'query_file_uri_value', 'query_list': {}, 'continue_on_failure': True, 'script_variables': {}, 'properties': {}, 'jar_file_uris': ['jar_file_uris_value1', 'jar_file_uris_value2'], 'logging_config': {}}, 'spark_r_job': {'main_r_file_uri': 'main_r_file_uri_value', 'args': ['args_value1', 'args_value2'], 'file_uris': ['file_uris_value1', 'file_uris_value2'], 'archive_uris': ['archive_uris_value1', 'archive_uris_value2'], 'properties': {}, 'logging_config': {}}, 'spark_sql_job': {'query_file_uri': 'query_file_uri_value', 'query_list': {}, 'script_variables': {}, 'properties': {}, 'jar_file_uris': ['jar_file_uris_value1', 'jar_file_uris_value2'], 'logging_config': {}}, 'presto_job': {'query_file_uri': 'query_file_uri_value', 'query_list': {}, 'continue_on_failure': True, 'output_format': 'output_format_value', 'client_tags': ['client_tags_value1', 'client_tags_value2'], 'properties': {}, 'logging_config': {}}, 'trino_job': {'query_file_uri': 'query_file_uri_value', 'query_list': {}, 'continue_on_failure': True, 'output_format': 'output_format_value', 'client_tags': ['client_tags_value1', 'client_tags_value2'], 'properties': {}, 'logging_config': {}}, 'flink_job': {'main_jar_file_uri': 'main_jar_file_uri_value', 'main_class': 'main_class_value', 'args': ['args_value1', 'args_value2'], 'jar_file_uris': ['jar_file_uris_value1', 'jar_file_uris_value2'], 'savepoint_uri': 'savepoint_uri_value', 'properties': {}, 'logging_config': {}}, 'labels': {}, 'scheduling': {'max_failures_per_hour': 2243, 'max_failures_total': 1923}, 'prerequisite_step_ids': ['prerequisite_step_ids_value1', 'prerequisite_step_ids_value2']}], 'parameters': [{'name': 'name_value', 'fields': ['fields_value1', 'fields_value2'], 'description': 'description_value', 'validation': {'regex': {'regexes': ['regexes_value1', 'regexes_value2']}, 'values': {'values': ['values_value1', 'values_value2']}}}], 'dag_timeout': {}, 'encryption_config': {'kms_key': 'kms_key_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_update_workflow_template") as post, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_update_workflow_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_update_workflow_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_workflow_templates_rest_bad_request(request_type=workflow_templates.ListWorkflowTemplatesRequest):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_workflow_templates_rest_call_success(request_type):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_workflow_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_list_workflow_templates") as post, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_list_workflow_templates_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_list_workflow_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = workflow_templates.ListWorkflowTemplatesResponse.to_json(workflow_templates.ListWorkflowTemplatesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = workflow_templates.ListWorkflowTemplatesResponse(), metadata
...
def test_delete_workflow_template_rest_bad_request(request_type=workflow_templates.DeleteWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_workflow_template_rest_call_success(request_type):
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_delete_workflow_template") as pre:
        pre.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_workflow_template_empty_call_rest():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_workflow_template_empty_call_rest():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_instantiate_workflow_template_empty_call_rest():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_workflow_template_empty_call_rest():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_workflow_templates_empty_call_rest():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_workflow_template_empty_call_rest():
    client = WorkflowTemplateServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_crypto_key_path():
    ...
    actual = WorkflowTemplateServiceClient.crypto_key_path(project, location, key_ring, crypto_key)
...
@pytest.mark.parametrize("client_class,transport_class", [
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceGrpcTransport),
    (WorkflowTemplateServiceAsyncClient, transports.WorkflowTemplateServiceGrpcAsyncIOTransport),
])

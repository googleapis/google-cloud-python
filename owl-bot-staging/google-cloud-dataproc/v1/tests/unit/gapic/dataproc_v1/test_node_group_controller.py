...
from google.cloud.dataproc_v1.services.node_group_controller import NodeGroupControllerAsyncClient
from google.cloud.dataproc_v1.services.node_group_controller import NodeGroupControllerClient
from google.cloud.dataproc_v1.services.node_group_controller import transports
...
def test__read_environment_variables():
    assert NodeGroupControllerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert NodeGroupControllerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert NodeGroupControllerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert NodeGroupControllerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert NodeGroupControllerClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert NodeGroupControllerClient._get_client_cert_source(None, False) is None
    assert NodeGroupControllerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert NodeGroupControllerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert NodeGroupControllerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert NodeGroupControllerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(NodeGroupControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerClient))
@mock.patch.object(NodeGroupControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NodeGroupControllerClient._DEFAULT_UNIVERSE
    default_endpoint = NodeGroupControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = NodeGroupControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert NodeGroupControllerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert NodeGroupControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NodeGroupControllerClient.DEFAULT_MTLS_ENDPOINT
    assert NodeGroupControllerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NodeGroupControllerClient._get_api_endpoint(None, None, default_universe, "always") == NodeGroupControllerClient.DEFAULT_MTLS_ENDPOINT
    assert NodeGroupControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NodeGroupControllerClient.DEFAULT_MTLS_ENDPOINT
    assert NodeGroupControllerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert NodeGroupControllerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        NodeGroupControllerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert NodeGroupControllerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert NodeGroupControllerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert NodeGroupControllerClient._get_universe_domain(None, None) == NodeGroupControllerClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        NodeGroupControllerClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = NodeGroupControllerClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (NodeGroupControllerClient, transports.NodeGroupControllerGrpcTransport, "grpc"),
    (NodeGroupControllerAsyncClient, transports.NodeGroupControllerGrpcAsyncIOTransport, "grpc_asyncio"),
    (NodeGroupControllerClient, transports.NodeGroupControllerRestTransport, "rest"),
])
@mock.patch.object(NodeGroupControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerClient))
@mock.patch.object(NodeGroupControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (NodeGroupControllerClient, transports.NodeGroupControllerGrpcTransport, "grpc", "true"),
    (NodeGroupControllerAsyncClient, transports.NodeGroupControllerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (NodeGroupControllerClient, transports.NodeGroupControllerGrpcTransport, "grpc", "false"),
    (NodeGroupControllerAsyncClient, transports.NodeGroupControllerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (NodeGroupControllerClient, transports.NodeGroupControllerRestTransport, "rest", "true"),
    (NodeGroupControllerClient, transports.NodeGroupControllerRestTransport, "rest", "false"),
])
@mock.patch.object(NodeGroupControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerClient))
@mock.patch.object(NodeGroupControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    NodeGroupControllerClient, NodeGroupControllerAsyncClient
])
...
@mock.patch.object(NodeGroupControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerClient))
@mock.patch.object(NodeGroupControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NodeGroupControllerAsyncClient))
def test_node_group_controller_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (NodeGroupControllerClient, transports.NodeGroupControllerGrpcTransport, "grpc", grpc_helpers),
    (NodeGroupControllerAsyncClient, transports.NodeGroupControllerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (NodeGroupControllerClient, transports.NodeGroupControllerRestTransport, "rest", None),
])
...
def test_create_node_group(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_node_group),
            '__call__') as call:
...
def test_create_node_group_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_node_group in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_node_group] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_node_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_node_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_node_group] = mock_rpc
...
async def test_create_node_group_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_node_group(
            node_groups.CreateNodeGroupRequest(),
            parent='parent_value',
            node_group=clusters.NodeGroup(name='name_value'),
            node_group_id='node_group_id_value',
...
def test_resize_node_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resize_node_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_resize_node_group_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.resize_node_group in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.resize_node_group] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_resize_node_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NodeGroupControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.resize_node_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resize_node_group] = mock_rpc
...
async def test_resize_node_group_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.resize_node_group(
            node_groups.ResizeNodeGroupRequest(),
            name='name_value',
            size=443,
        )
...
def test_get_node_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_node_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_node_group_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_node_group in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_node_group] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_node_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NodeGroupControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_node_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_node_group] = mock_rpc
...
async def test_get_node_group_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_node_group(
            node_groups.GetNodeGroupRequest(),
            name='name_value',
        )


def test_create_node_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NodeGroupControllerClient(
...
def test_resize_node_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NodeGroupControllerClient(
...
def test_get_node_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NodeGroupControllerClient(
...
def test_transport_get_channel():
    ...
    transport = transports.NodeGroupControllerGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_create_node_group_empty_call_grpc():
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_node_group(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resize_node_group_empty_call_grpc():
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.resize_node_group(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_node_group_empty_call_grpc():
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = clusters.NodeGroup()
        client.get_node_group(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = NodeGroupControllerAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_node_group_empty_call_grpc_asyncio():
    client = NodeGroupControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_node_group(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_resize_node_group_empty_call_grpc_asyncio():
    client = NodeGroupControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.resize_node_group(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_node_group_empty_call_grpc_asyncio():
    client = NodeGroupControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_node_group(request=None)
...
def test_transport_kind_rest():
    transport = NodeGroupControllerClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_node_group_rest_bad_request(request_type=node_groups.CreateNodeGroupRequest):
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_node_group_rest_call_success(request_type):
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_node_group_rest_interceptors(null_interceptor):
    transport = transports.NodeGroupControllerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NodeGroupControllerRestInterceptor(),
        )
    client = NodeGroupControllerClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "post_create_node_group") as post, \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "post_create_node_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "pre_create_node_group") as pre:
...
def test_resize_node_group_rest_bad_request(request_type=node_groups.ResizeNodeGroupRequest):
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_resize_node_group_rest_call_success(request_type):
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_resize_node_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "post_resize_node_group") as post, \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "post_resize_node_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "pre_resize_node_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_node_group_rest_bad_request(request_type=node_groups.GetNodeGroupRequest):
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_node_group_rest_call_success(request_type):
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_node_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "post_get_node_group") as post, \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "post_get_node_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NodeGroupControllerRestInterceptor, "pre_get_node_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = clusters.NodeGroup.to_json(clusters.NodeGroup())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = clusters.NodeGroup(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_node_group_empty_call_rest():
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resize_node_group_empty_call_rest():
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_node_group_empty_call_rest():
    client = NodeGroupControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.NodeGroupControllerGrpcTransport, grpc_helpers),
        (transports.NodeGroupControllerGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_node_group_controller_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.NodeGroupControllerGrpcTransport, transports.NodeGroupControllerGrpcAsyncIOTransport])
def test_node_group_controller_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (NodeGroupControllerClient, transports.NodeGroupControllerGrpcTransport),
    (NodeGroupControllerAsyncClient, transports.NodeGroupControllerGrpcAsyncIOTransport),
])

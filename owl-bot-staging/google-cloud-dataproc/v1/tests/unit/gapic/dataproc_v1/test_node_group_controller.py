...
def test_create_node_group_rest_required_fields(request_type=node_groups.CreateNodeGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_node_group._get_unset_required_fields(jsonified_request)
...
def test_create_node_group_rest_unset_required_fields():
    transport = transports.NodeGroupControllerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_resize_node_group_rest_required_fields(request_type=node_groups.ResizeNodeGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).resize_node_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_node_group_rest_required_fields(request_type=node_groups.GetNodeGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_node_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

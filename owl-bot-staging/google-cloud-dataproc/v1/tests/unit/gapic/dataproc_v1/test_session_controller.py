...
@pytest.mark.asyncio
async def test_terminate_session_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = SessionControllerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.terminate_session] = mock_object
...
def test_create_session_rest_bad_request(transport: str = 'rest', request_type=sessions.CreateSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_session_rest_bad_request(transport: str = 'rest', request_type=sessions.GetSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = sessions.ListSessionsResponse.to_json(sessions.ListSessionsResponse())
...
def test_list_sessions_rest_bad_request(transport: str = 'rest', request_type=sessions.ListSessionsRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_terminate_session_rest_bad_request(transport: str = 'rest', request_type=sessions.TerminateSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_session_rest_bad_request(transport: str = 'rest', request_type=sessions.DeleteSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

...
from google.cloud.dataproc_v1.services.session_controller import SessionControllerAsyncClient
from google.cloud.dataproc_v1.services.session_controller import SessionControllerClient
from google.cloud.dataproc_v1.services.session_controller import pagers
from google.cloud.dataproc_v1.services.session_controller import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert SessionControllerClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert SessionControllerClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert SessionControllerClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert SessionControllerClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert SessionControllerClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert SessionControllerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SessionControllerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SessionControllerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SessionControllerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SessionControllerClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert SessionControllerClient._get_client_cert_source(None, False) is None
    assert SessionControllerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SessionControllerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SessionControllerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SessionControllerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SessionControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerClient))
@mock.patch.object(SessionControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SessionControllerClient._DEFAULT_UNIVERSE
    default_endpoint = SessionControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SessionControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SessionControllerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SessionControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SessionControllerClient.DEFAULT_MTLS_ENDPOINT
    assert SessionControllerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SessionControllerClient._get_api_endpoint(None, None, default_universe, "always") == SessionControllerClient.DEFAULT_MTLS_ENDPOINT
    assert SessionControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SessionControllerClient.DEFAULT_MTLS_ENDPOINT
    assert SessionControllerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SessionControllerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SessionControllerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SessionControllerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SessionControllerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SessionControllerClient._get_universe_domain(None, None) == SessionControllerClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        SessionControllerClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SessionControllerClient(credentials=cred)
...
def test_session_controller_client_from_service_account_info(client_class, transport_name):
...
def test_session_controller_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_session_controller_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (SessionControllerAsyncClient, transports.SessionControllerGrpcAsyncIOTransport, "grpc_asyncio"),
    (SessionControllerClient, transports.SessionControllerRestTransport, "rest"),
])
@mock.patch.object(SessionControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerClient))
@mock.patch.object(SessionControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerAsyncClient))
def test_session_controller_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (SessionControllerClient, transports.SessionControllerGrpcTransport, "grpc", "true"),
    (SessionControllerAsyncClient, transports.SessionControllerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (SessionControllerClient, transports.SessionControllerGrpcTransport, "grpc", "false"),
    (SessionControllerAsyncClient, transports.SessionControllerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (SessionControllerClient, transports.SessionControllerRestTransport, "rest", "true"),
    (SessionControllerClient, transports.SessionControllerRestTransport, "rest", "false"),
])
@mock.patch.object(SessionControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerClient))
@mock.patch.object(SessionControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_session_controller_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    SessionControllerClient, SessionControllerAsyncClient
])
@mock.patch.object(SessionControllerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SessionControllerClient))
@mock.patch.object(SessionControllerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SessionControllerAsyncClient))
...
@mock.patch.object(SessionControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerClient))
@mock.patch.object(SessionControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionControllerAsyncClient))
def test_session_controller_client_client_api_endpoint(client_class):
...
def test_session_controller_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (SessionControllerClient, transports.SessionControllerGrpcTransport, "grpc", grpc_helpers),
    (SessionControllerAsyncClient, transports.SessionControllerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SessionControllerClient, transports.SessionControllerRestTransport, "rest", None),
])
def test_session_controller_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_session_controller_client_client_options_from_dict():
    with mock.patch('google.cloud.dataproc_v1.services.session_controller.transports.SessionControllerGrpcTransport.__init__') as grpc_transport:
...
def test_session_controller_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_create_session_async(transport: str = 'grpc_asyncio', request_type=sessions.CreateSessionRequest):
    client = SessionControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_session_async(transport: str = 'grpc_asyncio', request_type=sessions.GetSessionRequest):
    client = SessionControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_sessions_async(transport: str = 'grpc_asyncio', request_type=sessions.ListSessionsRequest):
    client = SessionControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(sessions.ListSessionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_sessions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, sessions.Session)
                   for i in results)
...
def test_terminate_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.terminate_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_terminate_session_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_terminate_session_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.terminate_session in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.terminate_session] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_terminate_session_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionControllerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.terminate_session in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.terminate_session] = mock_rpc
...
@pytest.mark.asyncio
async def test_terminate_session_async(transport: str = 'grpc_asyncio', request_type=sessions.TerminateSessionRequest):
    client = SessionControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_session_async(transport: str = 'grpc_asyncio', request_type=sessions.DeleteSessionRequest):
    client = SessionControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_session_rest_required_fields(request_type=sessions.CreateSessionRequest):
    ...
    assert not set(unset_fields) - set(("request_id", "session_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_session_rest_unset_required_fields():
    transport = transports.SessionControllerRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_session._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId", "sessionId", )) & set(("parent", "session", "sessionId", )))
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/sessions" % client.transport._host, args[1])
...
def test_get_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/sessions/*}" % client.transport._host, args[1])
...
def test_terminate_session_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SessionControllerClient(
...
def test_terminate_session_rest_required_fields(request_type=sessions.TerminateSessionRequest):
    transport_class = transports.SessionControllerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).terminate_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_terminate_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/sessions/*}:terminate" % client.transport._host, args[1])
...
def test_delete_session_rest_required_fields(request_type=sessions.DeleteSessionRequest):
    transport_class = transports.SessionControllerRestTransport
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_terminate_session_empty_call_grpc():
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.terminate_session(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = SessionControllerAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_terminate_session_empty_call_grpc_asyncio():
    client = SessionControllerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.terminate_session(request=None)
...
def test_transport_kind_rest():
    transport = SessionControllerClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_session_rest_bad_request(request_type=sessions.CreateSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_session_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["session"] = {'name': 'name_value', 'uuid': 'uuid_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'jupyter_session': {'kernel': 1, 'display_name': 'display_name_value'}, 'spark_connect_session': {}, 'runtime_info': {'endpoints': {}, 'output_uri': 'output_uri_value', 'diagnostic_output_uri': 'diagnostic_output_uri_value', 'approximate_usage': {'milli_dcu_seconds': 1792, 'shuffle_storage_gb_seconds': 2743, 'milli_accelerator_seconds': 2633, 'accelerator_type': 'accelerator_type_value'}, 'current_usage': {'milli_dcu': 946, 'shuffle_storage_gb': 1897, 'milli_dcu_premium': 1808, 'shuffle_storage_gb_premium': 2759, 'milli_accelerator': 1787, 'accelerator_type': 'accelerator_type_value', 'snapshot_time': {}}}, 'state': 1, 'state_message': 'state_message_value', 'state_time': {}, 'creator': 'creator_value', 'labels': {}, 'runtime_config': {'version': 'version_value', 'container_image': 'container_image_value', 'properties': {}, 'repository_config': {'pypi_repository_config': {'pypi_repository': 'pypi_repository_value'}}, 'autotuning_config': {'scenarios': [2]}, 'cohort': 'cohort_value'}, 'environment_config': {'execution_config': {'service_account': 'service_account_value', 'network_uri': 'network_uri_value', 'subnetwork_uri': 'subnetwork_uri_value', 'network_tags': ['network_tags_value1', 'network_tags_value2'], 'kms_key': 'kms_key_value', 'idle_ttl': {'seconds': 751, 'nanos': 543}, 'ttl': {}, 'staging_bucket': 'staging_bucket_value', 'authentication_config': {'user_workload_authentication_type': 1}}, 'peripherals_config': {'metastore_service': 'metastore_service_value', 'spark_history_server_config': {'dataproc_cluster': 'dataproc_cluster_value'}}}, 'user': 'user_value', 'state_history': [{'state': 1, 'state_message': 'state_message_value', 'state_start_time': {}}], 'session_template': 'session_template_value'}
...
def test_create_session_rest_interceptors(null_interceptor):
    transport = transports.SessionControllerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SessionControllerRestInterceptor(),
        )
    client = SessionControllerClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_create_session") as post, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_create_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "pre_create_session") as pre:
...
def test_get_session_rest_bad_request(request_type=sessions.GetSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_get_session") as post, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_get_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "pre_get_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = sessions.Session.to_json(sessions.Session())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = sessions.Session(), metadata
...
def test_list_sessions_rest_bad_request(request_type=sessions.ListSessionsRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_list_sessions") as post, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_list_sessions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "pre_list_sessions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = sessions.ListSessionsResponse.to_json(sessions.ListSessionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = sessions.ListSessionsResponse(), metadata
...
def test_terminate_session_rest_bad_request(request_type=sessions.TerminateSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_terminate_session_rest_call_success(request_type):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_terminate_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_terminate_session") as post, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_terminate_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "pre_terminate_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = sessions.TerminateSessionRequest.pb(sessions.TerminateSessionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.terminate_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_session_rest_bad_request(request_type=sessions.DeleteSessionRequest):
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_delete_session") as post, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "post_delete_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionControllerRestInterceptor, "pre_delete_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_terminate_session_empty_call_rest():
    client = SessionControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_session_controller_base_transport():
    ...
    with mock.patch('google.cloud.dataproc_v1.services.session_controller.transports.SessionControllerTransport.__init__') as Transport:
...
def test_session_controller_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dataproc_v1.services.session_controller.transports.SessionControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_session_controller_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dataproc_v1.services.session_controller.transports.SessionControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SessionControllerTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.SessionControllerGrpcTransport, transports.SessionControllerGrpcAsyncIOTransport])
def test_session_controller_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.SessionControllerGrpcTransport, transports.SessionControllerGrpcAsyncIOTransport])
def test_session_controller_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.SessionControllerTransport, '_prep_wrapped_messages') as prep:
        client = SessionControllerClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (SessionControllerAsyncClient, transports.SessionControllerGrpcAsyncIOTransport),
])

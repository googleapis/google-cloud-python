...
def test_create_session_rest_required_fields(request_type=sessions.CreateSessionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_session._get_unset_required_fields(jsonified_request)
...
def test_create_session_rest_unset_required_fields():
    transport = transports.SessionControllerRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_session_rest_required_fields(request_type=sessions.GetSessionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_sessions_rest_required_fields(request_type=sessions.ListSessionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_sessions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_terminate_session_rest_required_fields(request_type=sessions.TerminateSessionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).terminate_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_session_rest_required_fields(request_type=sessions.DeleteSessionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

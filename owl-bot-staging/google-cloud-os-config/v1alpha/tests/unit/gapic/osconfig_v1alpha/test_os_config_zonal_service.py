...
def test__get_api_endpoint():
    ...
    assert OsConfigZonalServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == OsConfigZonalServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert OsConfigZonalServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == OsConfigZonalServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    OsConfigZonalServiceClient, OsConfigZonalServiceAsyncClient
])
...
def test_get_instance_os_policies_compliance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_instance_os_policies_compliance in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_instance_os_policies_compliance] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_instance_os_policies_compliance_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_instance_os_policies_compliance in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_instance_os_policies_compliance] = mock_rpc
...
def test_list_instance_os_policies_compliances_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_instance_os_policies_compliances in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_instance_os_policies_compliances] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_instance_os_policies_compliances_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsConfigZonalServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_instance_os_policies_compliances in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_instance_os_policies_compliances] = mock_rpc
...
def test_list_instance_os_policies_compliances_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_instance_os_policies_compliances(request={}, retry=retry, timeout=timeout)
...
def test_get_os_policy_assignment_report(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_os_policy_assignment_report),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_os_policy_assignment_reports_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, os_policy_assignment_reports.OSPolicyAssignmentReport)
                   for i in results)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_instance_os_policies_compliance_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = instance_os_policies_compliance.InstanceOSPoliciesCompliance()
        client.get_instance_os_policies_compliance(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_instance_os_policies_compliances_empty_call_grpc():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesResponse()
        client.list_instance_os_policies_compliances(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_instance_os_policies_compliance_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_instance_os_policies_compliance(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_instance_os_policies_compliances_empty_call_grpc_asyncio():
    client = OsConfigZonalServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_instance_os_policies_compliances(request=None)
...
def test_create_os_policy_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_create_os_policy_assignment") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_create_os_policy_assignment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_create_os_policy_assignment") as pre:
...
def test_update_os_policy_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_update_os_policy_assignment") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_update_os_policy_assignment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_update_os_policy_assignment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_os_policy_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_get_os_policy_assignment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_os_policy_assignments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignments") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_list_os_policy_assignments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_os_policy_assignment_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_revisions") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_revisions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_list_os_policy_assignment_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse.to_json(os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse())
        req.return_value.content = return_value
...
def test_delete_os_policy_assignment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_delete_os_policy_assignment") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_delete_os_policy_assignment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_delete_os_policy_assignment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_instance_os_policies_compliance_rest_bad_request(request_type=instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_instance_os_policies_compliance_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_instance_os_policies_compliance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_instance_os_policies_compliance") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_instance_os_policies_compliance_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_get_instance_os_policies_compliance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = instance_os_policies_compliance.InstanceOSPoliciesCompliance.to_json(instance_os_policies_compliance.InstanceOSPoliciesCompliance())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = instance_os_policies_compliance.InstanceOSPoliciesCompliance(), metadata
...
def test_list_instance_os_policies_compliances_rest_bad_request(request_type=instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_instance_os_policies_compliances_rest_call_success(request_type):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_instance_os_policies_compliances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_instance_os_policies_compliances") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_instance_os_policies_compliances_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_list_instance_os_policies_compliances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesResponse.to_json(instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesResponse(), metadata
...
def test_get_os_policy_assignment_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment_report") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_os_policy_assignment_report_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_get_os_policy_assignment_report") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_os_policy_assignment_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_reports") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_os_policy_assignment_reports_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_list_os_policy_assignment_reports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse.to_json(os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse())
        req.return_value.content = return_value
...
def test_get_inventory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_inventory") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_inventory_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_get_inventory") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_inventories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_inventories") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_inventories_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_list_inventories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_vulnerability_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_vulnerability_report") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_get_vulnerability_report_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_get_vulnerability_report") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_vulnerability_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_vulnerability_reports") as post, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "post_list_vulnerability_reports_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OsConfigZonalServiceRestInterceptor, "pre_list_vulnerability_reports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_instance_os_policies_compliance_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_instance_os_policies_compliances_empty_call_rest():
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

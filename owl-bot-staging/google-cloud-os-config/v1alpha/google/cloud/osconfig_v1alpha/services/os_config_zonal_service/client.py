...
class OsConfigZonalServiceClient(metaclass=OsConfigZonalServiceClientMeta):
    ...
    @staticmethod
    def instance_os_policies_compliance_path(project: str,location: str,instance: str,) -> str:
        """Returns a fully-qualified instance_os_policies_compliance string."""
        return "projects/{project}/locations/{location}/instanceOSPoliciesCompliances/{instance}".format(project=project, location=location, instance=instance, )
    ...
    def parse_instance_os_policies_compliance_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instanceOSPoliciesCompliances/(?P<instance>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def instance_os_policy_assignment_path(project: str,location: str,instance: str,assignment: str,) -> str:
        """Returns a fully-qualified instance_os_policy_assignment string."""
        return "projects/{project}/locations/{location}/instances/{instance}/osPolicyAssignments/{assignment}".format(project=project, location=location, instance=instance, assignment=assignment, )
    ...
    def parse_instance_os_policy_assignment_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/osPolicyAssignments/(?P<assignment>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def os_policy_assignment_report_path(project: str,location: str,instance: str,assignment: str,) -> str:
        """Returns a fully-qualified os_policy_assignment_report string."""
        return "projects/{project}/locations/{location}/instances/{instance}/osPolicyAssignments/{assignment}/report".format(project=project, location=location, instance=instance, assignment=assignment, )
    ...
    def parse_os_policy_assignment_report_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/osPolicyAssignments/(?P<assignment>.+?)/report$", path)
        return m.groupdict() if m else {}
    ...
    def vulnerability_report_path(project: str,location: str,instance: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/instances/{instance}/vulnerabilityReport".format(project=project, location=location, instance=instance, )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            OsConfigZonalServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_os_policy_assignment(self,
    ...
    def update_os_policy_assignment(self,
    ...
    def get_os_policy_assignment(self,
    ...
    def list_os_policy_assignments(self,
    ...
    def list_os_policy_assignment_revisions(self,
    ...
    def delete_os_policy_assignment(self,
    ...
    def get_instance_os_policies_compliance(self,
        ...
        """
        warnings.warn("OsConfigZonalServiceClient.get_instance_os_policies_compliance is deprecated",
            DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_instance_os_policies_compliance]
    ...
    def list_instance_os_policies_compliances(self,
        ...
        """
        warnings.warn("OsConfigZonalServiceClient.list_instance_os_policies_compliances is deprecated",
            DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_instance_os_policies_compliances]
    ...
    def get_os_policy_assignment_report(self,
    ...
    def list_os_policy_assignment_reports(self,

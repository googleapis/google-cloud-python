...
class OsConfigZonalServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_os_policy_assignment(self, request: os_policy_assignments.CreateOSPolicyAssignmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.CreateOSPolicyAssignmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_os_policy_assignment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_os_policy_assignment
    ...
    def pre_delete_os_policy_assignment(self, request: os_policy_assignments.DeleteOSPolicyAssignmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.DeleteOSPolicyAssignmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_os_policy_assignment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_os_policy_assignment
    ...
    def pre_get_instance_os_policies_compliance(self, request: instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_instance_os_policies_compliance_with_metadata(self, response: instance_os_policies_compliance.InstanceOSPoliciesCompliance, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[instance_os_policies_compliance.InstanceOSPoliciesCompliance, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_instance_os_policies_compliance
    ...
    def pre_get_inventory(self, request: inventory.GetInventoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[inventory.GetInventoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_inventory_with_metadata(self, response: inventory.Inventory, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[inventory.Inventory, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_inventory
    ...
    def pre_get_os_policy_assignment(self, request: os_policy_assignments.GetOSPolicyAssignmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.GetOSPolicyAssignmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_os_policy_assignment_with_metadata(self, response: os_policy_assignments.OSPolicyAssignment, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.OSPolicyAssignment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_os_policy_assignment
    ...
    def pre_get_os_policy_assignment_report(self, request: os_policy_assignment_reports.GetOSPolicyAssignmentReportRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignment_reports.GetOSPolicyAssignmentReportRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_os_policy_assignment_report_with_metadata(self, response: os_policy_assignment_reports.OSPolicyAssignmentReport, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignment_reports.OSPolicyAssignmentReport, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_os_policy_assignment_report
    ...
    def pre_get_vulnerability_report(self, request: vulnerability.GetVulnerabilityReportRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vulnerability.GetVulnerabilityReportRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_vulnerability_report_with_metadata(self, response: vulnerability.VulnerabilityReport, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vulnerability.VulnerabilityReport, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_vulnerability_report
    ...
    def pre_list_instance_os_policies_compliances(self, request: instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_instance_os_policies_compliances_with_metadata(self, response: instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_instance_os_policies_compliances
    ...
    def pre_list_inventories(self, request: inventory.ListInventoriesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[inventory.ListInventoriesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_inventories_with_metadata(self, response: inventory.ListInventoriesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[inventory.ListInventoriesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_inventories
    ...
    def pre_list_os_policy_assignment_reports(self, request: os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_os_policy_assignment_reports_with_metadata(self, response: os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignment_reports.ListOSPolicyAssignmentReportsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_os_policy_assignment_reports
    ...
    def pre_list_os_policy_assignment_revisions(self, request: os_policy_assignments.ListOSPolicyAssignmentRevisionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.ListOSPolicyAssignmentRevisionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_os_policy_assignment_revisions_with_metadata(self, response: os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.ListOSPolicyAssignmentRevisionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_os_policy_assignment_revisions
    ...
    def pre_list_os_policy_assignments(self, request: os_policy_assignments.ListOSPolicyAssignmentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.ListOSPolicyAssignmentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_os_policy_assignments_with_metadata(self, response: os_policy_assignments.ListOSPolicyAssignmentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.ListOSPolicyAssignmentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_os_policy_assignments
    ...
    def pre_list_vulnerability_reports(self, request: vulnerability.ListVulnerabilityReportsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vulnerability.ListVulnerabilityReportsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_vulnerability_reports_with_metadata(self, response: vulnerability.ListVulnerabilityReportsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[vulnerability.ListVulnerabilityReportsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_vulnerability_reports
    ...
    def pre_update_os_policy_assignment(self, request: os_policy_assignments.UpdateOSPolicyAssignmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[os_policy_assignments.UpdateOSPolicyAssignmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_os_policy_assignment_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_os_policy_assignment
...
class OsConfigZonalServiceRestTransport(_BaseOsConfigZonalServiceRestTransport):
    ...
    class _CreateOSPolicyAssignment(_BaseOsConfigZonalServiceRestTransport._BaseCreateOSPolicyAssignment, OsConfigZonalServiceRestStub):
        ...
        assignment method over HTTP.
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._CreateOSPolicyAssignment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteOSPolicyAssignment(_BaseOsConfigZonalServiceRestTransport._BaseDeleteOSPolicyAssignment, OsConfigZonalServiceRestStub):
        ...
        assignment method over HTTP.
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._DeleteOSPolicyAssignment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetInstanceOSPoliciesCompliance(_BaseOsConfigZonalServiceRestTransport._BaseGetInstanceOSPoliciesCompliance, OsConfigZonalServiceRestStub):
        ...
        compliance method over HTTP.
            ...
            transcoded_request = _BaseOsConfigZonalServiceRestTransport._BaseGetInstanceOSPoliciesCompliance._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._GetInstanceOSPoliciesCompliance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetInventory(_BaseOsConfigZonalServiceRestTransport._BaseGetInventory, OsConfigZonalServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._GetInventory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOSPolicyAssignment(_BaseOsConfigZonalServiceRestTransport._BaseGetOSPolicyAssignment, OsConfigZonalServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._GetOSPolicyAssignment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOSPolicyAssignmentReport(_BaseOsConfigZonalServiceRestTransport._BaseGetOSPolicyAssignmentReport, OsConfigZonalServiceRestStub):
        ...
        report method over HTTP.
            ...
            transcoded_request = _BaseOsConfigZonalServiceRestTransport._BaseGetOSPolicyAssignmentReport._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._GetOSPolicyAssignmentReport._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetVulnerabilityReport(_BaseOsConfigZonalServiceRestTransport._BaseGetVulnerabilityReport, OsConfigZonalServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._GetVulnerabilityReport._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListInstanceOSPoliciesCompliances(_BaseOsConfigZonalServiceRestTransport._BaseListInstanceOSPoliciesCompliances, OsConfigZonalServiceRestStub):
        def __hash__(self):
        ...
        compliances method over HTTP.
            ...
            transcoded_request = _BaseOsConfigZonalServiceRestTransport._BaseListInstanceOSPoliciesCompliances._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._ListInstanceOSPoliciesCompliances._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListInventories(_BaseOsConfigZonalServiceRestTransport._BaseListInventories, OsConfigZonalServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._ListInventories._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOSPolicyAssignmentReports(_BaseOsConfigZonalServiceRestTransport._BaseListOSPolicyAssignmentReports, OsConfigZonalServiceRestStub):
        ...
        reports method over HTTP.
            ...
            transcoded_request = _BaseOsConfigZonalServiceRestTransport._BaseListOSPolicyAssignmentReports._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._ListOSPolicyAssignmentReports._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOSPolicyAssignmentRevisions(_BaseOsConfigZonalServiceRestTransport._BaseListOSPolicyAssignmentRevisions, OsConfigZonalServiceRestStub):
        ...
        revisions method over HTTP.
            ...
            transcoded_request = _BaseOsConfigZonalServiceRestTransport._BaseListOSPolicyAssignmentRevisions._get_transcoded_request(http_options, request)
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._ListOSPolicyAssignmentRevisions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOSPolicyAssignments(_BaseOsConfigZonalServiceRestTransport._BaseListOSPolicyAssignments, OsConfigZonalServiceRestStub):
        ...
        assignments method over HTTP.
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._ListOSPolicyAssignments._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListVulnerabilityReports(_BaseOsConfigZonalServiceRestTransport._BaseListVulnerabilityReports, OsConfigZonalServiceRestStub):
        ...
        reports method over HTTP.
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._ListVulnerabilityReports._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateOSPolicyAssignment(_BaseOsConfigZonalServiceRestTransport._BaseUpdateOSPolicyAssignment, OsConfigZonalServiceRestStub):
        ...
        assignment method over HTTP.
            ...
            # Send the request
            response = OsConfigZonalServiceRestTransport._UpdateOSPolicyAssignment._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

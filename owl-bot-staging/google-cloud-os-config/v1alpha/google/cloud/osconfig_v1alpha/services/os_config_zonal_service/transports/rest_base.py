...
class _BaseOsConfigZonalServiceRestTransport(OsConfigZonalServiceTransport):
    ...
    class _BaseGetInstanceOSPoliciesCompliance:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOsConfigZonalServiceRestTransport._BaseGetInstanceOSPoliciesCompliance._get_unset_required_fields(query_params))
    ...
    class _BaseListInstanceOSPoliciesCompliances:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOsConfigZonalServiceRestTransport._BaseListInstanceOSPoliciesCompliances._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseOsConfigZonalServiceRestTransport',
)

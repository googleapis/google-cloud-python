...
def test_execute_patch_job_rest_required_fields(request_type=patch_jobs.ExecutePatchJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).execute_patch_job._get_unset_required_fields(jsonified_request)
...
def test_execute_patch_job_rest_unset_required_fields():
    transport = transports.OsConfigServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_patch_job_rest_required_fields(request_type=patch_jobs.GetPatchJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_patch_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_patch_job_rest_required_fields(request_type=patch_jobs.CancelPatchJobRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).cancel_patch_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_patch_jobs_rest_required_fields(request_type=patch_jobs.ListPatchJobsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_patch_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_patch_job_instance_details_rest_required_fields(request_type=patch_jobs.ListPatchJobInstanceDetailsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_patch_job_instance_details._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_patch_deployment_rest_required_fields(request_type=patch_deployments.CreatePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_patch_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_patch_deployment_rest_required_fields(request_type=patch_deployments.GetPatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_patch_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_patch_deployments_rest_required_fields(request_type=patch_deployments.ListPatchDeploymentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_patch_deployments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_patch_deployment_rest_required_fields(request_type=patch_deployments.DeletePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_patch_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_patch_deployment_rest_required_fields(request_type=patch_deployments.UpdatePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_patch_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pause_patch_deployment_rest_required_fields(request_type=patch_deployments.PausePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).pause_patch_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resume_patch_deployment_rest_required_fields(request_type=patch_deployments.ResumePatchDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).resume_patch_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
from google.cloud.osconfig_v1.services.os_config_zonal_service import OsConfigZonalServiceAsyncClient
from google.cloud.osconfig_v1.services.os_config_zonal_service import OsConfigZonalServiceClient
...
def test_os_config_zonal_service_client_client_options_from_dict():
    with mock.patch('google.cloud.osconfig_v1.services.os_config_zonal_service.transports.OsConfigZonalServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.CreateOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_os_policy_assignment._get_unset_required_fields(jsonified_request)
...
def test_create_os_policy_assignment_rest_unset_required_fields():
    transport = transports.OsConfigZonalServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.UpdateOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_os_policy_assignment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_os_policy_assignment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{os_policy_assignment.name=projects/*/locations/*/osPolicyAssignments/*}" % client.transport._host, args[1])
...
def test_get_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.GetOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_os_policy_assignment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_os_policy_assignments_rest_required_fields(request_type=os_policy_assignments.ListOSPolicyAssignmentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_os_policy_assignments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_os_policy_assignment_revisions_rest_required_fields(request_type=os_policy_assignments.ListOSPolicyAssignmentRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_os_policy_assignment_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_os_policy_assignment_rest_required_fields(request_type=os_policy_assignments.DeleteOSPolicyAssignmentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_os_policy_assignment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_os_policy_assignment_report_rest_required_fields(request_type=os_policy_assignment_reports.GetOSPolicyAssignmentReportRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_os_policy_assignment_report._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_os_policy_assignment_report_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/instances/*/osPolicyAssignments/*/report}" % client.transport._host, args[1])
...
def test_list_os_policy_assignment_reports_rest_required_fields(request_type=os_policy_assignment_reports.ListOSPolicyAssignmentReportsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_os_policy_assignment_reports._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_os_policy_assignment_reports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/instances/*/osPolicyAssignments/*}/reports" % client.transport._host, args[1])
...
def test_get_inventory_rest_required_fields(request_type=inventory.GetInventoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_inventories_rest_required_fields(request_type=inventory.ListInventoriesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_inventories._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_vulnerability_report_rest_required_fields(request_type=vulnerability.GetVulnerabilityReportRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_vulnerability_report._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_vulnerability_reports_rest_required_fields(request_type=vulnerability.ListVulnerabilityReportsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_vulnerability_reports._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_os_config_zonal_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.osconfig_v1.services.os_config_zonal_service.transports.OsConfigZonalServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_os_config_zonal_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.osconfig_v1.services.os_config_zonal_service.transports.OsConfigZonalServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.OsConfigZonalServiceTransport()
        adc.assert_called_once()

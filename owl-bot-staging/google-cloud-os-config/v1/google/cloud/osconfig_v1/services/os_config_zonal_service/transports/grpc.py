...
class OsConfigZonalServiceGrpcTransport(OsConfigZonalServiceTransport):
    ...
    @property
    def get_os_policy_assignment_report(self) -> Callable[
        ...
        if 'get_os_policy_assignment_report' not in self._stubs:
            self._stubs['get_os_policy_assignment_report'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_os_policy_assignment_reports(self) -> Callable[
        ...
        if 'list_os_policy_assignment_reports' not in self._stubs:
            self._stubs['list_os_policy_assignment_reports'] = self.grpc_channel.unary_unary(

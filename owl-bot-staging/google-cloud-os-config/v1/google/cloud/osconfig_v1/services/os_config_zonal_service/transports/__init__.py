...
from .rest import OsConfigZonalServiceRestTransport
from .rest import OsConfigZonalServiceRestInterceptor
...
__all__ = (
    ...
    'OsConfigZonalServiceRestTransport',
    'OsConfigZonalServiceRestInterceptor',
)

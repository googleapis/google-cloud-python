...
class OSPolicyAssignmentReport(proto.Message):
    ...
    class OSPolicyCompliance(proto.Message):
        ...
        class OSPolicyResourceCompliance(proto.Message):
            ...
            config_steps: MutableSequence['OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
        ...
        os_policy_resource_compliances: MutableSequence['OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance'] = proto.RepeatedField(
            proto.MESSAGE,
            number=4,

...
def test_get_workstation_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_get_workstation_cluster_with_metadata") as post_with_metadata, \
...
def test_list_workstation_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_list_workstation_clusters_with_metadata") as post_with_metadata, \
...
def test_create_workstation_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_create_workstation_cluster_with_metadata") as post_with_metadata, \
...
def test_update_workstation_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_update_workstation_cluster_with_metadata") as post_with_metadata, \
...
def test_delete_workstation_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_delete_workstation_cluster_with_metadata") as post_with_metadata, \
...
def test_get_workstation_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_get_workstation_config_with_metadata") as post_with_metadata, \
...
def test_list_workstation_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_list_workstation_configs_with_metadata") as post_with_metadata, \
...
def test_list_usable_workstation_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_list_usable_workstation_configs_with_metadata") as post_with_metadata, \
...
def test_create_workstation_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_create_workstation_config_with_metadata") as post_with_metadata, \
...
def test_update_workstation_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_update_workstation_config_with_metadata") as post_with_metadata, \
...
def test_delete_workstation_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_delete_workstation_config_with_metadata") as post_with_metadata, \
...
def test_get_workstation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_get_workstation_with_metadata") as post_with_metadata, \
...
def test_list_workstations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_list_workstations_with_metadata") as post_with_metadata, \
...
def test_list_usable_workstations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_list_usable_workstations_with_metadata") as post_with_metadata, \
...
def test_create_workstation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_create_workstation_with_metadata") as post_with_metadata, \
...
def test_update_workstation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_update_workstation_with_metadata") as post_with_metadata, \
...
def test_delete_workstation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_delete_workstation_with_metadata") as post_with_metadata, \
...
def test_start_workstation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_start_workstation_with_metadata") as post_with_metadata, \
...
def test_stop_workstation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_stop_workstation_with_metadata") as post_with_metadata, \
...
def test_generate_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WorkstationsRestInterceptor, "post_generate_access_token_with_metadata") as post_with_metadata, \

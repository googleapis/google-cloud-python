...
from .transports.grpc import WorkstationsGrpcTransport
from .transports.grpc_asyncio import WorkstationsGrpcAsyncIOTransport
from .transports.rest import WorkstationsRestTransport


class WorkstationsClientMeta(type):
    """Metaclass for the Workstations client.
...
class WorkstationsClient(metaclass=WorkstationsClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "workstations.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            WorkstationsClient: The constructed client.
        """
    ...
    def transport(self) -> WorkstationsTransport:
        ...
        Returns:
            WorkstationsTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def workstation_path(project: str,location: str,workstation_cluster: str,workstation_config: str,workstation: str,) -> str:
        """Returns a fully-qualified workstation string."""
        return "projects/{project}/locations/{location}/workstationClusters/{workstation_cluster}/workstationConfigs/{workstation_config}/workstations/{workstation}".format(project=project, location=location, workstation_cluster=workstation_cluster, workstation_config=workstation_config, workstation=workstation, )

    @staticmethod
    def parse_workstation_path(path: str) -> Dict[str,str]:
        """Parses a workstation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/workstationClusters/(?P<workstation_cluster>.+?)/workstationConfigs/(?P<workstation_config>.+?)/workstations/(?P<workstation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def workstation_cluster_path(project: str,location: str,workstation_cluster: str,) -> str:
        """Returns a fully-qualified workstation_cluster string."""
        return "projects/{project}/locations/{location}/workstationClusters/{workstation_cluster}".format(project=project, location=location, workstation_cluster=workstation_cluster, )

    @staticmethod
    def parse_workstation_cluster_path(path: str) -> Dict[str,str]:
        """Parses a workstation_cluster path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/workstationClusters/(?P<workstation_cluster>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def workstation_config_path(project: str,location: str,workstation_cluster: str,workstation_config: str,) -> str:
        """Returns a fully-qualified workstation_config string."""
        return "projects/{project}/locations/{location}/workstationClusters/{workstation_cluster}/workstationConfigs/{workstation_config}".format(project=project, location=location, workstation_cluster=workstation_cluster, workstation_config=workstation_config, )

    @staticmethod
    def parse_workstation_config_path(path: str) -> Dict[str,str]:
        """Parses a workstation_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/workstationClusters/(?P<workstation_cluster>.+?)/workstationConfigs/(?P<workstation_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = WorkstationsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = WorkstationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = WorkstationsClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = WorkstationsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            WorkstationsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, WorkstationsTransport, Callable[..., WorkstationsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = WorkstationsClient._read_environment_variables()
        self._client_cert_source = WorkstationsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = WorkstationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, WorkstationsTransport)
        if transport_provided:
            # transport is a WorkstationsTransport instance.
            ...
            self._transport = cast(WorkstationsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            WorkstationsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[WorkstationsTransport], Callable[..., WorkstationsTransport]] = (
    ...
    def get_workstation_cluster(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_workstation_cluster]
    ...
    def list_workstation_clusters(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> pagers.ListWorkstationClustersPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_workstation_clusters]
        ...
        response = pagers.ListWorkstationClustersPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def create_workstation_cluster(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_workstation_cluster]
    ...
    def update_workstation_cluster(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_workstation_cluster]
    ...
    def delete_workstation_cluster(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_workstation_cluster]
    ...
    def get_workstation_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_workstation_config]
    ...
    def list_workstation_configs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_workstation_configs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListWorkstationConfigsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def list_usable_workstation_configs(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> pagers.ListUsableWorkstationConfigsPager:
        r"""Returns all workstation configurations in the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_usable_workstation_configs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListUsableWorkstationConfigsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def create_workstation_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_workstation_config]
    ...
    def update_workstation_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_workstation_config]
    ...
    def delete_workstation_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_workstation_config]
    ...
    def get_workstation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_workstation]
    ...
    def list_workstations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_workstations]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListWorkstationsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def list_usable_workstations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_usable_workstations]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListUsableWorkstationsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def create_workstation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_workstation]
    ...
    def update_workstation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_workstation]
    ...
    def delete_workstation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_workstation]
    ...
    def start_workstation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.start_workstation]
    ...
    def stop_workstation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.stop_workstation]
    ...
    def __enter__(self) -> "WorkstationsClient":
        return self

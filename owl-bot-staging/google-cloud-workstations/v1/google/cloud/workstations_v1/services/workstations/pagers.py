...
class ListWorkstationClustersPager:
    ...
    :class:`google.cloud.workstations_v1.types.ListWorkstationClustersResponse` object, and
    ...
    All the usual :class:`google.cloud.workstations_v1.types.ListWorkstationClustersResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.workstations_v1.types.ListWorkstationClustersRequest):
                The initial request object.
            response (google.cloud.workstations_v1.types.ListWorkstationClustersResponse):
...
class ListWorkstationClustersAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[workstations.ListWorkstationClustersResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListWorkstationConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.workstations_v1.types.ListWorkstationConfigsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.workstations_v1.types.ListWorkstationConfigsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.workstations_v1.types.ListWorkstationConfigsRequest):
                The initial request object.
            response (google.cloud.workstations_v1.types.ListWorkstationConfigsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListUsableWorkstationConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.workstations_v1.types.ListUsableWorkstationConfigsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``workstation_configs`` field.
    ...
    All the usual :class:`google.cloud.workstations_v1.types.ListUsableWorkstationConfigsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.workstations_v1.types.ListUsableWorkstationConfigsRequest):
                The initial request object.
            response (google.cloud.workstations_v1.types.ListUsableWorkstationConfigsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListUsableWorkstationConfigsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[workstations.ListUsableWorkstationConfigsResponse]],
            request: workstations.ListUsableWorkstationConfigsRequest,
            response: workstations.ListUsableWorkstationConfigsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[workstations.ListUsableWorkstationConfigsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
...
class ListWorkstationsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.workstations_v1.types.ListWorkstationsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``workstations`` field.
    ...
    All the usual :class:`google.cloud.workstations_v1.types.ListWorkstationsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.workstations_v1.types.ListWorkstationsRequest):
                The initial request object.
            response (google.cloud.workstations_v1.types.ListWorkstationsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListUsableWorkstationsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.workstations_v1.types.ListUsableWorkstationsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``workstations`` field.
    ...
    All the usual :class:`google.cloud.workstations_v1.types.ListUsableWorkstationsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.workstations_v1.types.ListUsableWorkstationsRequest):
                The initial request object.
            response (google.cloud.workstations_v1.types.ListUsableWorkstationsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """

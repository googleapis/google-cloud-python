...
from google.cloud.workstations_v1.services.workstations import pagers
...
from .transports.grpc_asyncio import WorkstationsGrpcAsyncIOTransport
from .client import WorkstationsClient
...
class WorkstationsAsyncClient:
    """Service for interacting with Cloud Workstations."""

    _client: WorkstationsClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = WorkstationsClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = WorkstationsClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = WorkstationsClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = WorkstationsClient._DEFAULT_UNIVERSE

    workstation_path = staticmethod(WorkstationsClient.workstation_path)
    parse_workstation_path = staticmethod(WorkstationsClient.parse_workstation_path)
    workstation_cluster_path = staticmethod(WorkstationsClient.workstation_cluster_path)
    parse_workstation_cluster_path = staticmethod(WorkstationsClient.parse_workstation_cluster_path)
    workstation_config_path = staticmethod(WorkstationsClient.workstation_config_path)
    parse_workstation_config_path = staticmethod(WorkstationsClient.parse_workstation_config_path)
    common_billing_account_path = staticmethod(WorkstationsClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(WorkstationsClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(WorkstationsClient.common_folder_path)
    parse_common_folder_path = staticmethod(WorkstationsClient.parse_common_folder_path)
    common_organization_path = staticmethod(WorkstationsClient.common_organization_path)
    parse_common_organization_path = staticmethod(WorkstationsClient.parse_common_organization_path)
    common_project_path = staticmethod(WorkstationsClient.common_project_path)
    parse_common_project_path = staticmethod(WorkstationsClient.parse_common_project_path)
    common_location_path = staticmethod(WorkstationsClient.common_location_path)
    parse_common_location_path = staticmethod(WorkstationsClient.parse_common_location_path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return WorkstationsClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore

    @property
    def transport(self) -> WorkstationsTransport:
        """Returns the transport used by the client instance.

        Returns:
            WorkstationsTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = WorkstationsClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, WorkstationsTransport, Callable[..., WorkstationsTransport]]] = "grpc_asyncio",
        ...
        """
        self._client = WorkstationsClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.workstations_v1.WorkstationsAsyncClient`.",
                extra = {
    ...
    async def get_workstation_cluster(self,
            request: Optional[Union[workstations.GetWorkstationClusterRequest, dict]] = None,
            *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.GetWorkstationClusterRequest, dict]]):
                The request object. Request message for
                GetWorkstationCluster.
            name (:class:`str`):
                Required. Name of the requested
                resource.
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_workstation_cluster]
    ...
    async def list_workstation_clusters(self,
            request: Optional[Union[workstations.ListWorkstationClustersRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListWorkstationClustersAsyncPager:
        r"""Returns all workstation clusters in the specified
        location.
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.ListWorkstationClustersRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_workstation_clusters]
        ...
        response = pagers.ListWorkstationClustersAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def create_workstation_cluster(self,
            request: Optional[Union[workstations.CreateWorkstationClusterRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            workstation_cluster: Optional[workstations.WorkstationCluster] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.CreateWorkstationClusterRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            workstation_cluster (:class:`google.cloud.workstations_v1.types.WorkstationCluster`):
                Required. Workstation cluster to
                create.

                This corresponds to the ``workstation_cluster`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            workstation_cluster_id (:class:`str`):
                Required. ID to use for the
                workstation cluster.

                This corresponds to the ``workstation_cluster_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, workstation_cluster, workstation_cluster_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        if workstation_cluster is not None:
            request.workstation_cluster = workstation_cluster
        if workstation_cluster_id is not None:
            request.workstation_cluster_id = workstation_cluster_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_workstation_cluster]
        ...
        response = operation_async.from_gapic(
            ...
            workstations.WorkstationCluster,
            metadata_type=workstations.OperationMetadata,
        )

        # Done; return the response.
        return response

    async def update_workstation_cluster(self,
            request: Optional[Union[workstations.UpdateWorkstationClusterRequest, dict]] = None,
            *,
            workstation_cluster: Optional[workstations.WorkstationCluster] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.UpdateWorkstationClusterRequest, dict]]):
                The request object. Request message for
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                Required. Mask that specifies which
                fields in the workstation cluster should
                be updated.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [workstation_cluster, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_workstation_cluster]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("workstation_cluster.name", request.workstation_cluster.name),
            )),
        )
    ...
    async def delete_workstation_cluster(self,
            request: Optional[Union[workstations.DeleteWorkstationClusterRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.DeleteWorkstationClusterRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_workstation_cluster]
    ...
    async def get_workstation_config(self,
            request: Optional[Union[workstations.GetWorkstationConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.GetWorkstationConfigRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_workstation_config]
    ...
    async def list_workstation_configs(self,
            request: Optional[Union[workstations.ListWorkstationConfigsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.ListWorkstationConfigsRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_workstation_configs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListWorkstationConfigsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def list_usable_workstation_configs(self,
            request: Optional[Union[workstations.ListUsableWorkstationConfigsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListUsableWorkstationConfigsAsyncPager:
        r"""Returns all workstation configurations in the
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.ListUsableWorkstationConfigsRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_usable_workstation_configs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListUsableWorkstationConfigsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def create_workstation_config(self,
            request: Optional[Union[workstations.CreateWorkstationConfigRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            workstation_config: Optional[workstations.WorkstationConfig] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.CreateWorkstationConfigRequest, dict]]):
                The request object. Message for creating a
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, workstation_config, workstation_config_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        if workstation_config is not None:
            request.workstation_config = workstation_config
        if workstation_config_id is not None:
            request.workstation_config_id = workstation_config_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_workstation_config]
    ...
    async def update_workstation_config(self,
            request: Optional[Union[workstations.UpdateWorkstationConfigRequest, dict]] = None,
            *,
            workstation_config: Optional[workstations.WorkstationConfig] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.UpdateWorkstationConfigRequest, dict]]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [workstation_config, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_workstation_config]
    ...
    async def delete_workstation_config(self,
            request: Optional[Union[workstations.DeleteWorkstationConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_workstation_config]
    ...
    async def get_workstation(self,
            request: Optional[Union[workstations.GetWorkstationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.GetWorkstationRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_workstation]
    ...
    async def list_workstations(self,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.ListWorkstationsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_workstations]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListWorkstationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def list_usable_workstations(self,
            request: Optional[Union[workstations.ListUsableWorkstationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.ListUsableWorkstationsRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_usable_workstations]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListUsableWorkstationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def create_workstation(self,
            request: Optional[Union[workstations.CreateWorkstationRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            workstation: Optional[workstations.Workstation] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.CreateWorkstationRequest, dict]]):
                The request object. Message for creating a
                CreateWorkstation.
            parent (:class:`str`):
                Required. Parent resource name.
            ...
            workstation (:class:`google.cloud.workstations_v1.types.Workstation`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            workstation_id (:class:`str`):
                Required. ID to use for the
                workstation.

                This corresponds to the ``workstation_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.workstations_v1.types.Workstation`
                A single instance of a developer workstation with its
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, workstation, workstation_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_workstation]
    ...
    async def update_workstation(self,
            request: Optional[Union[workstations.UpdateWorkstationRequest, dict]] = None,
            *,
            workstation: Optional[workstations.Workstation] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.UpdateWorkstationRequest, dict]]):
                The request object. Request message for
                UpdateWorkstation.
            workstation (:class:`google.cloud.workstations_v1.types.Workstation`):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [workstation, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_workstation]
    ...
    async def delete_workstation(self,
            request: Optional[Union[workstations.DeleteWorkstationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.DeleteWorkstationRequest, dict]]):
                The request object. Request message for
                DeleteWorkstation.
            name (:class:`str`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_workstation]
    ...
    async def start_workstation(self,
            request: Optional[Union[workstations.StartWorkstationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Starts running a workstation so that users can
        connect to it.
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.StartWorkstationRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.start_workstation]
    ...
    async def stop_workstation(self,
            request: Optional[Union[workstations.StopWorkstationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.StopWorkstationRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_workstation]
    ...
    async def generate_access_token(self,
            request: Optional[Union[workstations.GenerateAccessTokenRequest, dict]] = None,
            *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1.types.GenerateAccessTokenRequest, dict]]):
                The request object. Request message for
                GenerateAccessToken.
            workstation (:class:`str`):
                Required. Name of the workstation for
                which the access token should be
                generated.

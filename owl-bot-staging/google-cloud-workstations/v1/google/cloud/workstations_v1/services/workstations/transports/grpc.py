...
class WorkstationsGrpcTransport(WorkstationsTransport):
    ...
    @property
    def get_workstation_cluster(self) -> Callable[
    ...
    @property
    def list_workstation_clusters(self) -> Callable[
    ...
    @property
    def create_workstation_cluster(self) -> Callable[
    ...
    @property
    def update_workstation_cluster(self) -> Callable[
    ...
    @property
    def delete_workstation_cluster(self) -> Callable[
    ...
    @property
    def get_workstation_config(self) -> Callable[
    ...
    @property
    def list_workstation_configs(self) -> Callable[
    ...
    @property
    def list_usable_workstation_configs(self) -> Callable[
        ...
        if 'list_usable_workstation_configs' not in self._stubs:
            self._stubs['list_usable_workstation_configs'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_workstation_config(self) -> Callable[
    ...
    @property
    def update_workstation_config(self) -> Callable[
    ...
    @property
    def delete_workstation_config(self) -> Callable[
    ...
    @property
    def get_workstation(self) -> Callable[
    ...
    @property
    def list_workstations(self) -> Callable[
    ...
    @property
    def list_usable_workstations(self) -> Callable[
    ...
    @property
    def create_workstation(self) -> Callable[
    ...
    @property
    def update_workstation(self) -> Callable[
    ...
    @property
    def delete_workstation(self) -> Callable[
    ...
    @property
    def start_workstation(self) -> Callable[
    ...
    @property
    def stop_workstation(self) -> Callable[

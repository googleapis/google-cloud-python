...
class AccessApprovalRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_approve_approval_request(self, request: accessapproval.ApproveApprovalRequestMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.ApproveApprovalRequestMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_approve_approval_request_with_metadata(self, response: accessapproval.ApprovalRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.ApprovalRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for approve_approval_request
    ...
    def pre_delete_access_approval_settings(self, request: accessapproval.DeleteAccessApprovalSettingsMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.DeleteAccessApprovalSettingsMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_dismiss_approval_request(self, request: accessapproval.DismissApprovalRequestMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.DismissApprovalRequestMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_dismiss_approval_request_with_metadata(self, response: accessapproval.ApprovalRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.ApprovalRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for dismiss_approval_request
    ...
    def pre_get_access_approval_service_account(self, request: accessapproval.GetAccessApprovalServiceAccountMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.GetAccessApprovalServiceAccountMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_access_approval_service_account_with_metadata(self, response: accessapproval.AccessApprovalServiceAccount, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.AccessApprovalServiceAccount, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_access_approval_service_account
    ...
    def pre_get_access_approval_settings(self, request: accessapproval.GetAccessApprovalSettingsMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.GetAccessApprovalSettingsMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_access_approval_settings_with_metadata(self, response: accessapproval.AccessApprovalSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.AccessApprovalSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_access_approval_settings
    ...
    def pre_get_approval_request(self, request: accessapproval.GetApprovalRequestMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.GetApprovalRequestMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_approval_request_with_metadata(self, response: accessapproval.ApprovalRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.ApprovalRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_approval_request
    ...
    def pre_invalidate_approval_request(self, request: accessapproval.InvalidateApprovalRequestMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.InvalidateApprovalRequestMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_invalidate_approval_request_with_metadata(self, response: accessapproval.ApprovalRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.ApprovalRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for invalidate_approval_request
    ...
    def pre_list_approval_requests(self, request: accessapproval.ListApprovalRequestsMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.ListApprovalRequestsMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_approval_requests_with_metadata(self, response: accessapproval.ListApprovalRequestsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.ListApprovalRequestsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_approval_requests
    ...
    def pre_update_access_approval_settings(self, request: accessapproval.UpdateAccessApprovalSettingsMessage, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.UpdateAccessApprovalSettingsMessage, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_access_approval_settings_with_metadata(self, response: accessapproval.AccessApprovalSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[accessapproval.AccessApprovalSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_access_approval_settings
...
class AccessApprovalRestTransport(_BaseAccessApprovalRestTransport):
    ...
    class _ApproveApprovalRequest(_BaseAccessApprovalRestTransport._BaseApproveApprovalRequest, AccessApprovalRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccessApprovalRestTransport._ApproveApprovalRequest._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteAccessApprovalSettings(_BaseAccessApprovalRestTransport._BaseDeleteAccessApprovalSettings, AccessApprovalRestStub):
        ...
        settings method over HTTP.
            ...
            # Send the request
            response = AccessApprovalRestTransport._DeleteAccessApprovalSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DismissApprovalRequest(_BaseAccessApprovalRestTransport._BaseDismissApprovalRequest, AccessApprovalRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccessApprovalRestTransport._DismissApprovalRequest._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetAccessApprovalServiceAccount(_BaseAccessApprovalRestTransport._BaseGetAccessApprovalServiceAccount, AccessApprovalRestStub):
        ...
        service account method over HTTP.
            ...
            # Send the request
            response = AccessApprovalRestTransport._GetAccessApprovalServiceAccount._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetAccessApprovalSettings(_BaseAccessApprovalRestTransport._BaseGetAccessApprovalSettings, AccessApprovalRestStub):
        ...
        settings method over HTTP.
            ...
            # Send the request
            response = AccessApprovalRestTransport._GetAccessApprovalSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetApprovalRequest(_BaseAccessApprovalRestTransport._BaseGetApprovalRequest, AccessApprovalRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccessApprovalRestTransport._GetApprovalRequest._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _InvalidateApprovalRequest(_BaseAccessApprovalRestTransport._BaseInvalidateApprovalRequest, AccessApprovalRestStub):
        ...
        request method over HTTP.
            ...
            # Send the request
            response = AccessApprovalRestTransport._InvalidateApprovalRequest._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListApprovalRequests(_BaseAccessApprovalRestTransport._BaseListApprovalRequests, AccessApprovalRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AccessApprovalRestTransport._ListApprovalRequests._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateAccessApprovalSettings(_BaseAccessApprovalRestTransport._BaseUpdateAccessApprovalSettings, AccessApprovalRestStub):
        ...
        settings method over HTTP.
            ...
            # Send the request
            response = AccessApprovalRestTransport._UpdateAccessApprovalSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

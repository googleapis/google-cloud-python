...
class DataformGrpcAsyncIOTransport(DataformTransport):
    ...
    def query_repository_directory_contents(self) -> Callable[
        ...
        if 'query_repository_directory_contents' not in self._stubs:
            self._stubs['query_repository_directory_contents'] = self.grpc_channel.unary_unary(
    ...
    def compute_repository_access_token_status(self) -> Callable[
        ...
        if 'compute_repository_access_token_status' not in self._stubs:
            self._stubs['compute_repository_access_token_status'] = self.grpc_channel.unary_unary(
    ...
    def query_compilation_result_actions(self) -> Callable[
        ...
        if 'query_compilation_result_actions' not in self._stubs:
            self._stubs['query_compilation_result_actions'] = self.grpc_channel.unary_unary(
    ...
    def query_workflow_invocation_actions(self) -> Callable[
        ...
        if 'query_workflow_invocation_actions' not in self._stubs:
            self._stubs['query_workflow_invocation_actions'] = self.grpc_channel.unary_unary(

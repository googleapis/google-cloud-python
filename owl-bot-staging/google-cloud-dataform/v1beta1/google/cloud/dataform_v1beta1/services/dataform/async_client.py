...
class DataformAsyncClient:
    ...
    get_transport_class = functools.partial(type(DataformClient).get_transport_class, type(DataformClient))
    ...
    async def commit_repository_changes(self,
    ...
    async def read_repository_file(self,
    ...
    async def query_repository_directory_contents(self,
    ...
    async def fetch_repository_history(self,
    ...
    async def compute_repository_access_token_status(self,
    ...
    async def fetch_remote_branches(self,
    ...
    async def install_npm_packages(self,
    ...
    async def pull_git_commits(self,
    ...
    async def push_git_commits(self,
    ...
    async def fetch_file_git_statuses(self,
    ...
    async def fetch_git_ahead_behind(self,
    ...
    async def commit_workspace_changes(self,
    ...
    async def reset_workspace_changes(self,
    ...
    async def fetch_file_diff(self,
    ...
    async def query_directory_contents(self,
    ...
    async def list_release_configs(self,
    ...
    async def get_release_config(self,
    ...
    async def create_release_config(self,
    ...
    async def update_release_config(self,
    ...
    async def delete_release_config(self,
    ...
    async def list_compilation_results(self,
    ...
    async def get_compilation_result(self,
    ...
    async def create_compilation_result(self,
    ...
    async def query_compilation_result_actions(self,
    ...
    async def list_workflow_configs(self,
    ...
    async def create_workflow_config(self,
    ...
    async def update_workflow_config(self,
    ...
    async def delete_workflow_config(self,
    ...
    async def list_workflow_invocations(self,
    ...
    async def get_workflow_invocation(self,
    ...
    async def create_workflow_invocation(self,
    ...
    async def delete_workflow_invocation(self,
    ...
    async def cancel_workflow_invocation(self,
    ...
    async def query_workflow_invocation_actions(self,

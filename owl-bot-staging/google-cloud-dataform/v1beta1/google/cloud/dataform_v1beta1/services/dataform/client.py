...
class DataformClient(metaclass=DataformClientMeta):
    ...
    @staticmethod
    def compilation_result_path(project: str,location: str,repository: str,compilation_result: str,) -> str:
        """Returns a fully-qualified compilation_result string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/compilationResults/{compilation_result}".format(project=project, location=location, repository=repository, compilation_result=compilation_result, )

    @staticmethod
    def parse_compilation_result_path(path: str) -> Dict[str,str]:
        """Parses a compilation_result path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/compilationResults/(?P<compilation_result>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def config_path(project: str,location: str,) -> str:
        """Returns a fully-qualified config string."""
        return "projects/{project}/locations/{location}/config".format(project=project, location=location, )
    ...
    @staticmethod
    def release_config_path(project: str,location: str,repository: str,release_config: str,) -> str:
        """Returns a fully-qualified release_config string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/releaseConfigs/{release_config}".format(project=project, location=location, repository=repository, release_config=release_config, )

    @staticmethod
    def parse_release_config_path(path: str) -> Dict[str,str]:
        """Parses a release_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/releaseConfigs/(?P<release_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def workflow_config_path(project: str,location: str,repository: str,workflow_config: str,) -> str:
        """Returns a fully-qualified workflow_config string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/workflowConfigs/{workflow_config}".format(project=project, location=location, repository=repository, workflow_config=workflow_config, )

    @staticmethod
    def parse_workflow_config_path(path: str) -> Dict[str,str]:
        """Parses a workflow_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/workflowConfigs/(?P<workflow_config>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def workflow_invocation_path(project: str,location: str,repository: str,workflow_invocation: str,) -> str:
        """Returns a fully-qualified workflow_invocation string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/workflowInvocations/{workflow_invocation}".format(project=project, location=location, repository=repository, workflow_invocation=workflow_invocation, )

    @staticmethod
    def parse_workflow_invocation_path(path: str) -> Dict[str,str]:
        """Parses a workflow_invocation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/workflowInvocations/(?P<workflow_invocation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def workspace_path(project: str,location: str,repository: str,workspace: str,) -> str:
        """Returns a fully-qualified workspace string."""
        return "projects/{project}/locations/{location}/repositories/{repository}/workspaces/{workspace}".format(project=project, location=location, repository=repository, workspace=workspace, )
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            DataformClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dataform_v1beta1.DataformClient`.",
                    extra = {
    ...
    def commit_repository_changes(self,
    ...
    def query_repository_directory_contents(self,
    ...
    def fetch_repository_history(self,
    ...
    def compute_repository_access_token_status(self,
    ...
    def fetch_file_git_statuses(self,
    ...
    def fetch_git_ahead_behind(self,
    ...
    def query_directory_contents(self,
    ...
    def create_release_config(self,
    ...
    def update_release_config(self,
    ...
    def delete_release_config(self,
    ...
    def create_compilation_result(self,
    ...
    def query_compilation_result_actions(self,
    ...
    def list_workflow_invocations(self,
    ...
    def delete_workflow_invocation(self,
    ...
    def cancel_workflow_invocation(self,
    ...
    def query_workflow_invocation_actions(self,

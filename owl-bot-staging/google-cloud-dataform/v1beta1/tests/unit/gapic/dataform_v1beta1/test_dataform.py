...
def test__get_default_mtls_endpoint():
    ...
    assert DataformClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert DataformClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert DataformClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test_dataform_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(DataformClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataformClient))
@mock.patch.object(DataformAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataformAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (DataformAsyncClient, transports.DataformGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DataformClient, transports.DataformGrpcTransport, "grpc", "false"),
    (DataformAsyncClient, transports.DataformGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_dataform_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    DataformClient, DataformAsyncClient
])
@mock.patch.object(DataformClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataformClient))
@mock.patch.object(DataformAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataformAsyncClient))
...
def test_dataform_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (DataformAsyncClient, transports.DataformGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DataformClient, transports.DataformRestTransport, "rest", None),
])
def test_dataform_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_dataform_client_client_options_from_dict():
    with mock.patch('google.cloud.dataform_v1beta1.services.dataform.transports.DataformGrpcTransport.__init__') as grpc_transport:
...
def test_dataform_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_list_repositories_async(transport: str = 'grpc_asyncio', request_type=dataform.ListRepositoriesRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.ListRepositoriesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_repositories_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, dataform.Repository)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_repository_async(transport: str = 'grpc_asyncio', request_type=dataform.GetRepositoryRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_repository_async(transport: str = 'grpc_asyncio', request_type=dataform.CreateRepositoryRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_repository_async(transport: str = 'grpc_asyncio', request_type=dataform.UpdateRepositoryRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_repository_async(transport: str = 'grpc_asyncio', request_type=dataform.DeleteRepositoryRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_remote_branches(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_remote_branches),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_fetch_remote_branches_async(transport: str = 'grpc_asyncio', request_type=dataform.FetchRemoteBranchesRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.FetchRemoteBranchesResponse(
            branches=['branches_value'],
        ))
...
@pytest.mark.asyncio
async def test_list_workspaces_async(transport: str = 'grpc_asyncio', request_type=dataform.ListWorkspacesRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.ListWorkspacesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_workspaces_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataform.Workspace)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_workspace_async(transport: str = 'grpc_asyncio', request_type=dataform.GetWorkspaceRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = dataform.Workspace(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_workspace_async(transport: str = 'grpc_asyncio', request_type=dataform.CreateWorkspaceRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_workspace_async(transport: str = 'grpc_asyncio', request_type=dataform.DeleteWorkspaceRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_install_npm_packages(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.install_npm_packages),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_install_npm_packages_async(transport: str = 'grpc_asyncio', request_type=dataform.InstallNpmPackagesRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.InstallNpmPackagesResponse(
        ))
...
def test_pull_git_commits(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pull_git_commits),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_pull_git_commits_async(transport: str = 'grpc_asyncio', request_type=dataform.PullGitCommitsRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_push_git_commits(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.push_git_commits),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_push_git_commits_async(transport: str = 'grpc_asyncio', request_type=dataform.PushGitCommitsRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_file_git_statuses(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_file_git_statuses),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_fetch_file_git_statuses_async(transport: str = 'grpc_asyncio', request_type=dataform.FetchFileGitStatusesRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.FetchFileGitStatusesResponse(
        ))
...
def test_fetch_git_ahead_behind(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_git_ahead_behind),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_fetch_git_ahead_behind_async(transport: str = 'grpc_asyncio', request_type=dataform.FetchGitAheadBehindRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.FetchGitAheadBehindResponse(
            commits_ahead=1358,
            commits_behind=1477,
        ))
...
def test_commit_workspace_changes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.commit_workspace_changes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_commit_workspace_changes_async(transport: str = 'grpc_asyncio', request_type=dataform.CommitWorkspaceChangesRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_reset_workspace_changes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.reset_workspace_changes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_reset_workspace_changes_async(transport: str = 'grpc_asyncio', request_type=dataform.ResetWorkspaceChangesRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_file_diff(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_file_diff),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_fetch_file_diff_async(transport: str = 'grpc_asyncio', request_type=dataform.FetchFileDiffRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_query_directory_contents_async(transport: str = 'grpc_asyncio', request_type=dataform.QueryDirectoryContentsRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.QueryDirectoryContentsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_query_directory_contents_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataform.QueryDirectoryContentsResponse.DirectoryEntry)
                   for i in results)
...
async def test_query_directory_contents_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.query_directory_contents(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_make_directory(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.make_directory),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_make_directory_async(transport: str = 'grpc_asyncio', request_type=dataform.MakeDirectoryRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.MakeDirectoryResponse(
        ))
...
def test_remove_directory(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_directory),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_remove_directory_async(transport: str = 'grpc_asyncio', request_type=dataform.RemoveDirectoryRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_directory(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.move_directory),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_move_directory_async(transport: str = 'grpc_asyncio', request_type=dataform.MoveDirectoryRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.MoveDirectoryResponse(
        ))
...
def test_read_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.read_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_read_file_async(transport: str = 'grpc_asyncio', request_type=dataform.ReadFileRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.ReadFileResponse(
            file_contents=b'file_contents_blob',
        ))
...
def test_remove_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_remove_file_async(transport: str = 'grpc_asyncio', request_type=dataform.RemoveFileRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.move_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_move_file_async(transport: str = 'grpc_asyncio', request_type=dataform.MoveFileRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.write_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_write_file_async(transport: str = 'grpc_asyncio', request_type=dataform.WriteFileRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.WriteFileResponse(
        ))
...
@pytest.mark.asyncio
async def test_list_compilation_results_async(transport: str = 'grpc_asyncio', request_type=dataform.ListCompilationResultsRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.ListCompilationResultsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_compilation_results_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataform.CompilationResult)
                   for i in results)
...
async def test_list_compilation_results_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_compilation_results(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_compilation_result(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_compilation_result),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_compilation_result_async(transport: str = 'grpc_asyncio', request_type=dataform.GetCompilationResultRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.CompilationResult(
            name='name_value',
            dataform_core_version='dataform_core_version_value',
        ))
...
def test_create_compilation_result(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_compilation_result),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = dataform.CompilationResult(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_compilation_result_async(transport: str = 'grpc_asyncio', request_type=dataform.CreateCompilationResultRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_query_compilation_result_actions_async(transport: str = 'grpc_asyncio', request_type=dataform.QueryCompilationResultActionsRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.QueryCompilationResultActionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_query_compilation_result_actions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataform.CompilationResultAction)
                   for i in results)
...
async def test_query_compilation_result_actions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.query_compilation_result_actions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
@pytest.mark.asyncio
async def test_list_workflow_invocations_async(transport: str = 'grpc_asyncio', request_type=dataform.ListWorkflowInvocationsRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.ListWorkflowInvocationsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_workflow_invocations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataform.WorkflowInvocation)
                   for i in results)
...
async def test_list_workflow_invocations_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_workflow_invocations(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_workflow_invocation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_workflow_invocation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_workflow_invocation_async(transport: str = 'grpc_asyncio', request_type=dataform.GetWorkflowInvocationRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.WorkflowInvocation(
            name='name_value',
            compilation_result='compilation_result_value',
            state=dataform.WorkflowInvocation.State.RUNNING,
        ))
...
def test_create_workflow_invocation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_workflow_invocation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = dataform.WorkflowInvocation(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_workflow_invocation_async(transport: str = 'grpc_asyncio', request_type=dataform.CreateWorkflowInvocationRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_workflow_invocation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_workflow_invocation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_workflow_invocation_async(transport: str = 'grpc_asyncio', request_type=dataform.DeleteWorkflowInvocationRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_workflow_invocation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_workflow_invocation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_cancel_workflow_invocation_async(transport: str = 'grpc_asyncio', request_type=dataform.CancelWorkflowInvocationRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_query_workflow_invocation_actions_async(transport: str = 'grpc_asyncio', request_type=dataform.QueryWorkflowInvocationActionsRequest):
    client = DataformAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataform.QueryWorkflowInvocationActionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_query_workflow_invocation_actions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataform.WorkflowInvocationAction)
                   for i in results)
...
def test_list_repositories_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        return_value = dataform.ListRepositoriesResponse.pb(return_value)
...
def test_list_repositories_rest_required_fields(request_type=dataform.ListRepositoriesRequest):
...
def test_list_repositories_rest_unset_required_fields():
    transport = transports.DataformRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DataformRestInterceptor, "post_list_repositories") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_list_repositories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.ListRepositoriesRequest.pb(dataform.ListRepositoriesRequest())
        ...
        req.return_value._content = dataform.ListRepositoriesResponse.to_json(dataform.ListRepositoriesResponse())
...
def test_list_repositories_rest_bad_request(transport: str = 'rest', request_type=dataform.ListRepositoriesRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_repositories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/repositories" % client.transport._host, args[1])
...
def test_get_repository_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.Repository.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_repository_rest_required_fields(request_type=dataform.GetRepositoryRequest):
    transport_class = transports.DataformRestTransport
...
def test_get_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_get_repository") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_get_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_repository_rest_bad_request(transport: str = 'rest', request_type=dataform.GetRepositoryRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_repository_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/repositories/*}" % client.transport._host, args[1])
...
def test_create_repository_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["repository"] = {'name': 'name_value', 'git_remote_settings': {'url': 'url_value', 'default_branch': 'default_branch_value', 'authentication_token_secret_version': 'authentication_token_secret_version_value', 'token_status': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = dataform.CreateRepositoryRequest.meta.fields["repository"]
...
def test_create_repository_rest_required_fields(request_type=dataform.CreateRepositoryRequest):
    transport_class = transports.DataformRestTransport
...
def test_create_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_create_repository") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_create_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.CreateRepositoryRequest.pb(dataform.CreateRepositoryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_repository_rest_bad_request(transport: str = 'rest', request_type=dataform.CreateRepositoryRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_repository_rest(request_type):
    ...
    request_init["repository"] = {'name': 'projects/sample1/locations/sample2/repositories/sample3', 'git_remote_settings': {'url': 'url_value', 'default_branch': 'default_branch_value', 'authentication_token_secret_version': 'authentication_token_secret_version_value', 'token_status': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = dataform.UpdateRepositoryRequest.meta.fields["repository"]
...
def test_update_repository_rest_required_fields(request_type=dataform.UpdateRepositoryRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_repository._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_update_repository") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_update_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.UpdateRepositoryRequest.pb(dataform.UpdateRepositoryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_repository_rest_bad_request(transport: str = 'rest', request_type=dataform.UpdateRepositoryRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_repository_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{repository.name=projects/*/locations/*/repositories/*}" % client.transport._host, args[1])
...
def test_delete_repository_rest_required_fields(request_type=dataform.DeleteRepositoryRequest):
    transport_class = transports.DataformRestTransport
...
def test_delete_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_delete_repository") as pre:
        pre.assert_not_called()
        pb_message = dataform.DeleteRepositoryRequest.pb(dataform.DeleteRepositoryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_repository_rest_bad_request(transport: str = 'rest', request_type=dataform.DeleteRepositoryRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_remote_branches_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.FetchRemoteBranchesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_fetch_remote_branches_rest_required_fields(request_type=dataform.FetchRemoteBranchesRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_remote_branches._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_remote_branches_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_fetch_remote_branches") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_fetch_remote_branches") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.FetchRemoteBranchesRequest.pb(dataform.FetchRemoteBranchesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.FetchRemoteBranchesResponse.to_json(dataform.FetchRemoteBranchesResponse())
        ...
        client.fetch_remote_branches(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_fetch_remote_branches_rest_bad_request(transport: str = 'rest', request_type=dataform.FetchRemoteBranchesRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_workspaces_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.ListWorkspacesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_workspaces_rest_required_fields(request_type=dataform.ListWorkspacesRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_workspaces._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_workspaces_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_list_workspaces") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_list_workspaces") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.ListWorkspacesResponse.to_json(dataform.ListWorkspacesResponse())
...
def test_list_workspaces_rest_bad_request(transport: str = 'rest', request_type=dataform.ListWorkspacesRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_workspaces_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/repositories/*}/workspaces" % client.transport._host, args[1])
...
def test_get_workspace_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/repositories/sample3/workspaces/sample4'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.Workspace.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_workspace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_get_workspace") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_get_workspace") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_workspace_rest_bad_request(transport: str = 'rest', request_type=dataform.GetWorkspaceRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_workspace_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/repositories/sample3/workspaces/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/repositories/*/workspaces/*}" % client.transport._host, args[1])
...
def test_create_workspace_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = dataform.CreateWorkspaceRequest.meta.fields["workspace"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["workspace"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["workspace"][field])):
                    del request_init["workspace"][field][i][subfield]
            else:
                del request_init["workspace"][field][subfield]
    request = request_type(**request_init)
...
def test_create_workspace_rest_required_fields(request_type=dataform.CreateWorkspaceRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_workspace._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_workspace_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("workspaceId", )) & set(("parent", "workspace", "workspaceId", )))
...
def test_create_workspace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_create_workspace") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_create_workspace") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.CreateWorkspaceRequest.pb(dataform.CreateWorkspaceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_workspace(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_workspace_rest_bad_request(transport: str = 'rest', request_type=dataform.CreateWorkspaceRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_workspace_rest_required_fields(request_type=dataform.DeleteWorkspaceRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_workspace._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_workspace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_delete_workspace") as pre:
        pre.assert_not_called()
        pb_message = dataform.DeleteWorkspaceRequest.pb(dataform.DeleteWorkspaceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_workspace(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_workspace_rest_bad_request(transport: str = 'rest', request_type=dataform.DeleteWorkspaceRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_install_npm_packages_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'workspace': 'projects/sample1/locations/sample2/repositories/sample3/workspaces/sample4'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.InstallNpmPackagesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_install_npm_packages_rest_required_fields(request_type=dataform.InstallNpmPackagesRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).install_npm_packages._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_install_npm_packages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_install_npm_packages") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_install_npm_packages") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.InstallNpmPackagesRequest.pb(dataform.InstallNpmPackagesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.InstallNpmPackagesResponse.to_json(dataform.InstallNpmPackagesResponse())
        ...
        client.install_npm_packages(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_install_npm_packages_rest_bad_request(transport: str = 'rest', request_type=dataform.InstallNpmPackagesRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pull_git_commits_rest_required_fields(request_type=dataform.PullGitCommitsRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).pull_git_commits._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pull_git_commits_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "author", )))
...
def test_pull_git_commits_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_pull_git_commits") as pre:
        pre.assert_not_called()
        ...
        client.pull_git_commits(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_push_git_commits_rest_required_fields(request_type=dataform.PushGitCommitsRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).push_git_commits._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_push_git_commits_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_push_git_commits") as pre:
        pre.assert_not_called()
        ...
        client.push_git_commits(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_push_git_commits_rest_bad_request(transport: str = 'rest', request_type=dataform.PushGitCommitsRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_file_git_statuses_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.FetchFileGitStatusesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_fetch_file_git_statuses_rest_required_fields(request_type=dataform.FetchFileGitStatusesRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_file_git_statuses._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_file_git_statuses_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_fetch_file_git_statuses") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_fetch_file_git_statuses") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.FetchFileGitStatusesRequest.pb(dataform.FetchFileGitStatusesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.FetchFileGitStatusesResponse.to_json(dataform.FetchFileGitStatusesResponse())
        ...
        client.fetch_file_git_statuses(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_fetch_file_git_statuses_rest_bad_request(transport: str = 'rest', request_type=dataform.FetchFileGitStatusesRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_git_ahead_behind_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.FetchGitAheadBehindResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_fetch_git_ahead_behind_rest_required_fields(request_type=dataform.FetchGitAheadBehindRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_git_ahead_behind._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_git_ahead_behind_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_fetch_git_ahead_behind") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_fetch_git_ahead_behind") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.FetchGitAheadBehindRequest.pb(dataform.FetchGitAheadBehindRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.FetchGitAheadBehindResponse.to_json(dataform.FetchGitAheadBehindResponse())
        ...
        client.fetch_git_ahead_behind(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_fetch_git_ahead_behind_rest_bad_request(transport: str = 'rest', request_type=dataform.FetchGitAheadBehindRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_commit_workspace_changes_rest_required_fields(request_type=dataform.CommitWorkspaceChangesRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).commit_workspace_changes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_commit_workspace_changes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_commit_workspace_changes") as pre:
        pre.assert_not_called()
        pb_message = dataform.CommitWorkspaceChangesRequest.pb(dataform.CommitWorkspaceChangesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.commit_workspace_changes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_commit_workspace_changes_rest_bad_request(transport: str = 'rest', request_type=dataform.CommitWorkspaceChangesRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_reset_workspace_changes_rest_required_fields(request_type=dataform.ResetWorkspaceChangesRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset_workspace_changes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_workspace_changes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_reset_workspace_changes") as pre:
        pre.assert_not_called()
        pb_message = dataform.ResetWorkspaceChangesRequest.pb(dataform.ResetWorkspaceChangesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.reset_workspace_changes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_reset_workspace_changes_rest_bad_request(transport: str = 'rest', request_type=dataform.ResetWorkspaceChangesRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_file_diff_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.FetchFileDiffResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_fetch_file_diff_rest_required_fields(request_type=dataform.FetchFileDiffRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_file_diff._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_file_diff_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_fetch_file_diff") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_fetch_file_diff") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.FetchFileDiffResponse.to_json(dataform.FetchFileDiffResponse())
        ...
        client.fetch_file_diff(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_fetch_file_diff_rest_bad_request(transport: str = 'rest', request_type=dataform.FetchFileDiffRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_directory_contents_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.QueryDirectoryContentsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_query_directory_contents_rest_required_fields(request_type=dataform.QueryDirectoryContentsRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_directory_contents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_directory_contents._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("page_size", "page_token", "path", ))
    jsonified_request.update(unset_fields)
...
def test_query_directory_contents_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", "path", )) & set(("workspace", )))
...
def test_query_directory_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_query_directory_contents") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_query_directory_contents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.QueryDirectoryContentsRequest.pb(dataform.QueryDirectoryContentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.QueryDirectoryContentsResponse.to_json(dataform.QueryDirectoryContentsResponse())
        ...
        client.query_directory_contents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_query_directory_contents_rest_bad_request(transport: str = 'rest', request_type=dataform.QueryDirectoryContentsRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_directory_contents_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataform.QueryDirectoryContentsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        sample_request = {'workspace': 'projects/sample1/locations/sample2/repositories/sample3/workspaces/sample4'}
...
def test_make_directory_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.MakeDirectoryResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_make_directory_rest_required_fields(request_type=dataform.MakeDirectoryRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).make_directory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_make_directory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_make_directory") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_make_directory") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.MakeDirectoryResponse.to_json(dataform.MakeDirectoryResponse())
        ...
        client.make_directory(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_make_directory_rest_bad_request(transport: str = 'rest', request_type=dataform.MakeDirectoryRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_directory_rest_required_fields(request_type=dataform.RemoveDirectoryRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_directory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_directory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_remove_directory") as pre:
        pre.assert_not_called()
        pb_message = dataform.RemoveDirectoryRequest.pb(dataform.RemoveDirectoryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.remove_directory(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_remove_directory_rest_bad_request(transport: str = 'rest', request_type=dataform.RemoveDirectoryRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_directory_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.MoveDirectoryResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_move_directory_rest_required_fields(request_type=dataform.MoveDirectoryRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).move_directory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_move_directory_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("workspace", "path", "newPath", )))
...
def test_move_directory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_move_directory") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_move_directory") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.MoveDirectoryResponse.to_json(dataform.MoveDirectoryResponse())
        ...
        client.move_directory(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_move_directory_rest_bad_request(transport: str = 'rest', request_type=dataform.MoveDirectoryRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_file_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.ReadFileResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_read_file_rest_required_fields(request_type=dataform.ReadFileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).read_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_read_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.ReadFileResponse.to_json(dataform.ReadFileResponse())
        ...
        client.read_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_read_file_rest_bad_request(transport: str = 'rest', request_type=dataform.ReadFileRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_file_rest_required_fields(request_type=dataform.RemoveFileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.remove_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_remove_file_rest_bad_request(transport: str = 'rest', request_type=dataform.RemoveFileRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_file_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.MoveFileResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_move_file_rest_required_fields(request_type=dataform.MoveFileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).move_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_move_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.MoveFileResponse.to_json(dataform.MoveFileResponse())
        ...
        client.move_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_move_file_rest_bad_request(transport: str = 'rest', request_type=dataform.MoveFileRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_file_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.WriteFileResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_write_file_rest_required_fields(request_type=dataform.WriteFileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).write_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_write_file_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("workspace", "path", "contents", )))
...
def test_write_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_write_file") as post, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.WriteFileResponse.to_json(dataform.WriteFileResponse())
        ...
        client.write_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_write_file_rest_bad_request(transport: str = 'rest', request_type=dataform.WriteFileRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_compilation_results_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.ListCompilationResultsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_compilation_results_rest_required_fields(request_type=dataform.ListCompilationResultsRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_compilation_results._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_compilation_results_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_list_compilation_results") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_list_compilation_results") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.ListCompilationResultsRequest.pb(dataform.ListCompilationResultsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.ListCompilationResultsResponse.to_json(dataform.ListCompilationResultsResponse())
        ...
        client.list_compilation_results(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_compilation_results_rest_bad_request(transport: str = 'rest', request_type=dataform.ListCompilationResultsRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_compilation_results_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/repositories/*}/compilationResults" % client.transport._host, args[1])
...
def test_list_compilation_results_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataform.ListCompilationResultsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_compilation_result_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/repositories/sample3/compilationResults/sample4'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.CompilationResult.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_compilation_result_rest_required_fields(request_type=dataform.GetCompilationResultRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_compilation_result._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_compilation_result_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_get_compilation_result") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_get_compilation_result") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.GetCompilationResultRequest.pb(dataform.GetCompilationResultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.CompilationResult.to_json(dataform.CompilationResult())
        ...
        client.get_compilation_result(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_compilation_result_rest_bad_request(transport: str = 'rest', request_type=dataform.GetCompilationResultRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_compilation_result_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/repositories/sample3/compilationResults/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/repositories/*/compilationResults/*}" % client.transport._host, args[1])
...
def test_create_compilation_result_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = dataform.CreateCompilationResultRequest.meta.fields["compilation_result"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["compilation_result"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["compilation_result"][field])):
                    del request_init["compilation_result"][field][i][subfield]
            else:
                del request_init["compilation_result"][field][subfield]
    request = request_type(**request_init)
...
def test_create_compilation_result_rest_required_fields(request_type=dataform.CreateCompilationResultRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_compilation_result._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_compilation_result_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "compilationResult", )))
...
def test_create_compilation_result_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_create_compilation_result") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_create_compilation_result") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.CreateCompilationResultRequest.pb(dataform.CreateCompilationResultRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_compilation_result(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_compilation_result_rest_bad_request(transport: str = 'rest', request_type=dataform.CreateCompilationResultRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_compilation_result_actions_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.QueryCompilationResultActionsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_query_compilation_result_actions_rest_required_fields(request_type=dataform.QueryCompilationResultActionsRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_compilation_result_actions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_compilation_result_actions_rest_unset_required_fields():
    ...
    unset_fields = transport.query_compilation_result_actions._get_unset_required_fields({})
...
def test_query_compilation_result_actions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_query_compilation_result_actions") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_query_compilation_result_actions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.QueryCompilationResultActionsRequest.pb(dataform.QueryCompilationResultActionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.QueryCompilationResultActionsResponse.to_json(dataform.QueryCompilationResultActionsResponse())
        ...
        client.query_compilation_result_actions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_query_compilation_result_actions_rest_bad_request(transport: str = 'rest', request_type=dataform.QueryCompilationResultActionsRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_compilation_result_actions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataform.QueryCompilationResultActionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.query_compilation_result_actions(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_list_workflow_invocations_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.ListWorkflowInvocationsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_workflow_invocations_rest_required_fields(request_type=dataform.ListWorkflowInvocationsRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_workflow_invocations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_workflow_invocations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_list_workflow_invocations") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_list_workflow_invocations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.ListWorkflowInvocationsRequest.pb(dataform.ListWorkflowInvocationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.ListWorkflowInvocationsResponse.to_json(dataform.ListWorkflowInvocationsResponse())
        ...
        client.list_workflow_invocations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_workflow_invocations_rest_bad_request(transport: str = 'rest', request_type=dataform.ListWorkflowInvocationsRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_workflow_invocations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/repositories/*}/workflowInvocations" % client.transport._host, args[1])
...
def test_list_workflow_invocations_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataform.ListWorkflowInvocationsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_workflow_invocation_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/repositories/sample3/workflowInvocations/sample4'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.WorkflowInvocation.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_workflow_invocation_rest_required_fields(request_type=dataform.GetWorkflowInvocationRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_workflow_invocation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_workflow_invocation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_get_workflow_invocation") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_get_workflow_invocation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.GetWorkflowInvocationRequest.pb(dataform.GetWorkflowInvocationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.WorkflowInvocation.to_json(dataform.WorkflowInvocation())
        ...
        client.get_workflow_invocation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_workflow_invocation_rest_bad_request(transport: str = 'rest', request_type=dataform.GetWorkflowInvocationRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_workflow_invocation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/repositories/sample3/workflowInvocations/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/repositories/*/workflowInvocations/*}" % client.transport._host, args[1])
...
def test_create_workflow_invocation_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["workflow_invocation"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["workflow_invocation"][field])):
                    del request_init["workflow_invocation"][field][i][subfield]
            else:
                del request_init["workflow_invocation"][field][subfield]
    request = request_type(**request_init)
...
def test_create_workflow_invocation_rest_required_fields(request_type=dataform.CreateWorkflowInvocationRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_workflow_invocation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_workflow_invocation_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "workflowInvocation", )))
...
def test_create_workflow_invocation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_create_workflow_invocation") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_create_workflow_invocation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.CreateWorkflowInvocationRequest.pb(dataform.CreateWorkflowInvocationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_workflow_invocation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_workflow_invocation_rest_bad_request(transport: str = 'rest', request_type=dataform.CreateWorkflowInvocationRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_workflow_invocation_rest_required_fields(request_type=dataform.DeleteWorkflowInvocationRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_workflow_invocation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_workflow_invocation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_delete_workflow_invocation") as pre:
        pre.assert_not_called()
        pb_message = dataform.DeleteWorkflowInvocationRequest.pb(dataform.DeleteWorkflowInvocationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_workflow_invocation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_workflow_invocation_rest_bad_request(transport: str = 'rest', request_type=dataform.DeleteWorkflowInvocationRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_workflow_invocation_rest_required_fields(request_type=dataform.CancelWorkflowInvocationRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_workflow_invocation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_workflow_invocation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_cancel_workflow_invocation") as pre:
        pre.assert_not_called()
        pb_message = dataform.CancelWorkflowInvocationRequest.pb(dataform.CancelWorkflowInvocationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.cancel_workflow_invocation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_cancel_workflow_invocation_rest_bad_request(transport: str = 'rest', request_type=dataform.CancelWorkflowInvocationRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_workflow_invocation_actions_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = dataform.QueryWorkflowInvocationActionsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_query_workflow_invocation_actions_rest_required_fields(request_type=dataform.QueryWorkflowInvocationActionsRequest):
    transport_class = transports.DataformRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_workflow_invocation_actions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_workflow_invocation_actions_rest_unset_required_fields():
    ...
    unset_fields = transport.query_workflow_invocation_actions._get_unset_required_fields({})
...
def test_query_workflow_invocation_actions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataformRestInterceptor, "post_query_workflow_invocation_actions") as post, \
         mock.patch.object(transports.DataformRestInterceptor, "pre_query_workflow_invocation_actions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = dataform.QueryWorkflowInvocationActionsRequest.pb(dataform.QueryWorkflowInvocationActionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataform.QueryWorkflowInvocationActionsResponse.to_json(dataform.QueryWorkflowInvocationActionsResponse())
        ...
        client.query_workflow_invocation_actions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_query_workflow_invocation_actions_rest_bad_request(transport: str = 'rest', request_type=dataform.QueryWorkflowInvocationActionsRequest):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_workflow_invocation_actions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataform.QueryWorkflowInvocationActionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.query_workflow_invocation_actions(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_dataform_base_transport():
    ...
    with mock.patch('google.cloud.dataform_v1beta1.services.dataform.transports.DataformTransport.__init__') as Transport:
...
def test_dataform_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dataform_v1beta1.services.dataform.transports.DataformTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataform_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dataform_v1beta1.services.dataform.transports.DataformTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataformTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.DataformGrpcTransport, transports.DataformGrpcAsyncIOTransport])
def test_dataform_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_dataform_host_no_port(transport_name):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='dataform.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'dataform.googleapis.com:443'
...
def test_dataform_host_with_port(transport_name):
    client = DataformClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='dataform.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.DataformGrpcTransport, transports.DataformGrpcAsyncIOTransport])
def test_dataform_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataformGrpcTransport, transports.DataformGrpcAsyncIOTransport])
def test_dataform_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_compilation_result_path():
    ...
    expected = "projects/{project}/locations/{location}/repositories/{repository}/compilationResults/{compilation_result}".format(project=project, location=location, repository=repository, compilation_result=compilation_result, )
    actual = DataformClient.compilation_result_path(project, location, repository, compilation_result)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.DataformTransport, '_prep_wrapped_messages') as prep:
        client = DataformClient(
            credentials=ga_credentials.AnonymousCredentials(),

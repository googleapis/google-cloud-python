...
class CloudRedisClusterRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_cluster(self, request: cloud_redis_cluster.CreateClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_redis_cluster.CreateClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_cluster(self, request: cloud_redis_cluster.DeleteClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_redis_cluster.DeleteClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_cluster(self, request: cloud_redis_cluster.GetClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_redis_cluster.GetClusterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_cluster_certificate_authority(self, request: cloud_redis_cluster.GetClusterCertificateAuthorityRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_redis_cluster.GetClusterCertificateAuthorityRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_clusters(self, request: cloud_redis_cluster.ListClustersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_redis_cluster.ListClustersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_cluster(self, request: cloud_redis_cluster.UpdateClusterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_redis_cluster.UpdateClusterRequest, Sequence[Tuple[str, str]]]:

...
class CloudRedisClusterGrpcTransport(CloudRedisClusterTransport):
    """gRPC backend transport for CloudRedisCluster.
    ...
    @property
    def get_cluster_certificate_authority(self) -> Callable[
    ...
    @property
    def reschedule_cluster_maintenance(self) -> Callable[
    ...
    @property
    def list_backup_collections(self) -> Callable[
    ...
    @property
    def get_backup_collection(self) -> Callable[
    ...
    @property
    def export_backup(self) -> Callable[
    ...
    @property
    def backup_cluster(self) -> Callable[
...
__all__ = (
    'CloudRedisClusterGrpcTransport',
)

...
# [START redis_v1beta1_generated_CloudRedisCluster_GetBackupCollection_sync]
...
def sample_get_backup_collection():
    # Create a client
    ...
    # Make the request
    response = client.get_backup_collection(request=request)

    # Handle the response
    print(response)

# [END redis_v1beta1_generated_CloudRedisCluster_GetBackupCollection_sync]

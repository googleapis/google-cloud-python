...
# [START redis_v1beta1_generated_CloudRedisCluster_ListClusters_sync]
...
def sample_list_clusters():
    ...
    request = redis_cluster_v1beta1.ListClustersRequest(
        parent="parent_value",
    )
...
# [END redis_v1beta1_generated_CloudRedisCluster_ListClusters_sync]

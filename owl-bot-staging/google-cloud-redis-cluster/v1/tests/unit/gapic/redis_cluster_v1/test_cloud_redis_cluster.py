...
def test_list_clusters_rest_required_fields(request_type=cloud_redis_cluster.ListClustersRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_clusters._get_unset_required_fields(jsonified_request)
...
def test_list_clusters_rest_unset_required_fields():
    transport = transports.CloudRedisClusterRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_cluster_rest_required_fields(request_type=cloud_redis_cluster.GetClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_cluster_rest_required_fields(request_type=cloud_redis_cluster.UpdateClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_cluster_rest_required_fields(request_type=cloud_redis_cluster.DeleteClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_cluster_rest_required_fields(request_type=cloud_redis_cluster.CreateClusterRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
from .transports.grpc import CloudRedisClusterGrpcTransport
from .transports.grpc_asyncio import CloudRedisClusterGrpcAsyncIOTransport
from .transports.rest import CloudRedisClusterRestTransport


class CloudRedisClusterClientMeta(type):
    """Metaclass for the CloudRedisCluster client.
...
class CloudRedisClusterClient(metaclass=CloudRedisClusterClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CloudRedisClusterClient: The constructed client.
        """
    ...
    def transport(self) -> CloudRedisClusterTransport:
        ...
        Returns:
            CloudRedisClusterTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def certificate_authority_path(project: str,location: str,cluster: str,) -> str:
        """Returns a fully-qualified certificate_authority string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/certificateAuthority".format(project=project, location=location, cluster=cluster, )
    ...
    def parse_certificate_authority_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/certificateAuthority$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudRedisClusterClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CloudRedisClusterClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CloudRedisClusterClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CloudRedisClusterTransport, Callable[..., CloudRedisClusterTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CloudRedisClusterClient._read_environment_variables()
        self._client_cert_source = CloudRedisClusterClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CloudRedisClusterClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CloudRedisClusterTransport)
        if transport_provided:
            # transport is a CloudRedisClusterTransport instance.
            ...
            self._transport = cast(CloudRedisClusterTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            CloudRedisClusterClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CloudRedisClusterTransport], Callable[..., CloudRedisClusterTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.redis.cluster_v1.CloudRedisClusterClient`.",
                    extra = {
    ...
    def list_clusters(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.ListClustersRequest, dict]):
    ...
    def get_cluster(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.GetClusterRequest, dict]):
    ...
    def delete_cluster(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.DeleteClusterRequest, dict]):
    ...
    def create_cluster(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.CreateClusterRequest, dict]):
    ...
    def get_cluster_certificate_authority(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.GetClusterCertificateAuthorityRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_cluster_certificate_authority]
    ...
    def reschedule_cluster_maintenance(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.RescheduleClusterMaintenanceRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reschedule_cluster_maintenance]
    ...
    def list_backup_collections(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.ListBackupCollectionsRequest, dict]):
    ...
    def get_backup_collection(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.GetBackupCollectionRequest, dict]):
    ...
    def list_backups(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.ListBackupsRequest, dict]):
    ...
    def get_backup(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.GetBackupRequest, dict]):
    ...
    def delete_backup(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.DeleteBackupRequest, dict]):
    ...
    def export_backup(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.ExportBackupRequest, dict]):
    ...
    def backup_cluster(self,
        ...
        Args:
            request (Union[google.cloud.redis_cluster_v1.types.BackupClusterRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.backup_cluster]
    ...
    def __enter__(self) -> "CloudRedisClusterClient":
        return self

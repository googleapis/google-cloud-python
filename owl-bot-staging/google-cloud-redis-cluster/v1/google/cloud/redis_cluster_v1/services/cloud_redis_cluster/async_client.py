...
from .transports.base import CloudRedisClusterTransport, DEFAULT_CLIENT_INFO
...
class CloudRedisClusterAsyncClient:
    ...
    async def get_cluster_certificate_authority(self,
    ...
    async def reschedule_cluster_maintenance(self,
    ...
    async def list_backup_collections(self,
    ...
    async def get_backup_collection(self,

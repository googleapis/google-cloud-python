...
#
# Snippet for GetClusterCertificateAuthority
...
def sample_get_cluster_certificate_authority():
    # Create a client
    ...
    # Make the request
    response = client.get_cluster_certificate_authority(request=request)

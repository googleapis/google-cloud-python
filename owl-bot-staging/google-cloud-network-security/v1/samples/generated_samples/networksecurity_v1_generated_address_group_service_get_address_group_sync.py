...
def sample_get_address_group():
    ...
    # Make the request
    response = client.get_address_group(request=request)

    # Handle the response
    print(response)

# [END networksecurity_v1_generated_AddressGroupService_GetAddressGroup_sync]

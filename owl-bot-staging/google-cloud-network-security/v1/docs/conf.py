...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-network-security",
...
man_pages = [
    (
        ...
        "google-cloud-network-security Documentation",
        [author],
        1,
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-network-security",
        "google-cloud-network-security Library",
        "APIs",
    )
]

...
class OrganizationAddressGroupServiceGrpcAsyncIOTransport(OrganizationAddressGroupServiceTransport):
    ...
    def list_address_groups(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAddressGroupsRequest],
                    Awaitable[~.ListAddressGroupsResponse]]:
    ...
    def list_address_group_references(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAddressGroupReferencesRequest],
                    Awaitable[~.ListAddressGroupReferencesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_address_groups: self._wrap_method(
                self.list_address_groups,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_address_group: self._wrap_method(
                self.get_address_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_address_group: self._wrap_method(
                self.create_address_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_address_group: self._wrap_method(
                self.update_address_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.add_address_group_items: self._wrap_method(
                self.add_address_group_items,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_address_group_items: self._wrap_method(
                self.remove_address_group_items,
                default_timeout=None,
                client_info=client_info,
            ),
            self.clone_address_group_items: self._wrap_method(
                self.clone_address_group_items,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_address_group: self._wrap_method(
                self.delete_address_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_address_group_references: self._wrap_method(

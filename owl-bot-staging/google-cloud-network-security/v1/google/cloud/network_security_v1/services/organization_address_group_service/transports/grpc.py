...
from .base import OrganizationAddressGroupServiceTransport, DEFAULT_CLIENT_INFO
...
class OrganizationAddressGroupServiceGrpcTransport(OrganizationAddressGroupServiceTransport):
    ...
    @property
    def list_address_groups(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAddressGroupsRequest],
        ...
        if 'list_address_groups' not in self._stubs:
            self._stubs['list_address_groups'] = self._logged_channel.unary_unary(
                '/google.cloud.networksecurity.v1.OrganizationAddressGroupService/ListAddressGroups',
                request_serializer=address_group.ListAddressGroupsRequest.serialize,
                response_deserializer=address_group.ListAddressGroupsResponse.deserialize,
            )
        return self._stubs['list_address_groups']

    @property
    def get_address_group(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetAddressGroupRequest],
                    ~.AddressGroup]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'get_address_group' not in self._stubs:
            self._stubs['get_address_group'] = self._logged_channel.unary_unary(
                '/google.cloud.networksecurity.v1.OrganizationAddressGroupService/GetAddressGroup',
                request_serializer=address_group.GetAddressGroupRequest.serialize,
                response_deserializer=address_group.AddressGroup.deserialize,
            )
        return self._stubs['get_address_group']

    @property
    def create_address_group(self) -> Callable[
        ...
        Returns:
            Callable[[~.CreateAddressGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'create_address_group' not in self._stubs:
            self._stubs['create_address_group'] = self._logged_channel.unary_unary(
                '/google.cloud.networksecurity.v1.OrganizationAddressGroupService/CreateAddressGroup',
                request_serializer=gcn_address_group.CreateAddressGroupRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs['create_address_group']

    @property
    def update_address_group(self) -> Callable[
        ...
        Returns:
            Callable[[~.UpdateAddressGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'update_address_group' not in self._stubs:
            self._stubs['update_address_group'] = self._logged_channel.unary_unary(
                '/google.cloud.networksecurity.v1.OrganizationAddressGroupService/UpdateAddressGroup',
                request_serializer=gcn_address_group.UpdateAddressGroupRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs['update_address_group']

    @property
    def add_address_group_items(self) -> Callable[
        ...
        Returns:
            Callable[[~.AddAddressGroupItemsRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'add_address_group_items' not in self._stubs:
            self._stubs['add_address_group_items'] = self._logged_channel.unary_unary(
                '/google.cloud.networksecurity.v1.OrganizationAddressGroupService/AddAddressGroupItems',
                request_serializer=gcn_address_group.AddAddressGroupItemsRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs['add_address_group_items']

    @property
    def remove_address_group_items(self) -> Callable[
        ...
        Returns:
            Callable[[~.RemoveAddressGroupItemsRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    @property
    def clone_address_group_items(self) -> Callable[
        ...
        Returns:
            Callable[[~.CloneAddressGroupItemsRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'clone_address_group_items' not in self._stubs:
            self._stubs['clone_address_group_items'] = self._logged_channel.unary_unary(
                '/google.cloud.networksecurity.v1.OrganizationAddressGroupService/CloneAddressGroupItems',
                request_serializer=gcn_address_group.CloneAddressGroupItemsRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs['clone_address_group_items']

    @property
    def delete_address_group(self) -> Callable[
        ...
        Returns:
            Callable[[~.DeleteAddressGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'delete_address_group' not in self._stubs:
            self._stubs['delete_address_group'] = self._logged_channel.unary_unary(
                '/google.cloud.networksecurity.v1.OrganizationAddressGroupService/DeleteAddressGroup',
                request_serializer=address_group.DeleteAddressGroupRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs['delete_address_group']

    @property
    def list_address_group_references(self) -> Callable[
...
__all__ = (
    'OrganizationAddressGroupServiceGrpcTransport',
)

...
class network_securityCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'add_address_group_items': ('address_group', 'items', 'request_id', ),
        'clone_address_group_items': ('address_group', 'source_address_group', 'request_id', ),
        'create_address_group': ('parent', 'address_group_id', 'address_group', 'request_id', ),
        ...
        'delete_address_group': ('name', 'request_id', ),
        'delete_authorization_policy': ('name', ),
        'delete_client_tls_policy': ('name', ),
        'delete_server_tls_policy': ('name', ),
        'get_address_group': ('name', ),
        'get_authorization_policy': ('name', ),
        'get_client_tls_policy': ('name', ),
        'get_server_tls_policy': ('name', ),
        'list_address_group_references': ('address_group', 'page_size', 'page_token', ),
        'list_address_groups': ('parent', 'page_size', 'page_token', 'return_partial_success', ),
        ...
        'remove_address_group_items': ('address_group', 'items', 'request_id', ),
        'update_address_group': ('address_group', 'update_mask', 'request_id', ),

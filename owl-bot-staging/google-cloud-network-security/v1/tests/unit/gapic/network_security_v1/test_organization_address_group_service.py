...
from google.cloud.network_security_v1.services.organization_address_group_service import OrganizationAddressGroupServiceAsyncClient
from google.cloud.network_security_v1.services.organization_address_group_service import OrganizationAddressGroupServiceClient
from google.cloud.network_security_v1.services.organization_address_group_service import pagers
from google.cloud.network_security_v1.services.organization_address_group_service import transports
...
@mock.patch.object(OrganizationAddressGroupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OrganizationAddressGroupServiceClient))
@mock.patch.object(OrganizationAddressGroupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OrganizationAddressGroupServiceAsyncClient))
def test__get_api_endpoint():
    ...
    assert OrganizationAddressGroupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == OrganizationAddressGroupServiceClient.DEFAULT_MTLS_ENDPOINT
    assert OrganizationAddressGroupServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert OrganizationAddressGroupServiceClient._get_api_endpoint(None, None, default_universe, "always") == OrganizationAddressGroupServiceClient.DEFAULT_MTLS_ENDPOINT
    assert OrganizationAddressGroupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == OrganizationAddressGroupServiceClient.DEFAULT_MTLS_ENDPOINT
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = OrganizationAddressGroupServiceClient(credentials=cred)
...
@pytest.mark.parametrize("client_class,transport_name", [
    (OrganizationAddressGroupServiceClient, "grpc"),
    (OrganizationAddressGroupServiceAsyncClient, "grpc_asyncio"),
...
def test_organization_address_group_service_client_get_transport_class():
    transport = OrganizationAddressGroupServiceClient.get_transport_class()
    ...
    assert transport == transports.OrganizationAddressGroupServiceGrpcTransport
...
@mock.patch.object(OrganizationAddressGroupServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OrganizationAddressGroupServiceAsyncClient))
...
@mock.patch.object(OrganizationAddressGroupServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OrganizationAddressGroupServiceClient))
@mock.patch.object(OrganizationAddressGroupServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OrganizationAddressGroupServiceAsyncClient))
def test_organization_address_group_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (OrganizationAddressGroupServiceAsyncClient, transports.OrganizationAddressGroupServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_organization_address_group_service_client_client_options_from_dict():
    with mock.patch('google.cloud.network_security_v1.services.organization_address_group_service.transports.OrganizationAddressGroupServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_address_groups(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        response = client.list_address_groups(request)
    ...
    assert isinstance(response, pagers.ListAddressGroupsPager)
...
async def test_list_address_groups_async(transport: str = 'grpc_asyncio', request_type=address_group.ListAddressGroupsRequest):
    ...
    with mock.patch.object(
        ...
        response = await client.list_address_groups(request)
...
@pytest.mark.asyncio
async def test_list_address_groups_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_address_groups_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_address_groups_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_address_groups_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_address_groups_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_address_groups(
            address_group.ListAddressGroupsRequest(),
            parent='parent_value',
        )


def test_list_address_groups_pager(transport_name: str = "grpc"):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, address_group.AddressGroup)
                   for i in results)
def test_list_address_groups_pages(transport_name: str = "grpc"):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_address_groups(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

@pytest.mark.asyncio
async def test_list_address_groups_async_pager():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_address_groups(request={},)
...
@pytest.mark.asyncio
async def test_list_address_groups_async_pages():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_address_group(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = address_group.AddressGroup(
            ...
            type_=address_group.AddressGroup.Type.IPV4,
            items=['items_value'],
            capacity=846,
            self_link='self_link_value',
            purpose=[address_group.AddressGroup.Purpose.DEFAULT],
        )
        response = client.get_address_group(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, address_group.AddressGroup)
    assert response.name == 'name_value'
    assert response.description == 'description_value'
    assert response.type_ == address_group.AddressGroup.Type.IPV4
...
def test_get_address_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_address_group_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_address_group in client._transport._wrapped_methods
...
async def test_get_address_group_async(transport: str = 'grpc_asyncio', request_type=address_group.GetAddressGroupRequest):
    ...
    with mock.patch.object(
        ...
        response = await client.get_address_group(request)
...
@pytest.mark.asyncio
async def test_get_address_group_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_address_group_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_address_group_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_address_group_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_address_group_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_address_group(
            address_group.GetAddressGroupRequest(),
            name='name_value',
        )
...
def test_create_address_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_address_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_address_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_address_group_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_address_group_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.create_address_group(
            parent='parent_value',
            address_group=gcn_address_group.AddressGroup(name='name_value'),
            address_group_id='address_group_id_value',
        )
        ...
        mock_val = 'parent_value'
        assert arg == mock_val
        arg = args[0].address_group
        mock_val = gcn_address_group.AddressGroup(name='name_value')
        assert arg == mock_val
        arg = args[0].address_group_id
        mock_val = 'address_group_id_value'
        assert arg == mock_val


def test_create_address_group_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_address_group_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_address_group_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_address_group(
            gcn_address_group.CreateAddressGroupRequest(),
            parent='parent_value',
            address_group=gcn_address_group.AddressGroup(name='name_value'),
            address_group_id='address_group_id_value',
...
def test_update_address_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_address_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_address_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_address_group_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_address_group_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_address_group_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_address_group_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_address_group_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_address_group(
            gcn_address_group.UpdateAddressGroupRequest(),
            address_group=gcn_address_group.AddressGroup(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_add_address_group_items_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_add_address_group_items_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_add_address_group_items_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.add_address_group_items(
            address_group='address_group_value',
            items=['items_value'],
        )
        ...
        _, args, _ = call.mock_calls[0]
        arg = args[0].address_group
        mock_val = 'address_group_value'
        assert arg == mock_val
        arg = args[0].items
        mock_val = ['items_value']
        assert arg == mock_val


def test_add_address_group_items_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_add_address_group_items_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_add_address_group_items_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.add_address_group_items(
            gcn_address_group.AddAddressGroupItemsRequest(),
            address_group='address_group_value',
            items=['items_value'],
        )
...
def test_remove_address_group_items(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_address_group_items),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_remove_address_group_items_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_remove_address_group_items_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_remove_address_group_items_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.remove_address_group_items(
            address_group='address_group_value',
            items=['items_value'],
        )
...
def test_remove_address_group_items_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_remove_address_group_items_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_remove_address_group_items_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.remove_address_group_items(
            gcn_address_group.RemoveAddressGroupItemsRequest(),
            address_group='address_group_value',
            items=['items_value'],
        )
...
def test_clone_address_group_items(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.clone_address_group_items),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_clone_address_group_items_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_clone_address_group_items_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_clone_address_group_items_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.clone_address_group_items(
            address_group='address_group_value',
            source_address_group='source_address_group_value',
        )
        ...
        mock_val = 'address_group_value'
        assert arg == mock_val
        arg = args[0].source_address_group
        mock_val = 'source_address_group_value'
        assert arg == mock_val


def test_clone_address_group_items_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_clone_address_group_items_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_clone_address_group_items_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.clone_address_group_items(
            gcn_address_group.CloneAddressGroupItemsRequest(),
            address_group='address_group_value',
            source_address_group='source_address_group_value',
        )
...
def test_delete_address_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_address_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_address_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_address_group_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_address_group_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_address_group_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_address_group_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_address_group_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_address_group(
            address_group.DeleteAddressGroupRequest(),
            name='name_value',
        )
...
def test_list_address_group_references(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        response = client.list_address_group_references(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListAddressGroupReferencesPager)
    assert response.next_page_token == 'next_page_token_value'


def test_list_address_group_references_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_list_address_group_references_async(transport: str = 'grpc_asyncio', request_type=gcn_address_group.ListAddressGroupReferencesRequest):
    ...
    with mock.patch.object(
        ...
        response = await client.list_address_group_references(request)
...
@pytest.mark.asyncio
async def test_list_address_group_references_field_headers_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_address_group_references_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_address_group_references_flattened_error():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_address_group_references_flattened_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_address_group_references_flattened_error_async():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_address_group_references(
            gcn_address_group.ListAddressGroupReferencesRequest(),
            address_group='address_group_value',
        )


def test_list_address_group_references_pager(transport_name: str = "grpc"):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, gcn_address_group.ListAddressGroupReferencesResponse.AddressGroupReference)
                   for i in results)
def test_list_address_group_references_pages(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_address_group_references(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

@pytest.mark.asyncio
async def test_list_address_group_references_async_pager():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_address_group_references(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
@pytest.mark.asyncio
async def test_list_address_group_references_async_pages():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_address_groups_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_list_address_groups_rest_required_fields(request_type=address_group.ListAddressGroupsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_address_groups._get_unset_required_fields(jsonified_request)
    ...
    return_value = address_group.ListAddressGroupsResponse()
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = address_group.ListAddressGroupsResponse.pb(return_value)
...
def test_list_address_groups_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", "returnPartialSuccess", )) & set(("parent", )))


def test_list_address_groups_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_address_groups(**mock_args)
...
def test_list_address_groups_rest_pager(transport: str = 'rest'):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        pages = list(client.list_address_groups(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token


def test_get_address_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_get_address_group_rest_required_fields(request_type=address_group.GetAddressGroupRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = address_group.AddressGroup.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_address_group_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.get_address_group(**mock_args)
...
def test_create_address_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_create_address_group_rest_required_fields(request_type=gcn_address_group.CreateAddressGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_address_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "addressGroupId" in jsonified_request
    assert jsonified_request["addressGroupId"] == request_init["address_group_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_address_group._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("address_group_id", "request_id", ))
    jsonified_request.update(unset_fields)
    ...
    assert jsonified_request["parent"] == 'parent_value'
    assert "addressGroupId" in jsonified_request
    assert jsonified_request["addressGroupId"] == 'address_group_id_value'
...
def test_create_address_group_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.create_address_group(**mock_args)
...
def test_update_address_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_update_address_group_rest_required_fields(request_type=gcn_address_group.UpdateAddressGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_address_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_address_group_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("addressGroup", )))


def test_update_address_group_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.update_address_group(**mock_args)
...
def test_add_address_group_items_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_add_address_group_items_rest_required_fields(request_type=gcn_address_group.AddAddressGroupItemsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_address_group_items._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # verify required fields with non-default values are left alone
    assert "addressGroup" in jsonified_request
    assert jsonified_request["addressGroup"] == 'address_group_value'
    assert "items" in jsonified_request
...
def test_add_address_group_items_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("addressGroup", "items", )))


def test_add_address_group_items_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.add_address_group_items(**mock_args)
...
def test_remove_address_group_items_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_remove_address_group_items_rest_required_fields(request_type=gcn_address_group.RemoveAddressGroupItemsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_address_group_items._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_address_group_items_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.remove_address_group_items(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{address_group=organizations/*/locations/*/addressGroups/*}:removeItems" % client.transport._host, args[1])


def test_remove_address_group_items_rest_flattened_error(transport: str = 'rest'):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_clone_address_group_items_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_clone_address_group_items_rest_required_fields(request_type=gcn_address_group.CloneAddressGroupItemsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).clone_address_group_items._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    assert "addressGroup" in jsonified_request
    assert jsonified_request["addressGroup"] == 'address_group_value'
    assert "sourceAddressGroup" in jsonified_request
    assert jsonified_request["sourceAddressGroup"] == 'source_address_group_value'
...
def test_clone_address_group_items_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("addressGroup", "sourceAddressGroup", )))


def test_clone_address_group_items_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.clone_address_group_items(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{address_group=organizations/*/locations/*/addressGroups/*}:cloneItems" % client.transport._host, args[1])


def test_clone_address_group_items_rest_flattened_error(transport: str = 'rest'):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_address_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_delete_address_group_rest_required_fields(request_type=address_group.DeleteAddressGroupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_address_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_address_group_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.delete_address_group(**mock_args)
...
def test_list_address_group_references_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OrganizationAddressGroupServiceClient(
...
def test_list_address_group_references_rest_required_fields(request_type=gcn_address_group.ListAddressGroupReferencesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_address_group_references._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_address_group_references_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", )) & set(("addressGroup", )))


def test_list_address_group_references_rest_flattened():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_address_group_references(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{address_group=organizations/*/locations/*/addressGroups/*}:listReferences" % client.transport._host, args[1])


def test_list_address_group_references_rest_flattened_error(transport: str = 'rest'):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_address_group_references_rest_pager(transport: str = 'rest'):
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_get_channel():
    ...
    transport = transports.OrganizationAddressGroupServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_list_address_groups_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_address_group_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_address_group_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_address_group_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_add_address_group_items_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_remove_address_group_items_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_clone_address_group_items_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_address_group_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_address_group_references_empty_call_grpc():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = OrganizationAddressGroupServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_address_groups_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_address_groups(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_address_group_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_address_group(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_address_group_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_address_group_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_add_address_group_items_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_remove_address_group_items_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_clone_address_group_items_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_address_group_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_address_group_references_empty_call_grpc_asyncio():
    client = OrganizationAddressGroupServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_address_group_references(request=None)
...
def test_list_address_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_list_address_groups") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_list_address_groups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_list_address_groups") as pre:
        ...
        client.list_address_groups(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_get_address_group") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_get_address_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_get_address_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = address_group.AddressGroup.to_json(address_group.AddressGroup())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = address_group.AddressGroup()
        post_with_metadata.return_value = address_group.AddressGroup(), metadata

        client.get_address_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_address_group_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1/locations/sample2'}
    request_init["address_group"] = {'name': 'name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'type_': 1, 'items': ['items_value1', 'items_value2'], 'capacity': 846, 'self_link': 'self_link_value', 'purpose': [1]}
    ...
    for field, value in request_init["address_group"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["address_group"][field])):
                    del request_init["address_group"][field][i][subfield]
            else:
                del request_init["address_group"][field][subfield]
    request = request_type(**request_init)
...
def test_create_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_create_address_group") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_create_address_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_create_address_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_address_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_address_group_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'address_group': {'name': 'organizations/sample1/locations/sample2/addressGroups/sample3'}}
    request_init["address_group"] = {'name': 'organizations/sample1/locations/sample2/addressGroups/sample3', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'type_': 1, 'items': ['items_value1', 'items_value2'], 'capacity': 846, 'self_link': 'self_link_value', 'purpose': [1]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_update_address_group") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_update_address_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_update_address_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_address_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_add_address_group_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_add_address_group_items") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_add_address_group_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_add_address_group_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.add_address_group_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_remove_address_group_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_remove_address_group_items") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_remove_address_group_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_remove_address_group_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.remove_address_group_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_clone_address_group_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_clone_address_group_items") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_clone_address_group_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_clone_address_group_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.clone_address_group_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_delete_address_group") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_delete_address_group_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_delete_address_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_address_group(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_address_group_references_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_list_address_group_references") as post, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "post_list_address_group_references_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.OrganizationAddressGroupServiceRestInterceptor, "pre_list_address_group_references") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_address_group_references(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_address_groups_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_address_group_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_address_group_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_add_address_group_items_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_remove_address_group_items_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_clone_address_group_items_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_address_group_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_address_group_references_empty_call_rest():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_organization_address_group_service_rest_lro_client():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_organization_address_group_service_base_transport_error():
...
def test_organization_address_group_service_base_transport():
    # Instantiate the base transport.
    with mock.patch('google.cloud.network_security_v1.services.organization_address_group_service.transports.OrganizationAddressGroupServiceTransport.__init__') as Transport:
...
def test_organization_address_group_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.network_security_v1.services.organization_address_group_service.transports.OrganizationAddressGroupServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_organization_address_group_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.network_security_v1.services.organization_address_group_service.transports.OrganizationAddressGroupServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OrganizationAddressGroupServiceTransport()
        adc.assert_called_once()
...
def test_organization_address_group_service_auth_adc():
...
def test_organization_address_group_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize("transport_class", [transports.OrganizationAddressGroupServiceGrpcTransport, transports.OrganizationAddressGroupServiceGrpcAsyncIOTransport])
...
def test_organization_address_group_service_client_transport_session_collision(transport_name):
    ...
    client2 = OrganizationAddressGroupServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.list_address_groups._session
    session2 = client2.transport.list_address_groups._session
    assert session1 != session2
    session1 = client1.transport.get_address_group._session
    session2 = client2.transport.get_address_group._session
    assert session1 != session2
    session1 = client1.transport.create_address_group._session
    session2 = client2.transport.create_address_group._session
    assert session1 != session2
    session1 = client1.transport.update_address_group._session
    session2 = client2.transport.update_address_group._session
    assert session1 != session2
    session1 = client1.transport.add_address_group_items._session
    session2 = client2.transport.add_address_group_items._session
    assert session1 != session2
    session1 = client1.transport.remove_address_group_items._session
    session2 = client2.transport.remove_address_group_items._session
    assert session1 != session2
    session1 = client1.transport.clone_address_group_items._session
    session2 = client2.transport.clone_address_group_items._session
    assert session1 != session2
    session1 = client1.transport.delete_address_group._session
    session2 = client2.transport.delete_address_group._session
    assert session1 != session2
    session1 = client1.transport.list_address_group_references._session
    session2 = client2.transport.list_address_group_references._session
    assert session1 != session2
def test_organization_address_group_service_grpc_transport_channel():
...
def test_organization_address_group_service_grpc_lro_client():
    client = OrganizationAddressGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='grpc',
    )
...
def test_address_group_path():
    project = "squid"
    location = "clam"
    address_group = "whelk"
    expected = "projects/{project}/locations/{location}/addressGroups/{address_group}".format(project=project, location=location, address_group=address_group, )
...
def test_parse_address_group_path():
    expected = {
        "project": "octopus",
        "location": "oyster",
        "address_group": "nudibranch",
    }
    path = OrganizationAddressGroupServiceClient.address_group_path(**expected)

    # Check that the path construction is reversible.
    actual = OrganizationAddressGroupServiceClient.parse_address_group_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = OrganizationAddressGroupServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = OrganizationAddressGroupServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = OrganizationAddressGroupServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = OrganizationAddressGroupServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = OrganizationAddressGroupServiceClient.parse_common_organization_path(path)
    assert expected == actual

def test_common_project_path():
    project = "squid"
    expected = "projects/{project}".format(project=project, )
    actual = OrganizationAddressGroupServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = OrganizationAddressGroupServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = OrganizationAddressGroupServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = OrganizationAddressGroupServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = OrganizationAddressGroupServiceClient.parse_common_location_path(path)
    assert expected == actual

...
def test_list_authorization_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_authorization_policies_with_metadata") as post_with_metadata, \
...
def test_get_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_authorization_policy_with_metadata") as post_with_metadata, \
...
def test_create_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_create_authorization_policy_with_metadata") as post_with_metadata, \
...
def test_update_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_update_authorization_policy_with_metadata") as post_with_metadata, \
...
def test_delete_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_delete_authorization_policy_with_metadata") as post_with_metadata, \
...
def test_list_server_tls_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_server_tls_policies_with_metadata") as post_with_metadata, \
...
def test_get_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_server_tls_policy_with_metadata") as post_with_metadata, \
...
def test_create_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_create_server_tls_policy_with_metadata") as post_with_metadata, \
...
def test_update_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_update_server_tls_policy_with_metadata") as post_with_metadata, \
...
def test_delete_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_delete_server_tls_policy_with_metadata") as post_with_metadata, \

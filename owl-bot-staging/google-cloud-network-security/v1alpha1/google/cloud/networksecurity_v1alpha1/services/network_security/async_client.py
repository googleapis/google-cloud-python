...
from google.cloud.networksecurity_v1alpha1.services.network_security import pagers
from google.cloud.networksecurity_v1alpha1.types import client_tls_policy
from google.cloud.networksecurity_v1alpha1.types import client_tls_policy as gcn_client_tls_policy
from google.cloud.networksecurity_v1alpha1.types import common
from google.cloud.networksecurity_v1alpha1.types import tls
...
class NetworkSecurityAsyncClient:
    ...
    async def list_client_tls_policies(self,
        ...
        .. code-block:: python
            ...
            from google.cloud import networksecurity_v1alpha1

            async def sample_list_client_tls_policies():
                # Create a client
                client = networksecurity_v1alpha1.NetworkSecurityAsyncClient()

                # Initialize request argument(s)
                request = networksecurity_v1alpha1.ListClientTlsPoliciesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.networksecurity_v1alpha1.types.ListClientTlsPoliciesRequest, dict]]):
        ...
        Returns:
            google.cloud.networksecurity_v1alpha1.services.network_security.pagers.ListClientTlsPoliciesAsyncPager:
    ...
    async def get_client_tls_policy(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_client_tls_policy():
                ...
                # Initialize request argument(s)
                request = networksecurity_v1alpha1.GetClientTlsPolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.networksecurity_v1alpha1.types.GetClientTlsPolicyRequest, dict]]):
                The request object. Request used by the
        ...
        Returns:
            google.cloud.networksecurity_v1alpha1.types.ClientTlsPolicy:
    ...
    async def create_client_tls_policy(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_client_tls_policy():
                ...
                # Initialize request argument(s)
                client_tls_policy = networksecurity_v1alpha1.ClientTlsPolicy()
                client_tls_policy.name = "name_value"

                request = networksecurity_v1alpha1.CreateClientTlsPolicyRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.networksecurity_v1alpha1.types.CreateClientTlsPolicyRequest, dict]]):
                The request object. Request used by the
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            client_tls_policy (:class:`google.cloud.networksecurity_v1alpha1.types.ClientTlsPolicy`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.networksecurity_v1alpha1.types.ClientTlsPolicy` ClientTlsPolicy is a resource that specifies how a client should authenticate
    ...
    async def update_client_tls_policy(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_client_tls_policy():
                ...
                request = networksecurity_v1alpha1.UpdateClientTlsPolicyRequest(
                    client_tls_policy=client_tls_policy,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.networksecurity_v1alpha1.types.UpdateClientTlsPolicyRequest, dict]]):
    ...
    async def delete_client_tls_policy(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_client_tls_policy():
                ...
                # Initialize request argument(s)
                request = networksecurity_v1alpha1.DeleteClientTlsPolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.networksecurity_v1alpha1.types.DeleteClientTlsPolicyRequest, dict]]):
                The request object. Request used by the

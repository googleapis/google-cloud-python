...
class ListClientTlsPoliciesPager:
    ...
    :class:`google.cloud.networksecurity_v1alpha1.types.ListClientTlsPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.networksecurity_v1alpha1.types.ListClientTlsPoliciesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.networksecurity_v1alpha1.types.ListClientTlsPoliciesRequest):
                The initial request object.
            response (google.cloud.networksecurity_v1alpha1.types.ListClientTlsPoliciesResponse):

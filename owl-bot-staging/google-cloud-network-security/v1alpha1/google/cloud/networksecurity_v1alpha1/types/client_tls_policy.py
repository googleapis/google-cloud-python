...
class ClientTlsPolicy(proto.Message):
    ...
    Attributes:
        ...
        sni (str):
            ...
            "secure.example.com".
        client_certificate (google.cloud.networksecurity_v1alpha1.types.CertificateProvider):
            ...
            this dictates mTLS.
        server_validation_ca (MutableSequence[google.cloud.networksecurity_v1alpha1.types.ValidationCA]):
...
class ListClientTlsPoliciesResponse(proto.Message):
    ...
    Attributes:
        client_tls_policies (MutableSequence[google.cloud.networksecurity_v1alpha1.types.ClientTlsPolicy]):
...
class CreateClientTlsPolicyRequest(proto.Message):
    ...
    Attributes:
        ...
        client_tls_policy_id (str):
            ...
            "client_mtls_policy".
        client_tls_policy (google.cloud.networksecurity_v1alpha1.types.ClientTlsPolicy):

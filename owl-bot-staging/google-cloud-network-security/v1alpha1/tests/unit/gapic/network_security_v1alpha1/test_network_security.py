...
from google.cloud.network_security_v1alpha1.services.network_security import NetworkSecurityAsyncClient
from google.cloud.network_security_v1alpha1.services.network_security import NetworkSecurityClient
from google.cloud.network_security_v1alpha1.services.network_security import pagers
from google.cloud.network_security_v1alpha1.services.network_security import transports
...
def test__read_environment_variables():
    assert NetworkSecurityClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert NetworkSecurityClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert NetworkSecurityClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert NetworkSecurityClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert NetworkSecurityClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert NetworkSecurityClient._get_client_cert_source(None, False) is None
    assert NetworkSecurityClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert NetworkSecurityClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert NetworkSecurityClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert NetworkSecurityClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(NetworkSecurityClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkSecurityClient))
@mock.patch.object(NetworkSecurityAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkSecurityAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NetworkSecurityClient._DEFAULT_UNIVERSE
    default_endpoint = NetworkSecurityClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = NetworkSecurityClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert NetworkSecurityClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert NetworkSecurityClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == NetworkSecurityClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkSecurityClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NetworkSecurityClient._get_api_endpoint(None, None, default_universe, "always") == NetworkSecurityClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkSecurityClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == NetworkSecurityClient.DEFAULT_MTLS_ENDPOINT
    assert NetworkSecurityClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert NetworkSecurityClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        NetworkSecurityClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert NetworkSecurityClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert NetworkSecurityClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert NetworkSecurityClient._get_universe_domain(None, None) == NetworkSecurityClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (NetworkSecurityClient, transports.NetworkSecurityRestTransport, "rest", "true"),
    (NetworkSecurityClient, transports.NetworkSecurityRestTransport, "rest", "false"),
])
@mock.patch.object(NetworkSecurityClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkSecurityClient))
@mock.patch.object(NetworkSecurityAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkSecurityAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    NetworkSecurityClient, NetworkSecurityAsyncClient
])
...
@mock.patch.object(NetworkSecurityClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkSecurityClient))
@mock.patch.object(NetworkSecurityAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkSecurityAsyncClient))
def test_network_security_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (NetworkSecurityClient, transports.NetworkSecurityGrpcTransport, "grpc", grpc_helpers),
    (NetworkSecurityAsyncClient, transports.NetworkSecurityGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_network_security_client_client_options_from_dict():
    with mock.patch('google.cloud.network_security_v1alpha1.services.network_security.transports.NetworkSecurityGrpcTransport.__init__') as grpc_transport:
...
def test_list_client_tls_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_client_tls_policies in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_client_tls_policies] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_client_tls_policies_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_client_tls_policies in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_client_tls_policies] = mock_rpc
...
def test_list_client_tls_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_client_tls_policies(request={}, retry=retry, timeout=timeout)
...
def test_get_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_client_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_client_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_client_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_client_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_client_tls_policy] = mock_rpc
...
def test_create_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_client_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_client_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_client_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_client_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_client_tls_policy] = mock_rpc
...
def test_update_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_client_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_client_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_client_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_client_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_client_tls_policy] = mock_rpc
...
def test_delete_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_client_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_client_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_client_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_client_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_client_tls_policy] = mock_rpc
...
def test_list_client_tls_policies_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_list_client_tls_policies_rest_required_fields(request_type=client_tls_policy.ListClientTlsPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_client_tls_policies._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = client_tls_policy.ListClientTlsPoliciesResponse.pb(return_value)
...
def test_list_client_tls_policies_rest_unset_required_fields():
    transport = transports.NetworkSecurityRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_client_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha1/{parent=projects/*/locations/*}/clientTlsPolicies" % client.transport._host, args[1])
...
def test_list_client_tls_policies_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(client_tls_policy.ListClientTlsPoliciesResponse.to_json(x) for x in response)
...
def test_get_client_tls_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_get_client_tls_policy_rest_required_fields(request_type=client_tls_policy.GetClientTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_client_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = client_tls_policy.ClientTlsPolicy.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/clientTlsPolicies/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{name=projects/*/locations/*/clientTlsPolicies/*}" % client.transport._host, args[1])
...
def test_create_client_tls_policy_rest_required_fields(request_type=gcn_client_tls_policy.CreateClientTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_client_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "clientTlsPolicyId" in jsonified_request
    assert jsonified_request["clientTlsPolicyId"] == request_init["client_tls_policy_id"]
...
def test_create_client_tls_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("clientTlsPolicyId", )) & set(("parent", "clientTlsPolicyId", "clientTlsPolicy", )))
...
def test_update_client_tls_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_update_client_tls_policy_rest_required_fields(request_type=gcn_client_tls_policy.UpdateClientTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_client_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'client_tls_policy': {'name': 'projects/sample1/locations/sample2/clientTlsPolicies/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha1/{client_tls_policy.name=projects/*/locations/*/clientTlsPolicies/*}" % client.transport._host, args[1])
...
def test_delete_client_tls_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_delete_client_tls_policy_rest_required_fields(request_type=client_tls_policy.DeleteClientTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_client_tls_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_client_tls_policies_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = client_tls_policy.ListClientTlsPoliciesResponse()
        client.list_client_tls_policies(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_client_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = client_tls_policy.ClientTlsPolicy()
        client.get_client_tls_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_client_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_client_tls_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_client_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_client_tls_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_client_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_client_tls_policy(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = NetworkSecurityAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_client_tls_policies_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_client_tls_policies(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_client_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_client_tls_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_client_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_client_tls_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_client_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_client_tls_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_client_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_client_tls_policy(request=None)
...
def test_transport_kind_rest():
    transport = NetworkSecurityClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_client_tls_policies_rest_bad_request(request_type=client_tls_policy.ListClientTlsPoliciesRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_client_tls_policies_rest_call_success(request_type):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_client_tls_policies_rest_interceptors(null_interceptor):
    transport = transports.NetworkSecurityRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NetworkSecurityRestInterceptor(),
        )
    client = NetworkSecurityClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_client_tls_policies") as post, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_client_tls_policies_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_list_client_tls_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_tls_policy.ListClientTlsPoliciesRequest.pb(client_tls_policy.ListClientTlsPoliciesRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_tls_policy.ListClientTlsPoliciesResponse.to_json(client_tls_policy.ListClientTlsPoliciesResponse())
        ...
        post_with_metadata.return_value = client_tls_policy.ListClientTlsPoliciesResponse(), metadata

        client.list_client_tls_policies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_client_tls_policy_rest_bad_request(request_type=client_tls_policy.GetClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/clientTlsPolicies/sample3'}
    request = request_type(**request_init)
...
def test_get_client_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_client_tls_policy") as post, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_client_tls_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_get_client_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_tls_policy.GetClientTlsPolicyRequest.pb(client_tls_policy.GetClientTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_tls_policy.ClientTlsPolicy.to_json(client_tls_policy.ClientTlsPolicy())
        req.return_value.content = return_value
        ...
        client.get_client_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_client_tls_policy_rest_bad_request(request_type=gcn_client_tls_policy.CreateClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_client_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    test_field = gcn_client_tls_policy.CreateClientTlsPolicyRequest.meta.fields["client_tls_policy"]
    ...
    for field, value in request_init["client_tls_policy"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["client_tls_policy"][field])):
                    del request_init["client_tls_policy"][field][i][subfield]
            else:
                del request_init["client_tls_policy"][field][subfield]
    request = request_type(**request_init)
...
def test_create_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_create_client_tls_policy") as post, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_create_client_tls_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_create_client_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcn_client_tls_policy.CreateClientTlsPolicyRequest.pb(gcn_client_tls_policy.CreateClientTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_client_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_client_tls_policy_rest_bad_request(request_type=gcn_client_tls_policy.UpdateClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'client_tls_policy': {'name': 'projects/sample1/locations/sample2/clientTlsPolicies/sample3'}}
    request = request_type(**request_init)
...
def test_update_client_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_update_client_tls_policy") as post, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_update_client_tls_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_update_client_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcn_client_tls_policy.UpdateClientTlsPolicyRequest.pb(gcn_client_tls_policy.UpdateClientTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_client_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_client_tls_policy_rest_bad_request(request_type=client_tls_policy.DeleteClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_client_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_delete_client_tls_policy") as post, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_delete_client_tls_policy_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NetworkSecurityRestInterceptor, "pre_delete_client_tls_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_tls_policy.DeleteClientTlsPolicyRequest.pb(client_tls_policy.DeleteClientTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_client_tls_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_client_tls_policies_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_client_tls_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_client_tls_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_client_tls_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_network_security_base_transport():
    ...
    with mock.patch('google.cloud.network_security_v1alpha1.services.network_security.transports.NetworkSecurityTransport.__init__') as Transport:
...
def test_network_security_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.network_security_v1alpha1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_security_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.network_security_v1alpha1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkSecurityTransport()
        adc.assert_called_once()

...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-networksecurity",
...
man_pages = [
    (
        ...
        "google-cloud-networksecurity Documentation",
        [author],
        1,
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-networksecurity",
        "google-cloud-networksecurity Library",
        "APIs",
    )
]

...
class ProductInputsServiceGrpcAsyncIOTransport(ProductInputsServiceTransport):
    ...
    def insert_product_input(self) -> Callable[
        ...
        if 'insert_product_input' not in self._stubs:
            self._stubs['insert_product_input'] = self._logged_channel.unary_unary(
    ...
    def delete_product_input(self) -> Callable[
        ...
        if 'delete_product_input' not in self._stubs:
            self._stubs['delete_product_input'] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.delete_product_input: self._wrap_method(

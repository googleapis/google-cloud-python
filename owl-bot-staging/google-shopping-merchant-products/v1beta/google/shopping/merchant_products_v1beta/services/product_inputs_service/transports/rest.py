...
from .base import ProductInputsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ProductInputsServiceRestTransport(ProductInputsServiceTransport):
    """REST backend transport for ProductInputsService.
    ...
    class _DeleteProductInput(ProductInputsServiceRestStub):
        def __hash__(self):
            return hash("DeleteProductInput")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/products/v1beta/{name=accounts/*/productInputs/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_product_input(request, metadata)
            pb_request = productinputs.DeleteProductInputRequest.pb(request)
    ...
    class _InsertProductInput(ProductInputsServiceRestStub):
        def __hash__(self):
            return hash("InsertProductInput")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/products/v1beta/{parent=accounts/*}/productInputs:insert',
                'body': 'product_input',
            },
            ]
            request, metadata = self._interceptor.pre_insert_product_input(request, metadata)
            pb_request = productinputs.InsertProductInputRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

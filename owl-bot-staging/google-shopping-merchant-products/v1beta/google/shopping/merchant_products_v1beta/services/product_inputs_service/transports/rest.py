...
class ProductInputsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_product_input(self, request: productinputs.DeleteProductInputRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[productinputs.DeleteProductInputRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert_product_input(self, request: productinputs.InsertProductInputRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[productinputs.InsertProductInputRequest, Sequence[Tuple[str, str]]]:

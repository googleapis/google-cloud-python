...
class ProductInputsServiceClient(metaclass=ProductInputsServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ProductInputsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def insert_product_input(self,
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1beta.types.InsertProductInputRequest, dict]):
    ...
    def delete_product_input(self,
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1beta.types.DeleteProductInputRequest, dict]):
                The request object. Request message for the

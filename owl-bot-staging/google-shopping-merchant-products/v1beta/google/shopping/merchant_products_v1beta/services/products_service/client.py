...
from google.shopping.merchant_products_v1beta.types import products
from google.shopping.merchant_products_v1beta.types import products_common
from google.shopping.type.types import types
from .transports.base import ProductsServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ProductsServiceGrpcTransport
from .transports.grpc_asyncio import ProductsServiceGrpcAsyncIOTransport
from .transports.rest import ProductsServiceRestTransport


class ProductsServiceClientMeta(type):
    """Metaclass for the ProductsService client.
...
class ProductsServiceClient(metaclass=ProductsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ProductsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ProductsServiceTransport:
        ...
        Returns:
            ProductsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def product_path(account: str,product: str,) -> str:
        """Returns a fully-qualified product string."""
        return "accounts/{account}/products/{product}".format(account=account, product=product, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ProductsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ProductsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ProductsServiceClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = ProductsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ProductsServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ProductsServiceTransport, Callable[..., ProductsServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the products service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ProductsServiceClient._read_environment_variables()
        self._client_cert_source = ProductsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ProductsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ProductsServiceTransport)
        if transport_provided:
            # transport is a ProductsServiceTransport instance.
            ...
            self._transport = cast(ProductsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ProductsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ProductsServiceTransport], Callable[..., ProductsServiceTransport]] = (
                ProductsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ProductsServiceTransport], transport)
            )
    ...
    def get_product(self,
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1beta.types.GetProductRequest, dict]):
    ...
    def list_products(self,
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1beta.types.ListProductsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_products_v1beta.services.products_service.pagers.ListProductsPager:
    ...
    def __enter__(self) -> "ProductsServiceClient":
        return self

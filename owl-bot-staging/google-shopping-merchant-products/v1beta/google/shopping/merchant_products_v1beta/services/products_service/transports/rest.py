...
from .base import ProductsServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ProductsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_product(self, request: products.GetProductRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[products.GetProductRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_product(self, response: products.Product) -> products.Product:
        ...
        """
        return response
    def pre_list_products(self, request: products.ListProductsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[products.ListProductsRequest, Sequence[Tuple[str, str]]]:

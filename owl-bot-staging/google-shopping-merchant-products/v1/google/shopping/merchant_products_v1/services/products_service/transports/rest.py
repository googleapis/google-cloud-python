...
class ProductsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_product(self, request: products.GetProductRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[products.GetProductRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_product_with_metadata(self, response: products.Product, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[products.Product, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_product
    ...
    def pre_list_products(self, request: products.ListProductsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[products.ListProductsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_products_with_metadata(self, response: products.ListProductsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[products.ListProductsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_products
...
class ProductsServiceRestTransport(_BaseProductsServiceRestTransport):
    ...
    class _GetProduct(_BaseProductsServiceRestTransport._BaseGetProduct, ProductsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProductsServiceRestTransport._GetProduct._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListProducts(_BaseProductsServiceRestTransport._BaseListProducts, ProductsServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ProductsServiceRestTransport._ListProducts._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

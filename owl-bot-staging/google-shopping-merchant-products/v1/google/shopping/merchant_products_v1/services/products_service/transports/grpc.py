...
from google.shopping.merchant_products_v1.types import products
from .base import ProductsServiceTransport, DEFAULT_CLIENT_INFO
...
class ProductsServiceGrpcTransport(ProductsServiceTransport):
    ...
    def get_product(self) -> Callable[
        ...
        if 'get_product' not in self._stubs:
            self._stubs['get_product'] = self._logged_channel.unary_unary(
                '/google.shopping.merchant.products.v1.ProductsService/GetProduct',
    ...
    def list_products(self) -> Callable[
        ...
        if 'list_products' not in self._stubs:
            self._stubs['list_products'] = self._logged_channel.unary_unary(
                '/google.shopping.merchant.products.v1.ProductsService/ListProducts',

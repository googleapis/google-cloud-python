...
from .transports.base import ProductInputsServiceTransport, DEFAULT_CLIENT_INFO
...
class ProductInputsServiceClient(metaclass=ProductInputsServiceClientMeta):
    ...
    @staticmethod
    def product_input_path(account: str,productinput: str,) -> str:
        """Returns a fully-qualified product_input string."""
        return "accounts/{account}/productInputs/{productinput}".format(account=account, productinput=productinput, )
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            ProductInputsServiceClient._get_api_endpoint(

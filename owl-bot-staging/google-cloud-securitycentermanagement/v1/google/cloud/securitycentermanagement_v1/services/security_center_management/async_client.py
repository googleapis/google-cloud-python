...
class SecurityCenterManagementAsyncClient:
    ...
    effective_event_threat_detection_custom_module_path = staticmethod(SecurityCenterManagementClient.effective_event_threat_detection_custom_module_path)
    parse_effective_event_threat_detection_custom_module_path = staticmethod(SecurityCenterManagementClient.parse_effective_event_threat_detection_custom_module_path)
    effective_security_health_analytics_custom_module_path = staticmethod(SecurityCenterManagementClient.effective_security_health_analytics_custom_module_path)
    ...
    parse_security_health_analytics_custom_module_path = staticmethod(SecurityCenterManagementClient.parse_security_health_analytics_custom_module_path)
    ...
    get_transport_class = functools.partial(type(SecurityCenterManagementClient).get_transport_class, type(SecurityCenterManagementClient))
    ...
    async def get_security_center_service(self,
    ...
    async def list_security_center_services(self,
    ...
    async def update_security_center_service(self,

...
from .transports.base import SecurityCenterManagementTransport, DEFAULT_CLIENT_INFO
...
class SecurityCenterManagementClient(metaclass=SecurityCenterManagementClientMeta):
    ...
    @staticmethod
    def effective_event_threat_detection_custom_module_path(organization: str,location: str,effective_event_threat_detection_custom_module: str,) -> str:
        """Returns a fully-qualified effective_event_threat_detection_custom_module string."""
        return "organizations/{organization}/locations/{location}/effectiveEventThreatDetectionCustomModules/{effective_event_threat_detection_custom_module}".format(organization=organization, location=location, effective_event_threat_detection_custom_module=effective_event_threat_detection_custom_module, )

    @staticmethod
    def parse_effective_event_threat_detection_custom_module_path(path: str) -> Dict[str,str]:
        """Parses a effective_event_threat_detection_custom_module path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/effectiveEventThreatDetectionCustomModules/(?P<effective_event_threat_detection_custom_module>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def effective_security_health_analytics_custom_module_path(organization: str,location: str,effective_security_health_analytics_custom_module: str,) -> str:
        """Returns a fully-qualified effective_security_health_analytics_custom_module string."""
        return "organizations/{organization}/locations/{location}/effectiveSecurityHealthAnalyticsCustomModules/{effective_security_health_analytics_custom_module}".format(organization=organization, location=location, effective_security_health_analytics_custom_module=effective_security_health_analytics_custom_module, )

    @staticmethod
    def parse_effective_security_health_analytics_custom_module_path(path: str) -> Dict[str,str]:
        """Parses a effective_security_health_analytics_custom_module path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/effectiveSecurityHealthAnalyticsCustomModules/(?P<effective_security_health_analytics_custom_module>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def event_threat_detection_custom_module_path(organization: str,location: str,event_threat_detection_custom_module: str,) -> str:
        """Returns a fully-qualified event_threat_detection_custom_module string."""
        return "organizations/{organization}/locations/{location}/eventThreatDetectionCustomModules/{event_threat_detection_custom_module}".format(organization=organization, location=location, event_threat_detection_custom_module=event_threat_detection_custom_module, )
    ...
    def parse_event_threat_detection_custom_module_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/eventThreatDetectionCustomModules/(?P<event_threat_detection_custom_module>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def security_center_service_path(project: str,location: str,service: str,) -> str:
        """Returns a fully-qualified security_center_service string."""
        return "projects/{project}/locations/{location}/securityCenterServices/{service}".format(project=project, location=location, service=service, )
    ...
    def parse_security_center_service_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/securityCenterServices/(?P<service>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def security_health_analytics_custom_module_path(organization: str,location: str,security_health_analytics_custom_module: str,) -> str:
        """Returns a fully-qualified security_health_analytics_custom_module string."""
        return "organizations/{organization}/locations/{location}/securityHealthAnalyticsCustomModules/{security_health_analytics_custom_module}".format(organization=organization, location=location, security_health_analytics_custom_module=security_health_analytics_custom_module, )
    ...
    def parse_security_health_analytics_custom_module_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/securityHealthAnalyticsCustomModules/(?P<security_health_analytics_custom_module>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SecurityCenterManagementClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SecurityCenterManagementClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SecurityCenterManagementTransport, Callable[..., SecurityCenterManagementTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SecurityCenterManagementClient._read_environment_variables()
        self._client_cert_source = SecurityCenterManagementClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SecurityCenterManagementClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SecurityCenterManagementTransport], Callable[..., SecurityCenterManagementTransport]] = (
    ...
    def list_effective_security_health_analytics_custom_modules(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_effective_security_health_analytics_custom_modules]
    ...
    def get_effective_security_health_analytics_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_effective_security_health_analytics_custom_module]
    ...
    def list_security_health_analytics_custom_modules(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_security_health_analytics_custom_modules]
    ...
    def list_descendant_security_health_analytics_custom_modules(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_descendant_security_health_analytics_custom_modules]
    ...
    def get_security_health_analytics_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_security_health_analytics_custom_module]
    ...
    def create_security_health_analytics_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_security_health_analytics_custom_module]
    ...
    def update_security_health_analytics_custom_module(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([security_health_analytics_custom_module, update_mask])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_security_health_analytics_custom_module]
    ...
    def delete_security_health_analytics_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_security_health_analytics_custom_module]
    ...
    def simulate_security_health_analytics_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.simulate_security_health_analytics_custom_module]
    ...
    def list_effective_event_threat_detection_custom_modules(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_effective_event_threat_detection_custom_modules]
    ...
    def get_effective_event_threat_detection_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_effective_event_threat_detection_custom_module]
    ...
    def list_event_threat_detection_custom_modules(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_event_threat_detection_custom_modules]
    ...
    def list_descendant_event_threat_detection_custom_modules(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_descendant_event_threat_detection_custom_modules]
    ...
    def get_event_threat_detection_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_event_threat_detection_custom_module]
    ...
    def create_event_threat_detection_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_event_threat_detection_custom_module]
    ...
    def update_event_threat_detection_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_event_threat_detection_custom_module]
    ...
    def delete_event_threat_detection_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_event_threat_detection_custom_module]
    ...
    def validate_event_threat_detection_custom_module(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.validate_event_threat_detection_custom_module]
    ...
    def get_security_center_service(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_security_center_service]
    ...
    def list_security_center_services(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_security_center_services]
    ...
    def update_security_center_service(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_security_center_service]

         # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("security_center_service.name", request.security_center_service.name),
            )),
        )

...
from .base import SecurityCenterManagementTransport, DEFAULT_CLIENT_INFO
...
class SecurityCenterManagementGrpcAsyncIOTransport(SecurityCenterManagementTransport):
    ...
    def list_effective_security_health_analytics_custom_modules(self) -> Callable[
        ...
        if 'list_effective_security_health_analytics_custom_modules' not in self._stubs:
            self._stubs['list_effective_security_health_analytics_custom_modules'] = self.grpc_channel.unary_unary(
    ...
    def get_effective_security_health_analytics_custom_module(self) -> Callable[
        ...
        if 'get_effective_security_health_analytics_custom_module' not in self._stubs:
            self._stubs['get_effective_security_health_analytics_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def list_security_health_analytics_custom_modules(self) -> Callable[
        ...
        if 'list_security_health_analytics_custom_modules' not in self._stubs:
            self._stubs['list_security_health_analytics_custom_modules'] = self.grpc_channel.unary_unary(
    ...
    def list_descendant_security_health_analytics_custom_modules(self) -> Callable[
        ...
        if 'list_descendant_security_health_analytics_custom_modules' not in self._stubs:
            self._stubs['list_descendant_security_health_analytics_custom_modules'] = self.grpc_channel.unary_unary(
    ...
    def get_security_health_analytics_custom_module(self) -> Callable[
        ...
        if 'get_security_health_analytics_custom_module' not in self._stubs:
            self._stubs['get_security_health_analytics_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def create_security_health_analytics_custom_module(self) -> Callable[
        ...
        if 'create_security_health_analytics_custom_module' not in self._stubs:
            self._stubs['create_security_health_analytics_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def update_security_health_analytics_custom_module(self) -> Callable[
        ...
        if 'update_security_health_analytics_custom_module' not in self._stubs:
            self._stubs['update_security_health_analytics_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def delete_security_health_analytics_custom_module(self) -> Callable[
        ...
        if 'delete_security_health_analytics_custom_module' not in self._stubs:
            self._stubs['delete_security_health_analytics_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def simulate_security_health_analytics_custom_module(self) -> Callable[
        ...
        if 'simulate_security_health_analytics_custom_module' not in self._stubs:
            self._stubs['simulate_security_health_analytics_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def list_effective_event_threat_detection_custom_modules(self) -> Callable[
        ...
        if 'list_effective_event_threat_detection_custom_modules' not in self._stubs:
            self._stubs['list_effective_event_threat_detection_custom_modules'] = self.grpc_channel.unary_unary(
    ...
    def get_effective_event_threat_detection_custom_module(self) -> Callable[
        ...
        if 'get_effective_event_threat_detection_custom_module' not in self._stubs:
            self._stubs['get_effective_event_threat_detection_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def list_event_threat_detection_custom_modules(self) -> Callable[
        ...
        if 'list_event_threat_detection_custom_modules' not in self._stubs:
            self._stubs['list_event_threat_detection_custom_modules'] = self.grpc_channel.unary_unary(
    ...
    def list_descendant_event_threat_detection_custom_modules(self) -> Callable[
        ...
        if 'list_descendant_event_threat_detection_custom_modules' not in self._stubs:
            self._stubs['list_descendant_event_threat_detection_custom_modules'] = self.grpc_channel.unary_unary(
    ...
    def get_event_threat_detection_custom_module(self) -> Callable[
        ...
        if 'get_event_threat_detection_custom_module' not in self._stubs:
            self._stubs['get_event_threat_detection_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def create_event_threat_detection_custom_module(self) -> Callable[
        ...
        if 'create_event_threat_detection_custom_module' not in self._stubs:
            self._stubs['create_event_threat_detection_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def update_event_threat_detection_custom_module(self) -> Callable[
        ...
        if 'update_event_threat_detection_custom_module' not in self._stubs:
            self._stubs['update_event_threat_detection_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def delete_event_threat_detection_custom_module(self) -> Callable[
        ...
        if 'delete_event_threat_detection_custom_module' not in self._stubs:
            self._stubs['delete_event_threat_detection_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def validate_event_threat_detection_custom_module(self) -> Callable[
        ...
        if 'validate_event_threat_detection_custom_module' not in self._stubs:
            self._stubs['validate_event_threat_detection_custom_module'] = self.grpc_channel.unary_unary(
    ...
    def list_security_center_services(self) -> Callable[
        ...
        if 'list_security_center_services' not in self._stubs:
            self._stubs['list_security_center_services'] = self.grpc_channel.unary_unary(
    ...
    def update_security_center_service(self) -> Callable[
        ...
        if 'update_security_center_service' not in self._stubs:
            self._stubs['update_security_center_service'] = self.grpc_channel.unary_unary(

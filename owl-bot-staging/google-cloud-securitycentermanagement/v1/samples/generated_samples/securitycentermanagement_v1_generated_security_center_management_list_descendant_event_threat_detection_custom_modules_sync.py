...
#
# Snippet for ListDescendantEventThreatDetectionCustomModules
...
# [END securitycentermanagement_v1_generated_SecurityCenterManagement_ListDescendantEventThreatDetectionCustomModules_sync]

...
from .base import NetAppTransport, DEFAULT_CLIENT_INFO
...
class NetAppGrpcTransport(NetAppTransport):
    ...
    @property
    def validate_directory_service(self) -> Callable[
    ...
    @property
    def switch_active_replica_zone(self) -> Callable[
    ...
    @property
    def establish_peering(self) -> Callable[
    ...
    @property
    def sync_replication(self) -> Callable[
    ...
    @property
    def create_backup_vault(self) -> Callable[
    ...
    @property
    def get_backup_vault(self) -> Callable[
    ...
    @property
    def list_backup_vaults(self) -> Callable[
    ...
    @property
    def update_backup_vault(self) -> Callable[
    ...
    @property
    def delete_backup_vault(self) -> Callable[
    ...
    @property
    def create_backup_policy(self) -> Callable[
    ...
    @property
    def get_backup_policy(self) -> Callable[
    ...
    @property
    def list_backup_policies(self) -> Callable[
    ...
    @property
    def update_backup_policy(self) -> Callable[
    ...
    @property
    def delete_backup_policy(self) -> Callable[
    ...
    @property
    def list_quota_rules(self) -> Callable[
    ...
    @property
    def get_quota_rule(self) -> Callable[
    ...
    @property
    def create_quota_rule(self) -> Callable[
    ...
    @property
    def update_quota_rule(self) -> Callable[
    ...
    @property
    def delete_quota_rule(self) -> Callable[

...
class NetAppClient(metaclass=NetAppClientMeta):
    ...
    @staticmethod
    def backup_path(project: str,location: str,backup_vault: str,backup: str,) -> str:
        """Returns a fully-qualified backup string."""
        return "projects/{project}/locations/{location}/backupVaults/{backup_vault}/backups/{backup}".format(project=project, location=location, backup_vault=backup_vault, backup=backup, )
    ...
    @staticmethod
    def backup_policy_path(project: str,location: str,backup_policy: str,) -> str:
        """Returns a fully-qualified backup_policy string."""
        return "projects/{project}/locations/{location}/backupPolicies/{backup_policy}".format(project=project, location=location, backup_policy=backup_policy, )
    ...
    @staticmethod
    def backup_vault_path(project: str,location: str,backup_vault: str,) -> str:
        """Returns a fully-qualified backup_vault string."""
        return "projects/{project}/locations/{location}/backupVaults/{backup_vault}".format(project=project, location=location, backup_vault=backup_vault, )
    ...
    @staticmethod
    def quota_rule_path(project: str,location: str,volume: str,quota_rule: str,) -> str:
        """Returns a fully-qualified quota_rule string."""
        return "projects/{project}/locations/{location}/volumes/{volume}/quotaRules/{quota_rule}".format(project=project, location=location, volume=volume, quota_rule=quota_rule, )
    ...
    def validate_directory_service(self,
    ...
    def switch_active_replica_zone(self,

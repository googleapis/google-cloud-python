...
from google.cloud.netapp_v1.types import cloud_netapp_service
...
class NetAppAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = NetAppClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    backup_path = staticmethod(NetAppClient.backup_path)
    parse_backup_path = staticmethod(NetAppClient.parse_backup_path)
    backup_policy_path = staticmethod(NetAppClient.backup_policy_path)
    ...
    quota_rule_path = staticmethod(NetAppClient.quota_rule_path)
    parse_quota_rule_path = staticmethod(NetAppClient.parse_quota_rule_path)
    ...
    get_transport_class = NetAppClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, NetAppTransport, Callable[..., NetAppTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.netapp_v1.NetAppAsyncClient`.",
                extra = {
    ...
    async def list_storage_pools(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_storage_pools]
    ...
    async def create_storage_pool(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, storage_pool, storage_pool_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_storage_pool]
    ...
    async def get_storage_pool(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_storage_pool]
    ...
    async def update_storage_pool(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [storage_pool, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_storage_pool]
    ...
    async def delete_storage_pool(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_storage_pool]
    ...
    async def validate_directory_service(self,
            request: Optional[Union[storage_pool.ValidateDirectoryServiceRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.validate_directory_service]
    ...
    async def switch_active_replica_zone(self,
            request: Optional[Union[storage_pool.SwitchActiveReplicaZoneRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.switch_active_replica_zone]
    ...
    async def create_volume(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, volume, volume_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_volume]
    ...
    async def delete_volume(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_volume]
    ...
    async def revert_volume(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.revert_volume]
    ...
    async def list_active_directories(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_active_directories]
    ...
    async def get_active_directory(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_active_directory]
    ...
    async def create_active_directory(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_active_directory]
    ...
    async def update_active_directory(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [active_directory, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_active_directory]
    ...
    async def delete_active_directory(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_active_directory]
    ...
    async def list_kms_configs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_kms_configs]
    ...
    async def create_kms_config(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, kms_config, kms_config_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_kms_config]
    ...
    async def get_kms_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_kms_config]
    ...
    async def update_kms_config(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [kms_config, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_kms_config]
    ...
    async def encrypt_volumes(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.encrypt_volumes]
    ...
    async def verify_kms_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.verify_kms_config]
    ...
    async def delete_kms_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_kms_config]
    ...
    async def list_replications(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_replications]
    ...
    async def get_replication(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_replication]
    ...
    async def create_replication(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, replication, replication_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_replication]
    ...
    async def delete_replication(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_replication]
    ...
    async def update_replication(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [replication, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_replication]
    ...
    async def stop_replication(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_replication]
    ...
    async def resume_replication(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.resume_replication]
    ...
    async def reverse_replication_direction(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reverse_replication_direction]
    ...
    async def establish_peering(self,
            request: Optional[Union[replication.EstablishPeeringRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.EstablishPeeringRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, replication.EstablishPeeringRequest):
            request = replication.EstablishPeeringRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.establish_peering]
    ...
    async def sync_replication(self,
            request: Optional[Union[replication.SyncReplicationRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation_async.AsyncOperation:
        r"""Syncs the replication. This will invoke one time
        ...
        .. code-block:: python
            ...
            async def sample_sync_replication():
                # Create a client
                client = netapp_v1.NetAppAsyncClient()

                # Initialize request argument(s)
                request = netapp_v1.SyncReplicationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.SyncReplicationRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, replication.SyncReplicationRequest):
            request = replication.SyncReplicationRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.sync_replication]
    ...
    async def create_backup_vault(self,
            request: Optional[Union[gcn_backup_vault.CreateBackupVaultRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.CreateBackupVaultRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup_vault (:class:`google.cloud.netapp_v1.types.BackupVault`):
            ...
            backup_vault_id (:class:`str`):
                ...
                hyphen, with the first character a
                letter, the last a letter or a number,
    ...
    async def get_backup_vault(self,
    ...
    async def list_backup_vaults(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.ListBackupVaultsRequest, dict]]):
    ...
    async def update_backup_vault(self,
            request: Optional[Union[gcn_backup_vault.UpdateBackupVaultRequest, dict]] = None,
            *,
            backup_vault: Optional[gcn_backup_vault.BackupVault] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.UpdateBackupVaultRequest, dict]]):
    ...
    async def delete_backup_vault(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.DeleteBackupVaultRequest, dict]]):
    ...
    async def create_backup(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.CreateBackupRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup (:class:`google.cloud.netapp_v1.types.Backup`):
    ...
    async def list_backups(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.ListBackupsRequest, dict]]):
    ...
    async def delete_backup(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.DeleteBackupRequest, dict]]):
    ...
    async def update_backup(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.UpdateBackupRequest, dict]]):
    ...
    async def create_backup_policy(self,
            request: Optional[Union[gcn_backup_policy.CreateBackupPolicyRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.CreateBackupPolicyRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup_policy (:class:`google.cloud.netapp_v1.types.BackupPolicy`):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, backup_policy, backup_policy_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_backup_policy]
    ...
    async def get_backup_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.GetBackupPolicyRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_backup_policy]
    ...
    async def list_backup_policies(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListBackupPoliciesAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.ListBackupPoliciesRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_backup_policies]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListBackupPoliciesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def update_backup_policy(self,
            request: Optional[Union[gcn_backup_policy.UpdateBackupPolicyRequest, dict]] = None,
            *,
            backup_policy: Optional[gcn_backup_policy.BackupPolicy] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.UpdateBackupPolicyRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [backup_policy, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_backup_policy]
    ...
    async def delete_backup_policy(self,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.DeleteBackupPolicyRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_backup_policy]
    ...
    async def list_quota_rules(self,
            request: Optional[Union[quota_rule.ListQuotaRulesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListQuotaRulesAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.ListQuotaRulesRequest, dict]]):
        ...
        Returns:
            google.cloud.netapp_v1.services.net_app.pagers.ListQuotaRulesAsyncPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, quota_rule.ListQuotaRulesRequest):
            request = quota_rule.ListQuotaRulesRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_quota_rules]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListQuotaRulesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_quota_rule(self,
            request: Optional[Union[quota_rule.GetQuotaRuleRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.GetQuotaRuleRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, quota_rule.GetQuotaRuleRequest):
            request = quota_rule.GetQuotaRuleRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_quota_rule]
    ...
    async def create_quota_rule(self,
            request: Optional[Union[gcn_quota_rule.CreateQuotaRuleRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            quota_rule: Optional[gcn_quota_rule.QuotaRule] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.CreateQuotaRuleRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            quota_rule (:class:`google.cloud.netapp_v1.types.QuotaRule`):
                Required. Fields of the to be created
                quota rule.

                This corresponds to the ``quota_rule`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            quota_rule_id (:class:`str`):
                Required. ID of the quota rule to
                create. Must be unique within the parent
                resource. Must contain only letters,
                ...
                This corresponds to the ``quota_rule_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.netapp_v1.types.QuotaRule` QuotaRule specifies the maximum disk space a user or group can use within a
                   volume. They can be used for creating default and
                   individual quota rules.

        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, quota_rule, quota_rule_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_quota_rule.CreateQuotaRuleRequest):
            request = gcn_quota_rule.CreateQuotaRuleRequest(request)
        ...
        if quota_rule is not None:
            request.quota_rule = quota_rule
        if quota_rule_id is not None:
            request.quota_rule_id = quota_rule_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_quota_rule]
    ...
    async def update_quota_rule(self,
            request: Optional[Union[gcn_quota_rule.UpdateQuotaRuleRequest, dict]] = None,
            *,
            quota_rule: Optional[gcn_quota_rule.QuotaRule] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.UpdateQuotaRuleRequest, dict]]):
                The request object. UpdateQuotaRuleRequest for updating a
                quota rule.
            quota_rule (:class:`google.cloud.netapp_v1.types.QuotaRule`):
                Required. The quota rule being
                updated
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                overwritten in the Quota Rule resource by the update.
                The fields specified in the update_mask are relative to
                the resource, not the full request. A field will be
                overwritten if it is in the mask. If the user does not
                provide a mask then all fields will be overwritten.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [quota_rule, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_quota_rule.UpdateQuotaRuleRequest):
            request = gcn_quota_rule.UpdateQuotaRuleRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_quota_rule]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("quota_rule.name", request.quota_rule.name),
            )),
        )
    ...
    async def delete_quota_rule(self,
            request: Optional[Union[quota_rule.DeleteQuotaRuleRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_quota_rule():
                # Create a client
                client = netapp_v1.NetAppAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.netapp_v1.types.DeleteQuotaRuleRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, quota_rule.DeleteQuotaRuleRequest):
            request = quota_rule.DeleteQuotaRuleRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_quota_rule]

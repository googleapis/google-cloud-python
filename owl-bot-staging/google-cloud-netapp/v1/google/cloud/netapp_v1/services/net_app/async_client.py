...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_backup_policy(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.create_backup_policy,
            default_timeout=60.0,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def get_backup_policy(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.get_backup_policy,
            default_retry=retries.AsyncRetry(
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                ),
    ...
    async def list_backup_policies(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.list_backup_policies,
            default_retry=retries.AsyncRetry(
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                ),
    ...
    async def update_backup_policy(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.update_backup_policy,
            default_timeout=60.0,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def delete_backup_policy(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.delete_backup_policy,
            default_timeout=60.0,
            client_info=DEFAULT_CLIENT_INFO,
        )

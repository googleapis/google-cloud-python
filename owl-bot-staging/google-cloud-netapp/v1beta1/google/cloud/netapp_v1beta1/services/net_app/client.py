...
class NetAppClient(metaclass=NetAppClientMeta):
    ...
    @staticmethod
    def active_directory_path(project: str,location: str,active_directory: str,) -> str:
        """Returns a fully-qualified active_directory string."""
        return "projects/{project}/locations/{location}/activeDirectories/{active_directory}".format(project=project, location=location, active_directory=active_directory, )
    ...
    @staticmethod
    def kms_config_path(project: str,location: str,kms_config: str,) -> str:
        """Returns a fully-qualified kms_config string."""
        return "projects/{project}/locations/{location}/kmsConfigs/{kms_config}".format(project=project, location=location, kms_config=kms_config, )
    ...
    @staticmethod
    def replication_path(project: str,location: str,volume: str,replication: str,) -> str:
        """Returns a fully-qualified replication string."""
        return "projects/{project}/locations/{location}/volumes/{volume}/replications/{replication}".format(project=project, location=location, volume=volume, replication=replication, )
    ...
    @staticmethod
    def snapshot_path(project: str,location: str,volume: str,snapshot: str,) -> str:
    ...
    @staticmethod
    def storage_pool_path(project: str,location: str,storage_pool: str,) -> str:
        """Returns a fully-qualified storage_pool string."""
        return "projects/{project}/locations/{location}/storagePools/{storage_pool}".format(project=project, location=location, storage_pool=storage_pool, )

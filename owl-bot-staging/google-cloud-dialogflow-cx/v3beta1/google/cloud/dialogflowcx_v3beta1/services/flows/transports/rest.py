...
class FlowsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_flow(self, request: gcdc_flow.CreateFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_flow.CreateFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_flow_with_metadata(self, response: gcdc_flow.Flow, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_flow.Flow, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_flow
    ...
    def pre_delete_flow(self, request: flow.DeleteFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.DeleteFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_export_flow(self, request: flow.ExportFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.ExportFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_flow_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_flow
    ...
    def pre_get_flow(self, request: flow.GetFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.GetFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_flow_with_metadata(self, response: flow.Flow, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.Flow, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_flow
    ...
    def pre_get_flow_validation_result(self, request: flow.GetFlowValidationResultRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.GetFlowValidationResultRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_flow_validation_result_with_metadata(self, response: flow.FlowValidationResult, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.FlowValidationResult, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_flow_validation_result
    ...
    def pre_import_flow(self, request: flow.ImportFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.ImportFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_flow_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_flow
    ...
    def pre_list_flows(self, request: flow.ListFlowsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.ListFlowsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_flows_with_metadata(self, response: flow.ListFlowsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.ListFlowsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_flows
    ...
    def pre_train_flow(self, request: flow.TrainFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.TrainFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_train_flow_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for train_flow
    ...
    def pre_update_flow(self, request: gcdc_flow.UpdateFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_flow.UpdateFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_flow_with_metadata(self, response: gcdc_flow.Flow, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_flow.Flow, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_flow
    ...
    def pre_validate_flow(self, request: flow.ValidateFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.ValidateFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_validate_flow_with_metadata(self, response: flow.FlowValidationResult, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[flow.FlowValidationResult, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for validate_flow
...
class FlowsRestTransport(_BaseFlowsRestTransport):
    ...
    class _CreateFlow(_BaseFlowsRestTransport._BaseCreateFlow, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._CreateFlow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ExportFlow(_BaseFlowsRestTransport._BaseExportFlow, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._ExportFlow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetFlowValidationResult(_BaseFlowsRestTransport._BaseGetFlowValidationResult, FlowsRestStub):
        ...
        result method over HTTP.
            ...
            # Send the request
            response = FlowsRestTransport._GetFlowValidationResult._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ImportFlow(_BaseFlowsRestTransport._BaseImportFlow, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._ImportFlow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TrainFlow(_BaseFlowsRestTransport._BaseTrainFlow, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._TrainFlow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateFlow(_BaseFlowsRestTransport._BaseUpdateFlow, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._UpdateFlow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ValidateFlow(_BaseFlowsRestTransport._BaseValidateFlow, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._ValidateFlow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseFlowsRestTransport._BaseCancelOperation, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseFlowsRestTransport._BaseListOperations, FlowsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FlowsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

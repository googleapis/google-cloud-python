...
class FlowsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_flow(self, request: gcdc_flow.CreateFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_flow.CreateFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_flow(self, request: flow.DeleteFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.DeleteFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_export_flow(self, request: flow.ExportFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.ExportFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_flow(self, request: flow.GetFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.GetFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_flow_validation_result(self, request: flow.GetFlowValidationResultRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.GetFlowValidationResultRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_import_flow(self, request: flow.ImportFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.ImportFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_flows(self, request: flow.ListFlowsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.ListFlowsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_train_flow(self, request: flow.TrainFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.TrainFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_flow(self, request: gcdc_flow.UpdateFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_flow.UpdateFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_validate_flow(self, request: flow.ValidateFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[flow.ValidateFlowRequest, Sequence[Tuple[str, str]]]:

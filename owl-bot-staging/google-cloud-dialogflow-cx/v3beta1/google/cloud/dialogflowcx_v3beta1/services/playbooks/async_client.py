...
class PlaybooksAsyncClient:
    ...
    get_transport_class = functools.partial(type(PlaybooksClient).get_transport_class, type(PlaybooksClient))
    ...
    async def delete_playbook(self,
    ...
    async def update_playbook(self,
    ...
    async def get_playbook_version(self,
    ...
    async def list_playbook_versions(self,
    ...
    async def delete_playbook_version(self,

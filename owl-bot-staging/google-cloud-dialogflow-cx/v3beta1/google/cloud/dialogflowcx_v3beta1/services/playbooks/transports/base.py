...
class PlaybooksTransport(abc.ABC):
    """Abstract transport class for Playbooks."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_playbook: gapic_v1.method.wrap_method(
                self.create_playbook,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_playbook: gapic_v1.method.wrap_method(
                self.delete_playbook,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_playbooks: gapic_v1.method.wrap_method(
                self.list_playbooks,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_playbook: gapic_v1.method.wrap_method(
                self.get_playbook,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.create_playbook_version: gapic_v1.method.wrap_method(
            ...
            self.list_playbook_versions: gapic_v1.method.wrap_method(
                self.list_playbook_versions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_playbook_version: gapic_v1.method.wrap_method(
    ...
    @property
    def create_playbook(self) -> Callable[
            [gcdc_playbook.CreatePlaybookRequest],
            Union[
                gcdc_playbook.Playbook,
                Awaitable[gcdc_playbook.Playbook]
            ]]:
        raise NotImplementedError()

    @property
    def delete_playbook(self) -> Callable[
    ...
    @property
    def list_playbooks(self) -> Callable[
            [playbook.ListPlaybooksRequest],
            Union[
                playbook.ListPlaybooksResponse,
                Awaitable[playbook.ListPlaybooksResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_playbook(self) -> Callable[
            [playbook.GetPlaybookRequest],
            Union[
                playbook.Playbook,
                Awaitable[playbook.Playbook]
            ]]:
        raise NotImplementedError()

    @property
    def export_playbook(self) -> Callable[
    ...
    @property
    def import_playbook(self) -> Callable[
    ...
    @property
    def update_playbook(self) -> Callable[
    ...
    @property
    def create_playbook_version(self) -> Callable[
            [playbook.CreatePlaybookVersionRequest],
            Union[
                playbook.PlaybookVersion,
                Awaitable[playbook.PlaybookVersion]
            ]]:
        raise NotImplementedError()

    @property
    def get_playbook_version(self) -> Callable[
    ...
    @property
    def restore_playbook_version(self) -> Callable[
    ...
    @property
    def list_playbook_versions(self) -> Callable[
    ...
    @property
    def delete_playbook_version(self) -> Callable[

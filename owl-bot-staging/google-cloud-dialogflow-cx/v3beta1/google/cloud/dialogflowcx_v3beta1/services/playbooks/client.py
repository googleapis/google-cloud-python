...
from .transports.base import PlaybooksTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import PlaybooksGrpcTransport
from .transports.grpc_asyncio import PlaybooksGrpcAsyncIOTransport
from .transports.rest import PlaybooksRestTransport


class PlaybooksClientMeta(type):
    """Metaclass for the Playbooks client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[PlaybooksTransport]]
    _transport_registry["grpc"] = PlaybooksGrpcTransport
    _transport_registry["grpc_asyncio"] = PlaybooksGrpcAsyncIOTransport
    _transport_registry["rest"] = PlaybooksRestTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[PlaybooksTransport]:
...
class PlaybooksClient(metaclass=PlaybooksClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PlaybooksClient: The constructed client.
        """
    ...
    def transport(self) -> PlaybooksTransport:
        ...
        Returns:
            PlaybooksTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def example_path(project: str,location: str,agent: str,playbook: str,example: str,) -> str:
        """Returns a fully-qualified example string."""
        return "projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/examples/{example}".format(project=project, location=location, agent=agent, playbook=playbook, example=example, )

    @staticmethod
    def parse_example_path(path: str) -> Dict[str,str]:
        """Parses a example path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/playbooks/(?P<playbook>.+?)/examples/(?P<example>.+?)$", path)
    ...
    @staticmethod
    def generator_path(project: str,location: str,agent: str,generator: str,) -> str:
        """Returns a fully-qualified generator string."""
        return "projects/{project}/locations/{location}/agents/{agent}/generators/{generator}".format(project=project, location=location, agent=agent, generator=generator, )

    @staticmethod
    def parse_generator_path(path: str) -> Dict[str,str]:
        """Parses a generator path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/generators/(?P<generator>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def playbook_path(project: str,location: str,agent: str,playbook: str,) -> str:
        """Returns a fully-qualified playbook string."""
        return "projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}".format(project=project, location=location, agent=agent, playbook=playbook, )

    @staticmethod
    def parse_playbook_path(path: str) -> Dict[str,str]:
        """Parses a playbook path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/playbooks/(?P<playbook>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def playbook_version_path(project: str,location: str,agent: str,playbook: str,version: str,) -> str:
        """Returns a fully-qualified playbook_version string."""
        return "projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/versions/{version}".format(project=project, location=location, agent=agent, playbook=playbook, version=version, )

    @staticmethod
    def parse_playbook_version_path(path: str) -> Dict[str,str]:
        """Parses a playbook_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/playbooks/(?P<playbook>.+?)/versions/(?P<version>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def tool_path(project: str,location: str,agent: str,tool: str,) -> str:
        """Returns a fully-qualified tool string."""
        return "projects/{project}/locations/{location}/agents/{agent}/tools/{tool}".format(project=project, location=location, agent=agent, tool=tool, )

    @staticmethod
    def parse_tool_path(path: str) -> Dict[str,str]:
        """Parses a tool path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/tools/(?P<tool>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PlaybooksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PlaybooksClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PlaybooksTransport, Callable[..., PlaybooksTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PlaybooksClient._read_environment_variables()
        self._client_cert_source = PlaybooksClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PlaybooksClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PlaybooksTransport)
        if transport_provided:
            # transport is a PlaybooksTransport instance.
            ...
            self._transport = cast(PlaybooksTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PlaybooksTransport], Callable[..., PlaybooksTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3beta1.PlaybooksClient`.",
                    extra = {
    ...
    def create_playbook(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.CreatePlaybookRequest, dict]):
        ...
        flattened_params = [parent, playbook]
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_playbook]
    ...
    def delete_playbook(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.DeletePlaybookRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_playbook]
    ...
    def list_playbooks(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ListPlaybooksRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.playbooks.pagers.ListPlaybooksPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_playbooks]
        ...
        response = pagers.ListPlaybooksPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_playbook(self,
        ...
        .. code-block:: python
            ...
            def sample_get_playbook():
                ...
                # Make the request
                response = client.get_playbook(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.GetPlaybookRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_playbook]
    ...
    def export_playbook(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ExportPlaybookRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_playbook]
    ...
    def import_playbook(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ImportPlaybookRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_playbook]
    ...
    def update_playbook(self,
        ...
        .. code-block:: python
            ...
            def sample_update_playbook():
                ...
                # Make the request
                response = client.update_playbook(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.UpdatePlaybookRequest, dict]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [playbook, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_playbook]
    ...
    def create_playbook_version(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.CreatePlaybookVersionRequest, dict]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, playbook_version]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_playbook_version]
    ...
    def get_playbook_version(self,
        ...
        .. code-block:: python
            ...
            def sample_get_playbook_version():
                # Create a client
                client = dialogflowcx_v3beta1.PlaybooksClient()
                ...
                # Make the request
                response = client.get_playbook_version(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.GetPlaybookVersionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_playbook_version]
    ...
    def restore_playbook_version(self,
        ...
        .. code-block:: python
            ...
            def sample_restore_playbook_version():
                # Create a client
                client = dialogflowcx_v3beta1.PlaybooksClient()
                ...
                # Make the request
                response = client.restore_playbook_version(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.RestorePlaybookVersionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.restore_playbook_version]
    ...
    def list_playbook_versions(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListPlaybookVersionsPager:
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ListPlaybookVersionsRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.playbooks.pagers.ListPlaybookVersionsPager:
                The response message for
                   [Playbooks.ListPlaybookVersions][google.cloud.dialogflow.cx.v3beta1.Playbooks.ListPlaybookVersions].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_playbook_versions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListPlaybookVersionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def delete_playbook_version(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.DeletePlaybookVersionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_playbook_version]
    ...
    def __enter__(self) -> "PlaybooksClient":
        return self

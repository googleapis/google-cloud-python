...
from .base import ExamplesTransport, DEFAULT_CLIENT_INFO
from .grpc import ExamplesGrpcTransport


class ExamplesGrpcAsyncIOTransport(ExamplesTransport):
    """gRPC AsyncIO backend transport for Examples.
    ...
    @property
    def create_example(self) -> Callable[
            [gcdc_example.CreateExampleRequest],
            Awaitable[gcdc_example.Example]]:
        ...
        if 'create_example' not in self._stubs:
            self._stubs['create_example'] = self.grpc_channel.unary_unary(
                '/google.cloud.dialogflow.cx.v3beta1.Examples/CreateExample',
                request_serializer=gcdc_example.CreateExampleRequest.serialize,
                response_deserializer=gcdc_example.Example.deserialize,
            )
        return self._stubs['create_example']

    @property
    def delete_example(self) -> Callable[
        ...
        if 'delete_example' not in self._stubs:
            self._stubs['delete_example'] = self.grpc_channel.unary_unary(
                '/google.cloud.dialogflow.cx.v3beta1.Examples/DeleteExample',
                request_serializer=example.DeleteExampleRequest.serialize,
    ...
    def list_examples(self) -> Callable[
            ...
            Awaitable[example.ListExamplesResponse]]:
        ...
        if 'list_examples' not in self._stubs:
            self._stubs['list_examples'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=example.ListExamplesRequest.serialize,
                response_deserializer=example.ListExamplesResponse.deserialize,
            )
    ...
    def get_example(self) -> Callable[
        ...
        if 'get_example' not in self._stubs:
            self._stubs['get_example'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=example.GetExampleRequest.serialize,
                response_deserializer=example.Example.deserialize,
            )
        return self._stubs['get_example']

    @property
    def update_example(self) -> Callable[
        ...
        if 'update_example' not in self._stubs:
            self._stubs['update_example'] = self.grpc_channel.unary_unary(
                '/google.cloud.dialogflow.cx.v3beta1.Examples/UpdateExample',
                request_serializer=gcdc_example.UpdateExampleRequest.serialize,
                response_deserializer=gcdc_example.Example.deserialize,
            )

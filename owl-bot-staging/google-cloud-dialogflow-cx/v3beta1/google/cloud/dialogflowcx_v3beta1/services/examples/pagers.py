...
class ListExamplesPager:
    ...
    :class:`google.cloud.dialogflowcx_v3beta1.types.ListExamplesResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3beta1.types.ListExamplesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., example.ListExamplesResponse],
        ...
        Args:
            ...
            request (google.cloud.dialogflowcx_v3beta1.types.ListExamplesRequest):
    ...
    @property
    def pages(self) -> Iterator[example.ListExamplesResponse]:
...
class ListExamplesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[example.ListExamplesResponse]],
            request: example.ListExamplesRequest,
            response: example.ListExamplesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[example.ListExamplesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

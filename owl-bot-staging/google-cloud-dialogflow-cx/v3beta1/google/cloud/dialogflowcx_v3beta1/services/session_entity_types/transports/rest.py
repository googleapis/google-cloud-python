...
class SessionEntityTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_session_entity_type(self, request: gcdc_session_entity_type.CreateSessionEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_session_entity_type.CreateSessionEntityTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_session_entity_types(self, response: session_entity_type.ListSessionEntityTypesResponse) -> session_entity_type.ListSessionEntityTypesResponse:
        ...
        """
        return response
    def pre_update_session_entity_type(self, request: gcdc_session_entity_type.UpdateSessionEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_session_entity_type.UpdateSessionEntityTypeRequest, Sequence[Tuple[str, str]]]:

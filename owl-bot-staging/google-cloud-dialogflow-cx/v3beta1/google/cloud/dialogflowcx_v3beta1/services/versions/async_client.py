...
class VersionsAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = VersionsClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = VersionsClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, VersionsTransport, Callable[..., VersionsTransport]]] = "grpc_asyncio",
        ...
        Args:
            ...
            transport (Optional[Union[str,VersionsTransport,Callable[..., VersionsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the VersionsTransport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.VersionsAsyncClient`.",
                extra = {
    ...
    async def list_versions(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListVersionsRequest, dict]]):
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.versions.pagers.ListVersionsAsyncPager:
    ...
    async def get_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetVersionRequest, dict]]):
                The request object. The request message for
    ...
    async def create_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CreateVersionRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.dialogflowcx_v3beta1.types.Version`
                Represents a version of a flow.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, version]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_version]
    ...
    async def update_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.UpdateVersionRequest, dict]]):
                The request object. The request message for
    ...
    async def delete_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.DeleteVersionRequest, dict]]):
                The request object. The request message for
    ...
    async def load_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.LoadVersionRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.load_version]
    ...
    async def compare_versions(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CompareVersionsRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.compare_versions]

...
class VersionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_compare_versions(self, request: version.CompareVersionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[version.CompareVersionsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_version(self, request: gcdc_version.CreateVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_version.CreateVersionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_load_version(self, request: version.LoadVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[version.LoadVersionRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_version(self, request: gcdc_version.UpdateVersionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_version.UpdateVersionRequest, Sequence[Tuple[str, str]]]:

...
class IntentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_intent(self, request: gcdc_intent.CreateIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_intent.CreateIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_intent_with_metadata(self, response: gcdc_intent.Intent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_intent.Intent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_intent
    ...
    def pre_delete_intent(self, request: intent.DeleteIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.DeleteIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_export_intents(self, request: intent.ExportIntentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.ExportIntentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_intents(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_export_intents_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_intents
    ...
    def pre_get_intent(self, request: intent.GetIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.GetIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_intent_with_metadata(self, response: intent.Intent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.Intent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_intent
    ...
    def pre_import_intents(self, request: intent.ImportIntentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.ImportIntentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_intents(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_import_intents_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_intents
    ...
    def pre_list_intents(self, request: intent.ListIntentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.ListIntentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_intents_with_metadata(self, response: intent.ListIntentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[intent.ListIntentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_intents
    ...
    def pre_update_intent(self, request: gcdc_intent.UpdateIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_intent.UpdateIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_intent_with_metadata(self, response: gcdc_intent.Intent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_intent.Intent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_intent
...
class IntentsRestTransport(_BaseIntentsRestTransport):
    ...
    class _CreateIntent(_BaseIntentsRestTransport._BaseCreateIntent, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.CreateIntent",
                    extra = {
            ...
            # Send the request
            response = IntentsRestTransport._CreateIntent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsClient.create_intent",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "CreateIntent",
    ...
    class _DeleteIntent(_BaseIntentsRestTransport._BaseDeleteIntent, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.DeleteIntent",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
            ...
            # Send the request
            response = IntentsRestTransport._DeleteIntent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ExportIntents(_BaseIntentsRestTransport._BaseExportIntents, IntentsRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseIntentsRestTransport._BaseExportIntents._get_http_options()

            request, metadata = self._interceptor.pre_export_intents(request, metadata)
            transcoded_request = _BaseIntentsRestTransport._BaseExportIntents._get_transcoded_request(http_options, request)

            body = _BaseIntentsRestTransport._BaseExportIntents._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseIntentsRestTransport._BaseExportIntents._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.ExportIntents",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ExportIntents",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = IntentsRestTransport._ExportIntents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_export_intents_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsClient.export_intents",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ExportIntents",
                        "metadata": http_response["headers"],
    ...
    class _GetIntent(_BaseIntentsRestTransport._BaseGetIntent, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.GetIntent",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "GetIntent",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsClient.get_intent",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "GetIntent",
                        "metadata": http_response["headers"],
    ...
    class _ImportIntents(_BaseIntentsRestTransport._BaseImportIntents, IntentsRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseIntentsRestTransport._BaseImportIntents._get_http_options()

            request, metadata = self._interceptor.pre_import_intents(request, metadata)
            transcoded_request = _BaseIntentsRestTransport._BaseImportIntents._get_transcoded_request(http_options, request)

            body = _BaseIntentsRestTransport._BaseImportIntents._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseIntentsRestTransport._BaseImportIntents._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.ImportIntents",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ImportIntents",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = IntentsRestTransport._ImportIntents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_import_intents_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsClient.import_intents",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ImportIntents",
                        "metadata": http_response["headers"],
    ...
    class _ListIntents(_BaseIntentsRestTransport._BaseListIntents, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.ListIntents",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ListIntents",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsClient.list_intents",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ListIntents",
                        "metadata": http_response["headers"],
    ...
    class _UpdateIntent(_BaseIntentsRestTransport._BaseUpdateIntent, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.UpdateIntent",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
            ...
            # Send the request
            response = IntentsRestTransport._UpdateIntent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsClient.update_intent",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "UpdateIntent",
                        "metadata": http_response["headers"],
    ...
    @property
    def export_intents(self) -> Callable[
    ...
    @property
    def import_intents(self) -> Callable[
    ...
    class _GetLocation(_BaseIntentsRestTransport._BaseGetLocation, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseIntentsRestTransport._BaseListLocations, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
            ...
            # Send the request
            response = IntentsRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseIntentsRestTransport._BaseCancelOperation, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
            ...
            # Send the request
            response = IntentsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseIntentsRestTransport._BaseGetOperation, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
            ...
            # Send the request
            response = IntentsRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseIntentsRestTransport._BaseListOperations, IntentsRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3beta1.IntentsClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
            ...
            # Send the request
            response = IntentsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3beta1.IntentsAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3beta1.Intents",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

...
class TestCasesAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TestCasesTransport, Callable[..., TestCasesTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.TestCasesAsyncClient`.",
                extra = {
    ...
    async def list_test_cases(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListTestCasesRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_test_cases]
    ...
    async def batch_delete_test_cases(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.BatchDeleteTestCasesRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_delete_test_cases]
    ...
    async def get_test_case(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetTestCaseRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_test_case]
    ...
    async def create_test_case(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CreateTestCaseRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, test_case]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_test_case]
    ...
    async def update_test_case(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.UpdateTestCaseRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [test_case, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_test_case]
    ...
    async def run_test_case(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.RunTestCaseRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3beta1.types.RunTestCaseResponse` The response message for
                   [TestCases.RunTestCase][google.cloud.dialogflow.cx.v3beta1.TestCases.RunTestCase].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.run_test_case]
    ...
    async def batch_run_test_cases(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.BatchRunTestCasesRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3beta1.types.BatchRunTestCasesResponse` The response message for
                   [TestCases.BatchRunTestCases][google.cloud.dialogflow.cx.v3beta1.TestCases.BatchRunTestCases].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_run_test_cases]
    ...
    async def calculate_coverage(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CalculateCoverageRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.calculate_coverage]
    ...
    async def import_test_cases(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ImportTestCasesRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3beta1.types.ImportTestCasesResponse` The response message for
                   [TestCases.ImportTestCases][google.cloud.dialogflow.cx.v3beta1.TestCases.ImportTestCases].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_test_cases]
    ...
    async def export_test_cases(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ExportTestCasesRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3beta1.types.ExportTestCasesResponse` The response message for
                   [TestCases.ExportTestCases][google.cloud.dialogflow.cx.v3beta1.TestCases.ExportTestCases].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_test_cases]
    ...
    async def list_test_case_results(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListTestCaseResultsRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_test_case_results]
    ...
    async def get_test_case_result(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetTestCaseResultRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_test_case_result]

...
class TestCasesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_delete_test_cases(self, request: test_case.BatchDeleteTestCasesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.BatchDeleteTestCasesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_batch_run_test_cases(self, request: test_case.BatchRunTestCasesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.BatchRunTestCasesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_calculate_coverage(self, request: test_case.CalculateCoverageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.CalculateCoverageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_create_test_case(self, request: gcdc_test_case.CreateTestCaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_test_case.CreateTestCaseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_export_test_cases(self, request: test_case.ExportTestCasesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.ExportTestCasesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_test_case(self, request: test_case.GetTestCaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.GetTestCaseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_test_case_result(self, request: test_case.GetTestCaseResultRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.GetTestCaseResultRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_import_test_cases(self, request: test_case.ImportTestCasesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.ImportTestCasesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_test_case_results(self, request: test_case.ListTestCaseResultsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.ListTestCaseResultsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_test_cases(self, request: test_case.ListTestCasesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.ListTestCasesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_run_test_case(self, request: test_case.RunTestCaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[test_case.RunTestCaseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_test_case(self, request: gcdc_test_case.UpdateTestCaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_test_case.UpdateTestCaseRequest, Sequence[Tuple[str, str]]]:

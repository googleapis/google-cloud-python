...
class ListPagesPager:
    """A pager for iterating through ``list_pages`` requests.

    This class thinly wraps an initial
    :class:`google.cloud.dialogflowcx_v3beta1.types.ListPagesResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3beta1.types.ListPagesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., page.ListPagesResponse],
    ...
    @property
    def pages(self) -> Iterator[page.ListPagesResponse]:
    ...
    def __iter__(self) -> Iterator[page.Page]:
        for page in self.pages:
            yield from page.pages

    def __repr__(self) -> str:
        return '{0}<{1!r}>'.format(self.__class__.__name__, self._response)


class ListPagesAsyncPager:
    """A pager for iterating through ``list_pages`` requests.
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[page.ListPagesResponse]],
            request: page.ListPagesRequest,
            response: page.ListPagesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[page.ListPagesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

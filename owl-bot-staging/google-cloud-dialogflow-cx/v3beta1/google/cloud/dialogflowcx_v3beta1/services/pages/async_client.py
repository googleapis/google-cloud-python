...
class PagesAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = PagesClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = PagesClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PagesTransport, Callable[..., PagesTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the pages async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,PagesTransport,Callable[..., PagesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the PagesTransport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.PagesAsyncClient`.",
                extra = {
    ...
    async def list_pages(self,
            request: Optional[Union[page.ListPagesRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            async def sample_list_pages():
                # Create a client
                client = dialogflowcx_v3beta1.PagesAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListPagesRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_pages]
    ...
    async def get_page(self,
            request: Optional[Union[page.GetPageRequest, dict]] = None,
            *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetPageRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_page]
    ...
    async def create_page(self,
            request: Optional[Union[gcdc_page.CreatePageRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            page: Optional[gcdc_page.Page] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> gcdc_page.Page:
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CreatePageRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_page]
    ...
    async def update_page(self,
            request: Optional[Union[gcdc_page.UpdatePageRequest, dict]] = None,
            *,
            page: Optional[gcdc_page.Page] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.UpdatePageRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [page, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_page]
    ...
    async def delete_page(self,
            request: Optional[Union[page.DeletePageRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.DeletePageRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_page]

...
from google.cloud.dialogflowcx_v3beta1.services.generators import pagers
...
from .transports.base import GeneratorsTransport, DEFAULT_CLIENT_INFO
...
class GeneratorsClient(metaclass=GeneratorsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GeneratorsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GeneratorsTransport, Callable[..., GeneratorsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GeneratorsClient._read_environment_variables()
        self._client_cert_source = GeneratorsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GeneratorsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GeneratorsTransport], Callable[..., GeneratorsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3beta1.GeneratorsClient`.",
                    extra = {
    ...
    def list_generators(self,
        ...
        r"""Returns the list of all generators in the specified
        agent.
        ...
        .. code-block:: python
            ...
            def sample_list_generators():
                # Create a client
                client = dialogflowcx_v3beta1.GeneratorsClient()

                # Initialize request argument(s)
                request = dialogflowcx_v3beta1.ListGeneratorsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ListGeneratorsRequest, dict]):
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.generators.pagers.ListGeneratorsPager:
    ...
    def get_generator(self,
        ...
        r"""Retrieves the specified generator.
        ...
        .. code-block:: python
            ...
            def sample_get_generator():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3beta1.GetGeneratorRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.GetGeneratorRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.types.Generator:
                Generators contain prompt to be sent
                to the LLM model to generate text. The
                prompt can contain parameters which will
                be resolved before calling the model. It
                can optionally contain banned phrases to
                ensure the model responses are safe.
    ...
    def create_generator(self,
        ...
        .. code-block:: python
            ...
            def sample_create_generator():
                ...
                # Initialize request argument(s)
                generator = dialogflowcx_v3beta1.Generator()
                generator.display_name = "display_name_value"
                generator.prompt_text.text = "text_value"

                request = dialogflowcx_v3beta1.CreateGeneratorRequest(
                    parent="parent_value",
                    generator=generator,
                )
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.CreateGeneratorRequest, dict]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, generator]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_generator(self,
        ...
        .. code-block:: python
            ...
            def sample_update_generator():
                ...
                request = dialogflowcx_v3beta1.UpdateGeneratorRequest(
                    generator=generator,
                )
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.UpdateGeneratorRequest, dict]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [generator, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_generator(self,
        ...
        r"""Deletes the specified generators.
        ...
        .. code-block:: python
            ...
            def sample_delete_generator():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3beta1.DeleteGeneratorRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.DeleteGeneratorRequest, dict]):
                The request object. The request message for

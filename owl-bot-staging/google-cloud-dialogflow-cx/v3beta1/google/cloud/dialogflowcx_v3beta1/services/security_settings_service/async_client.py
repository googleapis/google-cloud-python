...
class SecuritySettingsServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(SecuritySettingsServiceClient).get_transport_class, type(SecuritySettingsServiceClient))
    ...
    def __init__(self, *,
        ...
        """Instantiates the security settings service async client.
    ...
    async def create_security_settings(self,
    ...
    async def update_security_settings(self,
    ...
    async def list_security_settings(self,
    ...
    async def delete_security_settings(self,

...
class SessionsGrpcAsyncIOTransport(SessionsTransport):
    ...
    def server_streaming_detect_intent(self) -> Callable[
        ...
        if 'server_streaming_detect_intent' not in self._stubs:
            self._stubs['server_streaming_detect_intent'] = self._logged_channel.unary_stream(
    ...
    def match_intent(self) -> Callable[
        ...
        if 'match_intent' not in self._stubs:
            self._stubs['match_intent'] = self._logged_channel.unary_unary(
    ...
    def fulfill_intent(self) -> Callable[
        ...
        if 'fulfill_intent' not in self._stubs:
            self._stubs['fulfill_intent'] = self._logged_channel.unary_unary(
    ...
    def submit_answer_feedback(self) -> Callable[
            ...
            Awaitable[session.AnswerFeedback]]:
        ...
        if 'submit_answer_feedback' not in self._stubs:
            self._stubs['submit_answer_feedback'] = self._logged_channel.unary_unary(

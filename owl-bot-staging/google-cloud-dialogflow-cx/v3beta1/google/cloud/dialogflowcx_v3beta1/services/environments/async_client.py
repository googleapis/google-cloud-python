...
class EnvironmentsAsyncClient:
    ...
    continuous_test_result_path = staticmethod(EnvironmentsClient.continuous_test_result_path)
    parse_continuous_test_result_path = staticmethod(EnvironmentsClient.parse_continuous_test_result_path)
    ...
    parse_secret_version_path = staticmethod(EnvironmentsClient.parse_secret_version_path)
    ...
    parse_test_case_result_path = staticmethod(EnvironmentsClient.parse_test_case_result_path)
    ...
    webhook_path = staticmethod(EnvironmentsClient.webhook_path)
    parse_webhook_path = staticmethod(EnvironmentsClient.parse_webhook_path)
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.EnvironmentsAsyncClient`.",
                extra = {
    ...
    async def lookup_environment_history(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.lookup_environment_history]
    ...
    async def run_continuous_test(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.run_continuous_test]
    ...
    async def list_continuous_test_results(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_continuous_test_results]
    ...
    async def deploy_flow(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.deploy_flow]

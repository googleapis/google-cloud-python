...
class EnvironmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_environment(self, request: gcdc_environment.CreateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_environment.CreateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_deploy_flow(self, request: environment.DeployFlowRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.DeployFlowRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_deploy_flow_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for deploy_flow
    ...
    def pre_list_continuous_test_results(self, request: environment.ListContinuousTestResultsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.ListContinuousTestResultsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_continuous_test_results(self, response: environment.ListContinuousTestResultsResponse) -> environment.ListContinuousTestResultsResponse:
    ...
    def post_list_continuous_test_results_with_metadata(self, response: environment.ListContinuousTestResultsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.ListContinuousTestResultsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_continuous_test_results
    ...
    def pre_lookup_environment_history(self, request: environment.LookupEnvironmentHistoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.LookupEnvironmentHistoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_lookup_environment_history_with_metadata(self, response: environment.LookupEnvironmentHistoryResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.LookupEnvironmentHistoryResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for lookup_environment_history
    ...
    def pre_run_continuous_test(self, request: environment.RunContinuousTestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[environment.RunContinuousTestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_run_continuous_test_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for run_continuous_test
    ...
    def pre_update_environment(self, request: gcdc_environment.UpdateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_environment.UpdateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class EnvironmentsRestTransport(_BaseEnvironmentsRestTransport):
    ...
    class _DeployFlow(_BaseEnvironmentsRestTransport._BaseDeployFlow, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._DeployFlow._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListContinuousTestResults(_BaseEnvironmentsRestTransport._BaseListContinuousTestResults, EnvironmentsRestStub):
        ...
        results method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._ListContinuousTestResults._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _LookupEnvironmentHistory(_BaseEnvironmentsRestTransport._BaseLookupEnvironmentHistory, EnvironmentsRestStub):
        ...
        history method over HTTP.
            ...
            # Send the request
            response = EnvironmentsRestTransport._LookupEnvironmentHistory._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RunContinuousTest(_BaseEnvironmentsRestTransport._BaseRunContinuousTest, EnvironmentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EnvironmentsRestTransport._RunContinuousTest._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

...
class EnvironmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_environment(self, request: gcdc_environment.CreateEnvironmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_environment.CreateEnvironmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_deploy_flow(self, request: environment.DeployFlowRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[environment.DeployFlowRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_continuous_test_results(self, request: environment.ListContinuousTestResultsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[environment.ListContinuousTestResultsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_lookup_environment_history(self, request: environment.LookupEnvironmentHistoryRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[environment.LookupEnvironmentHistoryRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_run_continuous_test(self, request: environment.RunContinuousTestRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[environment.RunContinuousTestRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_environment(self, request: gcdc_environment.UpdateEnvironmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_environment.UpdateEnvironmentRequest, Sequence[Tuple[str, str]]]:

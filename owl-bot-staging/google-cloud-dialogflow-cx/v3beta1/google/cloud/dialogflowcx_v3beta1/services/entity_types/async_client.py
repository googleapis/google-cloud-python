...
class EntityTypesAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EntityTypesTransport, Callable[..., EntityTypesTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.EntityTypesAsyncClient`.",
                extra = {
    ...
    async def get_entity_type(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_entity_type():
                ...
                request = dialogflowcx_v3beta1.GetEntityTypeRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetEntityTypeRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_entity_type]
    ...
    async def create_entity_type(self,
            request: Optional[Union[gcdc_entity_type.CreateEntityTypeRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            entity_type: Optional[gcdc_entity_type.EntityType] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CreateEntityTypeRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, entity_type]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_entity_type]
    ...
    async def update_entity_type(self,
            request: Optional[Union[gcdc_entity_type.UpdateEntityTypeRequest, dict]] = None,
            *,
            entity_type: Optional[gcdc_entity_type.EntityType] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.UpdateEntityTypeRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_entity_type]
    ...
    async def delete_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.DeleteEntityTypeRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_entity_type]
    ...
    async def list_entity_types(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_entity_types():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3beta1.ListEntityTypesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListEntityTypesRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_entity_types]
    ...
    async def export_entity_types(self,
            request: Optional[Union[entity_type.ExportEntityTypesRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation_async.AsyncOperation:
        r"""Exports the selected entity types.
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ExportEntityTypesRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3beta1.types.ExportEntityTypesResponse` The response message for
                   [EntityTypes.ExportEntityTypes][google.cloud.dialogflow.cx.v3beta1.EntityTypes.ExportEntityTypes].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, entity_type.ExportEntityTypesRequest):
            request = entity_type.ExportEntityTypesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_entity_types]
        ...
        response = operation_async.from_gapic(
            ...
            entity_type.ExportEntityTypesResponse,
            metadata_type=entity_type.ExportEntityTypesMetadata,
        )

        # Done; return the response.
        return response

    async def import_entity_types(self,
            request: Optional[Union[entity_type.ImportEntityTypesRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation_async.AsyncOperation:
        r"""Imports the specified entitytypes into the agent.
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ImportEntityTypesRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3beta1.types.ImportEntityTypesResponse` The response message for
                   [EntityTypes.ImportEntityTypes][google.cloud.dialogflow.cx.v3beta1.EntityTypes.ImportEntityTypes].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, entity_type.ImportEntityTypesRequest):
            request = entity_type.ImportEntityTypesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_entity_types]
        ...
        response = operation_async.from_gapic(
            response,
            self._client._transport.operations_client,
            entity_type.ImportEntityTypesResponse,
            metadata_type=entity_type.ImportEntityTypesMetadata,
        )

...
class EntityTypesClient(metaclass=EntityTypesClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            EntityTypesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def export_entity_types(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ExportEntityTypesRequest, dict]):
                The request object. The request message for
    ...
    def import_entity_types(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ImportEntityTypesRequest, dict]):
                The request object. The request message for

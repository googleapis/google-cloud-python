...
class _BaseEntityTypesRestTransport(EntityTypesTransport):
    ...
    class _BaseExportEntityTypes:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseEntityTypesRestTransport._BaseExportEntityTypes._get_unset_required_fields(query_params))
    ...
    class _BaseImportEntityTypes:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseEntityTypesRestTransport._BaseImportEntityTypes._get_unset_required_fields(query_params))

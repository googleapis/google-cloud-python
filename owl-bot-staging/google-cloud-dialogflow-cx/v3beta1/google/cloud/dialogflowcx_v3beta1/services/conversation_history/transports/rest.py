...
class ConversationHistoryRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_conversation(self, request: conversation_history.DeleteConversationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversation_history.DeleteConversationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_conversation(self, request: conversation_history.GetConversationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversation_history.GetConversationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_conversation(self, response: conversation_history.Conversation) -> conversation_history.Conversation:
    ...
    def post_get_conversation_with_metadata(self, response: conversation_history.Conversation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversation_history.Conversation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_conversation

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ConversationHistory server but before it is returned to user code.
    ...
    def pre_list_conversations(self, request: conversation_history.ListConversationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversation_history.ListConversationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_conversations(self, response: conversation_history.ListConversationsResponse) -> conversation_history.ListConversationsResponse:
    ...
    def post_list_conversations_with_metadata(self, response: conversation_history.ListConversationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[conversation_history.ListConversationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_conversations
...
class ConversationHistoryRestTransport(_BaseConversationHistoryRestTransport):
    ...
    class _DeleteConversation(_BaseConversationHistoryRestTransport._BaseDeleteConversation, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseDeleteConversation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseDeleteConversation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._DeleteConversation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetConversation(_BaseConversationHistoryRestTransport._BaseGetConversation, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseGetConversation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseGetConversation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._GetConversation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = conversation_history.Conversation.to_json(response)
                except:
    ...
    class _ListConversations(_BaseConversationHistoryRestTransport._BaseListConversations, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseListConversations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseListConversations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._ListConversations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = conversation_history.ListConversationsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _GetLocation(_BaseConversationHistoryRestTransport._BaseGetLocation, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseConversationHistoryRestTransport._BaseListLocations, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseConversationHistoryRestTransport._BaseCancelOperation, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseConversationHistoryRestTransport._BaseGetOperation, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseConversationHistoryRestTransport._BaseListOperations, ConversationHistoryRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseConversationHistoryRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseConversationHistoryRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ConversationHistoryRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

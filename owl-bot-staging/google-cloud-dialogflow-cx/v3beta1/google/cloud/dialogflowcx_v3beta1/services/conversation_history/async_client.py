...
class ConversationHistoryAsyncClient:
    """Service for managing conversation history."""

    _client: ConversationHistoryClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = ConversationHistoryClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = ConversationHistoryClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = ConversationHistoryClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConversationHistoryAsyncClient: The constructed client.
        """
        return ConversationHistoryClient.from_service_account_info.__func__(ConversationHistoryAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ConversationHistoryAsyncClient: The constructed client.
        """
        return ConversationHistoryClient.from_service_account_file.__func__(ConversationHistoryAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return ConversationHistoryClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> ConversationHistoryTransport:
        ...
        Returns:
            ConversationHistoryTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = functools.partial(type(ConversationHistoryClient).get_transport_class, type(ConversationHistoryClient))
    ...
    def __init__(self, *,
        ...
        """Instantiates the conversation history async client.
        ...
        """
        self._client = ConversationHistoryClient(
    ...
    async def list_conversations(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListConversationsRequest, dict]]):
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.conversation_history.pagers.ListConversationsAsyncPager:
    ...
    async def get_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetConversationRequest, dict]]):
                The request object. The request message for
    ...
    async def delete_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.DeleteConversationRequest, dict]]):
                The request object. The request message for
    ...
    async def __aenter__(self) -> "ConversationHistoryAsyncClient":
        return self

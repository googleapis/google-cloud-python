...
from .base import ConversationHistoryTransport, DEFAULT_CLIENT_INFO


class ConversationHistoryGrpcTransport(ConversationHistoryTransport):
    """gRPC backend transport for ConversationHistory.
    ...
    def list_conversations(self) -> Callable[
        ...
        if 'list_conversations' not in self._stubs:
            self._stubs['list_conversations'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=conversation_history.ListConversationsRequest.serialize,
                response_deserializer=conversation_history.ListConversationsResponse.deserialize,
            )
    ...
    def get_conversation(self) -> Callable[
        ...
        if 'get_conversation' not in self._stubs:
            self._stubs['get_conversation'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=conversation_history.GetConversationRequest.serialize,
                response_deserializer=conversation_history.Conversation.deserialize,
            )
    ...
    def delete_conversation(self) -> Callable[
        ...
        if 'delete_conversation' not in self._stubs:
            self._stubs['delete_conversation'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=conversation_history.DeleteConversationRequest.serialize,
...
__all__ = (
    'ConversationHistoryGrpcTransport',
)

...
from .transports.base import ConversationHistoryTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ConversationHistoryGrpcTransport
from .transports.grpc_asyncio import ConversationHistoryGrpcAsyncIOTransport
from .transports.rest import ConversationHistoryRestTransport


class ConversationHistoryClientMeta(type):
    """Metaclass for the ConversationHistory client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ConversationHistoryTransport]]
    _transport_registry["grpc"] = ConversationHistoryGrpcTransport
    _transport_registry["grpc_asyncio"] = ConversationHistoryGrpcAsyncIOTransport
    _transport_registry["rest"] = ConversationHistoryRestTransport
...
class ConversationHistoryClient(metaclass=ConversationHistoryClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConversationHistoryClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> ConversationHistoryTransport:
        """Returns the transport used by the client instance.

        Returns:
            ConversationHistoryTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def conversation_path(project: str,location: str,agent: str,conversation: str,) -> str:
        """Returns a fully-qualified conversation string."""
        return "projects/{project}/locations/{location}/agents/{agent}/conversations/{conversation}".format(project=project, location=location, agent=agent, conversation=conversation, )

    @staticmethod
    def parse_conversation_path(path: str) -> Dict[str,str]:
        """Parses a conversation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/conversations/(?P<conversation>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversationHistoryClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConversationHistoryClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConversationHistoryClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ConversationHistoryClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ConversationHistoryTransport, Callable[..., ConversationHistoryTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the conversation history client.
        ...
        Args:
            ...
            transport (Optional[Union[str,ConversationHistoryTransport,Callable[..., ConversationHistoryTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ConversationHistoryTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConversationHistoryClient._read_environment_variables()
        self._client_cert_source = ConversationHistoryClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConversationHistoryClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConversationHistoryTransport)
        if transport_provided:
            # transport is a ConversationHistoryTransport instance.
            ...
            self._transport = cast(ConversationHistoryTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ConversationHistoryClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConversationHistoryTransport], Callable[..., ConversationHistoryTransport]] = (
    ...
    def list_conversations(self,
        ...
        r"""Returns the list of all conversations.
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ListConversationsRequest, dict]):
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.conversation_history.pagers.ListConversationsPager:
        ...
        if not isinstance(request, conversation_history.ListConversationsRequest):
            request = conversation_history.ListConversationsRequest(request)
    ...
    def get_conversation(self,
        ...
        r"""Retrieves the specified conversation.
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.GetConversationRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.types.Conversation:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, conversation_history.GetConversationRequest):
            request = conversation_history.GetConversationRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def delete_conversation(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_conversation():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3beta1.DeleteConversationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.DeleteConversationRequest, dict]):
                The request object. The request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, conversation_history.DeleteConversationRequest):
            request = conversation_history.DeleteConversationRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def __enter__(self) -> "ConversationHistoryClient":
        return self

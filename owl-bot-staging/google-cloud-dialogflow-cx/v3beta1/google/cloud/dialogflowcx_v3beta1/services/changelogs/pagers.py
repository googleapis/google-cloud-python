...
class ListChangelogsPager:
    ...
    :class:`google.cloud.dialogflowcx_v3beta1.types.ListChangelogsResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3beta1.types.ListChangelogsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.dialogflowcx_v3beta1.types.ListChangelogsRequest):

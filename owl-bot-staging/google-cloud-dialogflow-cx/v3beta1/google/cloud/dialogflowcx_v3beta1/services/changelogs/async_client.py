...
class ChangelogsAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ChangelogsClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    common_billing_account_path = staticmethod(ChangelogsClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ChangelogsClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(ChangelogsClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(ChangelogsClient.parse_common_location_path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return ChangelogsClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    get_transport_class = functools.partial(type(ChangelogsClient).get_transport_class, type(ChangelogsClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, ChangelogsTransport, Callable[..., ChangelogsTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the changelogs async client.
    ...
    async def list_changelogs(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListChangelogsRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_changelogs]
    ...
    async def get_changelog(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetChangelogRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_changelog]

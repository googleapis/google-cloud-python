...
class ToolsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tool(self, request: gcdc_tool.CreateToolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_tool.CreateToolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_tool_with_metadata(self, response: gcdc_tool.Tool, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_tool.Tool, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_tool
    ...
    def pre_create_tool_version(self, request: tool.CreateToolVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.CreateToolVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_tool_version_with_metadata(self, response: tool.ToolVersion, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.ToolVersion, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_tool_version
    ...
    def pre_delete_tool_version(self, request: tool.DeleteToolVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.DeleteToolVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_tool_version(self, request: tool.GetToolVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.GetToolVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_tool_version_with_metadata(self, response: tool.ToolVersion, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.ToolVersion, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_tool_version
    ...
    def pre_list_tool_versions(self, request: tool.ListToolVersionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.ListToolVersionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_tool_versions_with_metadata(self, response: tool.ListToolVersionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.ListToolVersionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_tool_versions
    ...
    def pre_restore_tool_version(self, request: tool.RestoreToolVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.RestoreToolVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_restore_tool_version_with_metadata(self, response: tool.RestoreToolVersionResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tool.RestoreToolVersionResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for restore_tool_version
    ...
    def pre_update_tool(self, request: gcdc_tool.UpdateToolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_tool.UpdateToolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_tool_with_metadata(self, response: gcdc_tool.Tool, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_tool.Tool, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_tool
...
class ToolsRestTransport(_BaseToolsRestTransport):
    ...
    class _CreateToolVersion(_BaseToolsRestTransport._BaseCreateToolVersion, ToolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ToolsRestTransport._CreateToolVersion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteToolVersion(_BaseToolsRestTransport._BaseDeleteToolVersion, ToolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ToolsRestTransport._DeleteToolVersion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetToolVersion(_BaseToolsRestTransport._BaseGetToolVersion, ToolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ToolsRestTransport._GetToolVersion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListToolVersions(_BaseToolsRestTransport._BaseListToolVersions, ToolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ToolsRestTransport._ListToolVersions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RestoreToolVersion(_BaseToolsRestTransport._BaseRestoreToolVersion, ToolsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ToolsRestTransport._RestoreToolVersion._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)

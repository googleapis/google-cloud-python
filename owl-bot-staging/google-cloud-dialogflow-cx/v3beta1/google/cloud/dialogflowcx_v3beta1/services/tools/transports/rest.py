...
from .base import ToolsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ToolsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tool(self, request: gcdc_tool.CreateToolRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_tool.CreateToolRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_tool(self, response: gcdc_tool.Tool) -> gcdc_tool.Tool:
        ...
        """
        return response
    def pre_delete_tool(self, request: tool.DeleteToolRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tool.DeleteToolRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_export_tools(self, request: tool.ExportToolsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tool.ExportToolsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_export_tools(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_tool(self, request: tool.GetToolRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tool.GetToolRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_tool(self, response: tool.Tool) -> tool.Tool:
        ...
        """
        return response
    def pre_list_tools(self, request: tool.ListToolsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tool.ListToolsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_tools(self, response: tool.ListToolsResponse) -> tool.ListToolsResponse:
        ...
        """
        return response
    def pre_update_tool(self, request: gcdc_tool.UpdateToolRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_tool.UpdateToolRequest, Sequence[Tuple[str, str]]]:

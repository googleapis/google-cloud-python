...
class ToolsClient(metaclass=ToolsClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ToolsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ToolsTransport]] = None,
    ...
    def create_tool(self,
        ...
        # in a gcdc_tool.CreateToolRequest.
    ...
    def update_tool(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a gcdc_tool.UpdateToolRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

...
class ToolsClient(metaclass=ToolsClientMeta):
    ...
    @staticmethod
    def tool_version_path(project: str,location: str,agent: str,tool: str,version: str,) -> str:
        """Returns a fully-qualified tool_version string."""
        return "projects/{project}/locations/{location}/agents/{agent}/tools/{tool}/versions/{version}".format(project=project, location=location, agent=agent, tool=tool, version=version, )

    @staticmethod
    def parse_tool_version_path(path: str) -> Dict[str,str]:
        """Parses a tool_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/tools/(?P<tool>.+?)/versions/(?P<version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ToolsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ToolsTransport, Callable[..., ToolsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ToolsClient._read_environment_variables()
        self._client_cert_source = ToolsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ToolsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ToolsTransport], Callable[..., ToolsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3beta1.ToolsClient`.",
                    extra = {
    ...
    def create_tool(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.CreateToolRequest, dict]):
    ...
    def list_tools(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ListToolsRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.tools.pagers.ListToolsPager:
    ...
    def export_tools(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ExportToolsRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_tools]
    ...
    def get_tool(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.GetToolRequest, dict]):
                The request object. The request message for
    ...
    def update_tool(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.UpdateToolRequest, dict]):
                The request object. The request message for
    ...
    def delete_tool(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.DeleteToolRequest, dict]):
                The request object. The request message for
    ...
    def list_tool_versions(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.ListToolVersionsRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.tools.pagers.ListToolVersionsPager:
                The response message for
                   [Tools.ListToolVersions][google.cloud.dialogflow.cx.v3beta1.Tools.ListToolVersions].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_tool_versions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListToolVersionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_tool_version(self,
        ...
        .. code-block:: python
            ...
            def sample_create_tool_version():
                # Create a client
                client = dialogflowcx_v3beta1.ToolsClient()
                ...
                # Make the request
                response = client.create_tool_version(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.CreateToolVersionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_tool_version]
    ...
    def get_tool_version(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.GetToolVersionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_tool_version]
    ...
    def delete_tool_version(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.DeleteToolVersionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_tool_version]
    ...
    def restore_tool_version(self,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3beta1.types.RestoreToolVersionRequest, dict]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.restore_tool_version]

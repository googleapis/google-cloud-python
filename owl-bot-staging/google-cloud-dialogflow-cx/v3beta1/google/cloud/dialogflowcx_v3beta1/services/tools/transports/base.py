...
class ToolsTransport(abc.ABC):
    """Abstract transport class for Tools."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.export_tools: gapic_v1.method.wrap_method(
                self.export_tools,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def list_tools(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[tool.ListToolsResponse]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def list_tool_versions(self) -> Callable[
            [tool.ListToolVersionsRequest],
            Union[
                tool.ListToolVersionsResponse,
                Awaitable[tool.ListToolVersionsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def create_tool_version(self) -> Callable[
            [tool.CreateToolVersionRequest],
            Union[
                tool.ToolVersion,
                Awaitable[tool.ToolVersion]
            ]]:
        raise NotImplementedError()

    @property
    def get_tool_version(self) -> Callable[
    ...
    @property
    def delete_tool_version(self) -> Callable[
    ...
    @property
    def restore_tool_version(self) -> Callable[
            [tool.RestoreToolVersionRequest],
            Union[
                tool.RestoreToolVersionResponse,
                Awaitable[tool.RestoreToolVersionResponse]
            ]]:
        raise NotImplementedError()

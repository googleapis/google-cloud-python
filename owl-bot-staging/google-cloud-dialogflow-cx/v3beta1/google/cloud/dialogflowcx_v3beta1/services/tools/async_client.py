...
from .transports.base import ToolsTransport, DEFAULT_CLIENT_INFO
...
class ToolsAsyncClient:
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.ToolsAsyncClient`.",
                extra = {
    ...
    async def create_tool(self,
            request: Optional[Union[gcdc_tool.CreateToolRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            tool: Optional[gcdc_tool.Tool] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> gcdc_tool.Tool:
        r"""Creates a [Tool][google.cloud.dialogflow.cx.v3beta1.Tool] in the
        specified agent.
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CreateToolRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            tool (:class:`google.cloud.dialogflowcx_v3beta1.types.Tool`):
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.types.Tool:
                A tool provides a list of actions which are available to the
                   ...
                   to attain its goal. A Tool consists of a description
                   of the tool's usage and a specification of the tool
                   which contains the schema and authentication
                   information.
    ...
    async def list_tools(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListToolsRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.tools.pagers.ListToolsAsyncPager:
    ...
    async def export_tools(self,
            request: Optional[Union[tool.ExportToolsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation_async.AsyncOperation:
        r"""Exports the selected tools.
        ...
        .. code-block:: python
            ...
            async def sample_export_tools():
                ...
                # Make the request
                operation = client.export_tools(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ExportToolsRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3beta1.types.ExportToolsResponse` The response message for
                   [Tools.ExportTools][google.cloud.dialogflow.cx.v3beta1.Tools.ExportTools].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_tools]
        ...
        response = operation_async.from_gapic(
            ...
            tool.ExportToolsResponse,
            metadata_type=tool.ExportToolsMetadata,
        )
    ...
    async def get_tool(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetToolRequest, dict]]):
                The request object. The request message for
    ...
    async def update_tool(self,
            request: Optional[Union[gcdc_tool.UpdateToolRequest, dict]] = None,
            *,
            tool: Optional[gcdc_tool.Tool] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.UpdateToolRequest, dict]]):
                The request object. The request message for
    ...
    async def delete_tool(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_tool():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3beta1.DeleteToolRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.DeleteToolRequest, dict]]):
                The request object. The request message for
    ...
    async def list_tool_versions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_tool_versions]
    ...
    async def create_tool_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_tool_version]
    ...
    async def get_tool_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_tool_version]
    ...
    async def delete_tool_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_tool_version]
    ...
    async def restore_tool_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.restore_tool_version]

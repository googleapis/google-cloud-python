...
def test_import_intents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IntentsRestInterceptor, "post_import_intents_with_metadata") as post_with_metadata, \
...
def test_export_intents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.IntentsRestInterceptor, "post_export_intents_with_metadata") as post_with_metadata, \

...
def test_list_webhooks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebhooksRestInterceptor, "post_list_webhooks_with_metadata") as post_with_metadata, \
...
def test_get_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebhooksRestInterceptor, "post_get_webhook_with_metadata") as post_with_metadata, \
...
def test_create_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebhooksRestInterceptor, "post_create_webhook_with_metadata") as post_with_metadata, \
...
def test_update_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.WebhooksRestInterceptor, "post_update_webhook_with_metadata") as post_with_metadata, \

...
def test_list_webhooks_rest_required_fields(request_type=webhook.ListWebhooksRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_webhooks._get_unset_required_fields(jsonified_request)
...
def test_list_webhooks_rest_unset_required_fields():
    transport = transports.WebhooksRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_webhook_rest_required_fields(request_type=webhook.GetWebhookRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_webhook_rest_required_fields(request_type=gcdc_webhook.CreateWebhookRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_webhook_rest_required_fields(request_type=gcdc_webhook.UpdateWebhookRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_webhook_rest_required_fields(request_type=webhook.DeleteWebhookRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
async def test_list_agents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_agents] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_agent] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_agent] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.validate_agent] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_agent_validation_result] = mock_object
...
def test_get_generative_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_generative_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_generative_settings] = mock_object
...
def test_update_generative_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_generative_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_generative_settings] = mock_object
...
def test_list_agents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = agent.ListAgentsResponse.to_json(agent.ListAgentsResponse())
        ...
        client.list_agents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_agents_rest_bad_request(transport: str = 'rest', request_type=agent.ListAgentsRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_agent_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["agent"] = {'name': 'name_value', 'display_name': 'display_name_value', 'default_language_code': 'default_language_code_value', 'supported_language_codes': ['supported_language_codes_value1', 'supported_language_codes_value2'], 'time_zone': 'time_zone_value', 'description': 'description_value', 'avatar_uri': 'avatar_uri_value', 'speech_to_text_settings': {'enable_speech_adaptation': True}, 'start_flow': 'start_flow_value', 'start_playbook': 'start_playbook_value', 'security_settings': 'security_settings_value', 'enable_stackdriver_logging': True, 'enable_spell_correction': True, 'enable_multi_language_training': True, 'locked': True, 'advanced_settings': {'audio_export_gcs_destination': {'uri': 'uri_value'}, 'speech_settings': {'endpointer_sensitivity': 2402, 'no_speech_timeout': {'seconds': 751, 'nanos': 543}, 'use_timeout_based_endpointing': True, 'models': {}}, 'dtmf_settings': {'enabled': True, 'max_digits': 1065, 'finish_digit': 'finish_digit_value', 'interdigit_timeout_duration': {}, 'endpointing_timeout_duration': {}}, 'logging_settings': {'enable_stackdriver_logging': True, 'enable_interaction_logging': True}}, 'git_integration_settings': {'github_settings': {'display_name': 'display_name_value', 'repository_uri': 'repository_uri_value', 'tracking_branch': 'tracking_branch_value', 'access_token': 'access_token_value', 'branches': ['branches_value1', 'branches_value2']}}, 'text_to_speech_settings': {'synthesize_speech_configs': {}}, 'gen_app_builder_settings': {'engine': 'engine_value'}, 'answer_feedback_settings': {'enable_answer_feedback': True}, 'personalization_settings': {'default_end_user_metadata': {'fields': {}}}}
...
def test_create_agent_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "agent", )))
...
def test_create_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AgentsRestInterceptor, "post_create_agent") as post, \
        ...
        client.create_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_agent_rest_bad_request(transport: str = 'rest', request_type=gcdc_agent.CreateAgentRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_agent_rest(request_type):
    ...
    request_init["agent"] = {'name': 'projects/sample1/locations/sample2/agents/sample3', 'display_name': 'display_name_value', 'default_language_code': 'default_language_code_value', 'supported_language_codes': ['supported_language_codes_value1', 'supported_language_codes_value2'], 'time_zone': 'time_zone_value', 'description': 'description_value', 'avatar_uri': 'avatar_uri_value', 'speech_to_text_settings': {'enable_speech_adaptation': True}, 'start_flow': 'start_flow_value', 'start_playbook': 'start_playbook_value', 'security_settings': 'security_settings_value', 'enable_stackdriver_logging': True, 'enable_spell_correction': True, 'enable_multi_language_training': True, 'locked': True, 'advanced_settings': {'audio_export_gcs_destination': {'uri': 'uri_value'}, 'speech_settings': {'endpointer_sensitivity': 2402, 'no_speech_timeout': {'seconds': 751, 'nanos': 543}, 'use_timeout_based_endpointing': True, 'models': {}}, 'dtmf_settings': {'enabled': True, 'max_digits': 1065, 'finish_digit': 'finish_digit_value', 'interdigit_timeout_duration': {}, 'endpointing_timeout_duration': {}}, 'logging_settings': {'enable_stackdriver_logging': True, 'enable_interaction_logging': True}}, 'git_integration_settings': {'github_settings': {'display_name': 'display_name_value', 'repository_uri': 'repository_uri_value', 'tracking_branch': 'tracking_branch_value', 'access_token': 'access_token_value', 'branches': ['branches_value1', 'branches_value2']}}, 'text_to_speech_settings': {'synthesize_speech_configs': {}}, 'gen_app_builder_settings': {'engine': 'engine_value'}, 'answer_feedback_settings': {'enable_answer_feedback': True}, 'personalization_settings': {'default_end_user_metadata': {'fields': {}}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AgentsRestInterceptor, "post_update_agent") as post, \
        ...
        client.update_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_agent_rest_bad_request(transport: str = 'rest', request_type=gcdc_agent.UpdateAgentRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_validate_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AgentsRestInterceptor, "post_validate_agent") as post, \
         mock.patch.object(transports.AgentsRestInterceptor, "pre_validate_agent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = agent.AgentValidationResult.to_json(agent.AgentValidationResult())
        ...
        client.validate_agent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_validate_agent_rest_bad_request(transport: str = 'rest', request_type=agent.ValidateAgentRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_agent_validation_result_rest_required_fields(request_type=agent.GetAgentValidationResultRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_agent_validation_result._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_agent_validation_result_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AgentsRestInterceptor, "post_get_agent_validation_result") as post, \
         mock.patch.object(transports.AgentsRestInterceptor, "pre_get_agent_validation_result") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_agent_validation_result(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_agent_validation_result_rest_bad_request(transport: str = 'rest', request_type=agent.GetAgentValidationResultRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_generative_settings_rest_required_fields(request_type=agent.GetGenerativeSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_generative_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_generative_settings_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", )) & set(("name", "languageCode", )))
...
def test_get_generative_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AgentsRestInterceptor, "post_get_generative_settings") as post, \
         mock.patch.object(transports.AgentsRestInterceptor, "pre_get_generative_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = generative_settings.GenerativeSettings.to_json(generative_settings.GenerativeSettings())
        ...
        client.get_generative_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_generative_settings_rest_bad_request(transport: str = 'rest', request_type=agent.GetGenerativeSettingsRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_generative_settings_rest_required_fields(request_type=agent.UpdateGenerativeSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_generative_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_generative_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AgentsRestInterceptor, "post_update_generative_settings") as post, \
         mock.patch.object(transports.AgentsRestInterceptor, "pre_update_generative_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcdc_generative_settings.GenerativeSettings.to_json(gcdc_generative_settings.GenerativeSettings())
        ...
        client.update_generative_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_generative_settings_rest_bad_request(transport: str = 'rest', request_type=agent.UpdateGenerativeSettingsRequest):
    client = AgentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_generative_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{generative_settings.name=projects/*/locations/*/agents/*/generativeSettings}" % client.transport._host, args[1])
...
def test_agents_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3beta1.services.agents.transports.AgentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_agents_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3beta1.services.agents.transports.AgentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AgentsTransport()
        adc.assert_called_once()
...
def test_agent_generative_settings_path():
    ...
    location = "mussel"
    agent = "winkle"
    expected = "projects/{project}/locations/{location}/agents/{agent}/generativeSettings".format(project=project, location=location, agent=agent, )

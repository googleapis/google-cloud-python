...
def test_list_agents_rest_required_fields(request_type=agent.ListAgentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_agents._get_unset_required_fields(jsonified_request)
...
def test_create_agent_rest_required_fields(request_type=gcdc_agent.CreateAgentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_agent_rest_required_fields(request_type=gcdc_agent.UpdateAgentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_validate_agent_rest_required_fields(request_type=agent.ValidateAgentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).validate_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_agent_validation_result_rest_required_fields(request_type=agent.GetAgentValidationResultRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_agent_validation_result._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_generative_settings_rest_required_fields(request_type=agent.GetGenerativeSettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_generative_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_generative_settings_rest_required_fields(request_type=agent.UpdateGenerativeSettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_generative_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

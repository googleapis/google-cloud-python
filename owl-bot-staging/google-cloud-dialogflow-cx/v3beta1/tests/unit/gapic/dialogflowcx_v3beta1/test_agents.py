...
def test_list_agents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_list_agents_with_metadata") as post_with_metadata, \
...
def test_create_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_create_agent_with_metadata") as post_with_metadata, \
...
def test_update_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_update_agent_with_metadata") as post_with_metadata, \
...
def test_validate_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_validate_agent_with_metadata") as post_with_metadata, \
...
def test_get_agent_validation_result_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_get_agent_validation_result_with_metadata") as post_with_metadata, \
...
def test_get_generative_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_get_generative_settings_with_metadata") as post_with_metadata, \
...
def test_update_generative_settings_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'generative_settings': {'name': 'projects/sample1/locations/sample2/agents/sample3/generativeSettings'}}
    request_init["generative_settings"] = {'name': 'projects/sample1/locations/sample2/agents/sample3/generativeSettings', 'fallback_settings': {'selected_prompt': 'selected_prompt_value', 'prompt_templates': [{'display_name': 'display_name_value', 'prompt_text': 'prompt_text_value', 'frozen': True}]}, 'generative_safety_settings': {'default_banned_phrase_match_strategy': 1, 'banned_phrases': [{'text': 'text_value', 'language_code': 'language_code_value'}], 'prompt_security_settings': {'enable_prompt_security': True}}, 'knowledge_connector_settings': {'business': 'business_value', 'agent': 'agent_value', 'agent_identity': 'agent_identity_value', 'business_description': 'business_description_value', 'agent_scope': 'agent_scope_value', 'disable_data_store_fallback': True}, 'language_code': 'language_code_value', 'llm_model_settings': {'model': 'model_value', 'prompt_text': 'prompt_text_value', 'parameters': {'temperature': 0.1198, 'input_token_limit': 1, 'output_token_limit': 1}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_generative_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.AgentsRestInterceptor, "post_update_generative_settings_with_metadata") as post_with_metadata, \

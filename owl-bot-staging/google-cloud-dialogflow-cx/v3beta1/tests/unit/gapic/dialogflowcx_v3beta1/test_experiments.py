...
from google.cloud.dialogflowcx_v3beta1.services.experiments import ExperimentsAsyncClient
...
def test_experiments_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3beta1.services.experiments.transports.ExperimentsGrpcTransport.__init__') as grpc_transport:
...
def test_list_experiments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3beta1/{parent=projects/*/locations/*/agents/*/environments/*}/experiments" % client.transport._host, args[1])
...
def test_get_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}" % client.transport._host, args[1])
...
def test_update_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{experiment.name=projects/*/locations/*/agents/*/environments/*/experiments/*}" % client.transport._host, args[1])
...
def test_start_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:start" % client.transport._host, args[1])
...
def test_stop_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:stop" % client.transport._host, args[1])
...
def test_experiments_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3beta1.services.experiments.transports.ExperimentsTransport.__init__') as Transport:

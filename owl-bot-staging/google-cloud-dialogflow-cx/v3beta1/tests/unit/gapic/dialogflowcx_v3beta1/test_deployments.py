...
def test_list_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DeploymentsRestInterceptor, "post_list_deployments_with_metadata") as post_with_metadata, \
...
def test_get_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DeploymentsRestInterceptor, "post_get_deployment_with_metadata") as post_with_metadata, \

...
from google.cloud.dialogflowcx_v3beta1.services.playbooks import PlaybooksAsyncClient
...
from google.cloud.dialogflowcx_v3beta1.services.playbooks import transports
...
@pytest.mark.parametrize("client_class", [
    PlaybooksClient, PlaybooksAsyncClient
])
...
def test_create_playbook(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_playbook),
            '__call__') as call:
...
async def test_create_playbook_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_playbook] = mock_object
...
def test_delete_playbook(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_playbook),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_playbook] = mock_object
...
def test_list_playbooks(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_playbooks),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_playbooks] = mock_object
...
def test_list_playbooks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, playbook.Playbook)
                   for i in results)
...
async def test_list_playbooks_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_playbooks(request={},)
...
def test_get_playbook(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_playbook),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_playbook] = mock_object
...
def test_update_playbook(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_playbook),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcdc_playbook.Playbook(
            name='name_value',
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_playbook] = mock_object
...
def test_create_playbook_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_playbook_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_playbook_version] = mock_object
...
def test_get_playbook_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_playbook_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = playbook.PlaybookVersion(
            name='name_value',
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_playbook_version] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_playbook_versions] = mock_object
...
def test_list_playbook_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, playbook.PlaybookVersion)
                   for i in results)
...
async def test_list_playbook_versions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_playbook_versions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_delete_playbook_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_playbook_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_playbook_version] = mock_object
...
def test_create_playbook_rest(request_type):
    ...
    request_init["playbook"] = {'name': 'name_value', 'display_name': 'display_name_value', 'goal': 'goal_value', 'input_parameter_definitions': [{'name': 'name_value', 'type_': 1, 'description': 'description_value'}], 'output_parameter_definitions': {}, 'instruction': {'steps': [{'text': 'text_value', 'steps': {}}]}, 'token_count': 1193, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'referenced_playbooks': ['referenced_playbooks_value1', 'referenced_playbooks_value2'], 'referenced_flows': ['referenced_flows_value1', 'referenced_flows_value2'], 'referenced_tools': ['referenced_tools_value1', 'referenced_tools_value2'], 'llm_model_settings': {'model': 'model_value', 'prompt_text': 'prompt_text_value'}}
...
def test_create_playbook_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "playbook", )))
...
def test_create_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.PlaybooksRestInterceptor, "post_create_playbook") as post, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_create_playbook") as pre:
        ...
        req.return_value._content = gcdc_playbook.Playbook.to_json(gcdc_playbook.Playbook())
        ...
        client.create_playbook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_playbook_rest_bad_request(transport: str = 'rest', request_type=gcdc_playbook.CreatePlaybookRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_delete_playbook") as pre:
        pre.assert_not_called()
        ...
        client.delete_playbook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_playbook_rest_bad_request(transport: str = 'rest', request_type=playbook.DeletePlaybookRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_playbooks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "post_list_playbooks") as post, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_list_playbooks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = playbook.ListPlaybooksResponse.to_json(playbook.ListPlaybooksResponse())
        ...
        client.list_playbooks(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_playbooks_rest_bad_request(transport: str = 'rest', request_type=playbook.ListPlaybooksRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "post_get_playbook") as post, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_get_playbook") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_playbook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_playbook_rest_bad_request(transport: str = 'rest', request_type=playbook.GetPlaybookRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "post_update_playbook") as post, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_update_playbook") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_playbook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_playbook_rest_bad_request(transport: str = 'rest', request_type=gcdc_playbook.UpdatePlaybookRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_playbook_version_rest_required_fields(request_type=playbook.CreatePlaybookVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_playbook_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_playbook_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "playbookVersion", )))
...
def test_create_playbook_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "post_create_playbook_version") as post, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_create_playbook_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = playbook.PlaybookVersion.to_json(playbook.PlaybookVersion())
        ...
        client.create_playbook_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_playbook_version_rest_bad_request(transport: str = 'rest', request_type=playbook.CreatePlaybookVersionRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_playbook_version_rest_required_fields(request_type=playbook.GetPlaybookVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_playbook_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_playbook_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "post_get_playbook_version") as post, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_get_playbook_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_playbook_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_playbook_version_rest_bad_request(transport: str = 'rest', request_type=playbook.GetPlaybookVersionRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_playbook_versions_rest_required_fields(request_type=playbook.ListPlaybookVersionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_playbook_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_playbook_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "post_list_playbook_versions") as post, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_list_playbook_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = playbook.ListPlaybookVersionsResponse.to_json(playbook.ListPlaybookVersionsResponse())
        ...
        client.list_playbook_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_playbook_versions_rest_bad_request(transport: str = 'rest', request_type=playbook.ListPlaybookVersionsRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_playbook_version_rest_required_fields(request_type=playbook.DeletePlaybookVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_playbook_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_playbook_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PlaybooksRestInterceptor, "pre_delete_playbook_version") as pre:
        pre.assert_not_called()
        ...
        client.delete_playbook_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_playbook_version_rest_bad_request(transport: str = 'rest', request_type=playbook.DeletePlaybookVersionRequest):
    client = PlaybooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_playbooks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3beta1.services.playbooks.transports.PlaybooksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_playbooks_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3beta1.services.playbooks.transports.PlaybooksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PlaybooksTransport()
        adc.assert_called_once()
...
def test_playbooks_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.PlaybooksGrpcTransport, transports.PlaybooksGrpcAsyncIOTransport])
def test_playbooks_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.PlaybooksGrpcTransport, transports.PlaybooksGrpcAsyncIOTransport])
def test_playbooks_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_playbook_version_path():
    ...
    playbook = "nudibranch"
    version = "cuttlefish"
    expected = "projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/versions/{version}".format(project=project, location=location, agent=agent, playbook=playbook, version=version, )

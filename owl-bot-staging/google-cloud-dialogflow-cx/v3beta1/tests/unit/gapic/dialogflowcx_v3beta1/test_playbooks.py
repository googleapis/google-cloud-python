...
def test_export_playbook(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_playbook),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_import_playbook(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_playbook),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_restore_playbook_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restore_playbook_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_restore_playbook_version_rest_required_fields(request_type=playbook.RestorePlaybookVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).restore_playbook_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_playbook_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{name=projects/*/locations/*/agents/*/playbooks/*/versions/*}:restore" % client.transport._host, args[1])
...
def test_create_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_create_playbook_with_metadata") as post_with_metadata, \
...
def test_list_playbooks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_list_playbooks_with_metadata") as post_with_metadata, \
...
def test_get_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_get_playbook_with_metadata") as post_with_metadata, \
...
def test_export_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_export_playbook") as post, \
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_export_playbook_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PlaybooksRestInterceptor, "pre_export_playbook") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.export_playbook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_import_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_import_playbook") as post, \
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_import_playbook_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PlaybooksRestInterceptor, "pre_import_playbook") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.import_playbook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_playbook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_update_playbook_with_metadata") as post_with_metadata, \
...
def test_create_playbook_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_create_playbook_version_with_metadata") as post_with_metadata, \
...
def test_get_playbook_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_get_playbook_version_with_metadata") as post_with_metadata, \
...
def test_restore_playbook_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_restore_playbook_version") as post, \
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_restore_playbook_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PlaybooksRestInterceptor, "pre_restore_playbook_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.restore_playbook_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_playbook_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PlaybooksRestInterceptor, "post_list_playbook_versions_with_metadata") as post_with_metadata, \

...
def test_list_changelogs_rest_required_fields(request_type=changelog.ListChangelogsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_changelogs._get_unset_required_fields(jsonified_request)
...
def test_list_changelogs_rest_unset_required_fields():
    transport = transports.ChangelogsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_changelog_rest_required_fields(request_type=changelog.GetChangelogRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_changelog._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

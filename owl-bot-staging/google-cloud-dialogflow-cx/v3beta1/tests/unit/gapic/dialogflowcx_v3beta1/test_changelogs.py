...
from google.cloud.dialogflowcx_v3beta1.services.changelogs import ChangelogsAsyncClient
from google.cloud.dialogflowcx_v3beta1.services.changelogs import ChangelogsClient
from google.cloud.dialogflowcx_v3beta1.services.changelogs import pagers
from google.cloud.dialogflowcx_v3beta1.services.changelogs import transports
...
def test__read_environment_variables():
    assert ChangelogsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ChangelogsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            ChangelogsClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ChangelogsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ChangelogsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ChangelogsClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert ChangelogsClient._get_client_cert_source(None, False) is None
    assert ChangelogsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ChangelogsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ChangelogsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ChangelogsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ChangelogsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsClient))
@mock.patch.object(ChangelogsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ChangelogsClient._DEFAULT_UNIVERSE
    default_endpoint = ChangelogsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ChangelogsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ChangelogsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ChangelogsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ChangelogsClient.DEFAULT_MTLS_ENDPOINT
    assert ChangelogsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ChangelogsClient._get_api_endpoint(None, None, default_universe, "always") == ChangelogsClient.DEFAULT_MTLS_ENDPOINT
    assert ChangelogsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ChangelogsClient.DEFAULT_MTLS_ENDPOINT
    assert ChangelogsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ChangelogsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ChangelogsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ChangelogsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ChangelogsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ChangelogsClient._get_universe_domain(None, None) == ChangelogsClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_name", [
    (ChangelogsClient, "grpc"),
    (ChangelogsAsyncClient, "grpc_asyncio"),
    (ChangelogsClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.ChangelogsGrpcTransport, "grpc"),
    (transports.ChangelogsGrpcAsyncIOTransport, "grpc_asyncio"),
    (transports.ChangelogsRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (ChangelogsClient, transports.ChangelogsGrpcTransport, "grpc"),
    (ChangelogsAsyncClient, transports.ChangelogsGrpcAsyncIOTransport, "grpc_asyncio"),
    (ChangelogsClient, transports.ChangelogsRestTransport, "rest"),
])
@mock.patch.object(ChangelogsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsClient))
@mock.patch.object(ChangelogsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ChangelogsClient, transports.ChangelogsGrpcTransport, "grpc", "true"),
    (ChangelogsAsyncClient, transports.ChangelogsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ChangelogsClient, transports.ChangelogsGrpcTransport, "grpc", "false"),
    (ChangelogsAsyncClient, transports.ChangelogsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (ChangelogsClient, transports.ChangelogsRestTransport, "rest", "true"),
    (ChangelogsClient, transports.ChangelogsRestTransport, "rest", "false"),
])
@mock.patch.object(ChangelogsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsClient))
@mock.patch.object(ChangelogsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    ChangelogsClient, ChangelogsAsyncClient
])
...
@mock.patch.object(ChangelogsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsClient))
@mock.patch.object(ChangelogsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ChangelogsAsyncClient))
def test_changelogs_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ChangelogsClient, transports.ChangelogsGrpcTransport, "grpc", grpc_helpers),
    (ChangelogsAsyncClient, transports.ChangelogsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ChangelogsClient, transports.ChangelogsRestTransport, "rest", None),
])
...
def test_list_changelogs(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_changelogs),
            '__call__') as call:
...
def test_list_changelogs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_changelogs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_changelogs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_changelogs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_changelogs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_changelogs] = mock_rpc
...
def test_list_changelogs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, changelog.Changelog)
                   for i in results)
...
def test_get_changelog(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_changelog),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_changelog_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_changelog] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_changelog_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ChangelogsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_changelog in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_changelog] = mock_rpc
...
def test_list_changelogs_rest_interceptors(null_interceptor):
    transport = transports.ChangelogsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ChangelogsRestInterceptor(),
        )
    client = ChangelogsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ChangelogsRestInterceptor, "post_list_changelogs") as post, \
        mock.patch.object(transports.ChangelogsRestInterceptor, "post_list_changelogs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ChangelogsRestInterceptor, "pre_list_changelogs") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = changelog.ListChangelogsResponse.to_json(changelog.ListChangelogsResponse())
...
def test_get_changelog_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ChangelogsRestInterceptor, "post_get_changelog") as post, \
        mock.patch.object(transports.ChangelogsRestInterceptor, "post_get_changelog_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ChangelogsRestInterceptor, "pre_get_changelog") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [
        (transports.ChangelogsGrpcTransport, grpc_helpers),
        (transports.ChangelogsGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_changelogs_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_changelogs_client_transport_session_collision(transport_name):
    ...
    client1 = ChangelogsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ChangelogsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("transport_class", [transports.ChangelogsGrpcTransport, transports.ChangelogsGrpcAsyncIOTransport])
def test_changelogs_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ChangelogsGrpcTransport, transports.ChangelogsGrpcAsyncIOTransport])
def test_changelogs_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (ChangelogsClient, transports.ChangelogsGrpcTransport),
    (ChangelogsAsyncClient, transports.ChangelogsGrpcAsyncIOTransport),
])

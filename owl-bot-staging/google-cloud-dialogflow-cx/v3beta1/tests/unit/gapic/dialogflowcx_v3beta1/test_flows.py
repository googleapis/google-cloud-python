...
def test_create_flow_rest_required_fields(request_type=gcdc_flow.CreateFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_flow._get_unset_required_fields(jsonified_request)
...
def test_create_flow_rest_unset_required_fields():
    transport = transports.FlowsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_delete_flow_rest_required_fields(request_type=flow.DeleteFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_flows_rest_required_fields(request_type=flow.ListFlowsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_flows._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_flow_rest_required_fields(request_type=flow.GetFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_flow_rest_required_fields(request_type=gcdc_flow.UpdateFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_train_flow_rest_required_fields(request_type=flow.TrainFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).train_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_validate_flow_rest_required_fields(request_type=flow.ValidateFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).validate_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_flow_validation_result_rest_required_fields(request_type=flow.GetFlowValidationResultRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_flow_validation_result._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_flow_rest_required_fields(request_type=flow.ImportFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).import_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_flow_rest_required_fields(request_type=flow.ExportFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).export_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

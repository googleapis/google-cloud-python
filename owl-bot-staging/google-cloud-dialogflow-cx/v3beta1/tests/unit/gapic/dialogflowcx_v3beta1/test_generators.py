...
from google.cloud.dialogflowcx_v3beta1.services.generators import GeneratorsAsyncClient
from google.cloud.dialogflowcx_v3beta1.services.generators import GeneratorsClient
from google.cloud.dialogflowcx_v3beta1.services.generators import pagers
from google.cloud.dialogflowcx_v3beta1.services.generators import transports
...
def test_list_generators_rest_required_fields(request_type=generator.ListGeneratorsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_generators._get_unset_required_fields(jsonified_request)
...
def test_list_generators_rest_unset_required_fields():
    transport = transports.GeneratorsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_generator_rest_required_fields(request_type=generator.GetGeneratorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_generator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_generator_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/agents/sample3'}
    request_init["generator"] = {'name': 'name_value', 'display_name': 'display_name_value', 'prompt_text': {'text': 'text_value'}, 'placeholders': [{'id': 'id_value', 'name': 'name_value'}]}
...
def test_create_generator_rest_required_fields(request_type=gcdc_generator.CreateGeneratorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_generator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_generator_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", )) & set(("parent", "generator", )))
...
def test_create_generator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcdc_generator.Generator.to_json(gcdc_generator.Generator())
...
def test_create_generator_rest_bad_request(transport: str = 'rest', request_type=gcdc_generator.CreateGeneratorRequest):
    client = GeneratorsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_generator_rest(request_type):
    ...
    request_init["generator"] = {'name': 'projects/sample1/locations/sample2/agents/sample3/generators/sample4', 'display_name': 'display_name_value', 'prompt_text': {'text': 'text_value'}, 'placeholders': [{'id': 'id_value', 'name': 'name_value'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_generator_rest_required_fields(request_type=gcdc_generator.UpdateGeneratorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_generator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_generator_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("languageCode", "updateMask", )) & set(("generator", )))
...
def test_update_generator_rest_bad_request(transport: str = 'rest', request_type=gcdc_generator.UpdateGeneratorRequest):
    client = GeneratorsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_delete_generator_rest_required_fields(request_type=generator.DeleteGeneratorRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_generator._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generators_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3beta1.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generators_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3beta1.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.GeneratorsTransport()
        adc.assert_called_once()

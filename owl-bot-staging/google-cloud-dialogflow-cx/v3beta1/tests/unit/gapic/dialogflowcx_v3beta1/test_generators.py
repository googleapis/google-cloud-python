...
def test_create_generator_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/agents/sample3'}
    request_init["generator"] = {'name': 'name_value', 'display_name': 'display_name_value', 'prompt_text': {'text': 'text_value'}, 'placeholders': [{'id': 'id_value', 'name': 'name_value'}], 'llm_model_settings': {'model': 'model_value', 'prompt_text': 'prompt_text_value'}}
...
def test_update_generator_rest(request_type):
    ...
    request_init["generator"] = {'name': 'projects/sample1/locations/sample2/agents/sample3/generators/sample4', 'display_name': 'display_name_value', 'prompt_text': {'text': 'text_value'}, 'placeholders': [{'id': 'id_value', 'name': 'name_value'}], 'llm_model_settings': {'model': 'model_value', 'prompt_text': 'prompt_text_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

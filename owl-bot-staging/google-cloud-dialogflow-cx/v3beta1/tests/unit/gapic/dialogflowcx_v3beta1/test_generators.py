...
def test_create_generator_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/agents/sample3'}
    request_init["generator"] = {'name': 'name_value', 'display_name': 'display_name_value', 'prompt_text': {'text': 'text_value'}, 'placeholders': [{'id': 'id_value', 'name': 'name_value'}], 'llm_model_settings': {'model': 'model_value', 'prompt_text': 'prompt_text_value', 'parameters': {'temperature': 0.1198, 'input_token_limit': 1, 'output_token_limit': 1}}, 'model_parameter': {'temperature': 0.1198, 'max_decode_steps': 1687, 'top_p': 0.546, 'top_k': 541}}

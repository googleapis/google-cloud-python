...
from google.cloud.dialogflowcx_v3.services.experiments import ExperimentsAsyncClient
...
def test__get_default_mtls_endpoint():
    ...
    assert ExperimentsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ExperimentsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ExperimentsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ExperimentsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ExperimentsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ExperimentsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ExperimentsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ExperimentsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ExperimentsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ExperimentsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(ExperimentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ExperimentsClient))
@mock.patch.object(ExperimentsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ExperimentsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ExperimentsClient._DEFAULT_UNIVERSE
    default_endpoint = ExperimentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ExperimentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ExperimentsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ExperimentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ExperimentsClient.DEFAULT_MTLS_ENDPOINT
    assert ExperimentsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ExperimentsClient._get_api_endpoint(None, None, default_universe, "always") == ExperimentsClient.DEFAULT_MTLS_ENDPOINT
    assert ExperimentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ExperimentsClient.DEFAULT_MTLS_ENDPOINT
    assert ExperimentsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ExperimentsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ExperimentsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ExperimentsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ExperimentsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ExperimentsClient._get_universe_domain(None, None) == ExperimentsClient._DEFAULT_UNIVERSE
...
def test_experiments_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ExperimentsAsyncClient, transports.ExperimentsGrpcAsyncIOTransport, "grpc_asyncio"),
    (ExperimentsClient, transports.ExperimentsRestTransport, "rest"),
])
@mock.patch.object(ExperimentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ExperimentsClient))
@mock.patch.object(ExperimentsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ExperimentsAsyncClient))
def test_experiments_client_client_options(client_class, transport_class, transport_name):
...
def test_experiments_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    ExperimentsClient, ExperimentsAsyncClient
])
...
def test_experiments_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (ExperimentsAsyncClient, transports.ExperimentsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ExperimentsClient, transports.ExperimentsRestTransport, "rest", None),
])
def test_experiments_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_experiments_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.experiments.transports.ExperimentsGrpcTransport.__init__') as grpc_transport:
...
def test_experiments_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_experiments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_experiments] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_experiments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_experiments in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_experiments] = mock_rpc
...
def test_list_experiments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, experiment.Experiment)
                   for i in results)
...
async def test_list_experiments_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_experiments(request={},)
...
@pytest.mark.asyncio
async def test_get_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ExperimentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_experiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_experiment] = mock_rpc
...
def test_create_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_experiment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ExperimentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_experiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_experiment] = mock_rpc
...
def test_update_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_experiment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ExperimentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_experiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_experiment] = mock_rpc
...
def test_delete_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_experiment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ExperimentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_experiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_experiment] = mock_rpc
...
def test_start_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.start_experiment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_start_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ExperimentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_experiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_experiment] = mock_rpc
...
@pytest.mark.asyncio
async def test_stop_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ExperimentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.stop_experiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stop_experiment] = mock_rpc
...
def test_list_experiments_rest_required_fields(request_type=experiment.ListExperimentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_experiments._get_unset_required_fields(jsonified_request)
...
def test_list_experiments_rest_unset_required_fields():
    transport = transports.ExperimentsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_experiments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4'}
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*/environments/*}/experiments" % client.transport._host, args[1])
...
def test_list_experiments_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(experiment.ListExperimentsResponse.to_json(x) for x in response)
...
def test_get_experiment_rest_required_fields(request_type=experiment.GetExperimentRequest):
    transport_class = transports.ExperimentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4/experiments/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}" % client.transport._host, args[1])
...
def test_create_experiment_rest_required_fields(request_type=gcdc_experiment.CreateExperimentRequest):
    transport_class = transports.ExperimentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_experiment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "experiment", )))
...
def test_update_experiment_rest_required_fields(request_type=gcdc_experiment.UpdateExperimentRequest):
    transport_class = transports.ExperimentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_experiment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("experiment", "updateMask", )))
...
def test_update_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'experiment': {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4/experiments/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{experiment.name=projects/*/locations/*/agents/*/environments/*/experiments/*}" % client.transport._host, args[1])
...
def test_delete_experiment_rest_required_fields(request_type=experiment.DeleteExperimentRequest):
    transport_class = transports.ExperimentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_experiment_rest_required_fields(request_type=experiment.StartExperimentRequest):
    transport_class = transports.ExperimentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).start_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:start" % client.transport._host, args[1])
...
def test_stop_experiment_rest_required_fields(request_type=experiment.StopExperimentRequest):
    transport_class = transports.ExperimentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).stop_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:stop" % client.transport._host, args[1])
...
def test_list_experiments_rest_bad_request(request_type=experiment.ListExperimentsRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4'}
    request = request_type(**request_init)
...
def test_list_experiments_rest_interceptors(null_interceptor):
    transport = transports.ExperimentsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ExperimentsRestInterceptor(),
        )
    client = ExperimentsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_list_experiments") as post, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_list_experiments_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "pre_list_experiments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = experiment.ListExperimentsRequest.pb(experiment.ListExperimentsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = experiment.ListExperimentsResponse.to_json(experiment.ListExperimentsResponse())
        ...
        client.list_experiments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_experiment_rest_bad_request(request_type=experiment.GetExperimentRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4/experiments/sample5'}
    request = request_type(**request_init)
...
def test_get_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_get_experiment") as post, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_get_experiment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "pre_get_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = experiment.GetExperimentRequest.pb(experiment.GetExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_experiment_rest_bad_request(request_type=gcdc_experiment.CreateExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_create_experiment") as post, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_create_experiment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "pre_create_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_experiment.CreateExperimentRequest.pb(gcdc_experiment.CreateExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_experiment_rest_bad_request(request_type=gcdc_experiment.UpdateExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'experiment': {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4/experiments/sample5'}}
    request = request_type(**request_init)
...
def test_update_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_update_experiment") as post, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_update_experiment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "pre_update_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_experiment.UpdateExperimentRequest.pb(gcdc_experiment.UpdateExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_experiment_rest_bad_request(request_type=experiment.DeleteExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "pre_delete_experiment") as pre:
        pre.assert_not_called()
        pb_message = experiment.DeleteExperimentRequest.pb(experiment.DeleteExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_start_experiment_rest_bad_request(request_type=experiment.StartExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_start_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_start_experiment") as post, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_start_experiment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "pre_start_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = experiment.StartExperimentRequest.pb(experiment.StartExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.start_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stop_experiment_rest_bad_request(request_type=experiment.StopExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_stop_experiment") as post, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "post_stop_experiment_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.ExperimentsRestInterceptor, "pre_stop_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = experiment.StopExperimentRequest.pb(experiment.StopExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.stop_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_experiments_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.experiments.transports.ExperimentsTransport.__init__') as Transport:
...
def test_experiments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.experiments.transports.ExperimentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_experiments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.experiments.transports.ExperimentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ExperimentsTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.ExperimentsGrpcTransport, transports.ExperimentsGrpcAsyncIOTransport])
def test_experiments_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ExperimentsGrpcTransport, transports.ExperimentsGrpcAsyncIOTransport])
def test_experiments_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ExperimentsGrpcTransport, transports.ExperimentsGrpcAsyncIOTransport])
def test_experiments_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ExperimentsTransport, '_prep_wrapped_messages') as prep:
        client = ExperimentsClient(
            credentials=ga_credentials.AnonymousCredentials(),

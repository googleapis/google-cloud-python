...
def test_list_experiments_rest_required_fields(request_type=experiment.ListExperimentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_experiments._get_unset_required_fields(jsonified_request)
...
def test_list_experiments_rest_unset_required_fields():
    transport = transports.ExperimentsRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_experiment_rest_required_fields(request_type=experiment.GetExperimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_experiment_rest_required_fields(request_type=gcdc_experiment.CreateExperimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_experiment_rest_required_fields(request_type=gcdc_experiment.UpdateExperimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_experiment_rest_required_fields(request_type=experiment.DeleteExperimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_experiment_rest_required_fields(request_type=experiment.StartExperimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).start_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_experiment_rest_required_fields(request_type=experiment.StopExperimentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).stop_experiment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

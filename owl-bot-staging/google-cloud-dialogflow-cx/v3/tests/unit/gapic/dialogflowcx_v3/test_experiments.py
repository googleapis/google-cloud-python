...
async def test_list_experiments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.list_experiments] = mock_object
...
async def test_get_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_experiment] = mock_object
...
async def test_create_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_experiment] = mock_object
...
async def test_update_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_experiment] = mock_object
...
async def test_delete_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_experiment] = mock_object
...
async def test_start_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.start_experiment] = mock_object
...
async def test_stop_experiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.stop_experiment] = mock_object
...
def test_list_experiments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = experiment.ListExperimentsResponse.to_json(experiment.ListExperimentsResponse())
...
def test_list_experiments_rest_bad_request(transport: str = 'rest', request_type=experiment.ListExperimentsRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = experiment.Experiment.to_json(experiment.Experiment())
...
def test_get_experiment_rest_bad_request(transport: str = 'rest', request_type=experiment.GetExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcdc_experiment.Experiment.to_json(gcdc_experiment.Experiment())
...
def test_create_experiment_rest_bad_request(transport: str = 'rest', request_type=gcdc_experiment.CreateExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_experiment_rest_bad_request(transport: str = 'rest', request_type=gcdc_experiment.UpdateExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_experiment_rest_bad_request(transport: str = 'rest', request_type=experiment.DeleteExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_experiment_rest_bad_request(transport: str = 'rest', request_type=experiment.StartExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_experiment_rest_bad_request(transport: str = 'rest', request_type=experiment.StopExperimentRequest):
    client = ExperimentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

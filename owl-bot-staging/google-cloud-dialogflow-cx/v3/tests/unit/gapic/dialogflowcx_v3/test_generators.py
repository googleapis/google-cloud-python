...
from google.cloud.dialogflowcx_v3.services.generators import GeneratorsAsyncClient
from google.cloud.dialogflowcx_v3.services.generators import GeneratorsClient
from google.cloud.dialogflowcx_v3.services.generators import pagers
from google.cloud.dialogflowcx_v3.services.generators import transports
...
def test_create_generator_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/agents/sample3'}
    request_init["generator"] = {'name': 'name_value', 'display_name': 'display_name_value', 'prompt_text': {'text': 'text_value'}, 'placeholders': [{'id': 'id_value', 'name': 'name_value'}], 'model_parameter': {'temperature': 0.1198, 'max_decode_steps': 1687, 'top_p': 0.546, 'top_k': 541}}
...
def test_update_generator_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'generator': {'name': 'projects/sample1/locations/sample2/agents/sample3/generators/sample4'}}
    request_init["generator"] = {'name': 'projects/sample1/locations/sample2/agents/sample3/generators/sample4', 'display_name': 'display_name_value', 'prompt_text': {'text': 'text_value'}, 'placeholders': [{'id': 'id_value', 'name': 'name_value'}], 'model_parameter': {'temperature': 0.1198, 'max_decode_steps': 1687, 'top_p': 0.546, 'top_k': 541}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_generators_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_generators_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.generators.transports.GeneratorsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GeneratorsTransport()
        adc.assert_called_once()

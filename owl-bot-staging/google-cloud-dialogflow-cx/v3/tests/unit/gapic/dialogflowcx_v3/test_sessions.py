...
def test_server_streaming_detect_intent(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.server_streaming_detect_intent),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_server_streaming_detect_intent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.server_streaming_detect_intent in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.server_streaming_detect_intent] = mock_rpc
        request = {}
...
async def test_server_streaming_detect_intent_empty_call_async():
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[session.DetectIntentResponse()])
...
@pytest.mark.asyncio
async def test_server_streaming_detect_intent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.server_streaming_detect_intent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.server_streaming_detect_intent] = mock_object
...
@pytest.mark.asyncio
async def test_server_streaming_detect_intent_async(transport: str = 'grpc_asyncio', request_type=session.DetectIntentRequest):
    client = SessionsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_match_intent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.match_intent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.match_intent] = mock_object
...
@pytest.mark.asyncio
async def test_fulfill_intent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fulfill_intent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.fulfill_intent] = mock_object
...
def test_submit_answer_feedback(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.submit_answer_feedback),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_submit_answer_feedback_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.submit_answer_feedback in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.submit_answer_feedback] = mock_rpc
        request = {}
...
async def test_submit_answer_feedback_empty_call_async():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(session.AnswerFeedback(
            rating=session.AnswerFeedback.Rating.THUMBS_UP,
            custom_rating='custom_rating_value',
        ))
...
@pytest.mark.asyncio
async def test_submit_answer_feedback_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.submit_answer_feedback in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.submit_answer_feedback] = mock_object
...
@pytest.mark.asyncio
async def test_submit_answer_feedback_async(transport: str = 'grpc_asyncio', request_type=session.SubmitAnswerFeedbackRequest):
    client = SessionsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_detect_intent_rest(request_type):
    ...
    request_init = {'session': 'projects/sample1/locations/sample2/agents/sample3/sessions/sample4'}
...
def test_detect_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = session.DetectIntentResponse.to_json(session.DetectIntentResponse())
...
def test_detect_intent_rest_bad_request(transport: str = 'rest', request_type=session.DetectIntentRequest):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_server_streaming_detect_intent_rest_required_fields(request_type=session.DetectIntentRequest):
    transport_class = transports.SessionsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).server_streaming_detect_intent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_server_streaming_detect_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionsRestInterceptor, "post_server_streaming_detect_intent") as post, \
         mock.patch.object(transports.SessionsRestInterceptor, "pre_server_streaming_detect_intent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = session.DetectIntentRequest.pb(session.DetectIntentRequest())
        transcode.return_value = {
        ...
        client.server_streaming_detect_intent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_server_streaming_detect_intent_rest_bad_request(transport: str = 'rest', request_type=session.DetectIntentRequest):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_match_intent_rest_required_fields(request_type=session.MatchIntentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).match_intent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_match_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionsRestInterceptor, "post_match_intent") as post, \
         mock.patch.object(transports.SessionsRestInterceptor, "pre_match_intent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = session.MatchIntentResponse.to_json(session.MatchIntentResponse())
        ...
        client.match_intent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_match_intent_rest_bad_request(transport: str = 'rest', request_type=session.MatchIntentRequest):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fulfill_intent_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'match_intent_request': {'session': 'projects/sample1/locations/sample2/agents/sample3/sessions/sample4'}}
    request = request_type(**request_init)
...
def test_fulfill_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionsRestInterceptor, "post_fulfill_intent") as post, \
         mock.patch.object(transports.SessionsRestInterceptor, "pre_fulfill_intent") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = session.FulfillIntentResponse.to_json(session.FulfillIntentResponse())
        ...
        client.fulfill_intent(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_fulfill_intent_rest_bad_request(transport: str = 'rest', request_type=session.FulfillIntentRequest):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_submit_answer_feedback_rest_required_fields(request_type=session.SubmitAnswerFeedbackRequest):
    transport_class = transports.SessionsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).submit_answer_feedback._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_submit_answer_feedback_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "responseId", "answerFeedback", )))
...
def test_submit_answer_feedback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionsRestInterceptor, "post_submit_answer_feedback") as post, \
         mock.patch.object(transports.SessionsRestInterceptor, "pre_submit_answer_feedback") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = session.SubmitAnswerFeedbackRequest.pb(session.SubmitAnswerFeedbackRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = session.AnswerFeedback.to_json(session.AnswerFeedback())
        ...
        client.submit_answer_feedback(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_submit_answer_feedback_rest_bad_request(transport: str = 'rest', request_type=session.SubmitAnswerFeedbackRequest):
    client = SessionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_sessions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.sessions.transports.SessionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_sessions_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.sessions.transports.SessionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SessionsTransport()
        adc.assert_called_once()

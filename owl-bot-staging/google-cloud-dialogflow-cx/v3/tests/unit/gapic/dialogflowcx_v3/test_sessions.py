...
def test_match_intent_rest_required_fields(request_type=session.MatchIntentRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).match_intent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_submit_answer_feedback_rest_required_fields(request_type=session.SubmitAnswerFeedbackRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).submit_answer_feedback._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
def test_create_security_settings_rest_required_fields(request_type=gcdc_security_settings.CreateSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_security_settings._get_unset_required_fields(jsonified_request)
...
def test_create_security_settings_rest_unset_required_fields():
    transport = transports.SecuritySettingsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_security_settings_rest_required_fields(request_type=security_settings.GetSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_security_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_security_settings_rest_required_fields(request_type=gcdc_security_settings.UpdateSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_security_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_security_settings_rest_required_fields(request_type=security_settings.ListSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_security_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_security_settings_rest_required_fields(request_type=security_settings.DeleteSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_security_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

...
from google.cloud.dialogflowcx_v3.services.security_settings_service import SecuritySettingsServiceAsyncClient
from google.cloud.dialogflowcx_v3.services.security_settings_service import SecuritySettingsServiceClient
...
def test__read_environment_variables():
    assert SecuritySettingsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SecuritySettingsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        with pytest.raises(ValueError) as excinfo:
            SecuritySettingsServiceClient._read_environment_variables()
    assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SecuritySettingsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SecuritySettingsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SecuritySettingsServiceClient._read_environment_variables() == (False, "auto", "foo.com")

def test__get_client_cert_source():
    mock_provided_cert_source = mock.Mock()
    mock_default_cert_source = mock.Mock()

    assert SecuritySettingsServiceClient._get_client_cert_source(None, False) is None
    assert SecuritySettingsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SecuritySettingsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SecuritySettingsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SecuritySettingsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SecuritySettingsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceClient))
@mock.patch.object(SecuritySettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SecuritySettingsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SecuritySettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SecuritySettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SecuritySettingsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SecuritySettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SecuritySettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SecuritySettingsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SecuritySettingsServiceClient._get_api_endpoint(None, None, default_universe, "always") == SecuritySettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SecuritySettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SecuritySettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SecuritySettingsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SecuritySettingsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SecuritySettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SecuritySettingsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SecuritySettingsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SecuritySettingsServiceClient._get_universe_domain(None, None) == SecuritySettingsServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_name", [
    (SecuritySettingsServiceClient, "grpc"),
    (SecuritySettingsServiceAsyncClient, "grpc_asyncio"),
    (SecuritySettingsServiceClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.SecuritySettingsServiceRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (SecuritySettingsServiceClient, transports.SecuritySettingsServiceRestTransport, "rest"),
])
@mock.patch.object(SecuritySettingsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceClient))
@mock.patch.object(SecuritySettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (SecuritySettingsServiceClient, transports.SecuritySettingsServiceRestTransport, "rest", "true"),
    (SecuritySettingsServiceClient, transports.SecuritySettingsServiceRestTransport, "rest", "false"),
])
@mock.patch.object(SecuritySettingsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceClient))
@mock.patch.object(SecuritySettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceAsyncClient))
...
@mock.patch.object(SecuritySettingsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceClient))
@mock.patch.object(SecuritySettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceAsyncClient))
def test_security_settings_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (SecuritySettingsServiceClient, transports.SecuritySettingsServiceGrpcTransport, "grpc", grpc_helpers),
    (SecuritySettingsServiceAsyncClient, transports.SecuritySettingsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SecuritySettingsServiceClient, transports.SecuritySettingsServiceRestTransport, "rest", None),
])
...
def test_security_settings_service_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.security_settings_service.transports.SecuritySettingsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_security_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_security_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_security_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_security_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_security_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_security_settings] = mock_rpc
...
def test_get_security_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_security_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_security_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_security_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecuritySettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_security_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_security_settings] = mock_rpc
...
def test_update_security_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_security_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_security_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_security_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecuritySettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_security_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_security_settings] = mock_rpc
...
def test_list_security_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_security_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_security_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_security_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecuritySettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_security_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_security_settings] = mock_rpc
...
def test_delete_security_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_security_settings in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_security_settings] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_security_settings_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecuritySettingsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_security_settings in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_security_settings] = mock_rpc
...
def test_create_security_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}/securitySettings" % client.transport._host, args[1])
...
def test_get_security_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/securitySettings/*}" % client.transport._host, args[1])
...
def test_update_security_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{security_settings.name=projects/*/locations/*/securitySettings/*}" % client.transport._host, args[1])
...
def test_create_security_settings_rest_bad_request(request_type=gcdc_security_settings.CreateSecuritySettingsRequest):
    client = SecuritySettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_security_settings_rest_interceptors(null_interceptor):
    transport = transports.SecuritySettingsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SecuritySettingsServiceRestInterceptor(),
        )
    client = SecuritySettingsServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_create_security_settings") as post, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_create_security_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "pre_create_security_settings") as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcdc_security_settings.SecuritySettings.to_json(gcdc_security_settings.SecuritySettings())
        ...
        post_with_metadata.return_value = gcdc_security_settings.SecuritySettings(), metadata
...
def test_get_security_settings_rest_bad_request(request_type=security_settings.GetSecuritySettingsRequest):
    client = SecuritySettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_get_security_settings") as post, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_get_security_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "pre_get_security_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = security_settings.SecuritySettings.to_json(security_settings.SecuritySettings())
        req.return_value.content = return_value
...
def test_update_security_settings_rest_bad_request(request_type=gcdc_security_settings.UpdateSecuritySettingsRequest):
    client = SecuritySettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_update_security_settings") as post, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_update_security_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "pre_update_security_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_security_settings_rest_bad_request(request_type=security_settings.ListSecuritySettingsRequest):
    client = SecuritySettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_list_security_settings") as post, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_list_security_settings_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "pre_list_security_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = security_settings.ListSecuritySettingsResponse.to_json(security_settings.ListSecuritySettingsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = security_settings.ListSecuritySettingsResponse(), metadata
...
def test_delete_security_settings_rest_bad_request(request_type=security_settings.DeleteSecuritySettingsRequest):
    client = SecuritySettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "pre_delete_security_settings") as pre:
        pre.assert_not_called()
...
def test_security_settings_service_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.security_settings_service.transports.SecuritySettingsServiceTransport.__init__') as Transport:
...
def test_security_settings_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.security_settings_service.transports.SecuritySettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_security_settings_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.security_settings_service.transports.SecuritySettingsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SecuritySettingsServiceTransport()
        adc.assert_called_once()
...
def test_security_settings_service_client_transport_session_collision(transport_name):
    ...
    client1 = SecuritySettingsServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SecuritySettingsServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (SecuritySettingsServiceClient, transports.SecuritySettingsServiceGrpcTransport),
    (SecuritySettingsServiceAsyncClient, transports.SecuritySettingsServiceGrpcAsyncIOTransport),
])

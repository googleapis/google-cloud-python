...
def test_create_security_settings_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = gcdc_security_settings.SecuritySettings.pb(return_value)
...
def test_get_security_settings_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = security_settings.SecuritySettings.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_security_settings_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = security_settings.ListSecuritySettingsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)

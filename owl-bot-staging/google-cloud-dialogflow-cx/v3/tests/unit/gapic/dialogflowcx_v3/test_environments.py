...
def test_lookup_environment_history_rest_required_fields(request_type=environment.LookupEnvironmentHistoryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).lookup_environment_history._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_continuous_test_rest_required_fields(request_type=environment.RunContinuousTestRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).run_continuous_test._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_continuous_test_results_rest_required_fields(request_type=environment.ListContinuousTestResultsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_continuous_test_results._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deploy_flow_rest_required_fields(request_type=environment.DeployFlowRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).deploy_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

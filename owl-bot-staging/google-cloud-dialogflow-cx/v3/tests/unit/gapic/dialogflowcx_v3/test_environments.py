...
def test_environments_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.environments.transports.EnvironmentsGrpcTransport.__init__') as grpc_transport:
...
def test_lookup_environment_history_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.lookup_environment_history in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.lookup_environment_history] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_lookup_environment_history_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.lookup_environment_history in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.lookup_environment_history] = mock_rpc
...
async def test_lookup_environment_history_async(transport: str = 'grpc_asyncio', request_type=environment.LookupEnvironmentHistoryRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environment.LookupEnvironmentHistoryResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_lookup_environment_history_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.lookup_environment_history(request={}, retry=retry, timeout=timeout)
...
def test_run_continuous_test(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.run_continuous_test),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_run_continuous_test_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.run_continuous_test in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.run_continuous_test] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_run_continuous_test_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.run_continuous_test in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_continuous_test] = mock_rpc
...
@pytest.mark.asyncio
async def test_run_continuous_test_async(transport: str = 'grpc_asyncio', request_type=environment.RunContinuousTestRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_continuous_test_results_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_continuous_test_results in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_continuous_test_results] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_continuous_test_results_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_continuous_test_results in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_continuous_test_results] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_continuous_test_results_async(transport: str = 'grpc_asyncio', request_type=environment.ListContinuousTestResultsRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(environment.ListContinuousTestResultsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_continuous_test_results_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_continuous_test_results(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, environment.ContinuousTestResult)
                   for i in results)
...
def test_deploy_flow(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.deploy_flow),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_deploy_flow_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EnvironmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.deploy_flow in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.deploy_flow] = mock_rpc
...
@pytest.mark.asyncio
async def test_deploy_flow_async(transport: str = 'grpc_asyncio', request_type=environment.DeployFlowRequest):
    client = EnvironmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_environments_rest_required_fields(request_type=environment.ListEnvironmentsRequest):
...
def test_list_environments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*}/environments" % client.transport._host, args[1])
...
def test_list_environments_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(environment.ListEnvironmentsResponse.to_json(x) for x in response)
...
def test_get_environment_rest_required_fields(request_type=environment.GetEnvironmentRequest):
    transport_class = transports.EnvironmentsRestTransport
...
def test_get_environment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/environments/*}" % client.transport._host, args[1])
...
def test_create_environment_rest_required_fields(request_type=gcdc_environment.CreateEnvironmentRequest):
    transport_class = transports.EnvironmentsRestTransport
...
def test_create_environment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "environment", )))
...
def test_update_environment_rest_required_fields(request_type=gcdc_environment.UpdateEnvironmentRequest):
    transport_class = transports.EnvironmentsRestTransport
...
def test_update_environment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("environment", "updateMask", )))
...
def test_update_environment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'environment': {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{environment.name=projects/*/locations/*/agents/*/environments/*}" % client.transport._host, args[1])
...
def test_delete_environment_rest_required_fields(request_type=environment.DeleteEnvironmentRequest):
    transport_class = transports.EnvironmentsRestTransport
...
def test_lookup_environment_history_rest_required_fields(request_type=environment.LookupEnvironmentHistoryRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).lookup_environment_history._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lookup_environment_history_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/environments/*}:lookupEnvironmentHistory" % client.transport._host, args[1])
...
def test_lookup_environment_history_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(environment.LookupEnvironmentHistoryResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_run_continuous_test_rest_required_fields(request_type=environment.RunContinuousTestRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).run_continuous_test._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_continuous_test_results_rest_required_fields(request_type=environment.ListContinuousTestResultsRequest):
    transport_class = transports.EnvironmentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_continuous_test_results._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_continuous_test_results_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*/environments/*}/continuousTestResults" % client.transport._host, args[1])
...
def test_list_continuous_test_results_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(environment.ListContinuousTestResultsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_deploy_flow_rest_required_fields(request_type=environment.DeployFlowRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).deploy_flow._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deploy_flow_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("environment", "flowVersion", )))
...
def test_list_environments_rest_bad_request(request_type=environment.ListEnvironmentsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_environments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pb_message = environment.ListEnvironmentsRequest.pb(environment.ListEnvironmentsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environment.ListEnvironmentsResponse.to_json(environment.ListEnvironmentsResponse())
        ...
        post_with_metadata.return_value = environment.ListEnvironmentsResponse(), metadata
...
def test_get_environment_rest_bad_request(request_type=environment.GetEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4'}
    request = request_type(**request_init)
...
def test_get_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environment.GetEnvironmentRequest.pb(environment.GetEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_environment_rest_bad_request(request_type=gcdc_environment.CreateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_environment.CreateEnvironmentRequest.pb(gcdc_environment.CreateEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_environment_rest_bad_request(request_type=gcdc_environment.UpdateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'environment': {'name': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4'}}
    request = request_type(**request_init)
...
def test_update_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_environment.UpdateEnvironmentRequest.pb(gcdc_environment.UpdateEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_environment_rest_bad_request(request_type=environment.DeleteEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        pb_message = environment.DeleteEnvironmentRequest.pb(environment.DeleteEnvironmentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_lookup_environment_history_rest_bad_request(request_type=environment.LookupEnvironmentHistoryRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_lookup_environment_history_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_lookup_environment_history") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_lookup_environment_history_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_lookup_environment_history") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environment.LookupEnvironmentHistoryRequest.pb(environment.LookupEnvironmentHistoryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environment.LookupEnvironmentHistoryResponse.to_json(environment.LookupEnvironmentHistoryResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environment.LookupEnvironmentHistoryResponse(), metadata

        client.lookup_environment_history(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_run_continuous_test_rest_bad_request(request_type=environment.RunContinuousTestRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'environment': 'projects/sample1/locations/sample2/agents/sample3/environments/sample4'}
    request = request_type(**request_init)
...
def test_run_continuous_test_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_run_continuous_test") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_run_continuous_test_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_run_continuous_test") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environment.RunContinuousTestRequest.pb(environment.RunContinuousTestRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.run_continuous_test(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_continuous_test_results_rest_bad_request(request_type=environment.ListContinuousTestResultsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_continuous_test_results_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_continuous_test_results") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_continuous_test_results_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_list_continuous_test_results") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = environment.ListContinuousTestResultsRequest.pb(environment.ListContinuousTestResultsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = environment.ListContinuousTestResultsResponse.to_json(environment.ListContinuousTestResultsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = environment.ListContinuousTestResultsResponse(), metadata

        client.list_continuous_test_results(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_deploy_flow_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_deploy_flow") as post, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "post_deploy_flow_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_deploy_flow") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.deploy_flow(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_environments_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.environments.transports.EnvironmentsTransport.__init__') as Transport:
...
def test_environments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_environments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.environments.transports.EnvironmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EnvironmentsTransport()
        adc.assert_called_once()
...
def test_continuous_test_result_path():
    ...
    expected = "projects/{project}/locations/{location}/agents/{agent}/environments/{environment}/continuousTestResults/{continuous_test_result}".format(project=project, location=location, agent=agent, environment=environment, continuous_test_result=continuous_test_result, )
    actual = EnvironmentsClient.continuous_test_result_path(project, location, agent, environment, continuous_test_result)
...
def test_test_case_result_path():
    ...
    actual = EnvironmentsClient.test_case_result_path(project, location, agent, test_case, result)
    assert expected == actual

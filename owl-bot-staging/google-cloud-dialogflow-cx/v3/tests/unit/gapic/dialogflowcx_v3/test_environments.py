...
async def test_lookup_environment_history_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.lookup_environment_history] = mock_object
...
async def test_run_continuous_test_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.run_continuous_test] = mock_object
...
async def test_list_continuous_test_results_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_continuous_test_results] = mock_object
...
async def test_deploy_flow_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.deploy_flow] = mock_object
...
def test_list_environments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = environment.ListEnvironmentsResponse.to_json(environment.ListEnvironmentsResponse())
...
def test_list_environments_rest_bad_request(transport: str = 'rest', request_type=environment.ListEnvironmentsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_environment_rest_bad_request(transport: str = 'rest', request_type=environment.GetEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_environment_rest_bad_request(transport: str = 'rest', request_type=gcdc_environment.CreateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_environment_rest_bad_request(transport: str = 'rest', request_type=gcdc_environment.UpdateEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_environment_rest_bad_request(transport: str = 'rest', request_type=environment.DeleteEnvironmentRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_lookup_environment_history_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = environment.LookupEnvironmentHistoryResponse.to_json(environment.LookupEnvironmentHistoryResponse())
...
def test_lookup_environment_history_rest_bad_request(transport: str = 'rest', request_type=environment.LookupEnvironmentHistoryRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_continuous_test_rest_bad_request(transport: str = 'rest', request_type=environment.RunContinuousTestRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_continuous_test_results_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = environment.ListContinuousTestResultsResponse.to_json(environment.ListContinuousTestResultsResponse())
...
def test_list_continuous_test_results_rest_bad_request(transport: str = 'rest', request_type=environment.ListContinuousTestResultsRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_deploy_flow_rest_bad_request(transport: str = 'rest', request_type=environment.DeployFlowRequest):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

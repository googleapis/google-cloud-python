...
def test_export_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_export_entity_types_with_metadata") as post_with_metadata, \
...
def test_import_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EntityTypesRestInterceptor, "post_import_entity_types_with_metadata") as post_with_metadata, \

...
def test_export_entity_types(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_entity_types),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.export_entity_types] = mock_object
...
def test_import_entity_types(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_entity_types),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.import_entity_types] = mock_object
...
def test_create_entity_type_rest(request_type):
    ...
    request_init["entity_type"] = {'name': 'name_value', 'display_name': 'display_name_value', 'kind': 1, 'auto_expansion_mode': 1, 'entities': [{'value': 'value_value', 'synonyms': ['synonyms_value1', 'synonyms_value2']}], 'excluded_phrases': [{'value': 'value_value'}], 'enable_fuzzy_extraction': True, 'redact': True}
...
def test_create_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcdc_entity_type.EntityType.to_json(gcdc_entity_type.EntityType())
...
def test_create_entity_type_rest_bad_request(transport: str = 'rest', request_type=gcdc_entity_type.CreateEntityTypeRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_entity_type_rest(request_type):
    ...
    request_init["entity_type"] = {'name': 'projects/sample1/locations/sample2/agents/sample3/entityTypes/sample4', 'display_name': 'display_name_value', 'kind': 1, 'auto_expansion_mode': 1, 'entities': [{'value': 'value_value', 'synonyms': ['synonyms_value1', 'synonyms_value2']}], 'excluded_phrases': [{'value': 'value_value'}], 'enable_fuzzy_extraction': True, 'redact': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_entity_type_rest_bad_request(transport: str = 'rest', request_type=gcdc_entity_type.UpdateEntityTypeRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_entity_types_rest_required_fields(request_type=entity_type.ExportEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_entity_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_entity_types_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "entityTypes", )))
...
def test_export_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.EntityTypesRestInterceptor, "post_export_entity_types") as post, \
         mock.patch.object(transports.EntityTypesRestInterceptor, "pre_export_entity_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.export_entity_types(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_export_entity_types_rest_bad_request(transport: str = 'rest', request_type=entity_type.ExportEntityTypesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_entity_types_rest_required_fields(request_type=entity_type.ImportEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_entity_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_entity_types_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "mergeOption", )))
...
def test_import_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EntityTypesRestInterceptor, "post_import_entity_types") as post, \
         mock.patch.object(transports.EntityTypesRestInterceptor, "pre_import_entity_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.import_entity_types(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_import_entity_types_rest_bad_request(transport: str = 'rest', request_type=entity_type.ImportEntityTypesRequest):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_entity_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_entity_types_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EntityTypesTransport()
        adc.assert_called_once()

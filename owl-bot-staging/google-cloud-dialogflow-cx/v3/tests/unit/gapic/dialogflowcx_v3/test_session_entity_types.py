...
def test_list_session_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_list_session_entity_types_with_metadata") as post_with_metadata, \
...
def test_get_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_get_session_entity_type_with_metadata") as post_with_metadata, \
...
def test_create_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_create_session_entity_type_with_metadata") as post_with_metadata, \
...
def test_update_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_update_session_entity_type_with_metadata") as post_with_metadata, \

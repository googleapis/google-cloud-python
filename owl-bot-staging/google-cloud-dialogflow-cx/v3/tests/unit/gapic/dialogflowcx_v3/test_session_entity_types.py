...
from google.cloud.dialogflowcx_v3.services.session_entity_types import SessionEntityTypesAsyncClient
...
def test__get_api_endpoint():
    ...
    assert SessionEntityTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SessionEntityTypesClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert SessionEntityTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SessionEntityTypesClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    SessionEntityTypesClient, SessionEntityTypesAsyncClient
])
...
def test_session_entity_types_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.session_entity_types.transports.SessionEntityTypesGrpcTransport.__init__') as grpc_transport:
...
def test_list_session_entity_types_rest_required_fields(request_type=session_entity_type.ListSessionEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_session_entity_types._get_unset_required_fields(jsonified_request)
...
def test_list_session_entity_types_rest_unset_required_fields():
    transport = transports.SessionEntityTypesRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_session_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_list_session_entity_types") as post, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "pre_list_session_entity_types") as pre:
...
def test_get_session_entity_type_rest_required_fields(request_type=session_entity_type.GetSessionEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_session_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_get_session_entity_type") as post, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "pre_get_session_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_session_entity_type_rest_required_fields(request_type=gcdc_session_entity_type.CreateSessionEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_session_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_create_session_entity_type") as post, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "pre_create_session_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcdc_session_entity_type.SessionEntityType.to_json(gcdc_session_entity_type.SessionEntityType())
...
def test_create_session_entity_type_rest_bad_request(transport: str = 'rest', request_type=gcdc_session_entity_type.CreateSessionEntityTypeRequest):
    client = SessionEntityTypesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_session_entity_type_rest(request_type):
    ...
    request_init["session_entity_type"] = {'name': 'projects/sample1/locations/sample2/agents/sample3/sessions/sample4/entityTypes/sample5', 'entity_override_mode': 1, 'entities': [{'value': 'value_value', 'synonyms': ['synonyms_value1', 'synonyms_value2']}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_session_entity_type_rest_required_fields(request_type=gcdc_session_entity_type.UpdateSessionEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_session_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_update_session_entity_type") as post, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "pre_update_session_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_session_entity_type_rest_bad_request(transport: str = 'rest', request_type=gcdc_session_entity_type.UpdateSessionEntityTypeRequest):
    client = SessionEntityTypesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
    )
...
def test_update_session_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{session_entity_type.name=projects/*/locations/*/agents/*/sessions/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_delete_session_entity_type_rest_required_fields(request_type=session_entity_type.DeleteSessionEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_session_entity_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SessionEntityTypesRestInterceptor, "pre_delete_session_entity_type") as pre:
        pre.assert_not_called()
...
def test_session_entity_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.session_entity_types.transports.SessionEntityTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_session_entity_types_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.session_entity_types.transports.SessionEntityTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (_AnonymousCredentialsWithUniverseDomain(), None)
        transport = transports.SessionEntityTypesTransport()
        adc.assert_called_once()

...
def test_list_pages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PagesRestInterceptor, "post_list_pages_with_metadata") as post_with_metadata, \
...
def test_get_page_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PagesRestInterceptor, "post_get_page_with_metadata") as post_with_metadata, \
...
def test_create_page_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PagesRestInterceptor, "post_create_page_with_metadata") as post_with_metadata, \
...
def test_update_page_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PagesRestInterceptor, "post_update_page_with_metadata") as post_with_metadata, \

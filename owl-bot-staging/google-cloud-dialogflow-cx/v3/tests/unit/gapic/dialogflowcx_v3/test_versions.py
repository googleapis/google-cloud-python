    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.load_version] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.compare_versions] = mock_object
...
def test_create_version_rest_bad_request(transport: str = 'rest', request_type=gcdc_version.CreateVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_version_rest_bad_request(transport: str = 'rest', request_type=gcdc_version.UpdateVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_load_version_rest_bad_request(transport: str = 'rest', request_type=version.LoadVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_compare_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = version.CompareVersionsResponse.to_json(version.CompareVersionsResponse())
...
def test_compare_versions_rest_bad_request(transport: str = 'rest', request_type=version.CompareVersionsRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )

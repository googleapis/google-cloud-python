...
def test_versions_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.versions.transports.VersionsGrpcTransport.__init__') as grpc_transport:
...
def test_load_version_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.load_version(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_load_version_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VersionsClient(
        ...
        # Ensure method has been cached
        assert client._transport.load_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.load_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_load_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VersionsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.load_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.load_version] = mock_rpc
...
def test_compare_versions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.compare_versions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_compare_versions_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.compare_versions(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_compare_versions_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VersionsClient(
        ...
        # Ensure method has been cached
        assert client._transport.compare_versions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.compare_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_compare_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VersionsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.compare_versions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.compare_versions] = mock_rpc
...
@pytest.mark.asyncio
async def test_compare_versions_async(transport: str = 'grpc_asyncio', request_type=version.CompareVersionsRequest):
    client = VersionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(version.CompareVersionsResponse(
            base_version_content_json='base_version_content_json_value',
            target_version_content_json='target_version_content_json_value',
        ))
...
def test_list_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*/flows/*}/versions" % client.transport._host, args[1])
...
def test_get_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/agents/sample3/flows/sample4/versions/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/flows/*/versions/*}" % client.transport._host, args[1])
...
def test_create_version_rest_required_fields(request_type=gcdc_version.CreateVersionRequest):
    transport_class = transports.VersionsRestTransport
...
def test_update_version_rest_required_fields(request_type=gcdc_version.UpdateVersionRequest):
    transport_class = transports.VersionsRestTransport
...
def test_update_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'version': {'name': 'projects/sample1/locations/sample2/agents/sample3/flows/sample4/versions/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{version.name=projects/*/locations/*/agents/*/flows/*/versions/*}" % client.transport._host, args[1])
...
def test_load_version_rest_required_fields(request_type=version.LoadVersionRequest):
    transport_class = transports.VersionsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).load_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_load_version_rest_unset_required_fields():
    transport = transports.VersionsRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.load_version._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_load_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.load_version(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/flows/*/versions/*}:load" % client.transport._host, args[1])


def test_load_version_rest_flattened_error(transport: str = 'rest'):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_compare_versions_rest_required_fields(request_type=version.CompareVersionsRequest):
    transport_class = transports.VersionsRestTransport

    request_init = {}
    request_init["base_version"] = ""
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).compare_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # verify required fields with non-default values are left alone
    assert "baseVersion" in jsonified_request
    assert jsonified_request["baseVersion"] == 'base_version_value'
...
def test_compare_versions_rest_unset_required_fields():
    transport = transports.VersionsRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.compare_versions._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("baseVersion", "targetVersion", )))
...
def test_compare_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'base_version': 'projects/sample1/locations/sample2/agents/sample3/flows/sample4/versions/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{base_version=projects/*/locations/*/agents/*/flows/*/versions/*}:compareVersions" % client.transport._host, args[1])
...
def test_get_version_rest_bad_request(request_type=version.GetVersionRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/agents/sample3/flows/sample4/versions/sample5'}
    request = request_type(**request_init)
...
def test_create_version_rest_bad_request(request_type=gcdc_version.CreateVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_version_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/agents/sample3/flows/sample4'}
    request_init["version"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'nlu_settings': {'model_type': 1, 'classification_threshold': 0.25520000000000004, 'model_training_mode': 1}, 'create_time': {'seconds': 751, 'nanos': 543}, 'state': 1}
...
def test_create_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_version.CreateVersionRequest.pb(gcdc_version.CreateVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_version_rest_bad_request(request_type=gcdc_version.UpdateVersionRequest):
    client = VersionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'version': {'name': 'projects/sample1/locations/sample2/agents/sample3/flows/sample4/versions/sample5'}}
    request = request_type(**request_init)
...
def test_update_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_version.UpdateVersionRequest.pb(gcdc_version.UpdateVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_load_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VersionsRestInterceptor, "post_load_version") as post, \
        mock.patch.object(transports.VersionsRestInterceptor, "post_load_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VersionsRestInterceptor, "pre_load_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.load_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_compare_versions_rest_bad_request(request_type=version.CompareVersionsRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'base_version': 'projects/sample1/locations/sample2/agents/sample3/flows/sample4/versions/sample5'}
    request = request_type(**request_init)
...
def test_compare_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VersionsRestInterceptor, "post_compare_versions") as post, \
        mock.patch.object(transports.VersionsRestInterceptor, "post_compare_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VersionsRestInterceptor, "pre_compare_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = version.CompareVersionsResponse.to_json(version.CompareVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = version.CompareVersionsResponse(), metadata

        client.compare_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_versions_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.versions.transports.VersionsTransport.__init__') as Transport:
...
def test_versions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.versions.transports.VersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_versions_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.versions.transports.VersionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.VersionsTransport()
        adc.assert_called_once()
...
def test_versions_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.load_version._session
    session2 = client2.transport.load_version._session
    assert session1 != session2
    session1 = client1.transport.compare_versions._session
    session2 = client2.transport.compare_versions._session
    assert session1 != session2

...
from .base import IntentsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class IntentsRestTransport(IntentsTransport):
    ...
    class _CreateIntent(IntentsRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v3/{parent=projects/*/locations/*/agents/*}/intents',
                'body': 'intent',
            },
            ]
    ...
    class _DeleteIntent(IntentsRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v3/{name=projects/*/locations/*/agents/*/intents/*}',
            },
            ]
    ...
    class _UpdateIntent(IntentsRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v3/{intent.name=projects/*/locations/*/agents/*/intents/*}',
                'body': 'intent',
            },
            ]

...
class ListTransitionRouteGroupsPager:
    ...
    @property
    def pages(self) -> Iterator[transition_route_group.ListTransitionRouteGroupsResponse]:
...
class ListTransitionRouteGroupsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[transition_route_group.ListTransitionRouteGroupsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

...
class TransitionRouteGroupsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_transition_route_group(self, request: gcdc_transition_route_group.CreateTransitionRouteGroupRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_transition_route_group.CreateTransitionRouteGroupRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_transition_route_group(self, request: transition_route_group.DeleteTransitionRouteGroupRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[transition_route_group.DeleteTransitionRouteGroupRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_transition_route_group(self, request: transition_route_group.GetTransitionRouteGroupRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[transition_route_group.GetTransitionRouteGroupRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_transition_route_groups(self, request: transition_route_group.ListTransitionRouteGroupsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[transition_route_group.ListTransitionRouteGroupsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_transition_route_group(self, request: gcdc_transition_route_group.UpdateTransitionRouteGroupRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_transition_route_group.UpdateTransitionRouteGroupRequest, Sequence[Tuple[str, str]]]:

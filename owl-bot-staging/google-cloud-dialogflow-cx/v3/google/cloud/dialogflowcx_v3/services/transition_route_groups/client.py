...
class TransitionRouteGroupsClient(metaclass=TransitionRouteGroupsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = TransitionRouteGroupsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TransitionRouteGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = TransitionRouteGroupsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            TransitionRouteGroupsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TransitionRouteGroupsTransport, Callable[..., TransitionRouteGroupsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TransitionRouteGroupsClient._read_environment_variables()
        self._client_cert_source = TransitionRouteGroupsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TransitionRouteGroupsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, TransitionRouteGroupsTransport)
        if transport_provided:
            ...
            self._transport = cast(TransitionRouteGroupsTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TransitionRouteGroupsTransport], Callable[..., TransitionRouteGroupsTransport]] = (

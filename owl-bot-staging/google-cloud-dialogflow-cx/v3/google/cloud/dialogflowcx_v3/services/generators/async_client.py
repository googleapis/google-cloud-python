...
class GeneratorsAsyncClient:
    ...
    get_transport_class = functools.partial(type(GeneratorsClient).get_transport_class, type(GeneratorsClient))
    ...
    async def list_generators(self,
    ...
    async def delete_generator(self,

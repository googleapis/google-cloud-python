...
class AgentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_agent(self, request: gcdc_agent.CreateAgentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_agent.CreateAgentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_agent_with_metadata(self, response: gcdc_agent.Agent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_agent.Agent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_agent
    ...
    def pre_delete_agent(self, request: agent.DeleteAgentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.DeleteAgentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_export_agent(self, request: agent.ExportAgentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.ExportAgentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_agent_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_agent
    ...
    def pre_get_agent(self, request: agent.GetAgentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.GetAgentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_agent_with_metadata(self, response: agent.Agent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.Agent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_agent
    ...
    def pre_get_agent_validation_result(self, request: agent.GetAgentValidationResultRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.GetAgentValidationResultRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_agent_validation_result_with_metadata(self, response: agent.AgentValidationResult, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.AgentValidationResult, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_agent_validation_result
    ...
    def pre_get_generative_settings(self, request: agent.GetGenerativeSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.GetGenerativeSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_generative_settings_with_metadata(self, response: generative_settings.GenerativeSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[generative_settings.GenerativeSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_generative_settings
    ...
    def pre_list_agents(self, request: agent.ListAgentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.ListAgentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_agents_with_metadata(self, response: agent.ListAgentsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.ListAgentsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_agents
    ...
    def pre_restore_agent(self, request: agent.RestoreAgentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.RestoreAgentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_restore_agent_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for restore_agent
    ...
    def pre_update_agent(self, request: gcdc_agent.UpdateAgentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_agent.UpdateAgentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_agent_with_metadata(self, response: gcdc_agent.Agent, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_agent.Agent, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_agent
    ...
    def pre_update_generative_settings(self, request: agent.UpdateGenerativeSettingsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.UpdateGenerativeSettingsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_generative_settings_with_metadata(self, response: gcdc_generative_settings.GenerativeSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_generative_settings.GenerativeSettings, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_generative_settings
    ...
    def pre_validate_agent(self, request: agent.ValidateAgentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.ValidateAgentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_validate_agent_with_metadata(self, response: agent.AgentValidationResult, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[agent.AgentValidationResult, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for validate_agent
...
class AgentsRestTransport(_BaseAgentsRestTransport):
    ...
    class _CreateAgent(_BaseAgentsRestTransport._BaseCreateAgent, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._CreateAgent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ExportAgent(_BaseAgentsRestTransport._BaseExportAgent, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._ExportAgent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetAgentValidationResult(_BaseAgentsRestTransport._BaseGetAgentValidationResult, AgentsRestStub):
        ...
        result method over HTTP.
            ...
            # Send the request
            response = AgentsRestTransport._GetAgentValidationResult._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetGenerativeSettings(_BaseAgentsRestTransport._BaseGetGenerativeSettings, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._GetGenerativeSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RestoreAgent(_BaseAgentsRestTransport._BaseRestoreAgent, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._RestoreAgent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateAgent(_BaseAgentsRestTransport._BaseUpdateAgent, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._UpdateAgent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateGenerativeSettings(_BaseAgentsRestTransport._BaseUpdateGenerativeSettings, AgentsRestStub):
        ...
        settings method over HTTP.
            ...
            # Send the request
            response = AgentsRestTransport._UpdateGenerativeSettings._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ValidateAgent(_BaseAgentsRestTransport._BaseValidateAgent, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._ValidateAgent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    @property
    def get_generative_settings(self) -> Callable[
    ...
    @property
    def update_generative_settings(self) -> Callable[
    ...
    class _ListLocations(_BaseAgentsRestTransport._BaseListLocations, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseAgentsRestTransport._BaseCancelOperation, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseAgentsRestTransport._BaseListOperations, AgentsRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = AgentsRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

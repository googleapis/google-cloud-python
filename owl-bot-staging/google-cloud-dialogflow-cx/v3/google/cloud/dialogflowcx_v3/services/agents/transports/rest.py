...
class AgentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_agent(self, request: gcdc_agent.CreateAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_agent.CreateAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_agent(self, request: agent.DeleteAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.DeleteAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_export_agent(self, request: agent.ExportAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.ExportAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_agent(self, request: agent.GetAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.GetAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_agent_validation_result(self, request: agent.GetAgentValidationResultRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.GetAgentValidationResultRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_generative_settings(self, request: agent.GetGenerativeSettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.GetGenerativeSettingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_agents(self, request: agent.ListAgentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.ListAgentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_restore_agent(self, request: agent.RestoreAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.RestoreAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_agent(self, request: gcdc_agent.UpdateAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_agent.UpdateAgentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_generative_settings(self, request: agent.UpdateGenerativeSettingsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.UpdateGenerativeSettingsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_validate_agent(self, request: agent.ValidateAgentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[agent.ValidateAgentRequest, Sequence[Tuple[str, str]]]:

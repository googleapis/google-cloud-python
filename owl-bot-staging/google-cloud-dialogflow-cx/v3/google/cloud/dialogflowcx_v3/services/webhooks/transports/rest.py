...
class WebhooksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_webhook(self, request: gcdc_webhook.CreateWebhookRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_webhook.CreateWebhookRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_webhook_with_metadata(self, response: gcdc_webhook.Webhook, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_webhook.Webhook, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_webhook
    ...
    def pre_delete_webhook(self, request: webhook.DeleteWebhookRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[webhook.DeleteWebhookRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_webhook(self, request: webhook.GetWebhookRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[webhook.GetWebhookRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_webhook_with_metadata(self, response: webhook.Webhook, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[webhook.Webhook, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_webhook
    ...
    def pre_list_webhooks(self, request: webhook.ListWebhooksRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[webhook.ListWebhooksRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_webhooks_with_metadata(self, response: webhook.ListWebhooksResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[webhook.ListWebhooksResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_webhooks
    ...
    def pre_update_webhook(self, request: gcdc_webhook.UpdateWebhookRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_webhook.UpdateWebhookRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_webhook_with_metadata(self, response: gcdc_webhook.Webhook, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_webhook.Webhook, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_webhook
...
class WebhooksRestTransport(_BaseWebhooksRestTransport):
    ...
    class _CreateWebhook(_BaseWebhooksRestTransport._BaseCreateWebhook, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._CreateWebhook._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteWebhook(_BaseWebhooksRestTransport._BaseDeleteWebhook, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._DeleteWebhook._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListWebhooks(_BaseWebhooksRestTransport._BaseListWebhooks, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._ListWebhooks._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateWebhook(_BaseWebhooksRestTransport._BaseUpdateWebhook, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._UpdateWebhook._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetLocation(_BaseWebhooksRestTransport._BaseGetLocation, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseWebhooksRestTransport._BaseListLocations, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseWebhooksRestTransport._BaseCancelOperation, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseWebhooksRestTransport._BaseGetOperation, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseWebhooksRestTransport._BaseListOperations, WebhooksRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = WebhooksRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

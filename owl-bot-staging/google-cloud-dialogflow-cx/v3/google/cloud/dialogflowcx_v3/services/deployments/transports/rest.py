...
from .base import DeploymentsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class DeploymentsRestTransport(DeploymentsTransport):
    ...
    class _GetDeployment(DeploymentsRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v3/{name=projects/*/locations/*/agents/*/environments/*/deployments/*}',
            },
            ]
    ...
    class _ListDeployments(DeploymentsRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v3/{parent=projects/*/locations/*/agents/*/environments/*}/deployments',
            },
            ]

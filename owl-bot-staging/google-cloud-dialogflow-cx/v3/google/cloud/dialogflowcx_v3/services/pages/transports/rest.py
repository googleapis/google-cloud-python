...
class PagesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_page(self, request: gcdc_page.CreatePageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_page.CreatePageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_page_with_metadata(self, response: gcdc_page.Page, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_page.Page, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_page
    ...
    def pre_delete_page(self, request: page.DeletePageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[page.DeletePageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_page(self, request: page.GetPageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[page.GetPageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_page_with_metadata(self, response: page.Page, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[page.Page, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_page
    ...
    def pre_list_pages(self, request: page.ListPagesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[page.ListPagesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_pages_with_metadata(self, response: page.ListPagesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[page.ListPagesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_pages
    ...
    def pre_update_page(self, request: gcdc_page.UpdatePageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_page.UpdatePageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_page_with_metadata(self, response: gcdc_page.Page, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_page.Page, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_page
...
class PagesRestTransport(_BasePagesRestTransport):
    ...
    class _CreatePage(_BasePagesRestTransport._BaseCreatePage, PagesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PagesRestTransport._CreatePage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdatePage(_BasePagesRestTransport._BaseUpdatePage, PagesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PagesRestTransport._UpdatePage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BasePagesRestTransport._BaseCancelOperation, PagesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PagesRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BasePagesRestTransport._BaseListOperations, PagesRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PagesRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)

...
class EntityTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_entity_type(self, request: gcdc_entity_type.CreateEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_entity_type.CreateEntityTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_entity_type(self, request: entity_type.DeleteEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.DeleteEntityTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_export_entity_types(self, request: entity_type.ExportEntityTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.ExportEntityTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_entity_type(self, request: entity_type.GetEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.GetEntityTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_import_entity_types(self, request: entity_type.ImportEntityTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.ImportEntityTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_entity_types(self, request: entity_type.ListEntityTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[entity_type.ListEntityTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_entity_type(self, request: gcdc_entity_type.UpdateEntityTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[gcdc_entity_type.UpdateEntityTypeRequest, Sequence[Tuple[str, str]]]:

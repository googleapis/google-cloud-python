...
class EntityTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_entity_type(self, request: gcdc_entity_type.CreateEntityTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_entity_type.CreateEntityTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_entity_type(self, response: gcdc_entity_type.EntityType) -> gcdc_entity_type.EntityType:
    ...
    def post_create_entity_type_with_metadata(self, response: gcdc_entity_type.EntityType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_entity_type.EntityType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_entity_type
    ...
    def pre_delete_entity_type(self, request: entity_type.DeleteEntityTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[entity_type.DeleteEntityTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_export_entity_types(self, request: entity_type.ExportEntityTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[entity_type.ExportEntityTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_entity_types(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for export_entity_types

        DEPRECATED. Please use the `post_export_entity_types_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the EntityTypes server but before
        it is returned to user code. This `post_export_entity_types` interceptor runs
        before the `post_export_entity_types_with_metadata` interceptor.
        """
        return response

    def post_export_entity_types_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_entity_types

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the EntityTypes server but before it is returned to user code.

        We recommend only using this `post_export_entity_types_with_metadata`
        interceptor in new development instead of the `post_export_entity_types` interceptor.
        When both interceptors are used, this `post_export_entity_types_with_metadata` interceptor runs after the
        `post_export_entity_types` interceptor. The (possibly modified) response returned by
        `post_export_entity_types` will be passed to
        `post_export_entity_types_with_metadata`.
        """
        return response, metadata

    def pre_get_entity_type(self, request: entity_type.GetEntityTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[entity_type.GetEntityTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_entity_type_with_metadata(self, response: entity_type.EntityType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[entity_type.EntityType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_entity_type
    ...
    def pre_import_entity_types(self, request: entity_type.ImportEntityTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[entity_type.ImportEntityTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_entity_types(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for import_entity_types

        DEPRECATED. Please use the `post_import_entity_types_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the EntityTypes server but before
        it is returned to user code. This `post_import_entity_types` interceptor runs
        before the `post_import_entity_types_with_metadata` interceptor.
        """
        return response

    def post_import_entity_types_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_entity_types

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the EntityTypes server but before it is returned to user code.

        We recommend only using this `post_import_entity_types_with_metadata`
        interceptor in new development instead of the `post_import_entity_types` interceptor.
        When both interceptors are used, this `post_import_entity_types_with_metadata` interceptor runs after the
        `post_import_entity_types` interceptor. The (possibly modified) response returned by
        `post_import_entity_types` will be passed to
        `post_import_entity_types_with_metadata`.
        """
        return response, metadata

    def pre_list_entity_types(self, request: entity_type.ListEntityTypesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[entity_type.ListEntityTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_entity_types_with_metadata(self, response: entity_type.ListEntityTypesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[entity_type.ListEntityTypesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_entity_types
    ...
    def pre_update_entity_type(self, request: gcdc_entity_type.UpdateEntityTypeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_entity_type.UpdateEntityTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_entity_type(self, response: gcdc_entity_type.EntityType) -> gcdc_entity_type.EntityType:
    ...
    def post_update_entity_type_with_metadata(self, response: gcdc_entity_type.EntityType, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gcdc_entity_type.EntityType, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_entity_type
...
class EntityTypesRestTransport(_BaseEntityTypesRestTransport):
    ...
    class _CreateEntityType(_BaseEntityTypesRestTransport._BaseCreateEntityType, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.CreateEntityType",
                    extra = {
            ...
            # Send the request
            response = EntityTypesRestTransport._CreateEntityType._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesClient.create_entity_type",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "CreateEntityType",
    ...
    class _DeleteEntityType(_BaseEntityTypesRestTransport._BaseDeleteEntityType, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.DeleteEntityType",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._DeleteEntityType._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ExportEntityTypes(_BaseEntityTypesRestTransport._BaseExportEntityTypes, EntityTypesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseEntityTypesRestTransport._BaseExportEntityTypes._get_http_options()

            request, metadata = self._interceptor.pre_export_entity_types(request, metadata)
            transcoded_request = _BaseEntityTypesRestTransport._BaseExportEntityTypes._get_transcoded_request(http_options, request)

            body = _BaseEntityTypesRestTransport._BaseExportEntityTypes._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseEntityTypesRestTransport._BaseExportEntityTypes._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.ExportEntityTypes",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "ExportEntityTypes",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = EntityTypesRestTransport._ExportEntityTypes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_export_entity_types_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesClient.export_entity_types",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "ExportEntityTypes",
                        "metadata": http_response["headers"],
    ...
    class _GetEntityType(_BaseEntityTypesRestTransport._BaseGetEntityType, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.GetEntityType",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._GetEntityType._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesClient.get_entity_type",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "GetEntityType",
                        "metadata": http_response["headers"],
    ...
    class _ImportEntityTypes(_BaseEntityTypesRestTransport._BaseImportEntityTypes, EntityTypesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseEntityTypesRestTransport._BaseImportEntityTypes._get_http_options()

            request, metadata = self._interceptor.pre_import_entity_types(request, metadata)
            transcoded_request = _BaseEntityTypesRestTransport._BaseImportEntityTypes._get_transcoded_request(http_options, request)

            body = _BaseEntityTypesRestTransport._BaseImportEntityTypes._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseEntityTypesRestTransport._BaseImportEntityTypes._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.ImportEntityTypes",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "ImportEntityTypes",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = EntityTypesRestTransport._ImportEntityTypes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_import_entity_types_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesClient.import_entity_types",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "ImportEntityTypes",
                        "metadata": http_response["headers"],
    ...
    class _ListEntityTypes(_BaseEntityTypesRestTransport._BaseListEntityTypes, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.ListEntityTypes",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._ListEntityTypes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesClient.list_entity_types",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "ListEntityTypes",
                        "metadata": http_response["headers"],
    ...
    class _UpdateEntityType(_BaseEntityTypesRestTransport._BaseUpdateEntityType, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.UpdateEntityType",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._UpdateEntityType._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesClient.update_entity_type",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "UpdateEntityType",
                        "metadata": http_response["headers"],
    ...
    @property
    def export_entity_types(self) -> Callable[
    ...
    @property
    def import_entity_types(self) -> Callable[
    ...
    class _GetLocation(_BaseEntityTypesRestTransport._BaseGetLocation, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = EntityTypesRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(_BaseEntityTypesRestTransport._BaseListLocations, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(_BaseEntityTypesRestTransport._BaseCancelOperation, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseEntityTypesRestTransport._BaseGetOperation, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseEntityTypesRestTransport._BaseListOperations, EntityTypesRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow.cx_v3.EntityTypesClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
            ...
            # Send the request
            response = EntityTypesRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow.cx_v3.EntityTypesAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.dialogflow.cx.v3.EntityTypes",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

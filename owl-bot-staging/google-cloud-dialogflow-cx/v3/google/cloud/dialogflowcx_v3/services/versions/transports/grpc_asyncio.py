    ...
    async def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra = {
                    "serviceName": "google.cloud.dialogflow.cx.v3.Versions",
...
class VersionsGrpcAsyncIOTransport(VersionsTransport):
    ...
    def load_version(self) -> Callable[
        ...
        if 'load_version' not in self._stubs:
            self._stubs['load_version'] = self._logged_channel.unary_unary(
    ...
    @property
    def compare_versions(self) -> Callable[
            [version.CompareVersionsRequest],
            Awaitable[version.CompareVersionsResponse]]:
        ...
        if 'compare_versions' not in self._stubs:
            self._stubs['compare_versions'] = self._logged_channel.unary_unary(

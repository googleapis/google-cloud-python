...
class ListChangelogsPager:
    ...
    :class:`google.cloud.dialogflowcx_v3.types.ListChangelogsResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListChangelogsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., changelog.ListChangelogsResponse],
    ...
    @property
    def pages(self) -> Iterator[changelog.ListChangelogsResponse]:
...
class ListChangelogsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[changelog.ListChangelogsResponse]],
            request: changelog.ListChangelogsRequest,
            response: changelog.ListChangelogsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[changelog.ListChangelogsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

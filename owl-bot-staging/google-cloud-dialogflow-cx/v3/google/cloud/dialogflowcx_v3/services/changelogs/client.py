...
class ChangelogsClientMeta(type):
    """Metaclass for the Changelogs client.
...
class ChangelogsClient(metaclass=ChangelogsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ChangelogsClient: The constructed client.
        """
    ...
    def transport(self) -> ChangelogsTransport:
        ...
        Returns:
            ChangelogsTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def changelog_path(project: str,location: str,agent: str,changelog: str,) -> str:
        """Returns a fully-qualified changelog string."""
        return "projects/{project}/locations/{location}/agents/{agent}/changelogs/{changelog}".format(project=project, location=location, agent=agent, changelog=changelog, )

    @staticmethod
    def parse_changelog_path(path: str) -> Dict[str,str]:
        """Parses a changelog path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/changelogs/(?P<changelog>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = ChangelogsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = ChangelogsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ChangelogsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ChangelogsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ChangelogsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ChangelogsTransport, Callable[..., ChangelogsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,ChangelogsTransport,Callable[..., ChangelogsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ChangelogsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ChangelogsClient._read_environment_variables()
        self._client_cert_source = ChangelogsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ChangelogsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ChangelogsTransport)
        if transport_provided:
            # transport is a ChangelogsTransport instance.
            ...
            self._transport = cast(ChangelogsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            ChangelogsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ChangelogsTransport], Callable[..., ChangelogsTransport]] = (
    ...
    def list_changelogs(self,
            request: Optional[Union[changelog.ListChangelogsRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ListChangelogsRequest, dict]):
        ...
        if not isinstance(request, changelog.ListChangelogsRequest):
    ...
    def get_changelog(self,
            request: Optional[Union[changelog.GetChangelogRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.GetChangelogRequest, dict]):
                The request object. The request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, changelog.GetChangelogRequest):

...
class dialogflowcxCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_generator': ('parent', 'generator', 'language_code', ),
        ...
        'export_entity_types': ('parent', 'entity_types', 'entity_types_uri', 'entity_types_content_inline', 'data_format', 'language_code', ),
        'export_flow': ('name', 'flow_uri', 'include_referenced_flows', ),
        'export_intents': ('parent', 'intents', 'intents_uri', 'intents_content_inline', 'data_format', ),
        ...
        'get_generative_settings': ('name', 'language_code', ),
        'get_generator': ('name', 'language_code', ),
        ...
        'get_version': ('name', ),
        'get_webhook': ('name', ),
        'import_entity_types': ('parent', 'merge_option', 'entity_types_uri', 'entity_types_content', 'target_entity_type', ),
        'import_flow': ('parent', 'flow_uri', 'flow_content', 'import_option', 'flow_import_strategy', ),
        'import_intents': ('parent', 'intents_uri', 'intents_content', 'merge_option', ),
        ...
        'list_generators': ('parent', 'language_code', 'page_size', 'page_token', ),
        ...
        'streaming_detect_intent': ('query_input', 'session', 'query_params', 'output_audio_config', 'enable_partial_response', 'enable_debugging_info', ),
        'submit_answer_feedback': ('session', 'response_id', 'answer_feedback', 'update_mask', ),
        'train_flow': ('name', ),
        ...
        'update_generative_settings': ('generative_settings', 'update_mask', ),
        'update_generator': ('generator', 'language_code', 'update_mask', ),

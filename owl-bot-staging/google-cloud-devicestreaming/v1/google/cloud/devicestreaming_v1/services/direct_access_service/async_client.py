...
from .transports.base import DirectAccessServiceTransport, DEFAULT_CLIENT_INFO
...
class DirectAccessServiceAsyncClient:
    ...
    async def create_device_session(self,
    ...
    async def list_device_sessions(self,
    ...
    async def get_device_session(self,
    ...
    async def cancel_device_session(self,
    ...
    async def update_device_session(self,

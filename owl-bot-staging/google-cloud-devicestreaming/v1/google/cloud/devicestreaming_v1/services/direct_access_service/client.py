...
class DirectAccessServiceClient(metaclass=DirectAccessServiceClientMeta):
    ...
    @staticmethod
    def device_session_path(project: str,device_session: str,) -> str:
        """Returns a fully-qualified device_session string."""
        return "projects/{project}/deviceSessions/{device_session}".format(project=project, device_session=device_session, )
    ...
    def cancel_device_session(self,

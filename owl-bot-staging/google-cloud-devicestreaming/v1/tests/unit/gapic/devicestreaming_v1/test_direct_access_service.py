...
from google.cloud.devicestreaming_v1.services.direct_access_service import DirectAccessServiceAsyncClient
from google.cloud.devicestreaming_v1.services.direct_access_service import DirectAccessServiceClient
from google.cloud.devicestreaming_v1.services.direct_access_service import pagers
from google.cloud.devicestreaming_v1.services.direct_access_service import transports
...
def test__get_api_endpoint():
    ...
    assert DirectAccessServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DirectAccessServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert DirectAccessServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DirectAccessServiceClient.DEFAULT_MTLS_ENDPOINT
...
@pytest.mark.parametrize("client_class", [
    DirectAccessServiceClient, DirectAccessServiceAsyncClient
])
...
def test_direct_access_service_client_client_options_from_dict():
    with mock.patch('google.cloud.devicestreaming_v1.services.direct_access_service.transports.DirectAccessServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_device_session(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_device_session),
            '__call__') as call:
...
def test_list_device_sessions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, service.DeviceSession)
                   for i in results)
...
async def test_list_device_sessions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_device_sessions(request={},)
...
def test_get_device_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_device_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.DeviceSession(
            name='name_value',
...
def test_cancel_device_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_device_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_device_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_device_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.DeviceSession(
            name='name_value',
...
def test_adb_connect(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.adb_connect),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_device_session_rest_required_fields(request_type=service.CreateDeviceSessionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_device_session._get_unset_required_fields(jsonified_request)
...
def test_create_device_session_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deviceSessionId", )) & set(("parent", "deviceSession", )))
...
def test_list_device_sessions_rest_required_fields(request_type=service.ListDeviceSessionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_device_sessions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_device_session_rest_required_fields(request_type=service.CancelDeviceSessionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_device_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_device_session_rest_required_fields(request_type=service.UpdateDeviceSessionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_device_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_device_session_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1'}
    request_init["device_session"] = {'name': 'name_value', 'display_name': 'display_name_value', 'state': 1, 'state_histories': [{'session_state': 1, 'event_time': {'seconds': 751, 'nanos': 543}, 'state_message': 'state_message_value'}], 'ttl': {'seconds': 751, 'nanos': 543}, 'expire_time': {}, 'inactivity_timeout': {}, 'create_time': {}, 'active_start_time': {}, 'android_device': {'android_model_id': 'android_model_id_value', 'android_version_id': 'android_version_id_value', 'locale': 'locale_value', 'orientation': 'orientation_value'}}
...
def test_create_device_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_create_device_session") as post, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_create_device_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "pre_create_device_session") as pre:
        ...
        client.create_device_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_device_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_list_device_sessions") as post, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_list_device_sessions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "pre_list_device_sessions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.list_device_sessions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_device_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_get_device_session") as post, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_get_device_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "pre_get_device_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.get_device_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_cancel_device_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "pre_cancel_device_session") as pre:
        pre.assert_not_called()
        ...
        client.cancel_device_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_device_session_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'device_session': {'name': 'projects/sample1/deviceSessions/sample2'}}
    request_init["device_session"] = {'name': 'projects/sample1/deviceSessions/sample2', 'display_name': 'display_name_value', 'state': 1, 'state_histories': [{'session_state': 1, 'event_time': {'seconds': 751, 'nanos': 543}, 'state_message': 'state_message_value'}], 'ttl': {'seconds': 751, 'nanos': 543}, 'expire_time': {}, 'inactivity_timeout': {}, 'create_time': {}, 'active_start_time': {}, 'android_device': {'android_model_id': 'android_model_id_value', 'android_version_id': 'android_version_id_value', 'locale': 'locale_value', 'orientation': 'orientation_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_device_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_update_device_session") as post, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "post_update_device_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DirectAccessServiceRestInterceptor, "pre_update_device_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.update_device_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_direct_access_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.devicestreaming_v1.services.direct_access_service.transports.DirectAccessServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_direct_access_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.devicestreaming_v1.services.direct_access_service.transports.DirectAccessServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DirectAccessServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DirectAccessServiceGrpcTransport, transports.DirectAccessServiceGrpcAsyncIOTransport])
def test_direct_access_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_device_session_path():
    project = "squid"
    device_session = "clam"
    expected = "projects/{project}/deviceSessions/{device_session}".format(project=project, device_session=device_session, )

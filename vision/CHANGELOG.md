...
- [CHANGE ME] Re-generated vision to pick up changes in the API or client library generator. ([#7408](https://github.com/googleapis/google-cloud-python/pull/7408))

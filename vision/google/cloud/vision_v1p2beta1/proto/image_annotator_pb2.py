...
# source: google/cloud/vision_v1p2beta1/proto/image_annotator.proto
...
from google.cloud.vision_v1p2beta1.proto import geometry_pb2 as google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_geometry__pb2
from google.cloud.vision_v1p2beta1.proto import text_annotation_pb2 as google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_text__annotation__pb2
from google.cloud.vision_v1p2beta1.proto import web_detection_pb2 as google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_web__detection__pb2
...
_LIKELIHOOD = _descriptor.EnumDescriptor(
  name='Likelihood',
  full_name='google.cloud.vision.v1p2beta1.Likelihood',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FEATURE_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='google.cloud.vision.v1p2beta1.Feature.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_FACEANNOTATION_LANDMARK_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.Landmark.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_OPERATIONMETADATA_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='google.cloud.vision.v1p2beta1.OperationMetadata.State',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_FEATURE = _descriptor.Descriptor(
  name='Feature',
  full_name='google.cloud.vision.v1p2beta1.Feature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.vision.v1p2beta1.Feature.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_results', full_name='google.cloud.vision.v1p2beta1.Feature.max_results', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='model', full_name='google.cloud.vision.v1p2beta1.Feature.model', index=2,
...
_IMAGESOURCE = _descriptor.Descriptor(
  name='ImageSource',
  full_name='google.cloud.vision.v1p2beta1.ImageSource',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='gcs_image_uri', full_name='google.cloud.vision.v1p2beta1.ImageSource.gcs_image_uri', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_uri', full_name='google.cloud.vision.v1p2beta1.ImageSource.image_uri', index=1,
...
_IMAGE = _descriptor.Descriptor(
  name='Image',
  full_name='google.cloud.vision.v1p2beta1.Image',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='content', full_name='google.cloud.vision.v1p2beta1.Image.content', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source', full_name='google.cloud.vision.v1p2beta1.Image.source', index=1,
...
_FACEANNOTATION_LANDMARK = _descriptor.Descriptor(
  name='Landmark',
  full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.Landmark',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.Landmark.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='position', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.Landmark.position', index=1,
...
_FACEANNOTATION = _descriptor.Descriptor(
  name='FaceAnnotation',
  full_name='google.cloud.vision.v1p2beta1.FaceAnnotation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bounding_poly', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.bounding_poly', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fd_bounding_poly', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.fd_bounding_poly', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='landmarks', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.landmarks', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='roll_angle', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.roll_angle', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pan_angle', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.pan_angle', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tilt_angle', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.tilt_angle', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detection_confidence', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.detection_confidence', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='landmarking_confidence', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.landmarking_confidence', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='joy_likelihood', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.joy_likelihood', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sorrow_likelihood', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.sorrow_likelihood', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='anger_likelihood', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.anger_likelihood', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='surprise_likelihood', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.surprise_likelihood', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='under_exposed_likelihood', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.under_exposed_likelihood', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='blurred_likelihood', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.blurred_likelihood', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='headwear_likelihood', full_name='google.cloud.vision.v1p2beta1.FaceAnnotation.headwear_likelihood', index=14,
...
_LOCATIONINFO = _descriptor.Descriptor(
  name='LocationInfo',
  full_name='google.cloud.vision.v1p2beta1.LocationInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lat_lng', full_name='google.cloud.vision.v1p2beta1.LocationInfo.lat_lng', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROPERTY = _descriptor.Descriptor(
  name='Property',
  full_name='google.cloud.vision.v1p2beta1.Property',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.vision.v1p2beta1.Property.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.vision.v1p2beta1.Property.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='uint64_value', full_name='google.cloud.vision.v1p2beta1.Property.uint64_value', index=2,
...
_ENTITYANNOTATION = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.EntityAnnotation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mid', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.mid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='locale', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.locale', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.description', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='score', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.score', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='confidence', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.confidence', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='topicality', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.topicality', index=5,
      number=6, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bounding_poly', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.bounding_poly', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='locations', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.locations', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='properties', full_name='google.cloud.vision.v1p2beta1.EntityAnnotation.properties', index=8,
...
_SAFESEARCHANNOTATION = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.SafeSearchAnnotation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='adult', full_name='google.cloud.vision.v1p2beta1.SafeSearchAnnotation.adult', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='spoof', full_name='google.cloud.vision.v1p2beta1.SafeSearchAnnotation.spoof', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='medical', full_name='google.cloud.vision.v1p2beta1.SafeSearchAnnotation.medical', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='violence', full_name='google.cloud.vision.v1p2beta1.SafeSearchAnnotation.violence', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='racy', full_name='google.cloud.vision.v1p2beta1.SafeSearchAnnotation.racy', index=4,
      number=9, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LATLONGRECT = _descriptor.Descriptor(
  name='LatLongRect',
  full_name='google.cloud.vision.v1p2beta1.LatLongRect',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_lat_lng', full_name='google.cloud.vision.v1p2beta1.LatLongRect.min_lat_lng', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_lat_lng', full_name='google.cloud.vision.v1p2beta1.LatLongRect.max_lat_lng', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COLORINFO = _descriptor.Descriptor(
  name='ColorInfo',
  full_name='google.cloud.vision.v1p2beta1.ColorInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='color', full_name='google.cloud.vision.v1p2beta1.ColorInfo.color', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='score', full_name='google.cloud.vision.v1p2beta1.ColorInfo.score', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pixel_fraction', full_name='google.cloud.vision.v1p2beta1.ColorInfo.pixel_fraction', index=2,
...
_DOMINANTCOLORSANNOTATION = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.DominantColorsAnnotation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='colors', full_name='google.cloud.vision.v1p2beta1.DominantColorsAnnotation.colors', index=0,
...
_IMAGEPROPERTIES = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.ImageProperties',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dominant_colors', full_name='google.cloud.vision.v1p2beta1.ImageProperties.dominant_colors', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CROPHINT = _descriptor.Descriptor(
  name='CropHint',
  full_name='google.cloud.vision.v1p2beta1.CropHint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bounding_poly', full_name='google.cloud.vision.v1p2beta1.CropHint.bounding_poly', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='confidence', full_name='google.cloud.vision.v1p2beta1.CropHint.confidence', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='importance_fraction', full_name='google.cloud.vision.v1p2beta1.CropHint.importance_fraction', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CROPHINTSANNOTATION = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.CropHintsAnnotation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='crop_hints', full_name='google.cloud.vision.v1p2beta1.CropHintsAnnotation.crop_hints', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CROPHINTSPARAMS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.CropHintsParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='aspect_ratios', full_name='google.cloud.vision.v1p2beta1.CropHintsParams.aspect_ratios', index=0,
...
_WEBDETECTIONPARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='include_geo_results', full_name='google.cloud.vision.v1p2beta1.WebDetectionParams.include_geo_results', index=0,
...
_IMAGECONTEXT = _descriptor.Descriptor(
  name='ImageContext',
  full_name='google.cloud.vision.v1p2beta1.ImageContext',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lat_long_rect', full_name='google.cloud.vision.v1p2beta1.ImageContext.lat_long_rect', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='language_hints', full_name='google.cloud.vision.v1p2beta1.ImageContext.language_hints', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_hints_params', full_name='google.cloud.vision.v1p2beta1.ImageContext.crop_hints_params', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='web_detection_params', full_name='google.cloud.vision.v1p2beta1.ImageContext.web_detection_params', index=3,
...
_ANNOTATEIMAGEREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.AnnotateImageRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='image', full_name='google.cloud.vision.v1p2beta1.AnnotateImageRequest.image', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='features', full_name='google.cloud.vision.v1p2beta1.AnnotateImageRequest.features', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_context', full_name='google.cloud.vision.v1p2beta1.AnnotateImageRequest.image_context', index=2,
...
_IMAGEANNOTATIONCONTEXT = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.ImageAnnotationContext',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='google.cloud.vision.v1p2beta1.ImageAnnotationContext.uri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='page_number', full_name='google.cloud.vision.v1p2beta1.ImageAnnotationContext.page_number', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ANNOTATEIMAGERESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='face_annotations', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.face_annotations', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='landmark_annotations', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.landmark_annotations', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='logo_annotations', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.logo_annotations', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='label_annotations', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.label_annotations', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text_annotations', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.text_annotations', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='full_text_annotation', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.full_text_annotation', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='safe_search_annotation', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.safe_search_annotation', index=6,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='image_properties_annotation', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.image_properties_annotation', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_hints_annotation', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.crop_hints_annotation', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='web_detection', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.web_detection', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='error', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.error', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='context', full_name='google.cloud.vision.v1p2beta1.AnnotateImageResponse.context', index=11,
...
_BATCHANNOTATEIMAGESREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.BatchAnnotateImagesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='requests', full_name='google.cloud.vision.v1p2beta1.BatchAnnotateImagesRequest.requests', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BATCHANNOTATEIMAGESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.BatchAnnotateImagesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='responses', full_name='google.cloud.vision.v1p2beta1.BatchAnnotateImagesResponse.responses', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ASYNCANNOTATEFILEREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_config', full_name='google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest.input_config', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='features', full_name='google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest.features', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='image_context', full_name='google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest.image_context', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='output_config', full_name='google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest.output_config', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ASYNCANNOTATEFILERESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.AsyncAnnotateFileResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='output_config', full_name='google.cloud.vision.v1p2beta1.AsyncAnnotateFileResponse.output_config', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ASYNCBATCHANNOTATEFILESREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='requests', full_name='google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesRequest.requests', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ASYNCBATCHANNOTATEFILESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='responses', full_name='google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesResponse.responses', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INPUTCONFIG = _descriptor.Descriptor(
  name='InputConfig',
  full_name='google.cloud.vision.v1p2beta1.InputConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='gcs_source', full_name='google.cloud.vision.v1p2beta1.InputConfig.gcs_source', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mime_type', full_name='google.cloud.vision.v1p2beta1.InputConfig.mime_type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OUTPUTCONFIG = _descriptor.Descriptor(
  name='OutputConfig',
  full_name='google.cloud.vision.v1p2beta1.OutputConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='gcs_destination', full_name='google.cloud.vision.v1p2beta1.OutputConfig.gcs_destination', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='google.cloud.vision.v1p2beta1.OutputConfig.batch_size', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GCSSOURCE = _descriptor.Descriptor(
  name='GcsSource',
  full_name='google.cloud.vision.v1p2beta1.GcsSource',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='google.cloud.vision.v1p2beta1.GcsSource.uri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GCSDESTINATION = _descriptor.Descriptor(
  name='GcsDestination',
  full_name='google.cloud.vision.v1p2beta1.GcsDestination',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='google.cloud.vision.v1p2beta1.GcsDestination.uri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OPERATIONMETADATA = _descriptor.Descriptor(
  ...
  full_name='google.cloud.vision.v1p2beta1.OperationMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.vision.v1p2beta1.OperationMetadata.state', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.vision.v1p2beta1.OperationMetadata.create_time', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='update_time', full_name='google.cloud.vision.v1p2beta1.OperationMetadata.update_time', index=2,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FACEANNOTATION_LANDMARK.fields_by_name['position'].message_type = google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_geometry__pb2._POSITION
...
_FACEANNOTATION.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
_FACEANNOTATION.fields_by_name['fd_bounding_poly'].message_type = google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
_ENTITYANNOTATION.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
_CROPHINT.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
_ANNOTATEIMAGERESPONSE.fields_by_name['full_text_annotation'].message_type = google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_text__annotation__pb2._TEXTANNOTATION
...
_ANNOTATEIMAGERESPONSE.fields_by_name['web_detection'].message_type = google_dot_cloud_dot_vision__v1p2beta1_dot_proto_dot_web__detection__pb2._WEBDETECTION
...
LocationInfo = _reflection.GeneratedProtocolMessageType('LocationInfo', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.LocationInfo)
  ))
...
Property = _reflection.GeneratedProtocolMessageType('Property', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.Property)
  ))
...
ImageProperties = _reflection.GeneratedProtocolMessageType('ImageProperties', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.ImageProperties)
  ))
...
CropHint = _reflection.GeneratedProtocolMessageType('CropHint', (_message.Message,), dict(
  ...
  Attributes:
      ...
      importance_fraction:
          ...
          the original image.
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.CropHint)
  ))
...
CropHintsAnnotation = _reflection.GeneratedProtocolMessageType('CropHintsAnnotation', (_message.Message,), dict(
  ...
  Attributes:
      crop_hints:
          Crop hint results.
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.CropHintsAnnotation)
  ))
...
CropHintsParams = _reflection.GeneratedProtocolMessageType('CropHintsParams', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.CropHintsParams)
  ))
...
AsyncAnnotateFileRequest = _reflection.GeneratedProtocolMessageType('AsyncAnnotateFileRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      output_config:
          ...
          format).
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest)
  ))
...
OutputConfig = _reflection.GeneratedProtocolMessageType('OutputConfig', (_message.Message,), dict(
  ...
  Attributes:
      ...
      batch_size:
          ...
          file on GCS. The valid range is [1, 100]. If not specified,
          the default value is 20.  For example, for one pdf file with
          100 pages, 100 response protos will be generated. If
          ``batch_size`` = 20, then 5 json files each containing 20
          response protos will be written under the prefix
...
GcsSource = _reflection.GeneratedProtocolMessageType('GcsSource', (_message.Message,), dict(
  ...
  Attributes:
      uri:
          ...
          a GCS object. Wildcards are not currently supported.
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.GcsSource)
  ))
...
GcsDestination = _reflection.GeneratedProtocolMessageType('GcsDestination', (_message.Message,), dict(
  ...
  Attributes:
      uri:
          ...
          end in a ``/``.  Examples:  -  File: gs://bucket-
          name/filename.json -  Prefix: gs://bucket-name/prefix/here/ -
          File: gs://bucket-name/prefix/here  If multiple outputs, each
          response is still AnnotateFileResponse, each of which contains
          some subset of the full list of AnnotateImageResponse.
          Multiple outputs can happen if, for example, the output JSON
          is too large and overflows into multiple sharded files.
  """,
  # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.GcsDestination)
  ))
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n!com.google.cloud.vision.v1p2beta1B\023ImageAnnotatorProtoP\001ZCgoogle.golang.org/genproto/googleapis/cloud/vision/v1p2beta1;vision\370\001\001'))
try:
  ...
  class ImageAnnotatorStub(object):
    ...
    def __init__(self, channel):
      ...
      self.AsyncBatchAnnotateFiles = channel.unary_unary(
          ...
          request_serializer=AsyncBatchAnnotateFilesRequest.SerializeToString,
  ...
  def add_ImageAnnotatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'AsyncBatchAnnotateFiles': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=AsyncBatchAnnotateFilesRequest.FromString,
            response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        'google.cloud.vision.v1p2beta1.ImageAnnotator', rpc_method_handlers)
  ...
  class BetaImageAnnotatorStub(object):
    ...
    def AsyncBatchAnnotateFiles(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      """Run async image detection and annotation for a list of generic files (e.g.
      PDF) which may contain multiple pages and multiple images per page.
      Progress and results can be retrieved through the
      `google.longrunning.Operations` interface.
      ...
      """
      raise NotImplementedError()
    AsyncBatchAnnotateFiles.future = None
  ...
  def beta_create_ImageAnnotator_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'AsyncBatchAnnotateFiles'): AsyncBatchAnnotateFilesRequest.FromString,
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'BatchAnnotateImages'): BatchAnnotateImagesRequest.FromString,
    }
    response_serializers = {
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'AsyncBatchAnnotateFiles'): google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'BatchAnnotateImages'): BatchAnnotateImagesResponse.SerializeToString,
    }
    method_implementations = {
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'AsyncBatchAnnotateFiles'): face_utilities.unary_unary_inline(servicer.AsyncBatchAnnotateFiles),
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'BatchAnnotateImages'): face_utilities.unary_unary_inline(servicer.BatchAnnotateImages),
    }
  ...
  def beta_create_ImageAnnotator_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'AsyncBatchAnnotateFiles'): AsyncBatchAnnotateFilesRequest.SerializeToString,
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'BatchAnnotateImages'): BatchAnnotateImagesRequest.SerializeToString,
    }
    response_deserializers = {
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'AsyncBatchAnnotateFiles'): google_dot_longrunning_dot_operations__pb2.Operation.FromString,
      ('google.cloud.vision.v1p2beta1.ImageAnnotator', 'BatchAnnotateImages'): BatchAnnotateImagesResponse.FromString,
    }
    cardinalities = {
      'AsyncBatchAnnotateFiles': cardinality.Cardinality.UNARY_UNARY,
      'BatchAnnotateImages': cardinality.Cardinality.UNARY_UNARY,
    }
    stub_options = beta_implementations.stub_options(host=host, metadata_transformer=metadata_transformer, request_serializers=request_serializers, response_deserializers=response_deserializers, thread_pool=pool, thread_pool_size=pool_size)
    return beta_implementations.dynamic_stub(channel, 'google.cloud.vision.v1p2beta1.ImageAnnotator', cardinalities, options=stub_options)
except ImportError:
  pass

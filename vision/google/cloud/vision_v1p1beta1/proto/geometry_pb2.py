...
_VERTEX = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="google.cloud.vision.v1p1beta1.Vertex.x",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="google.cloud.vision.v1p1beta1.Vertex.y",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_BOUNDINGPOLY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="vertices",
            full_name="google.cloud.vision.v1p1beta1.BoundingPoly.vertices",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_POSITION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="google.cloud.vision.v1p1beta1.Position.x",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="google.cloud.vision.v1p1beta1.Position.y",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="z",
            full_name="google.cloud.vision.v1p1beta1.Position.z",
            index=2,
            number=3,
            type=2,
            cpp_type=6,

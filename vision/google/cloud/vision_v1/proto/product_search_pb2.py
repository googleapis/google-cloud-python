...
from google.cloud.vision_v1.proto import product_search_service_pb2 as google_dot_cloud_dot_vision__v1_dot_proto_dot_product__search__service__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_vision__v1_dot_proto_dot_geometry__pb2.DESCRIPTOR,google_dot_cloud_dot_vision__v1_dot_proto_dot_product__search__service__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
_PRODUCTSEARCHPARAMS.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision__v1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
_PRODUCTSEARCHRESULTS_RESULT.fields_by_name['product'].message_type = google_dot_cloud_dot_vision__v1_dot_proto_dot_product__search__service__pb2._PRODUCT
_PRODUCTSEARCHRESULTS_RESULT.containing_type = _PRODUCTSEARCHRESULTS
_PRODUCTSEARCHRESULTS_GROUPEDRESULT.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision__v1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
ProductSearchParams = _reflection.GeneratedProtocolMessageType('ProductSearchParams', (_message.Message,), dict(
...
ProductSearchResults = _reflection.GeneratedProtocolMessageType('ProductSearchResults', (_message.Message,), dict(
  ...
  GroupedResult = _reflection.GeneratedProtocolMessageType('GroupedResult', (_message.Message,), dict(

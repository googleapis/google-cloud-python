...
class ProductSearchClient(object):
    ...
    def list_product_sets(
        ...
        Returns:
            ...
            is an iterable of :class:`~google.cloud.vision_v1p4beta1.types.ProductSet` instances.
    ...
    def list_products(
        ...
        Returns:
            A :class:`~google.gax.PageIterator` instance. By default, this
            is an iterable of :class:`~google.cloud.vision_v1p4beta1.types.Product` instances.
            This object can also be configured to iterate over the pages
            of the response through the `options` parameter.
    ...
    def list_reference_images(
        ...
        Returns:
            A :class:`~google.gax.PageIterator` instance. By default, this
            is an iterable of :class:`~google.cloud.vision_v1p4beta1.types.ReferenceImage` instances.
            This object can also be configured to iterate over the pages
            of the response through the `options` parameter.

...
NotificationChannelDescriptor = _reflection.GeneratedProtocolMessageType('NotificationChannelDescriptor', (_message.Message,), dict(
...
_NOTIFICATIONCHANNEL_USERLABELSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

...
_AGGREGATION_ALIGNER = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALIGN_FRACTION_TRUE', index=12, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALIGN_PERCENTILE_99', index=13, number=18,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALIGN_PERCENTILE_95', index=14, number=19,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALIGN_PERCENTILE_50', index=15, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALIGN_PERCENTILE_05', index=16, number=21,
      options=None,
      type=None),
  ],
...
_AGGREGATION_REDUCER = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REDUCE_FRACTION_TRUE', index=8, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REDUCE_PERCENTILE_99', index=9, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REDUCE_PERCENTILE_95', index=10, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REDUCE_PERCENTILE_50', index=11, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REDUCE_PERCENTILE_05', index=12, number=12,
      options=None,
      type=None),
  ],
  containing_type=None,
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\030com.google.monitoring.v3B\013CommonProtoP\001Z>google.golang.org/genproto/googleapis/monitoring/v3;monitoring\252\002\032Google.Cloud.Monitoring.V3'))
try:

...
ListNotificationChannelDescriptorsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          syntax is:  ::      projects/[PROJECT_ID]  Note that this
          names the parent container in which to look for the
...
GetNotificationChannelDescriptorRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          The format is ``projects/[PROJECT_ID]/notificationChannelDescr
          iptors/{channel_type}``.
  """,
...
CreateNotificationChannelRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          format is:  ::      projects/[PROJECT_ID]  Note that this
...
ListNotificationChannelsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          Required. The project on which to execute the request. The
          format is ``projects/[PROJECT_ID]``. That is, this names the
          container in which to look for the notification channels; it
          does not name a specific channel. To query a specific channel
          by REST resource name, use the [``GetNotificationChannel``][go
          ogle.monitoring.v3.NotificationChannelService.GetNotificationC
          hannel] operation.
      filter:

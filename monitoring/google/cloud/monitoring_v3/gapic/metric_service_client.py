...
class MetricServiceClient(object):
    ...
    def __init__(self,
        ...
        self.metric_service_stub = (
            metric_service_pb2.MetricServiceStub(channel))
    ...
    def list_metric_descriptors(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(
                self._list_metric_descriptors, retry=retry, timeout=timeout),
            request=request,
    ...
    def delete_metric_descriptor(
        ...
        self._delete_metric_descriptor(request, retry=retry, timeout=timeout)
    ...
    def list_time_series(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(
                self._list_time_series, retry=retry, timeout=timeout),
            request=request,
    ...
    def create_time_series(self,
        ...
        self._create_time_series(request, retry=retry, timeout=timeout)

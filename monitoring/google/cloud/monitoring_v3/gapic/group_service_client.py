...
class GroupServiceClient(object):
    ...
    def __init__(self,
        ...
        self.group_service_stub = (group_service_pb2.GroupServiceStub(channel))
    ...
    def list_groups(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            ...
            method=functools.partial(
                self._list_groups, retry=retry, timeout=timeout),
            request=request,
            items_field='group',
    ...
    def get_group(self,
        ...
        return self._get_group(request, retry=retry, timeout=timeout)
    ...
    def create_group(self,
        ...
        return self._create_group(request, retry=retry, timeout=timeout)
    ...
    def update_group(self,
        ...
        return self._update_group(request, retry=retry, timeout=timeout)
    ...
    def delete_group(self,
        ...
        self._delete_group(request, retry=retry, timeout=timeout)
    ...
    def list_group_members(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(
                self._list_group_members, retry=retry, timeout=timeout),
            request=request,
            items_field='members',
            request_token_field='page_token',
            response_token_field='next_page_token')

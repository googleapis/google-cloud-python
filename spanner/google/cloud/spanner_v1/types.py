...
from google.cloud.proto.spanner.v1 import query_plan_pb2
...
names = []
for module in (auth_pb2, http_pb2, keys_pb2, mutation_pb2, query_plan_pb2,
               result_set_pb2, spanner_pb2, transaction_pb2, type_pb2,

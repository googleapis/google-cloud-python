...
class SpannerClient(object):
    ...
    def execute_sql(self,
        ...
        Args:
          ...
          transaction (Union[dict|:class:`google.cloud.proto.spanner.v1.transaction_pb2.TransactionSelector`]): The transaction to use. If none is provided, the default is a
            temporary read-only transaction with strong concurrency.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.v1.transaction_pb2.TransactionSelector`
          params (Union[dict|:class:`google.protobuf.struct_pb2.Struct`]): The SQL query string can contain parameter placeholders. A parameter
            ...
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.protobuf.struct_pb2.Struct`
          param_types (dict[str -> Union[dict|:class:`google.cloud.proto.spanner.v1.type_pb2.Type`]]): It is not always possible for Cloud Spanner to infer the right SQL type
            ...
            about SQL types.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.v1.type_pb2.Type`
          ...
          query_mode (~.enums.ExecuteSqlRequest.QueryMode): Used to control the amount of debugging information returned in
            ``ResultSetStats``.
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
    ...
    def execute_streaming_sql(self,
        ...
        Returns:
          Iterable[:class:`google.cloud.proto.spanner.v1.result_set_pb2.PartialResultSet`].
    ...
    def read(self,
        ...
        Args:
          ...
          columns (list[str]): The columns of ``table`` to be returned for each row matching
            this request.
          key_set (Union[dict|:class:`google.cloud.proto.spanner.v1.keys_pb2.KeySet`]): Required. ``key_set`` identifies the rows to be yielded. ``key_set`` names the
            ...
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.v1.keys_pb2.KeySet`
          transaction (Union[dict|:class:`google.cloud.proto.spanner.v1.transaction_pb2.TransactionSelector`]): The transaction to use. If none is provided, the default is a
            temporary read-only transaction with strong concurrency.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.v1.transaction_pb2.TransactionSelector`
    ...
    def begin_transaction(self, session, options_, options=None):
        ...
        Args:
          ...
          options_ (Union[dict|:class:`google.cloud.proto.spanner.v1.transaction_pb2.TransactionOptions`]): Required. Options for the new transaction.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.v1.transaction_pb2.TransactionOptions`
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.
    ...
    def commit(self,
        ...
        Args:
          ...
          mutations (list[Union[dict|:class:`google.cloud.proto.spanner.v1.mutation_pb2.Mutation`]]): The mutations to be executed when this transaction commits. All
            mutations are applied atomically, in the order they appear in
            this list.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.spanner.v1.mutation_pb2.Mutation`
          transaction_id (bytes): Commit a previously-started transaction.
          single_use_transaction (Union[dict|:class:`google.cloud.proto.spanner.v1.transaction_pb2.TransactionOptions`]): Execute mutations in a temporary transaction. Note that unlike

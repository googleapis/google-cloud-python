...
_DATABASEADMIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002/\022-/v1/{parent=projects/*/instances/*}/databases\332A\006parent'),
  ),
  _descriptor.MethodDescriptor(
    name='CreateDatabase',
    ...
    serialized_options=_b('\202\323\344\223\0022\"-/v1/{parent=projects/*/instances/*}/databases:\001*\332A\027parent,create_statement\312Ad\n)google.spanner.admin.database.v1.Database\0227google.spanner.admin.database.v1.CreateDatabaseMetadata'),
  ),
  _descriptor.MethodDescriptor(
    name='GetDatabase',
    ...
    serialized_options=_b('\202\323\344\223\002/\022-/v1/{name=projects/*/instances/*/databases/*}\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002:25/v1/{database=projects/*/instances/*/databases/*}/ddl:\001*\332A\023database,statements\312AS\n\025google.protobuf.Empty\022:google.spanner.admin.database.v1.UpdateDatabaseDdlMetadata'),
  ),
  _descriptor.MethodDescriptor(
    name='DropDatabase',
    ...
    serialized_options=_b('\202\323\344\223\0023*1/v1/{database=projects/*/instances/*/databases/*}\332A\010database'),
  ),
  _descriptor.MethodDescriptor(
    name='GetDatabaseDdl',
    ...
    serialized_options=_b('\202\323\344\223\0027\0225/v1/{database=projects/*/instances/*/databases/*}/ddl\332A\010database'),
  ),
  _descriptor.MethodDescriptor(
    name='SetIamPolicy',
    ...
    serialized_options=_b('\202\323\344\223\002\206\001\">/v1/{resource=projects/*/instances/*/databases/*}:setIamPolicy:\001*ZA\"</v1/{resource=projects/*/instances/*/backups/*}:setIamPolicy:\001*\332A\017resource,policy'),
  ),
  _descriptor.MethodDescriptor(
    name='GetIamPolicy',
    ...
    output_type=google_dot_iam_dot_v1_dot_policy__pb2._POLICY,
    serialized_options=_b('\202\323\344\223\002\206\001\">/v1/{resource=projects/*/instances/*/databases/*}:getIamPolicy:\001*ZA\"</v1/{resource=projects/*/instances/*/backups/*}:getIamPolicy:\001*\332A\010resource'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\222\001\"D/v1/{resource=projects/*/instances/*/databases/*}:testIamPermissions:\001*ZG\"B/v1/{resource=projects/*/instances/*/backups/*}:testIamPermissions:\001*\332A\024resource,permissions'),
  ),
])

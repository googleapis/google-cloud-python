...
class Dispatcher(object):
    ...
    def drop(self, items):
        ...
        """
        self._subscriber.leaser.remove(items)
        self._subscriber.maybe_resume_consumer()
    ...
    def lease(self, items):
        ...
        """
        self._subscriber.leaser.add(items)
        self._subscriber.maybe_pause_consumer()

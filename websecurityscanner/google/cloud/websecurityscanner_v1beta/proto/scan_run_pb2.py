...
ScanRun = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      error_trace:
          Output only. If result\_state is an ERROR, this field provides
          the primary reason for scan's termination and more details, if
          such are available.
      warning_traces:
          Output only. A list of warnings, if such are encountered

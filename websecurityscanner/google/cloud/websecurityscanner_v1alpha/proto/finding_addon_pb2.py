...
OutdatedLibrary = _reflection.GeneratedProtocolMessageType('OutdatedLibrary', (_message.Message,), dict(
...
ViolatingResource = _reflection.GeneratedProtocolMessageType('ViolatingResource', (_message.Message,), dict(
...
VulnerableParameters = _reflection.GeneratedProtocolMessageType('VulnerableParameters', (_message.Message,), dict(
...
Xss = _reflection.GeneratedProtocolMessageType('Xss', (_message.Message,), dict(
  DESCRIPTOR = _XSS,
  __module__ = 'google.cloud.websecurityscanner_v1alpha.proto.finding_addon_pb2'
  ,

...
from google.cloud.websecurityscanner_v1alpha.proto import finding_addon_pb2 as google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__addon__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__addon__pb2.DESCRIPTOR,])
...
_FINDING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vulnerable_parameters', full_name='google.cloud.websecurityscanner.v1alpha.Finding.vulnerable_parameters', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='xss', full_name='google.cloud.websecurityscanner.v1alpha.Finding.xss', index=13,
...
_FINDING.fields_by_name['outdated_library'].message_type = google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__addon__pb2._OUTDATEDLIBRARY
_FINDING.fields_by_name['violating_resource'].message_type = google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__addon__pb2._VIOLATINGRESOURCE
_FINDING.fields_by_name['vulnerable_parameters'].message_type = google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__addon__pb2._VULNERABLEPARAMETERS
_FINDING.fields_by_name['xss'].message_type = google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__addon__pb2._XSS

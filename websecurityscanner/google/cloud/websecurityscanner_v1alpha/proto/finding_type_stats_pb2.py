...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__pb2.DESCRIPTOR,])
...
_FINDINGTYPESTATS.fields_by_name['finding_type'].enum_type = google_dot_cloud_dot_websecurityscanner__v1alpha_dot_proto_dot_finding__pb2._FINDING_FINDINGTYPE
DESCRIPTOR.message_types_by_name['FindingTypeStats'] = _FINDINGTYPESTATS
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

FindingTypeStats = _reflection.GeneratedProtocolMessageType('FindingTypeStats', (_message.Message,), dict(

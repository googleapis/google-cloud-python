...
ScanConfig = _reflection.GeneratedProtocolMessageType('ScanConfig', (_message.Message,), dict(
  ...
  Authentication = _reflection.GeneratedProtocolMessageType('Authentication', (_message.Message,), dict(
    ...
    GoogleAccount = _reflection.GeneratedProtocolMessageType('GoogleAccount', (_message.Message,), dict(
    ...
    CustomAccount = _reflection.GeneratedProtocolMessageType('CustomAccount', (_message.Message,), dict(

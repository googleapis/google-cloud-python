...
class ClusterManagerClient(object):
    ...
    def list_usable_subnetworks(
        ...
        Example:
            ...
            >>> for element in client.list_usable_subnetworks(parent, filter_):
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>> for page in client.list_usable_subnetworks(parent, filter_, options=CallOptions(page_token=INITIAL_PAGE)):
            ...     for element in page:
            ...         # process element
            ...         pass

        Args:
            parent (str): The parent project where subnetworks are usable.
                Specified in the format 'projects/*'.
            filter_ (str): Filtering currently only supports equality on the networkProjectId and must
        ...
        Returns:
            ...
            is an iterable of :class:`~google.cloud.container_v1.types.UsableSubnetwork` instances.
        ...
        if 'list_usable_subnetworks' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_usable_subnetworks'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_usable_subnetworks,
                    default_retry=self.
                    _method_configs['ListUsableSubnetworks'].retry,
                    default_timeout=self.
                    _method_configs['ListUsableSubnetworks'].timeout,
                    client_info=self._client_info,
                )
    ...
    def list_locations(self,
        ...
        Args:
            parent (str): Contains the name of the resource requested.
                Specified in the format 'projects/*'.
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
        ...
        Returns:
            A :class:`~google.cloud.container_v1.types.ListLocationsResponse` instance.
        ...
        if 'list_locations' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_locations'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_locations,
                    default_retry=self._method_configs['ListLocations'].retry,
                    default_timeout=self._method_configs['ListLocations'].
                    timeout,
                    client_info=self._client_info,
                )

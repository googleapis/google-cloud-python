...
class StatusCondition(object):
    class Code(enum.IntEnum):
        ...
        Attributes:
          ...
          GCE_STOCKOUT (int): GCE_STOCKOUT indicates a GCE stockout.
          GKE_SERVICE_ACCOUNT_DELETED (int): GKE_SERVICE_ACCOUNT_DELETED indicates that the user deleted their robot
          service account.
          More codes TBA
        """
        UNKNOWN = 0
...
class Cluster(object):
    ...
    class NodeSchedulingStrategy(enum.IntEnum):
        """
        Defines possible options for node_scheduling_strategy field.

        Attributes:
          STRATEGY_UNSPECIFIED (int): Use default scheduling strategy.
          PRIORITIZE_LEAST_UTILIZED (int): Least utilized nodes will be prioritized by k8s scheduler.
          PRIORITIZE_MEDIUM_UTILIZED (int): Nodes with medium utilization will be prioritized by k8s scheduler.
...
class Operation(object):
    ...
    class Type(enum.IntEnum):
        ...
        Attributes:
          ...
          SET_NETWORK_POLICY (int): Updates network policy for a cluster.
          SET_MAINTENANCE_POLICY (int): Set the maintenance policy.
          UPDATE_IP_ALLOCATION_POLICY (int): Update cluster IP allocation policy.
        """
        TYPE_UNSPECIFIED = 0
        CREATE_CLUSTER = 1
        DELETE_CLUSTER = 2
...
class UsableSubnetworkSecondaryRange(object):
    class Status(enum.IntEnum):
        ...
        Attributes:
          ...
          IN_USE_SHAREABLE_POD (int): IN_USE_SHAREABLE_POD denotes this range was created by the network admin
          and is currently claimed by a cluster for pods. It can only be used by
          other clusters as a pod range.
          IN_USE_MANAGED_POD (int): IN_USE_MANAGED_POD denotes this range was created by GKE and is claimed
...
class Location(object):
    class LocationType(enum.IntEnum):
        ...
        Attributes:
          LOCATION_TYPE_UNSPECIFIED (int): LOCATION_TYPE_UNSPECIFIED means the location type was not determined.

...
HttpTarget = _reflection.GeneratedProtocolMessageType('HttpTarget', (_message.Message,), dict(
...
PubsubTarget = _reflection.GeneratedProtocolMessageType('PubsubTarget', (_message.Message,), dict(
...
_HTTPTARGET_HEADERSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_APPENGINEHTTPTARGET_HEADERSENTRY.has_options = True
_APPENGINEHTTPTARGET_HEADERSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_PUBSUBTARGET_ATTRIBUTESENTRY.has_options = True
_PUBSUBTARGET_ATTRIBUTESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

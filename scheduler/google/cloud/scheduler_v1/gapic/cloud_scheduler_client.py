...
from google.cloud.scheduler_v1.gapic import cloud_scheduler_client_config
from google.cloud.scheduler_v1.gapic import enums
from google.cloud.scheduler_v1.gapic.transports import cloud_scheduler_grpc_transport
...
class CloudSchedulerClient(object):
    ...
    _INTERFACE_NAME = "google.cloud.scheduler.v1.CloudScheduler"
    ...
    def update_job(
        ...
        Args:
            job (Union[dict, ~google.cloud.scheduler_v1.types.Job]): Required.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.scheduler_v1.types.Job`
            update_mask (Union[dict, ~google.cloud.scheduler_v1.types.FieldMask]): A  mask used to specify which fields of the job are being updated.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.scheduler_v1.types.FieldMask`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait

...
_STANDARDSQLFIELD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
StandardSqlDataType = _reflection.GeneratedProtocolMessageType('StandardSqlDataType', (_message.Message,), dict(
...
StandardSqlField = _reflection.GeneratedProtocolMessageType('StandardSqlField', (_message.Message,), dict(
...
StandardSqlStructType = _reflection.GeneratedProtocolMessageType('StandardSqlStructType', (_message.Message,), dict(

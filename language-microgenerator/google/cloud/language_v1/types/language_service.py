...
class Document(proto.Message):
    ...
    Attributes:
        type (~.language_service.Document.Type):
        ...
        language (str):
            ...
            Support </natural-language/docs/languages>`__ lists
            currently supported languages for each API method. If the
            language (either specified by the caller or automatically
    ...
    gcs_content_uri = proto.Field(proto.STRING, number=3)
...
class Entity(proto.Message):
    ...
    Attributes:
        ...
        type (~.language_service.Entity.Type):
            The entity type.
    ...
    class MetadataEntry(proto.Message):
        r"""
    ...
    type = proto.Field(proto.ENUM, number=2, enum=Type)
    metadata = proto.RepeatedField(proto.MESSAGE, number=3, message=MetadataEntry)
...
class EntityMention(proto.Message):
    ...
    Attributes:
        text (~.language_service.TextSpan):
            The mention text.
        type (~.language_service.EntityMention.Type):

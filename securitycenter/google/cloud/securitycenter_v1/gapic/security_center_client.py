...
class SecurityCenterClient(object):
    ...
    def asset_path(cls, organization, asset):
        """DEPRECATED. Return a fully-qualified asset string."""
        warnings.warn(
    ...
    def organization_sources_path(cls, organization):
        """DEPRECATED. Return a fully-qualified organization_sources string."""
        warnings.warn(
            "Resource name helper functions are deprecated.",
            PendingDeprecationWarning,
            stacklevel=1,
    ...
    def set_finding_state(
        ...
        Args:
            ...
            state (~google.cloud.securitycenter_v1.types.State): The desired State of the finding.
            start_time (Union[dict, ~google.cloud.securitycenter_v1.types.Timestamp]): The time at which the updated state takes effect.
    ...
    def update_finding(
        ...
        Args:
            finding (Union[dict, ~google.cloud.securitycenter_v1.types.Finding]): The finding resource to update or create if it does not already exist.
    ...
    def update_organization_settings(
        ...
        Args:
            organization_settings (Union[dict, ~google.cloud.securitycenter_v1.types.OrganizationSettings]): The organization settings resource to update.
    ...
    def update_source(
        ...
        Args:
            source (Union[dict, ~google.cloud.securitycenter_v1.types.Source]): The source resource to update.

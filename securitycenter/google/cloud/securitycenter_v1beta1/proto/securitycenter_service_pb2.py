...
from google.cloud.securitycenter_v1beta1.proto import asset_pb2 as google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_asset__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_asset__pb2.DESCRIPTOR,google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_finding__pb2.DESCRIPTOR,google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_organization__settings__pb2.DESCRIPTOR,google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_security__marks__pb2.DESCRIPTOR,google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_source__pb2.DESCRIPTOR,google_dot_iam_dot_v1_dot_iam__policy__pb2.DESCRIPTOR,google_dot_iam_dot_v1_dot_policy__pb2.DESCRIPTOR,google_dot_longrunning_dot_operations__pb2.DESCRIPTOR,google_dot_protobuf_dot_duration__pb2.DESCRIPTOR,google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
_CREATEFINDINGREQUEST.fields_by_name['finding'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_finding__pb2._FINDING
_CREATESOURCEREQUEST.fields_by_name['source'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_source__pb2._SOURCE
...
_LISTSOURCESRESPONSE.fields_by_name['sources'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_source__pb2._SOURCE
...
_LISTASSETSRESPONSE_LISTASSETSRESULT.fields_by_name['asset'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_asset__pb2._ASSET
...
_LISTFINDINGSRESPONSE.fields_by_name['findings'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_finding__pb2._FINDING
_LISTFINDINGSRESPONSE.fields_by_name['read_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_SETFINDINGSTATEREQUEST.fields_by_name['state'].enum_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_finding__pb2._FINDING_STATE
_SETFINDINGSTATEREQUEST.fields_by_name['start_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_UPDATEFINDINGREQUEST.fields_by_name['finding'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_finding__pb2._FINDING
_UPDATEFINDINGREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_UPDATEORGANIZATIONSETTINGSREQUEST.fields_by_name['organization_settings'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_organization__settings__pb2._ORGANIZATIONSETTINGS
...
_UPDATESOURCEREQUEST.fields_by_name['source'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_source__pb2._SOURCE
_UPDATESOURCEREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_UPDATESECURITYMARKSREQUEST.fields_by_name['security_marks'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_security__marks__pb2._SECURITYMARKS
...
GetOrganizationSettingsRequest = _reflection.GeneratedProtocolMessageType('GetOrganizationSettingsRequest', (_message.Message,), dict(
...
GroupAssetsRequest = _reflection.GeneratedProtocolMessageType('GroupAssetsRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      group_by:
          ...
          is not set:  -  security\_center\_properties.resource\_name -
      ...
      compare_duration:
          ...
          "ACTIVE\_AT\_BOTH": indicates that the asset was present at
...
GroupAssetsResponse = _reflection.GeneratedProtocolMessageType('GroupAssetsResponse', (_message.Message,), dict(
...
GroupFindingsRequest = _reflection.GeneratedProtocolMessageType('GroupFindingsRequest', (_message.Message,), dict(
...
GroupFindingsResponse = _reflection.GeneratedProtocolMessageType('GroupFindingsResponse', (_message.Message,), dict(
...
GroupResult = _reflection.GeneratedProtocolMessageType('GroupResult', (_message.Message,), dict(
...
ListAssetsResponse = _reflection.GeneratedProtocolMessageType('ListAssetsResponse', (_message.Message,), dict(
  ...
  ListAssetsResult = _reflection.GeneratedProtocolMessageType('ListAssetsResult', (_message.Message,), dict(
...
SetFindingStateRequest = _reflection.GeneratedProtocolMessageType('SetFindingStateRequest', (_message.Message,), dict(
...
RunAssetDiscoveryRequest = _reflection.GeneratedProtocolMessageType('RunAssetDiscoveryRequest', (_message.Message,), dict(
...
UpdateFindingRequest = _reflection.GeneratedProtocolMessageType('UpdateFindingRequest', (_message.Message,), dict(
...
UpdateOrganizationSettingsRequest = _reflection.GeneratedProtocolMessageType('UpdateOrganizationSettingsRequest', (_message.Message,), dict(
...
UpdateSecurityMarksRequest = _reflection.GeneratedProtocolMessageType('UpdateSecurityMarksRequest', (_message.Message,), dict(
...
_GROUPRESULT_PROPERTIESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
...
_SECURITYCENTER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0023\")/v1beta1/{parent=organizations/*}/sources:\006source')),
  ),
  _descriptor.MethodDescriptor(
    name='CreateFinding',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002?\"4/v1beta1/{parent=organizations/*/sources/*}/findings:\007finding')),
  ),
  _descriptor.MethodDescriptor(
    name='GetIamPolicy',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002?\":/v1beta1/{resource=organizations/*/sources/*}:getIamPolicy:\001*')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0026\0224/v1beta1/{name=organizations/*/organizationSettings}')),
  ),
  _descriptor.MethodDescriptor(
    name='GetSource',
    ...
    output_type=google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_source__pb2._SOURCE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002+\022)/v1beta1/{name=organizations/*/sources/*}')),
  ),
  _descriptor.MethodDescriptor(
    name='GroupAssets',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0023\"./v1beta1/{parent=organizations/*}/assets:group:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GroupFindings',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002?\":/v1beta1/{parent=organizations/*/sources/*}/findings:group:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='ListAssets',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002*\022(/v1beta1/{parent=organizations/*}/assets')),
  ),
  _descriptor.MethodDescriptor(
    name='ListFindings',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0026\0224/v1beta1/{parent=organizations/*/sources/*}/findings')),
  ),
  _descriptor.MethodDescriptor(
    name='ListSources',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002+\022)/v1beta1/{parent=organizations/*}/sources')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002:\"5/v1beta1/{parent=organizations/*}/assets:runDiscovery:\001*')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_finding__pb2._FINDING,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002B\"=/v1beta1/{name=organizations/*/sources/*/findings/*}:setState:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='SetIamPolicy',
    ...
    output_type=google_dot_iam_dot_v1_dot_policy__pb2._POLICY,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002?\":/v1beta1/{resource=organizations/*/sources/*}:setIamPolicy:\001*')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002E\"@/v1beta1/{resource=organizations/*/sources/*}:testIamPermissions:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateFinding',
    ...
    output_type=google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_finding__pb2._FINDING,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002G2</v1beta1/{finding.name=organizations/*/sources/*/findings/*}:\007finding')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_organization__settings__pb2._ORGANIZATIONSETTINGS,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002c2J/v1beta1/{organization_settings.name=organizations/*/organizationSettings}:\025organization_settings')),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateSource',
    ...
    output_type=google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_source__pb2._SOURCE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002:20/v1beta1/{source.name=organizations/*/sources/*}:\006source')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\274\0012E/v1beta1/{security_marks.name=organizations/*/assets/*/securityMarks}:\016security_marksZc2Q/v1beta1/{security_marks.name=organizations/*/sources/*/findings/*/securityMarks}:\016security_marks')),
  ),
])

...
_DEVICEREGISTRY = _descriptor.Descriptor(
    ...
    enum_types=[],
    serialized_options=_b(
        "\352Ag\n&cloudiot.googleapis.com/DeviceRegistry\022=projects/{project}/locations/{location}/registries/{registry}"
    ),
    is_extendable=False,
    syntax="proto3",
    extension_ranges=[],

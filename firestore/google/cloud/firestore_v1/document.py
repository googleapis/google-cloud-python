...
class DocumentReference(object):
    ...
    def parent(self):
        ...
        Returns:
            ~google.cloud.firestore_v1.collection.CollectionReference: The
            parent collection.
        """
    ...
    def update(self, field_updates, option=None):
        ...
        **field path** (For more information on **field paths**, see
        ...
        :attr:`~google.cloud.firestore_v1.transforms.DELETE_FIELD` sentinel. So
        ...
        :attr:`~google.cloud.firestore_v1.transforms.SERVER_TIMESTAMP` sentinel.
        Sending
    ...
    def get(self, field_paths=None, transaction=None):
        ...
        Returns:
            ~google.cloud.firestore_v1.document.DocumentSnapshot: A snapshot of
...
class DocumentSnapshot(object):
    ...
    def _client(self):
        ...
        Returns:
            ~google.cloud.firestore_v1.client.Client: The client that owns this
            document.
        """
    ...
    def reference(self):
        ...
        Returns:
            ~google.cloud.firestore_v1.document.DocumentReference: A document
...
def _get_document_path(client, path):
    ...
    Args:
        client (~google.cloud.firestore_v1.client.Client): The client that holds

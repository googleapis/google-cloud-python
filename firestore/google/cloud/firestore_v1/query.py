...
class Query(object):
    ...
    Args:
        parent (~google.cloud.firestore_v1.collection.Collection): The collection
    ...
    def _client(self):
        ...
        Returns:
            ~google.cloud.firestore_v1.client.Client: The client that owns
            this query.
        """
    ...
    def select(self, field_paths):
        ...
        Returns:
            ~google.cloud.firestore_v1.query.Query: A "projected" query. Acts as
    ...
    def where(self, field_path, op_string, value):
        ...
        Returns:
            ~google.cloud.firestore_v1.query.Query: A filtered query. Acts as a
    ...
    def order_by(self, field_path, direction=ASCENDING):
        ...
        Successive :meth:`~google.cloud.firestore_v1.query.Query.order_by` calls
        ...
        Returns:
            ~google.cloud.firestore_v1.query.Query: An ordered query. Acts as a
    ...
    def limit(self, count):
        ...
        Returns:
            ~google.cloud.firestore_v1.query.Query: A limited query. Acts as a
            copy of the current query, modified with the newly added
            "limit" filter.
        """
        return self.__class__(
    ...
    def offset(self, num_to_skip):
        ...
        Returns:
            ~google.cloud.firestore_v1.query.Query: An offset query. Acts as a
            copy of the current query, modified with the newly added
            "offset" field.
        """
        return self.__class__(
    ...
    def _cursor_helper(self, document_fields, before, start):
        ...
        Args:
            document_fields (Union[~google.cloud.firestore_v1.\
        ...
        Returns:
            ~google.cloud.firestore_v1.query.Query: A query with cursor. Acts as
            a copy of the current query, modified with the newly added
            "start at" cursor.
        """
    ...
    def start_at(self, document_fields):
        ...
        via this method or
        :meth:`~google.cloud.firestore_v1.query.Query.start_after` -- this will
        overwrite it.
    ...
    def stream(self, transaction=None):
        ...
        Yields:
            ~google.cloud.firestore_v1.document.DocumentSnapshot: The next
...
def _query_response_to_snapshot(response_pb, collection, expected_prefix):
    ...
    Args:
        ...
        collection (~google.cloud.firestore_v1.collection.CollectionReference): A

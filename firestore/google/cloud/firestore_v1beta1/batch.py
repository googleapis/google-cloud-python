...
class WriteBatch(object):
    ...
    :class:`~google.cloud.firestore_v1beta1.document.DocumentReference` does,
    e.g. :meth:`~google.cloud.firestore_v1beta1.document.DocumentReference.create`.

    Args:
        client (~google.cloud.firestore_v1beta1.client.Client): The client that
            created this batch.
    """
    ...
    def set(self, reference, document_data, merge=False):
        ...
        See
        :meth:`~google.cloud.firestore_v1beta1.document.DocumentReference.set` for
        more information on how ``option`` determines how the change is
        applied.

        Args:
            reference (~google.cloud.firestore_v1beta1.document.DocumentReference):
    ...
    def update(self, reference, field_updates, option=None):
        ...
        See
        :meth:`~google.cloud.firestore_v1beta1.document.DocumentReference.update` for
    ...
    def delete(self, reference, option=None):
        ...
        See
        :meth:`~google.cloud.firestore_v1beta1.document.DocumentReference.delete` for
        more information on how ``option`` determines how the change is
        applied.

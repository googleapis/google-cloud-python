...
StreamingAnnotateVideoResponse = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      error:
          If set, returns a [google.rpc.Status][] message that specifies

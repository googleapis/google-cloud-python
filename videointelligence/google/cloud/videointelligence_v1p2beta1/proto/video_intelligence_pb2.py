...
_FEATURE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="TEXT_DETECTION", index=4, number=7, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="OBJECT_TRACKING", index=5, number=9, options=None, type=None
        ),
    ],
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            options=_descriptor._ParseOptions(
                ...
                _b('\202\323\344\223\002\037"\032/v1p2beta1/videos:annotate:\001*'),
            ),
        )
    ],
)

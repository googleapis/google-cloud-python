...
# source: google/cloud/bigtable/admin_v2/proto/bigtable_instance_admin.proto
...
from google.cloud.bigtable_admin_v2.proto import instance_pb2 as google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2
...
_CREATEINSTANCEREQUEST_CLUSTERSENTRY.fields_by_name['value'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._CLUSTER
_CREATEINSTANCEREQUEST_CLUSTERSENTRY.containing_type = _CREATEINSTANCEREQUEST
_CREATEINSTANCEREQUEST.fields_by_name['instance'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._INSTANCE
_CREATEINSTANCEREQUEST.fields_by_name['clusters'].message_type = _CREATEINSTANCEREQUEST_CLUSTERSENTRY
_LISTINSTANCESRESPONSE.fields_by_name['instances'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._INSTANCE
_PARTIALUPDATEINSTANCEREQUEST.fields_by_name['instance'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._INSTANCE
...
_CREATECLUSTERREQUEST.fields_by_name['cluster'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._CLUSTER
_LISTCLUSTERSRESPONSE.fields_by_name['clusters'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._CLUSTER
...
_UPDATECLUSTERMETADATA.fields_by_name['original_request'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._CLUSTER
...
_CREATEAPPPROFILEREQUEST.fields_by_name['app_profile'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._APPPROFILE
_LISTAPPPROFILESRESPONSE.fields_by_name['app_profiles'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._APPPROFILE
_UPDATEAPPPROFILEREQUEST.fields_by_name['app_profile'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._APPPROFILE
...
CreateInstanceRequest = _reflection.GeneratedProtocolMessageType('CreateInstanceRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      clusters:
          ...
          exactly one cluster must be specified.
  """,
...
ListInstancesResponse = _reflection.GeneratedProtocolMessageType('ListInstancesResponse', (_message.Message,), dict(
  ...
  Attributes:
      ...
      next_page_token:
          Set if not all instances could be returned in a single
...
ListClustersResponse = _reflection.GeneratedProtocolMessageType('ListClustersResponse', (_message.Message,), dict(
  ...
  Attributes:
      ...
      next_page_token:
          Set if not all clusters could be returned in a single
          response. Pass this value to ``page_token`` in another request
          to get the next page of results.
  """,

...
_CREATEINSTANCEREQUEST_CLUSTERSENTRY.fields_by_name[
    ...
    google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._CLUSTER
)
_CREATEINSTANCEREQUEST_CLUSTERSENTRY.containing_type = _CREATEINSTANCEREQUEST
_CREATEINSTANCEREQUEST.fields_by_name[
    "instance"
].message_type = (
    google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._INSTANCE
)
_CREATEINSTANCEREQUEST.fields_by_name[
    "clusters"
...
_CREATEAPPPROFILEREQUEST.fields_by_name[
    ...
    google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_instance__pb2._APPPROFILE
)

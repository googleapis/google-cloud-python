...
class DataCatalogClient(object):
    ...
    def search_catalog(
        ...
        Example:
            ...
            >>> query = ''
            >>>
            >>> # TODO: Initialize `order_by`:
            >>> order_by = ''
            >>>
            >>> # Iterate over all results
            >>> for element in client.search_catalog(scope, query, order_by):
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>> for page in client.search_catalog(scope, query, order_by).pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        request = datacatalog_pb2.SearchCatalogRequest(
            scope=scope, query=query, order_by=order_by, page_size=page_size
        )
    ...
    def create_entry_group(
        ...
        Args:
            ...
            entry_group (Union[dict, ~google.cloud.datacatalog_v1beta1.types.EntryGroup]): Optional. The entry group to create. Defaults to an empty entry group.
    ...
    def get_entry_group(
        ...
        Args:
            ...
            read_mask (Union[dict, ~google.cloud.datacatalog_v1beta1.types.FieldMask]): Optional. The fields to return. If not set or empty, all fields are
                returned.
    ...
    def update_entry(
        ...
        Args:
            ...
            update_mask (Union[dict, ~google.cloud.datacatalog_v1beta1.types.FieldMask]): Optional. The fields to update on the entry. If absent or empty, all
                ...
                Currently only ``schema`` field in Cloud Pub/Sub topic entries is
                modifiable.

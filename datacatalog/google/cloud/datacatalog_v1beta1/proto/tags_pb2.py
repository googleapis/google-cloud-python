...
Tag = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          /{tag\_id}  where ``tag_id`` is a system-generated identifier.
...
TagTemplate = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          name of the tag template in URL format. Example:  -  projects/
      ...
      display_name:
          Optional. The display name for this template. Defaults to an
          empty string.
      fields:
...
TagTemplateField = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      display_name:
          Optional. The display name for this field. Defaults to an
          empty string.
      type:

...
SearchCatalogRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_token:
          ...
          SearchCatalogResponse.next\_page\_token], which indicates that
...
CreateEntryGroupRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      entry_group:
          Optional. The entry group to create. Defaults to an empty
          entry group.
  """,
...
GetEntryGroupRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      read_mask:
          Optional. The fields to return. If not set or empty, all
          fields are returned.
  """,
...
UpdateEntryRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      update_mask:
          ...
          empty, all modifiable fields are updated.  Currently only
          ``schema`` field in Cloud Pub/Sub topic entries is modifiable.
  """,
...
Entry = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          name of the entry in URL format. Example:  -  projects/{projec
          t\_id}/locations/{location}/entryGroups/{entry\_group\_id}/ent
          ries/{entry\_id}  Note that this Entry and its child resources
...
EntryGroup = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          Required when used in [UpdateEntryGroupRequest][google.cloud.d
          atacatalog.v1beta1.UpdateEntryGroupRequest]. The resource name
          of the entry group in URL format. Example:  -  projects/{proje
          ct\_id}/locations/{location}/entryGroups/{entry\_group\_id}
          Note that this EntryGroup and its child resources may not
          actually be stored in the location in this name.
      display_name:
          Optional. A short name to identify the entry group, for
          example, "analytics data - jan 2011". Default value is an
          empty string.
      description:
          Optional. Entry group description, which can consist of
          several sentences or paragraphs that describe entry group
...
UpdateTagTemplateRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      update_mask:
          ...
          to overwrite.  Allowed fields:  -  ``display_name``  If absent
          or empty, all of the allowed fields above will be updated.
  """,
...
_DATACATALOG = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002\034"\027/v1beta1/catalog:search:\001*\332A\024scope,query,order_by'
            ),
        ),
        _descriptor.MethodDescriptor(

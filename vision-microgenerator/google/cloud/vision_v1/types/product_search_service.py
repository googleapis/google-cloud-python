...
class Product(proto.Message):
    ...
    Attributes:
        ...
        product_category (str):
            ...
            be either "homegoods-v2", "apparel-v2",
...
class ImportProductSetsInputConfig(proto.Message):
    ...
    gcs_source = proto.Field(
        proto.MESSAGE, number=1, message=ImportProductSetsGcsSource
    )
...
class PurgeProductsRequest(proto.Message):
    ...
    product_set_purge_config = proto.Field(
        proto.MESSAGE, number=2, message=ProductSetPurgeConfig
    )
    delete_orphan_products = proto.Field(proto.BOOL, number=3)
    parent = proto.Field(proto.STRING, number=1)

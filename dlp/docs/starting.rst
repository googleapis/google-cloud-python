...
gapic-google-cloud-dlp-v2beta1 will allow you to connect to the `DLP API`_ and access all its methods. In order to achieve this, you need to set up authentication as well as install the library locally.

...
_DLPSERVICE = _descriptor.ServiceDescriptor(
    ...
    index=0,
    serialized_options=None,
    serialized_start=26809,
    serialized_end=32515,
    methods=[

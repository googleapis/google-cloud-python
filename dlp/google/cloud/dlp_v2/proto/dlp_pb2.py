...
ContentLocation = _reflection.GeneratedProtocolMessageType('ContentLocation', (_message.Message,), dict(
  ...
  Attributes:
      container_name:
          ...
          level name is the source file name or table name. Nested names
          could be absent if the embedded object has no string
          identifier (for an example an image contained within a
          document).
      location:

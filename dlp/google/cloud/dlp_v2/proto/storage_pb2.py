...
CustomInfoType = _reflection.GeneratedProtocolMessageType('CustomInfoType', (_message.Message,), dict(
  ...
  Attributes:
      info_type:
          All CustomInfoTypes must have a name that does not conflict
          with built-in InfoTypes or other CustomInfoTypes.
      likelihood:

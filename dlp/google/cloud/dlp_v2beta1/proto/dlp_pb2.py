...
from google.cloud.privacy.dlp_v2beta1.proto import storage_pb2 as google_dot_cloud_dot_privacy_dot_dlp__v2beta1_dot_proto_dot_storage__pb2
...
CharacterMaskConfig = _reflection.GeneratedProtocolMessageType('CharacterMaskConfig', (_message.Message,), dict(
  ...
  Attributes:
      masking_character:
          ...
          length 1. If not supplied, we will default to "*\ " for
          strings, 0 for digits.
      number_to_mask:

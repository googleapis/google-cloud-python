...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_tasks__v2beta2_dot_proto_dot_target__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])
...
_TASK.fields_by_name['app_engine_http_request'].message_type = google_dot_cloud_dot_tasks__v2beta2_dot_proto_dot_target__pb2._APPENGINEHTTPREQUEST
_TASK.fields_by_name['pull_message'].message_type = google_dot_cloud_dot_tasks__v2beta2_dot_proto_dot_target__pb2._PULLMESSAGE
...
AttemptStatus = _reflection.GeneratedProtocolMessageType('AttemptStatus', (_message.Message,), dict(

...
_LABELAUDIOREQUEST_FEATURE = _descriptor.EnumDescriptor(
    name="Feature",
    full_name="google.cloud.datalabeling.v1beta1.LabelAudioRequest.Feature",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_LABELAUDIOREQUEST = _descriptor.Descriptor(
    name="LabelAudioRequest",
    full_name="google.cloud.datalabeling.v1beta1.LabelAudioRequest",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="parent",
            full_name="google.cloud.datalabeling.v1beta1.LabelAudioRequest.parent",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="basic_config",
            full_name="google.cloud.datalabeling.v1beta1.LabelAudioRequest.basic_config",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_LABELAUDIOREQUEST_FEATURE],
    serialized_options=None,
    is_extendable=False,
    syntax="proto3",
    extension_ranges=[],
...
_LABELAUDIOREQUEST.fields_by_name["feature"].enum_type = _LABELAUDIOREQUEST_FEATURE
_LABELAUDIOREQUEST_FEATURE.containing_type = _LABELAUDIOREQUEST
...
DESCRIPTOR.message_types_by_name["LabelAudioRequest"] = _LABELAUDIOREQUEST
...
LabelImageRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      image_classification_config:
          ...
          polyline\_config and segmentation\_config is required.
      bounding_poly_config:
...
LabelAudioRequest = _reflection.GeneratedProtocolMessageType(
    "LabelAudioRequest",
    (_message.Message,),
    dict(
        DESCRIPTOR=_LABELAUDIOREQUEST,
        __module__="google.cloud.datalabeling_v1beta1.proto.data_labeling_service_pb2",
        __doc__="""Request message for LabelAudio.
...
_sym_db.RegisterMessage(LabelAudioRequest)
...
_DATALABELINGSERVICE = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name="LabelAudio",
            full_name="google.cloud.datalabeling.v1beta1.DataLabelingService.LabelAudio",
            index=14,
            containing_service=None,
            input_type=_LABELAUDIOREQUEST,
            output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
            serialized_options=_b(
                '\202\323\344\223\0028"3/v1beta1/{parent=projects/*/datasets/*}/audio:label:\001*'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="GetExample",

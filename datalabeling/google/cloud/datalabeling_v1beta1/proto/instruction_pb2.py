...
Instruction = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      csv_instruction:
          One of CSV and PDF instruction is required. Instruction from a
          csv file, such as for classification task. Csv file should
          have exact two columns, in the format of: The first column is
          labeled data, such as image reference, text. The second column
          is comma separated labels associated with data.
      pdf_instruction:
          One of CSV and PDF instruction is required. Instruction from a
          PDF doc. The PDF doc should be in GCS bucket.
  """,

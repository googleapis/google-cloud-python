...
_ATTESTATIONOCCURRENCE.fields_by_name['signatures'].message_type = grafeas__v1_dot_proto_dot_common__pb2._SIGNATURE
...
AttestationNote = _reflection.GeneratedProtocolMessageType('AttestationNote', (_message.Message,), dict(
...
AttestationOccurrence = _reflection.GeneratedProtocolMessageType('AttestationOccurrence', (_message.Message,), dict(

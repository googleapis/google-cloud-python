...
PackageNote = _reflection.GeneratedProtocolMessageType('PackageNote', (_message.Message,), dict(
...
PackageOccurrence = _reflection.GeneratedProtocolMessageType('PackageOccurrence', (_message.Message,), dict(

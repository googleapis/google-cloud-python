...
BuildProvenance = _reflection.GeneratedProtocolMessageType('BuildProvenance', (_message.Message,), dict(

  BuildOptionsEntry = _reflection.GeneratedProtocolMessageType('BuildOptionsEntry', (_message.Message,), dict(

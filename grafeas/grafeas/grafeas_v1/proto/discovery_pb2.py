...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_rpc_dot_status__pb2.DESCRIPTOR,grafeas__v1_dot_proto_dot_common__pb2.DESCRIPTOR,])
...
_DISCOVERYNOTE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='analysis_kind', full_name='grafeas.v1.DiscoveryNote.analysis_kind', index=0,
...
_DISCOVERYOCCURRENCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='continuous_analysis', full_name='grafeas.v1.DiscoveryOccurrence.continuous_analysis', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='analysis_status', full_name='grafeas.v1.DiscoveryOccurrence.analysis_status', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='analysis_status_error', full_name='grafeas.v1.DiscoveryOccurrence.analysis_status_error', index=2,
...
_DISCOVERYNOTE.fields_by_name['analysis_kind'].enum_type = grafeas__v1_dot_proto_dot_common__pb2._NOTEKIND
_DISCOVERYOCCURRENCE.fields_by_name['continuous_analysis'].enum_type = _DISCOVERYOCCURRENCE_CONTINUOUSANALYSIS
_DISCOVERYOCCURRENCE.fields_by_name['analysis_status'].enum_type = _DISCOVERYOCCURRENCE_ANALYSISSTATUS
_DISCOVERYOCCURRENCE.fields_by_name['analysis_status_error'].message_type = google_dot_rpc_dot_status__pb2._STATUS
...
DiscoveryNote = _reflection.GeneratedProtocolMessageType('DiscoveryNote', (_message.Message,), dict(
...
DiscoveryOccurrence = _reflection.GeneratedProtocolMessageType('DiscoveryOccurrence', (_message.Message,), dict(

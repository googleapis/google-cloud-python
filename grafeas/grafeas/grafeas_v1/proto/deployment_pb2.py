...
DeploymentNote = _reflection.GeneratedProtocolMessageType('DeploymentNote', (_message.Message,), dict(
...
DeploymentOccurrence = _reflection.GeneratedProtocolMessageType('DeploymentOccurrence', (_message.Message,), dict(

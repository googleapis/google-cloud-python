...
ImageNote = _reflection.GeneratedProtocolMessageType('ImageNote', (_message.Message,), dict(
...
ImageOccurrence = _reflection.GeneratedProtocolMessageType('ImageOccurrence', (_message.Message,), dict(

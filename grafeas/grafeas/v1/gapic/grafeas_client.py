...
from grafeas.v1.gapic import grafeas_client_config
from grafeas.v1.gapic.transports import grafeas_grpc_transport
...
class GrafeasClient(object):
    ...
    def get_occurrence(
        ...
        Returns:
            A :class:`~grafeas.v1.types.Occurrence` instance.
    ...
    def list_occurrences(
        ...
        Returns:
            ...
            is an iterable of :class:`~grafeas.v1.types.Occurrence` instances.
    ...
    def create_occurrence(
        ...
        Args:
            ...
            occurrence (Union[dict, ~grafeas.v1.types.Occurrence]): The occurrence to create.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~grafeas.v1.types.Occurrence`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def batch_create_occurrences(
        ...
        Args:
            ...
            occurrences (list[Union[dict, ~grafeas.v1.types.Occurrence]]): The occurrences to create. Max allowed length is 1000.
        ...
        Returns:
            A :class:`~grafeas.v1.types.BatchCreateOccurrencesResponse` instance.
    ...
    def update_occurrence(
        ...
        Args:
            name (str): The name of the occurrence in the form of
                ``projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]``.
            occurrence (Union[dict, ~grafeas.v1.types.Occurrence]): The updated occurrence.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~grafeas.v1.types.Occurrence`
            update_mask (Union[dict, ~grafeas.v1.types.FieldMask]): The fields to update.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~grafeas.v1.types.FieldMask`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def get_occurrence_note(
        ...
        Returns:
            A :class:`~grafeas.v1.types.Note` instance.
    ...
    def list_notes(
        ...
        Returns:
            A :class:`~google.gax.PageIterator` instance. By default, this
            is an iterable of :class:`~grafeas.v1.types.Note` instances.
            This object can also be configured to iterate over the pages
            of the response through the `options` parameter.
    ...
    def create_note(
        ...
        Args:
            ...
            note (Union[dict, ~grafeas.v1.types.Note]): The note to create.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~grafeas.v1.types.Note`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def batch_create_notes(
        ...
        Args:
            ...
            notes (dict[str -> Union[dict, ~grafeas.v1.types.Note]]): The notes to create. Max allowed length is 1000.
        ...
        Returns:
            A :class:`~grafeas.v1.types.BatchCreateNotesResponse` instance.
    ...
    def update_note(
        ...
        Args:
            name (str): The name of the note in the form of
                ``projects/[PROVIDER_ID]/notes/[NOTE_ID]``.
            note (Union[dict, ~grafeas.v1.types.Note]): The updated note.

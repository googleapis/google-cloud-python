...
class TestGrafeasClient(object):
    ...
    def test_get_occurrence(self):
        ...
        expected_response = {'name': name_2, 'resource_uri': resource_uri, 'note_name': note_name, 'remediation': remediation}
    ...
    def test_create_occurrence(self):
        ...
        note_name = 'noteName1780787896'
        remediation = 'remediation779381797'
        expected_response = {'name': name, 'resource_uri': resource_uri, 'note_name': note_name, 'remediation': remediation}
        expected_response = grafeas_pb2.Occurrence(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = grafeas_pb2.CreateOccurrenceRequest(parent=parent, occurrence=occurrence)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_create_occurrences(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = grafeas_pb2.BatchCreateOccurrencesResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = grafeas_pb2.BatchCreateOccurrencesRequest(parent=parent, occurrences=occurrences)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_occurrence(self):
        ...
        assert len(channel.requests) == 1
        expected_request = grafeas_pb2.UpdateOccurrenceRequest(name=name, occurrence=occurrence)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_occurrence_note(self):
        ...
        expected_response = {'name': name_2, 'short_description': short_description, 'long_description': long_description}
    ...
    def test_create_note(self):
        ...
        short_description = 'shortDescription-235369287'
        long_description = 'longDescription-1747792199'
        expected_response = {'name': name, 'short_description': short_description, 'long_description': long_description}
        expected_response = grafeas_pb2.Note(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = grafeas_pb2.CreateNoteRequest(parent=parent, note_id=note_id, note=note)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_create_notes(self):
        ...
        assert len(channel.requests) == 1
        expected_request = grafeas_pb2.BatchCreateNotesRequest(parent=parent, notes=notes)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request

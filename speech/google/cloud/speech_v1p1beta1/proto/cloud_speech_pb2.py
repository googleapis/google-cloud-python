...
_RECOGNITIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='model', full_name='google.cloud.speech.v1p1beta1.RecognitionConfig.model', index=7,

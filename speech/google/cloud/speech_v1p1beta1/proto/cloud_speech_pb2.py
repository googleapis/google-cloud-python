...
SpeakerDiarizationConfig = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
      ...
      min_speaker_count:
          *Optional* Only used if diarization\_speaker\_count is not
          set. Minimum number of speakers in the conversation. This
      ...
      max_speaker_count:
          *Optional* Only used if diarization\_speaker\_count is not
          set. Maximum number of speakers in the conversation. This
          range gives you more flexibility by allowing the system to
          automatically determine the correct number of speakers. If not
...
_SPEECH = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002 "\033/v1p1beta1/speech:recognize:\001*'
            ),
        ),
        _descriptor.MethodDescriptor(

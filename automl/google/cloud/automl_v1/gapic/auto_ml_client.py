...
"""Accesses the google.cloud.automl.v1 AutoMl API."""
...
class AutoMlClient(object):
    ...
    _INTERFACE_NAME = "google.cloud.automl.v1.AutoMl"
    ...
    def update_dataset(
        ...
        Args:
            dataset (Union[dict, ~google.cloud.automl_v1.types.Dataset]): The dataset which replaces the resource on the server.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.automl_v1.types.Dataset`
            update_mask (Union[dict, ~google.cloud.automl_v1.types.FieldMask]): Required. The update mask applies to the resource.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.automl_v1.types.FieldMask`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.cloud.automl_v1.types.Dataset` instance.
    ...
    def list_datasets(
        ...
        Returns:
            ...
            An iterable of :class:`~google.cloud.automl_v1.types.Dataset` instances.
    ...
    def import_data(
        ...
        Args:
            ...
            input_config (Union[dict, ~google.cloud.automl_v1.types.InputConfig]): Required. The desired input location and its domain specific semantics,
                if any.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.automl_v1.types.InputConfig`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def export_data(
        ...
        Args:
            ...
            output_config (Union[dict, ~google.cloud.automl_v1.types.OutputConfig]): Required. The desired output location.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.automl_v1.types.OutputConfig`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def get_annotation_spec(
        ...
        Returns:
            A :class:`~google.cloud.automl_v1.types.AnnotationSpec` instance.
    ...
    def get_model(
        ...
        Returns:
            A :class:`~google.cloud.automl_v1.types.Model` instance.
    ...
    def update_model(
        ...
        if "update_model" not in self._inner_api_calls:
            self._inner_api_calls[
                ...
                self.transport.update_model,
                default_retry=self._method_configs["UpdateModel"].retry,
                default_timeout=self._method_configs["UpdateModel"].timeout,
                client_info=self._client_info,
            )

        request = service_pb2.UpdateModelRequest(model=model, update_mask=update_mask)
        if metadata is None:
            metadata = []
        metadata = list(metadata)
        try:
            routing_header = [("model.name", model.name)]
        except AttributeError:
            pass
        else:
            routing_metadata = google.api_core.gapic_v1.routing_header.to_grpc_metadata(
        ...
        return self._inner_api_calls["update_model"](
            request, retry=retry, timeout=timeout, metadata=metadata
        )
    ...
    def list_models(
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.automl_v1.types.Model` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
    ...
    def deploy_model(
        ...
        Args:
            ...
            image_object_detection_model_deployment_metadata (Union[dict, ~google.cloud.automl_v1.types.ImageObjectDetectionModelDeploymentMetadata]): Model deployment metadata specific to Image Object Detection.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.automl_v1.types.ImageObjectDetectionModelDeploymentMetadata`
            image_classification_model_deployment_metadata (Union[dict, ~google.cloud.automl_v1.types.ImageClassificationModelDeploymentMetadata]): Model deployment metadata specific to Image Classification.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.automl_v1.types.ImageClassificationModelDeploymentMetadata`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def export_model(
        ...
        Args:
            ...
            output_config (Union[dict, ~google.cloud.automl_v1.types.ModelExportOutputConfig]): Required. The desired output location and configuration.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.automl_v1.types.ModelExportOutputConfig`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def get_model_evaluation(
        ...
        Returns:
            A :class:`~google.cloud.automl_v1.types.ModelEvaluation` instance.
    ...
    def list_model_evaluations(
        ...
        Example:
            ...
            >>>
            >>> # Iterate over all results
            >>> for element in client.list_model_evaluations(parent, filter_):
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>>
            >>> # Iterate over results one page at a time
            >>> for page in client.list_model_evaluations(parent, filter_).pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.automl_v1.types.ModelEvaluation` instances.
            You can also iterate over the pages of the response
            using its `pages` property.

...
PredictResponse = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      preprocessed_input:
          ...
          v1p1beta.Document.document\_text].  -  For Text
          Classification: If the input is a .pdf file, the OCR'ed
          trucated text will be provided in    [document\_text][google.c
          loud.automl.v1p1beta.Document.document\_text].  -  For Text
          Sentiment: If the input is a .pdf file, the OCR'ed trucated
          text will be provided in    [document\_text][google.cloud.auto
          ml.v1p1beta.Document.document\_text].
      metadata:

...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_io__pb2.DESCRIPTOR,])
...
_IMAGE.fields_by_name['input_config'].message_type = google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_io__pb2._INPUTCONFIG
...
TextSnippet = _reflection.GeneratedProtocolMessageType('TextSnippet', (_message.Message,), dict(
...
ExamplePayload = _reflection.GeneratedProtocolMessageType('ExamplePayload', (_message.Message,), dict(

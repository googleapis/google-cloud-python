...
_TEXTCLASSIFICATIONDATASETMETADATA.fields_by_name['classification_type'].enum_type = google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_classification__pb2._CLASSIFICATIONTYPE
...
TextClassificationDatasetMetadata = _reflection.GeneratedProtocolMessageType('TextClassificationDatasetMetadata', (_message.Message,), dict(
...
TextClassificationModelMetadata = _reflection.GeneratedProtocolMessageType('TextClassificationModelMetadata', (_message.Message,), dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\037com.google.cloud.automl.v1beta1B\tTextProtoP\001ZAgoogle.golang.org/genproto/googleapis/cloud/automl/v1beta1;automl'))

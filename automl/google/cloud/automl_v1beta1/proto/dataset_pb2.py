...
from google.cloud.automl_v1beta1.proto import image_pb2 as google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_image__pb2
from google.cloud.automl_v1beta1.proto import text_pb2 as google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_text__pb2
...
_DATASET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.automl.v1beta1.Dataset.name', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.automl.v1beta1.Dataset.display_name', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='example_count', full_name='google.cloud.automl.v1beta1.Dataset.example_count', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.automl.v1beta1.Dataset.create_time', index=6,
...
_DATASET.fields_by_name['translation_dataset_metadata'].message_type = google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_translation__pb2._TRANSLATIONDATASETMETADATA
_DATASET.fields_by_name['image_classification_dataset_metadata'].message_type = google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_image__pb2._IMAGECLASSIFICATIONDATASETMETADATA
_DATASET.fields_by_name['text_classification_dataset_metadata'].message_type = google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_text__pb2._TEXTCLASSIFICATIONDATASETMETADATA
...
Dataset = _reflection.GeneratedProtocolMessageType('Dataset', (_message.Message,), dict(
  ...
  problem. A workspace contains examples that may be annotated. (- Next
  ID: 27 -)

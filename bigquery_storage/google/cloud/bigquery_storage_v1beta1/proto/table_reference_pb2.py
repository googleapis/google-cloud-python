...
TableReference = _reflection.GeneratedProtocolMessageType('TableReference', (_message.Message,), dict(
...
TableModifiers = _reflection.GeneratedProtocolMessageType('TableModifiers', (_message.Message,), dict(

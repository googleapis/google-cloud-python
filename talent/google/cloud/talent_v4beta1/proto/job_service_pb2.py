...
_CREATEJOBREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=_b("\340A\002\372A\031\022\027jobs.googleapis.com/Job"),
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="job",
...
_GETJOBREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=_b("\340A\002\372A\031\n\027jobs.googleapis.com/Job"),
            file=DESCRIPTOR,
        )
    ],
    extensions=[],
...
SearchJobsRequest = _reflection.GeneratedProtocolMessageType(
    ...
    Attributes:
        ...
        ranking_expression:
            ...
            existing relevance score (determined by API algorithm). A
            combination of the ranking expression and relevance score is
            used to determine job's final ranking position.  The syntax
            for this expression is a subset of Google SQL syntax.
            Supported operators are: +, -, \*, /, where the left and right
            side of the operator is either a numeric [Job.custom\_attribut
            es][google.cloud.talent.v4beta1.Job.custom\_attributes] key,
            ...
            expression references custom attributes that are not populated
            on the job or if the expression results in a divide by zero.
            If an expression is invalid for a job, that job is demoted to
            the end of the results.  Sample ranking expression (year + 25)
            \* 0.25 - (freshness / 0.5)
    """,
  ...
  Attributes:
      ...
      offset:
          ...
          .page\_token] is unset.  The maximum allowed value is 5000.
          Otherwise an error is thrown.  The maximum allowed value is
          5000. Otherwise an error is thrown.  For example, 0 means to
...
_JOBSERVICE = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002X"+/v4beta1/{parent=projects/*/tenants/*}/jobs:\001*Z&"!/v4beta1/{parent=projects/*}/jobs:\001*\332A\nparent,job'
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002p"7/v4beta1/{parent=projects/*/tenants/*}/jobs:batchCreate:\001*Z2"-/v4beta1/{parent=projects/*}/jobs:batchCreate:\001*\332A\013parent,jobs\312A,\n\022JobOperationResult\022\026BatchOperationMetadata'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="GetJob",
            ...
            output_type=google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_job__pb2._JOB,
            serialized_options=_b(
                "\202\323\344\223\002R\022+/v4beta1/{name=projects/*/tenants/*/jobs/*}Z#\022!/v4beta1/{name=projects/*/jobs/*}\332A\004name"
            ),
        ),
        _descriptor.MethodDescriptor(
            name="UpdateJob",
            ...
            output_type=google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_job__pb2._JOB,
            serialized_options=_b(
                "\202\323\344\223\002`2//v4beta1/{job.name=projects/*/tenants/*/jobs/*}:\001*Z*2%/v4beta1/{job.name=projects/*/jobs/*}:\001*\332A\003job"
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
            serialized_options=_b(
                '\202\323\344\223\002p"7/v4beta1/{parent=projects/*/tenants/*}/jobs:batchUpdate:\001*Z2"-/v4beta1/{parent=projects/*}/jobs:batchUpdate:\001*\332A\013parent,jobs\312A,\n\022JobOperationResult\022\026BatchOperationMetadata'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="DeleteJob",
            ...
            serialized_options=_b(
                "\202\323\344\223\002R*+/v4beta1/{name=projects/*/tenants/*/jobs/*}Z#*!/v4beta1/{name=projects/*/jobs/*}\332A\004name"
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
            serialized_options=_b(
                '\202\323\344\223\002m"7/v4beta1/{parent=projects/*/tenants/*}/jobs:batchDelete:\001*Z/"-/v4beta1/{parent=projects/*}/jobs:batchDelete\332A\rparent,filter'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="ListJobs",
            ...
            serialized_options=_b(
                "\202\323\344\223\002R\022+/v4beta1/{parent=projects/*/tenants/*}/jobsZ#\022!/v4beta1/{parent=projects/*}/jobs\332A\rparent,filter"
            ),
        ),
        _descriptor.MethodDescriptor(
            name="SearchJobs",

...
Location = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      location_type:
          ...
          field of [PostalAddress][]. For example, "Downtown, Atlanta,
          GA, USA" has a type of [LocationType#NEIGHBORHOOD][], and
          "Kansas City, KS, USA" has a type of
      ...
      radius_miles:
          ...
          specified radius centered from [LatLng][] covers the area
...
CompensationInfo = _reflection.GeneratedProtocolMessageType(
    ...
    Attributes:
        type:
            ...
            [CompensationUnit.OTHER\_COMPENSATION\_TYPE][].
        unit:
            Optional.  Frequency of the specified amount.  Default is [Com
            pensationUnit.OTHER\_COMPENSATION\_UNIT][google.cloud.talent.v
            4beta1.CompensationInfo.CompensationUnit.OTHER\_COMPENSATION\_
            UNIT].
        compensation_amount:

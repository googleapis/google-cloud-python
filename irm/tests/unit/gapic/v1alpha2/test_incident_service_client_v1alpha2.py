...
class TestIncidentServiceClient(object):
    ...
    def test_search_incidents(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.SearchIncidentsRequest(
            parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_annotations(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.ListAnnotationsRequest(
            parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_tags(self):
        ...
        expected_response = incidents_service_pb2.ListTagsResponse(
            **expected_response)
    ...
    def test_list_signals(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.ListSignalsRequest(
            parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_signal(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.UpdateSignalRequest(
            signal=signal)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_acknowledge_signal(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.AcknowledgeSignalRequest(
            name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_artifacts(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.ListArtifactsRequest(
            parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_artifact(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.DeleteArtifactRequest(
            name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_subscriptions(self):
        ...
        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.ListSubscriptionsRequest(
            parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_subscription(self):
        ...
        # Setup Request
        name = client.subscription_path('[PROJECT]', '[INCIDENT]',
                                        '[SUBSCRIPTION]')

        client.delete_subscription(name)

        assert len(channel.requests) == 1
        expected_request = incidents_service_pb2.DeleteSubscriptionRequest(
            name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_incident_role_assignment(self):
        ...
        etag = 'etag3123477'
        expected_response = {'name': name, 'etag': etag}
        expected_response = incidents_pb2.IncidentRoleAssignment(
            **expected_response)
    ...
    def test_create_incident_role_assignment_exception(self):
        ...
        with pytest.raises(CustomException):
            client.create_incident_role_assignment(parent,
                                                   incident_role_assignment)
    ...
    def test_delete_incident_role_assignment(self):
        ...
        # Setup Request
        name = client.role_assignment_path('[PROJECT]', '[INCIDENT]',
                                           '[ROLE_ASSIGNMENT]')

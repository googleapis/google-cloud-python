...
_DATASTORE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002%\" /v1/projects/{project_id}:lookup:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='RunQuery',
    ...
    serialized_options=_b('\202\323\344\223\002\'\"\"/v1/projects/{project_id}:runQuery:\001*'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002/\"*/v1/projects/{project_id}:beginTransaction:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='Commit',
    ...
    serialized_options=_b('\202\323\344\223\002%\" /v1/projects/{project_id}:commit:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='Rollback',
    ...
    serialized_options=_b('\202\323\344\223\002\'\"\"/v1/projects/{project_id}:rollback:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='AllocateIds',
    ...
    serialized_options=_b('\202\323\344\223\002*\"%/v1/projects/{project_id}:allocateIds:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='ReserveIds',
    ...
    serialized_options=_b('\202\323\344\223\002)\"$/v1/projects/{project_id}:reserveIds:\001*'),
  ),
])
